...
func init() {gdclass.Register("EditorResourceConversionPlugin", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorResourceConversionPlugin(ptr)} })}
