...
import "github.com/AveryLucas/gogogd/classdb/AudioStreamWAV"
...
func (o *Extension[T]) Format() AudioStreamWAV.Format { return o.Super().Format() }
...
func (o *Extension[T]) SetFormat(value AudioStreamWAV.Format) *Extension[T] {
