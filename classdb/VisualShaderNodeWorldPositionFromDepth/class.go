...
func init() {gdclass.Register("VisualShaderNodeWorldPositionFromDepth", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeWorldPositionFromDepth(ptr)} })}
