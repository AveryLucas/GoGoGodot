...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_point_cloud, 0|(gdextension.SizePackedArray<<4), &struct{point_cloud gdextension.PackedArray[Vector2.XY]}{pointers.Get(gd.InternalPacked[gd.PackedVector2Array, Vector2.XY](point_cloud))})
}
...
func (o *Extension[T]) SetPointCloud(point_cloud []Vector2.XY) *Extension[T] {
	o.Super().SetPointCloud(point_cloud)
	return o
}
...
func init() {gdclass.Register("ConvexPolygonShape2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewConvexPolygonShape2D(ptr)} })}
