...
func (o *Extension[T]) GetSize() Vector3.XYZ {
	return o.Super().GetSize()
}
func (o *Extension[T]) GetPlane() Plane.NormalD {
	return o.Super().GetPlane()
}
...
func init() {gdclass.Register("XRAnchor3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewXRAnchor3D(ptr)} })}
