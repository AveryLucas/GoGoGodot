...
import "github.com/AveryLucas/gogogd/classdb/EngineProfiler"
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.register_profiler, 0|(gdextension.SizeStringName<<4)|(gdextension.SizeObject<<8), &struct{name gdextension.StringName; profiler gdextension.Object}{pointers.Get(gd.InternalStringName(name)), 	gdextension.Object(gdreference.GetObject(gdclass.GetEngineProfiler(profiler[0])[0]))})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.profiler_add_frame_data, 0|(gdextension.SizeStringName<<4)|(gdextension.SizeArray<<8), &struct{name gdextension.StringName; data gdextension.Array}{pointers.Get(gd.InternalStringName(name)), pointers.Get(gd.InternalArray(data))})
}
func (self class) ProfilerEnable(name String.Name, enable bool, arguments Array.Any)  { //gd:EngineDebugger.profiler_enable
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.profiler_enable, 0|(gdextension.SizeStringName<<4)|(gdextension.SizeBool<<8)|(gdextension.SizeArray<<12), &struct{name gdextension.StringName; enable bool; arguments gdextension.Array}{pointers.Get(gd.InternalStringName(name)), enable, pointers.Get(gd.InternalArray(arguments))})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.register_message_capture, 0|(gdextension.SizeStringName<<4)|(gdextension.SizeCallable<<8), &struct{name gdextension.StringName; callable gdextension.Callable}{pointers.Get(gd.InternalStringName(name)), pointers.Get(gd.InternalCallable(callable))})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.send_message, 0|(gdextension.SizeString<<4)|(gdextension.SizeArray<<8), &struct{message gdextension.String; data gdextension.Array}{pointers.Get(gd.InternalString(message)), pointers.Get(gd.InternalArray(data))})
}
func (self class) Debug(can_continue bool, is_error_breakpoint bool)  { //gd:EngineDebugger.debug
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.debug, 0|(gdextension.SizeBool<<4)|(gdextension.SizeBool<<8), &struct{can_continue bool; is_error_breakpoint bool}{can_continue, is_error_breakpoint})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.script_debug, 0|(gdextension.SizeObject<<4)|(gdextension.SizeBool<<8)|(gdextension.SizeBool<<12), &struct{language gdextension.Object; can_continue bool; is_error_breakpoint bool}{	gdextension.Object(gdreference.GetObject(gdclass.GetScriptLanguage(language[0])[0])), can_continue, is_error_breakpoint})
}
...
once.Do(singleton)
		var r_ret = noescape.Call[bool]( gdreference.GetObject(self.AsObject()[0]), methods.is_breakpoint, gdextension.SizeBool|(gdextension.SizeInt<<4)|(gdextension.SizeStringName<<8), &struct{line int64; source gdextension.StringName}{line, pointers.Get(gd.InternalStringName(source))})
	var ret = r_ret
	return ret
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.insert_breakpoint, 0|(gdextension.SizeInt<<4)|(gdextension.SizeStringName<<8), &struct{line int64; source gdextension.StringName}{line, pointers.Get(gd.InternalStringName(source))})
}
func (self class) RemoveBreakpoint(line int64, source String.Name)  { //gd:EngineDebugger.remove_breakpoint
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.remove_breakpoint, 0|(gdextension.SizeInt<<4)|(gdextension.SizeStringName<<8), &struct{line int64; source gdextension.StringName}{line, pointers.Get(gd.InternalStringName(source))})
}
...
func init() {gdclass.Register("EngineDebugger", func(ptr gdreference.Object) any { return Instance{gdclass.NewEngineDebugger(ptr)} })}
