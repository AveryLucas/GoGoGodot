...
func (o *Extension[T]) TextureRdRid() RID.Texture { return o.Super().TextureRdRid() }
...
func init() {gdclass.Register("TextureLayeredRD", func(ptr gdreference.Object) any { return Instance{gdclass.NewTextureLayeredRD(ptr)} })}
