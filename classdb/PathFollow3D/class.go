...
func (o *Extension[T]) RotationMode() RotationMode { return o.Super().RotationMode() }
...
func (o *Extension[T]) SetRotationMode(value RotationMode) *Extension[T] {
	o.Super().SetRotationMode(value)
	return o
}
...
func (o *Extension[T]) UseModelFront() bool { return o.Super().UseModelFront() }
...
func (o *Extension[T]) SetUseModelFront(value bool) *Extension[T] {
	o.Super().SetUseModelFront(value)
	return o
}
...
func (o *Extension[T]) TiltEnabled() bool { return o.Super().TiltEnabled() }
...
func (o *Extension[T]) SetTiltEnabled(value bool) *Extension[T] {
	o.Super().SetTiltEnabled(value)
	return o
}
...
func (self class) CorrectPosture(transform Transform3D.BasisOrigin, rotation_mode RotationMode) Transform3D.BasisOrigin { //gd:PathFollow3D.correct_posture
	var r_ret = noescape.CallStatic[Transform3D.BasisOrigin]( methods.correct_posture, gdextension.SizeTransform3D|(gdextension.SizeTransform3D<<4)|(gdextension.SizeInt<<8), &struct{transform Transform3D.BasisOrigin; rotation_mode RotationMode}{gd.Transposed(transform), rotation_mode})
...
func init() {gdclass.Register("PathFollow3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewPathFollow3D(ptr)} })}
