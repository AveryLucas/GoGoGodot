...
func (o *Extension[T]) BodyType() string { return o.Super().BodyType() }
...
func (o *Extension[T]) SetBodyType(value string) *Extension[T] {
	o.Super().SetBodyType(value)
	return o
}
...
func (o *Extension[T]) InertiaDiagonal() Vector3.XYZ { return o.Super().InertiaDiagonal() }
...
func (o *Extension[T]) SetInertiaDiagonal(value Vector3.XYZ) *Extension[T] {
	o.Super().SetInertiaDiagonal(value)
	return o
}
...
func (o *Extension[T]) InertiaOrientation() Quaternion.IJKX { return o.Super().InertiaOrientation() }
...
func (o *Extension[T]) SetInertiaOrientation(value Quaternion.IJKX) *Extension[T] {
	o.Super().SetInertiaOrientation(value)
	return o
}
...
func (o *Extension[T]) InertiaTensor() Basis.XYZ { return o.Super().InertiaTensor() }
...
func (o *Extension[T]) SetInertiaTensor(value Basis.XYZ) *Extension[T] {
	o.Super().SetInertiaTensor(value)
	return o
}
...
func (self class) GetInertiaDiagonal() Vector3.XYZ { //gd:GLTFPhysicsBody.get_inertia_diagonal
	var r_ret = noescape.Call[Vector3.XYZ]( gd.ObjectChecked(self.AsObject()), methods.get_inertia_diagonal, gdextension.SizeVector3, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetInertiaOrientation() Quaternion.IJKX { //gd:GLTFPhysicsBody.get_inertia_orientation
	var r_ret = noescape.Call[Quaternion.IJKX]( gd.ObjectChecked(self.AsObject()), methods.get_inertia_orientation, gdextension.SizeQuaternion, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (o *Extension[T]) ToNode() CollisionObject3D.Instance {
...
func init() {gdclass.Register("GLTFPhysicsBody", func(ptr gdreference.Object) any { return Instance{gdclass.NewGLTFPhysicsBody(ptr)} })}
