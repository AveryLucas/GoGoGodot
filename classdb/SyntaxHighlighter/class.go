...
func (o *Extension[T]) GetLineSyntaxHighlighting(line int) map[int]Entry {
	return o.Super().GetLineSyntaxHighlighting(line)
}
func (o *Extension[T]) UpdateCache() {
	o.Super().UpdateCache()
}
func (o *Extension[T]) ClearHighlightingCache() {
	o.Super().ClearHighlightingCache()
}
func (o *Extension[T]) GetTextEdit() TextEdit.Instance {
	return o.Super().GetTextEdit()
}
...
func init() {gdclass.Register("SyntaxHighlighter", func(ptr gdreference.Object) any { return Instance{gdclass.NewSyntaxHighlighter(ptr)} })}
type Entry struct {
