...
func (o *Extension[T]) IsCurrent() bool {
	return o.Super().IsCurrent()
}
func (o *Extension[T]) GetTargetPosition() Vector2.XY {
	return o.Super().GetTargetPosition()
}
func (o *Extension[T]) GetScreenCenterPosition() Vector2.XY {
	return o.Super().GetScreenCenterPosition()
}
func (o *Extension[T]) GetScreenRotation() Angle.Radians {
	return o.Super().GetScreenRotation()
}
func (o *Extension[T]) ForceUpdateScroll() {
	o.Super().ForceUpdateScroll()
}
func (o *Extension[T]) ResetSmoothing() {
	o.Super().ResetSmoothing()
}
func (o *Extension[T]) Align() {
	o.Super().Align()
}
