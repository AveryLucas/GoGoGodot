...
func (o *Extension[T]) DefaultValue() Color.RGBA { return o.Super().DefaultValue() }
...
func (o *Extension[T]) SetDefaultValue(value Color.RGBA) *Extension[T] {
...
func init() {gdclass.Register("VisualShaderNodeColorParameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeColorParameter(ptr)} })}
