...
func (o *Extension[T]) TextureMode() TextureMode { return o.Super().TextureMode() }
...
func (o *Extension[T]) SetTextureMode(value TextureMode) *Extension[T] {
...
func init() {gdclass.Register("CurveTexture", func(ptr gdreference.Object) any { return Instance{gdclass.NewCurveTexture(ptr)} })}
