...
import "github.com/AveryLucas/gogogd/classdb/ScrollBar"
...
// OnScrolling is promoted from [ScrollBar.Instance.OnScrolling].
...
// OnScrolling is promoted from [ScrollBar.Instance.OnScrolling].
func (o *Extension[T]) OnScrolling(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("scrolling"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
// CustomStep is promoted from [ScrollBar.Instance.CustomStep].
func (self Instance) CustomStep() Float.X { return self.AsScrollBar().CustomStep() }
func (o *Extension[T]) CustomStep() Float.X { return o.Super().AsScrollBar().CustomStep() }

// SetCustomStep is promoted from [ScrollBar.Instance.SetCustomStep].
func (self Instance) SetCustomStep(value Float.X) Instance {
	self.AsScrollBar().SetCustomStep(value)
	return self
}
func (o *Extension[T]) SetCustomStep(value Float.X) *Extension[T] {
	o.Super().AsScrollBar().SetCustomStep(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(ScrollBar.Advanced(self.AsScrollBar()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(ScrollBar.Instance(self.AsScrollBar()), name)
	}
}
func init() {gdclass.Register("VScrollBar", func(ptr gdreference.Object) any { return Instance{gdclass.NewVScrollBar(ptr)} })}
