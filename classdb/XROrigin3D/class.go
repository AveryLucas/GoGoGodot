...
func (o *Extension[T]) WorldScale() Float.X { return o.Super().WorldScale() }
...
func (o *Extension[T]) SetWorldScale(value Float.X) *Extension[T] {
	o.Super().SetWorldScale(value)
	return o
}
...
func init() {gdclass.Register("XROrigin3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewXROrigin3D(ptr)} })}
