...
func (o *Extension[T]) Axis() Input.JoyAxis { return o.Super().Axis() }
...
func (o *Extension[T]) SetAxis(value Input.JoyAxis) *Extension[T] {
...
func (o *Extension[T]) AxisValue() Float.X { return o.Super().AxisValue() }
...
func (o *Extension[T]) SetAxisValue(value Float.X) *Extension[T] {
	o.Super().SetAxisValue(value)
	return o
}
...
func init() {gdclass.Register("InputEventJoypadMotion", func(ptr gdreference.Object) any { return Instance{gdclass.NewInputEventJoypadMotion(ptr)} })}
