...
func (o *Extension[T]) Polyphony() int { return o.Super().Polyphony() }
...
func (o *Extension[T]) SetPolyphony(value int) *Extension[T] {
	o.Super().SetPolyphony(value)
	return o
}
...
func init() {gdclass.Register("AudioStreamPolyphonic", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioStreamPolyphonic(ptr)} })}
