...
import "github.com/AveryLucas/gogogd/classdb/VisualShader"
import "github.com/AveryLucas/gogogd/classdb/VisualShaderNode"
import "github.com/AveryLucas/gogogd/classdb/VisualShaderNodeVarying"
...
func (self Instance) VaryingName() string { return self.AsVisualShaderNodeVarying().VaryingName() }
...
func (self Instance) SetVaryingName(value string) Instance {
	self.AsVisualShaderNodeVarying().SetVaryingName(value)
	return self
}
...
func (self Instance) VaryingType() VisualShader.VaryingType { return self.AsVisualShaderNodeVarying().VaryingType() }
...
func (self Instance) SetVaryingType(value VisualShader.VaryingType) Instance {
	self.AsVisualShaderNodeVarying().SetVaryingType(value)
	return self
}
