...
func (o *Extension[T]) KeepAspect() KeepAspect { return o.Super().KeepAspect() }
...
func (o *Extension[T]) SetKeepAspect(value KeepAspect) *Extension[T] {
	o.Super().SetKeepAspect(value)
	return o
}
...
func (o *Extension[T]) CullMask() int { return o.Super().CullMask() }
...
func (o *Extension[T]) Attributes() CameraAttributes.Instance { return o.Super().Attributes() }
...
func (o *Extension[T]) Compositor() Compositor.Instance { return o.Super().Compositor() }
...
func (o *Extension[T]) HOffset() Float.X { return o.Super().HOffset() }
...
func (o *Extension[T]) VOffset() Float.X { return o.Super().VOffset() }
...
func (o *Extension[T]) DopplerTracking() DopplerTracking { return o.Super().DopplerTracking() }
...
func (o *Extension[T]) SetDopplerTracking(value DopplerTracking) *Extension[T] {
	o.Super().SetDopplerTracking(value)
	return o
}
...
func (o *Extension[T]) Projection() ProjectionType { return o.Super().Projection() }
...
func (o *Extension[T]) SetProjection(value ProjectionType) *Extension[T] {
	o.Super().SetProjection(value)
	return o
}
...
func (o *Extension[T]) Current() bool { return o.Super().Current() }
...
func (o *Extension[T]) FrustumOffset() Vector2.XY { return o.Super().FrustumOffset() }
...
func (o *Extension[T]) SetFrustumOffset(value Vector2.XY) *Extension[T] {
	o.Super().SetFrustumOffset(value)
	return o
}
...
func (o *Extension[T]) Near() Float.X { return o.Super().Near() }
...
func (o *Extension[T]) Far() Float.X { return o.Super().Far() }
