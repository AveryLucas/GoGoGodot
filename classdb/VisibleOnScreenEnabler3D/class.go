...
import "github.com/AveryLucas/gogogd/classdb/VisibleOnScreenNotifier3D"
...
func (o class) AsVisibleOnScreenNotifier3D() VisibleOnScreenNotifier3D.Advanced { return *(*VisibleOnScreenNotifier3D.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsVisibleOnScreenNotifier3D() VisibleOnScreenNotifier3D.Instance { return o.Super().AsVisibleOnScreenNotifier3D() }
func (o Instance) AsVisibleOnScreenNotifier3D() VisibleOnScreenNotifier3D.Instance { return *(*VisibleOnScreenNotifier3D.Instance)(ie.As(&o)) }
...
// OnScreenEntered is promoted from [VisibleOnScreenNotifier3D.Instance.OnScreenEntered].
...
// OnScreenExited is promoted from [VisibleOnScreenNotifier3D.Instance.OnScreenExited].
...
// IsOnScreen is promoted from [VisibleOnScreenNotifier3D.Instance.IsOnScreen].
func (self Instance) IsOnScreen() bool {
	return self.AsVisibleOnScreenNotifier3D().IsOnScreen()
}

// IsOnScreen is promoted from [VisibleOnScreenNotifier3D.Instance.IsOnScreen].
func (o *Extension[T]) IsOnScreen() bool {
	return o.Super().AsVisibleOnScreenNotifier3D().IsOnScreen()
}
...
// SetAabb is promoted from [VisibleOnScreenNotifier3D.Instance.SetAabb].
func (self Instance) SetAabb(value AABB.PositionSize) Instance {
	self.AsVisibleOnScreenNotifier3D().SetAabb(value)
	return self
}
func (o *Extension[T]) SetAabb(value AABB.PositionSize) *Extension[T] {
	o.Super().AsVisibleOnScreenNotifier3D().SetAabb(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(VisibleOnScreenNotifier3D.Advanced(self.AsVisibleOnScreenNotifier3D()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(VisibleOnScreenNotifier3D.Instance(self.AsVisibleOnScreenNotifier3D()), name)
	}
}
func init() {gdclass.Register("VisibleOnScreenEnabler3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisibleOnScreenEnabler3D(ptr)} })}
