...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_default_texture_parameter, 0|(gdextension.SizeStringName<<4)|(gdextension.SizeObject<<8)|(gdextension.SizeInt<<12), &struct{name gdextension.StringName; texture gdextension.Object; index int64}{pointers.Get(gd.InternalStringName(name)), 	gdextension.Object(gdreference.GetObject(gdclass.GetTexture(texture[0])[0])), index})
}
func (self class) GetDefaultTextureParameter(name String.Name, index int64) [1]gdclass.Texture { //gd:Shader.get_default_texture_parameter
	var r_ret = noescape.Call[gdextension.Object]( gd.ObjectChecked(self.AsObject()), methods.get_default_texture_parameter, gdextension.SizeObject|(gdextension.SizeStringName<<4)|(gdextension.SizeInt<<8), &struct{name gdextension.StringName; index int64}{pointers.Get(gd.InternalStringName(name)), index})
...
func (o *Extension[T]) GetMode() Mode {
	return o.Super().GetMode()
}
...
func init() {gdclass.Register("Shader", func(ptr gdreference.Object) any { return Instance{gdclass.NewShader(ptr)} })}
