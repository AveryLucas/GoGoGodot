...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.add_resource, 0|(gdextension.SizeStringName<<4)|(gdextension.SizeObject<<8), &struct{name gdextension.StringName; resource gdextension.Object}{pointers.Get(gd.InternalStringName(name)), 	gdextension.Object(gdreference.GetObject(gdclass.GetResource(resource[0])[0]))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.rename_resource, 0|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8), &struct{name gdextension.StringName; newname gdextension.StringName}{pointers.Get(gd.InternalStringName(name)), pointers.Get(gd.InternalStringName(newname))})
}
...
func (o *Extension[T]) AddResource(name string, resource Resource.Instance) {
	o.Super().AddResource(name, resource)
}
func (o *Extension[T]) RemoveResource(name string) {
	o.Super().RemoveResource(name)
}
func (o *Extension[T]) RenameResource(name string, newname string) {
	o.Super().RenameResource(name, newname)
}
func (o *Extension[T]) HasResource(name string) bool {
	return o.Super().HasResource(name)
}
func (o *Extension[T]) GetResource(name string) Resource.Instance {
	return o.Super().GetResource(name)
}
func (o *Extension[T]) GetResourceList() []string {
	return o.Super().GetResourceList()
}
...
func init() {gdclass.Register("ResourcePreloader", func(ptr gdreference.Object) any { return Instance{gdclass.NewResourcePreloader(ptr)} })}
