...
func (o *Extension[T]) DefaultValue() Vector3.XYZ { return o.Super().DefaultValue() }
...
func (o *Extension[T]) SetDefaultValue(value Vector3.XYZ) *Extension[T] {
...
func (self class) GetDefaultValue() Vector3.XYZ { //gd:VisualShaderNodeVec3Parameter.get_default_value
	var r_ret = noescape.Call[Vector3.XYZ]( gd.ObjectChecked(self.AsObject()), methods.get_default_value, gdextension.SizeVector3, &struct{}{})
	var ret = r_ret
	return ret
}
...
func init() {gdclass.Register("VisualShaderNodeVec3Parameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeVec3Parameter(ptr)} })}
