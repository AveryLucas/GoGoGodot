...
import "github.com/AveryLucas/gogogd/classdb/RenderSceneData"
...
func (self class) Virtual(name string) reflect.Value {
	...
	default: return gd.VirtualByName(RenderSceneData.Advanced(self.AsRenderSceneData()), name)
	}
}
...
func (self Instance) Virtual(name string) reflect.Value {
	...
	case "_get_view_projection": return reflect.ValueOf(self._get_view_projection);
	case "_get_uniform_buffer": return reflect.ValueOf(self._get_uniform_buffer);
	default: return gd.VirtualByName(RenderSceneData.Instance(self.AsRenderSceneData()), name)
	}
}
func init() {gdclass.Register("RenderSceneDataExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewRenderSceneDataExtension(ptr)} })}
