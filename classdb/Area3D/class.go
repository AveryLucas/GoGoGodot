...
func (o *Extension[T]) GravityPointCenter() Vector3.XYZ { return o.Super().GravityPointCenter() }
...
func (o *Extension[T]) SetGravityPointCenter(value Vector3.XYZ) *Extension[T] {
...
func (o *Extension[T]) GravityDirection() Vector3.XYZ { return o.Super().GravityDirection() }
...
func (o *Extension[T]) SetGravityDirection(value Vector3.XYZ) *Extension[T] {
...
func (o *Extension[T]) WindForceMagnitude() Float.X { return o.Super().WindForceMagnitude() }
...
func (o *Extension[T]) SetWindForceMagnitude(value Float.X) *Extension[T] {
	o.Super().SetWindForceMagnitude(value)
	return o
}
...
func (o *Extension[T]) WindAttenuationFactor() Float.X { return o.Super().WindAttenuationFactor() }
...
func (o *Extension[T]) SetWindAttenuationFactor(value Float.X) *Extension[T] {
	o.Super().SetWindAttenuationFactor(value)
	return o
}
...
func (o *Extension[T]) WindSourcePath() string { return o.Super().WindSourcePath() }
...
func (o *Extension[T]) SetWindSourcePath(value string) *Extension[T] {
	o.Super().SetWindSourcePath(value)
	return o
}
...
func (o *Extension[T]) ReverbBusEnabled() bool { return o.Super().ReverbBusEnabled() }
...
func (o *Extension[T]) SetReverbBusEnabled(value bool) *Extension[T] {
	o.Super().SetReverbBusEnabled(value)
	return o
}
...
func (o *Extension[T]) ReverbBusName() string { return o.Super().ReverbBusName() }
...
func (o *Extension[T]) SetReverbBusName(value string) *Extension[T] {
	o.Super().SetReverbBusName(value)
	return o
}
...
func (o *Extension[T]) ReverbBusAmount() Float.X { return o.Super().ReverbBusAmount() }
...
func (o *Extension[T]) SetReverbBusAmount(value Float.X) *Extension[T] {
	o.Super().SetReverbBusAmount(value)
	return o
}
...
func (o *Extension[T]) ReverbBusUniformity() Float.X { return o.Super().ReverbBusUniformity() }
...
func (o *Extension[T]) SetReverbBusUniformity(value Float.X) *Extension[T] {
	o.Super().SetReverbBusUniformity(value)
	return o
}
...
func (o *Extension[T]) OnBodyShapeEntered(cb func(body_rid RID.Any, body Node3D.Instance, body_shape_index int, local_shape_index int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
func (o *Extension[T]) OnBodyShapeExited(cb func(body_rid RID.Any, body Node3D.Instance, body_shape_index int, local_shape_index int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
func (o *Extension[T]) OnBodyEntered(cb func(body Node3D.Instance), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
func (o *Extension[T]) OnBodyExited(cb func(body Node3D.Instance), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
func (o *Extension[T]) GetOverlappingBodies() []Node3D.Instance {
