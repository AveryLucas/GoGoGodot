...
func (o *Extension[T]) SetCapacity(capacity int) *Extension[T] {
	o.Super().SetCapacity(capacity)
	return o
}

func (self class) Virtual(name string) reflect.Value {
	switch name {
	case "_set_capacity": return reflect.ValueOf(self._set_capacity);
	case "_get_component_type": return reflect.ValueOf(self._get_component_type);
	case "_get_structure_data": return reflect.ValueOf(self._get_structure_data);
...
func init() {gdclass.Register("OpenXRSpatialComponentData", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRSpatialComponentData(ptr)} })}
