...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(CSGShape3D.Advanced(self.AsCSGShape3D()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(CSGShape3D.Instance(self.AsCSGShape3D()), name)
	}
}
func init() {gdclass.Register("CSGPrimitive3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewCSGPrimitive3D(ptr)} })}
