...
func (o *Extension[T]) Icon() Texture2D.Instance { return o.Super().Icon() }
...
func (o *Extension[T]) IconAlignment() GUI.HorizontalAlignment { return o.Super().IconAlignment() }
...
func (o *Extension[T]) SetIconAlignment(value GUI.HorizontalAlignment) *Extension[T] {
	o.Super().SetIconAlignment(value)
	return o
}
...
func (o *Extension[T]) VerticalIconAlignment() GUI.VerticalAlignment { return o.Super().VerticalIconAlignment() }
...
func (o *Extension[T]) SetVerticalIconAlignment(value GUI.VerticalAlignment) *Extension[T] {
	o.Super().SetVerticalIconAlignment(value)
	return o
}
...
func (o *Extension[T]) ExpandIcon() bool { return o.Super().ExpandIcon() }
...
func init() {gdclass.Register("Button", func(ptr gdreference.Object) any { return Instance{gdclass.NewButton(ptr)} })}
