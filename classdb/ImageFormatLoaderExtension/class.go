...
import "github.com/AveryLucas/gogogd/classdb/ImageFormatLoader"
...
func (o class) AsImageFormatLoader() ImageFormatLoader.Advanced { return *(*ImageFormatLoader.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsImageFormatLoader() ImageFormatLoader.Instance { return o.Super().AsImageFormatLoader() }
func (o Instance) AsImageFormatLoader() ImageFormatLoader.Instance { return *(*ImageFormatLoader.Instance)(ie.As(&o)) }
...
func (self class) Virtual(name string) reflect.Value {
	...
	default: return gd.VirtualByName(ImageFormatLoader.Advanced(self.AsImageFormatLoader()), name)
	}
}
...
func (self Instance) Virtual(name string) reflect.Value {
	...
	case "_get_recognized_extensions": return reflect.ValueOf(self._get_recognized_extensions);
	case "_load_image": return reflect.ValueOf(self._load_image);
	default: return gd.VirtualByName(ImageFormatLoader.Instance(self.AsImageFormatLoader()), name)
	}
}
func init() {gdclass.Register("ImageFormatLoaderExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewImageFormatLoaderExtension(ptr)} })}
