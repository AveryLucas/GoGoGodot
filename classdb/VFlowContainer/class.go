...
import "github.com/AveryLucas/gogogd/classdb/FlowContainer"
...
func (o Instance) AsFlowContainer() FlowContainer.Instance { return *(*FlowContainer.Instance)(ie.As(&o)) }
...
// GetLineCount is promoted from [FlowContainer.Instance.GetLineCount].
func (self Instance) GetLineCount() int {
	return self.AsFlowContainer().GetLineCount()
}

// GetLineCount is promoted from [FlowContainer.Instance.GetLineCount].
func (o *Extension[T]) GetLineCount() int {
	return o.Super().AsFlowContainer().GetLineCount()
}
...
// Alignment is promoted from [FlowContainer.Instance.Alignment].
func (self Instance) Alignment() FlowContainer.AlignmentMode { return self.AsFlowContainer().Alignment() }
func (o *Extension[T]) Alignment() FlowContainer.AlignmentMode { return o.Super().AsFlowContainer().Alignment() }

// SetAlignment is promoted from [FlowContainer.Instance.SetAlignment].
func (self Instance) SetAlignment(value FlowContainer.AlignmentMode) Instance {
	self.AsFlowContainer().SetAlignment(value)
	return self
}
func (o *Extension[T]) SetAlignment(value FlowContainer.AlignmentMode) *Extension[T] {
	o.Super().AsFlowContainer().SetAlignment(value)
	return o
}

// LastWrapAlignment is promoted from [FlowContainer.Instance.LastWrapAlignment].
func (self Instance) LastWrapAlignment() FlowContainer.LastWrapAlignmentMode { return self.AsFlowContainer().LastWrapAlignment() }
func (o *Extension[T]) LastWrapAlignment() FlowContainer.LastWrapAlignmentMode { return o.Super().AsFlowContainer().LastWrapAlignment() }

// SetLastWrapAlignment is promoted from [FlowContainer.Instance.SetLastWrapAlignment].
func (self Instance) SetLastWrapAlignment(value FlowContainer.LastWrapAlignmentMode) Instance {
	self.AsFlowContainer().SetLastWrapAlignment(value)
	return self
}
func (o *Extension[T]) SetLastWrapAlignment(value FlowContainer.LastWrapAlignmentMode) *Extension[T] {
	o.Super().AsFlowContainer().SetLastWrapAlignment(value)
	return o
}

// Vertical is promoted from [FlowContainer.Instance.Vertical].
func (self Instance) Vertical() bool { return self.AsFlowContainer().Vertical() }
func (o *Extension[T]) Vertical() bool { return o.Super().AsFlowContainer().Vertical() }

// SetVertical is promoted from [FlowContainer.Instance.SetVertical].
func (self Instance) SetVertical(value bool) Instance {
	self.AsFlowContainer().SetVertical(value)
	return self
}
func (o *Extension[T]) SetVertical(value bool) *Extension[T] {
	o.Super().AsFlowContainer().SetVertical(value)
	return o
}

// ReverseFill is promoted from [FlowContainer.Instance.ReverseFill].
func (self Instance) ReverseFill() bool { return self.AsFlowContainer().ReverseFill() }
func (o *Extension[T]) ReverseFill() bool { return o.Super().AsFlowContainer().ReverseFill() }

// SetReverseFill is promoted from [FlowContainer.Instance.SetReverseFill].
func (self Instance) SetReverseFill(value bool) Instance {
	self.AsFlowContainer().SetReverseFill(value)
	return self
}
func (o *Extension[T]) SetReverseFill(value bool) *Extension[T] {
	o.Super().AsFlowContainer().SetReverseFill(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(FlowContainer.Advanced(self.AsFlowContainer()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(FlowContainer.Instance(self.AsFlowContainer()), name)
	}
}
func init() {gdclass.Register("VFlowContainer", func(ptr gdreference.Object) any { return Instance{gdclass.NewVFlowContainer(ptr)} })}
