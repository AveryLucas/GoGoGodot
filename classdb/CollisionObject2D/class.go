...
func (o *Extension[T]) CollisionPriority() Float.X { return o.Super().CollisionPriority() }
...
func (o *Extension[T]) SetCollisionPriority(value Float.X) *Extension[T] {
	o.Super().SetCollisionPriority(value)
	return o
}
...
func (o *Extension[T]) InputPickable() bool { return o.Super().InputPickable() }
...
func (o *Extension[T]) SetInputPickable(value bool) *Extension[T] {
	o.Super().SetInputPickable(value)
	return o
}
