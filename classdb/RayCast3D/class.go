...
func (o *Extension[T]) HitBackFaces() bool { return o.Super().HitBackFaces() }
...
func (o *Extension[T]) SetHitBackFaces(value bool) *Extension[T] {
	o.Super().SetHitBackFaces(value)
	return o
}
...
func (o *Extension[T]) DebugShapeThickness() int { return o.Super().DebugShapeThickness() }
...
func (o *Extension[T]) SetDebugShapeThickness(value int) *Extension[T] {
	o.Super().SetDebugShapeThickness(value)
	return o
}
...
func (o *Extension[T]) GetColliderRid() RID.Body3D {
	return o.Super().GetColliderRid()
}
func (o *Extension[T]) GetColliderShape() int {
	return o.Super().GetColliderShape()
}
func (o *Extension[T]) GetCollisionPoint() Vector3.XYZ {
	return o.Super().GetCollisionPoint()
}
func (o *Extension[T]) GetCollisionNormal() Vector3.XYZ {
	return o.Super().GetCollisionNormal()
}
func (o *Extension[T]) GetCollisionFaceIndex() int {
	return o.Super().GetCollisionFaceIndex()
}
