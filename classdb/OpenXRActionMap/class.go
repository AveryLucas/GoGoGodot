...
func (o *Extension[T]) ActionSets() []OpenXRActionSet.Instance { return o.Super().ActionSets() }
...
func (o *Extension[T]) SetActionSets(value []OpenXRActionSet.Instance) *Extension[T] {
	o.Super().SetActionSets(value)
	return o
}
...
func (o *Extension[T]) InteractionProfiles() []OpenXRInteractionProfile.Instance { return o.Super().InteractionProfiles() }
...
func (o *Extension[T]) SetInteractionProfiles(value []OpenXRInteractionProfile.Instance) *Extension[T] {
	o.Super().SetInteractionProfiles(value)
	return o
}
