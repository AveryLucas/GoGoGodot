...
func (o *Extension[T]) IsHemisphere() bool { return o.Super().IsHemisphere() }
...
func (o *Extension[T]) SetIsHemisphere(value bool) *Extension[T] {
	o.Super().SetIsHemisphere(value)
	return o
}
...
func (self class) GetIsHemisphere() bool { //gd:SphereMesh.get_is_hemisphere
	var r_ret = noescape.Call[bool]( gd.ObjectChecked(self.AsObject()), methods.get_is_hemisphere, gdextension.SizeBool, &struct{}{})
	var ret = r_ret
	return ret
}
...
func init() {gdclass.Register("SphereMesh", func(ptr gdreference.Object) any { return Instance{gdclass.NewSphereMesh(ptr)} })}
