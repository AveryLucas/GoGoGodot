...
func (self class) Save(path String.Readable, public_only bool) Error.Code { //gd:CryptoKey.save
	var r_ret = noescape.Call[int64]( gd.ObjectChecked(self.AsObject()), methods.save, gdextension.SizeInt|(gdextension.SizeString<<4)|(gdextension.SizeBool<<8), &struct{path gdextension.String; public_only bool}{pointers.Get(gd.InternalString(path)), public_only})
	var ret = Error.Code(r_ret)
	return ret
}
func (self class) Load(path String.Readable, public_only bool) Error.Code { //gd:CryptoKey.load
	var r_ret = noescape.Call[int64]( gd.ObjectChecked(self.AsObject()), methods.load, gdextension.SizeInt|(gdextension.SizeString<<4)|(gdextension.SizeBool<<8), &struct{path gdextension.String; public_only bool}{pointers.Get(gd.InternalString(path)), public_only})
	var ret = Error.Code(r_ret)
	return ret
}
...
func (self class) LoadFromString(string_key String.Readable, public_only bool) Error.Code { //gd:CryptoKey.load_from_string
	var r_ret = noescape.Call[int64]( gd.ObjectChecked(self.AsObject()), methods.load_from_string, gdextension.SizeInt|(gdextension.SizeString<<4)|(gdextension.SizeBool<<8), &struct{string_key gdextension.String; public_only bool}{pointers.Get(gd.InternalString(string_key)), public_only})
	var ret = Error.Code(r_ret)
	return ret
}
...
func (o *Extension[T]) IsPublicOnly() bool {
	return o.Super().IsPublicOnly()
}
...
func init() {gdclass.Register("CryptoKey", func(ptr gdreference.Object) any { return Instance{gdclass.NewCryptoKey(ptr)} })}
