...
import "github.com/AveryLucas/gogogd/classdb/AudioStreamOggVorbis"
...
func init() {gdclass.Register("ResourceImporterOggVorbis", func(ptr gdreference.Object) any { return Instance{gdclass.NewResourceImporterOggVorbis(ptr)} })}
