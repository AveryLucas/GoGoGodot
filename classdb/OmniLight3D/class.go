...
func (o *Extension[T]) OmniShadowMode() ShadowMode { return o.Super().OmniShadowMode() }
...
func (o *Extension[T]) SetOmniShadowMode(value ShadowMode) *Extension[T] {
	o.Super().SetOmniShadowMode(value)
	return o
}
...
func init() {gdclass.Register("OmniLight3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewOmniLight3D(ptr)} })}
