...
func (o *Extension[T]) BlendDistance() Float.X { return o.Super().BlendDistance() }
...
func (o *Extension[T]) SetBlendDistance(value Float.X) *Extension[T] {
	o.Super().SetBlendDistance(value)
	return o
}
...
func (o *Extension[T]) BoxProjection() bool { return o.Super().BoxProjection() }
...
func (o *Extension[T]) SetBoxProjection(value bool) *Extension[T] {
	o.Super().SetBoxProjection(value)
	return o
}
...
func (o *Extension[T]) EnableShadows() bool { return o.Super().EnableShadows() }
...
func (o *Extension[T]) SetEnableShadows(value bool) *Extension[T] {
	o.Super().SetEnableShadows(value)
	return o
}
...
func (o *Extension[T]) ReflectionMask() int { return o.Super().ReflectionMask() }
...
func (o *Extension[T]) SetReflectionMask(value int) *Extension[T] {
	o.Super().SetReflectionMask(value)
	return o
}
...
func (o *Extension[T]) AmbientMode() AmbientMode { return o.Super().AmbientMode() }
...
func (o *Extension[T]) SetAmbientMode(value AmbientMode) *Extension[T] {
	o.Super().SetAmbientMode(value)
	return o
}
...
func (o *Extension[T]) AmbientColor() Color.RGBA { return o.Super().AmbientColor() }
...
func (o *Extension[T]) SetAmbientColor(value Color.RGBA) *Extension[T] {
	o.Super().SetAmbientColor(value)
	return o
}
...
func (o *Extension[T]) AmbientColorEnergy() Float.X { return o.Super().AmbientColorEnergy() }
...
func (o *Extension[T]) SetAmbientColorEnergy(value Float.X) *Extension[T] {
	o.Super().SetAmbientColorEnergy(value)
	return o
}
