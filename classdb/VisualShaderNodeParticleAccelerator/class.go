...
func init() {gdclass.Register("VisualShaderNodeParticleAccelerator", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeParticleAccelerator(ptr)} })}
