...
func init() {gdclass.Register("VisualShaderNodeTextureParameterTriplanar", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeTextureParameterTriplanar(ptr)} })}
