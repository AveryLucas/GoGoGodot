...
import "github.com/AveryLucas/gogogd/classdb/ImporterMesh"
...
func (o *Extension[T]) SkeletonPath() string { return o.Super().SkeletonPath() }
...
func (o *Extension[T]) SetSkeletonPath(value string) *Extension[T] {
	o.Super().SetSkeletonPath(value)
	return o
}
...
func (o *Extension[T]) LayerMask() int { return o.Super().LayerMask() }
...
func (o *Extension[T]) SetLayerMask(value int) *Extension[T] {
	o.Super().SetLayerMask(value)
	return o
}
...
func (o *Extension[T]) CastShadow() GeometryInstance3D.ShadowCastingSetting { return o.Super().CastShadow() }
...
func (o *Extension[T]) VisibilityRangeFadeMode() GeometryInstance3D.VisibilityRangeFadeMode { return o.Super().VisibilityRangeFadeMode() }
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_cast_shadows_setting, 0|(gdextension.SizeInt<<4), &struct{shadow_casting_setting GeometryInstance3D.ShadowCastingSetting}{shadow_casting_setting})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_visibility_range_fade_mode, 0|(gdextension.SizeInt<<4), &struct{mode GeometryInstance3D.VisibilityRangeFadeMode}{mode})
}
...
func init() {gdclass.Register("ImporterMeshInstance3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewImporterMeshInstance3D(ptr)} })}
