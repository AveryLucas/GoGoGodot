...
import "github.com/AveryLucas/gogogd/classdb/EditorCommandPalette"
import "github.com/AveryLucas/gogogd/classdb/EditorFileSystem"
import "github.com/AveryLucas/gogogd/classdb/EditorInspector"
import "github.com/AveryLucas/gogogd/classdb/EditorPaths"
import "github.com/AveryLucas/gogogd/classdb/EditorResourcePreview"
import "github.com/AveryLucas/gogogd/classdb/EditorSelection"
import "github.com/AveryLucas/gogogd/classdb/EditorSettings"
import "github.com/AveryLucas/gogogd/classdb/EditorToaster"
import "github.com/AveryLucas/gogogd/classdb/EditorUndoRedoManager"
import "github.com/AveryLucas/gogogd/classdb/FileSystemDock"
...
once.Do(singleton)
		var r_ret = noescape.Call[gdextension.Array]( gdreference.GetObject(self.AsObject()[0]), methods.make_mesh_previews, gdextension.SizeArray|(gdextension.SizeArray<<4)|(gdextension.SizeInt<<8), &struct{meshes gdextension.Array; preview_size int64}{pointers.Get(gd.InternalArray(meshes)), preview_size})
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.set_plugin_enabled, 0|(gdextension.SizeString<<4)|(gdextension.SizeBool<<8), &struct{plugin gdextension.String; enabled bool}{pointers.Get(gd.InternalString(plugin)), enabled})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.popup_dialog, 0|(gdextension.SizeObject<<4)|(gdextension.SizeRect2i<<8), &struct{dialog gdextension.Object; rect Rect2i.PositionSize}{	gdextension.Object(gdreference.GetObject(gdclass.GetWindow(dialog[0])[0])), rect})
}
func (self class) PopupDialogCentered(dialog [1]gdclass.Window, minsize Vector2i.XY)  { //gd:EditorInterface.popup_dialog_centered
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.popup_dialog_centered, 0|(gdextension.SizeObject<<4)|(gdextension.SizeVector2i<<8), &struct{dialog gdextension.Object; minsize Vector2i.XY}{	gdextension.Object(gdreference.GetObject(gdclass.GetWindow(dialog[0])[0])), minsize})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.popup_dialog_centered_ratio, 0|(gdextension.SizeObject<<4)|(gdextension.SizeFloat<<8), &struct{dialog gdextension.Object; ratio float64}{	gdextension.Object(gdreference.GetObject(gdclass.GetWindow(dialog[0])[0])), ratio})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.popup_dialog_centered_clamped, 0|(gdextension.SizeObject<<4)|(gdextension.SizeVector2i<<8)|(gdextension.SizeFloat<<12), &struct{dialog gdextension.Object; minsize Vector2i.XY; fallback_ratio float64}{	gdextension.Object(gdreference.GetObject(gdclass.GetWindow(dialog[0])[0])), minsize, fallback_ratio})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.popup_node_selector, 0|(gdextension.SizeCallable<<4)|(gdextension.SizeArray<<8)|(gdextension.SizeObject<<12), &struct{callback gdextension.Callable; valid_types gdextension.Array; current_value gdextension.Object}{pointers.Get(gd.InternalCallable(callback)), pointers.Get(gd.InternalArray(valid_types)), 	gdextension.Object(gdreference.GetObject(gdclass.GetNode(current_value[0])[0]))})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.popup_property_selector, 0|(gdextension.SizeObject<<4)|(gdextension.SizeCallable<<8)|(gdextension.SizePackedArray<<12)|(gdextension.SizeString<<16), &struct{obj gdextension.Object; callback gdextension.Callable; type_filter gdextension.PackedArray[int32]; current_value gdextension.String}{	gdextension.Object(gdreference.GetObject(gdclass.GetObject(obj[0])[0])), pointers.Get(gd.InternalCallable(callback)), pointers.Get(gd.InternalPacked[gd.PackedInt32Array, int32](type_filter)), pointers.Get(gd.InternalString(current_value))})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.popup_method_selector, 0|(gdextension.SizeObject<<4)|(gdextension.SizeCallable<<8)|(gdextension.SizeString<<12), &struct{obj gdextension.Object; callback gdextension.Callable; current_value gdextension.String}{	gdextension.Object(gdreference.GetObject(gdclass.GetObject(obj[0])[0])), pointers.Get(gd.InternalCallable(callback)), pointers.Get(gd.InternalString(current_value))})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.popup_quick_open, 0|(gdextension.SizeCallable<<4)|(gdextension.SizeArray<<8), &struct{callback gdextension.Callable; base_types gdextension.Array}{pointers.Get(gd.InternalCallable(callback)), pointers.Get(gd.InternalArray(base_types))})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.popup_create_dialog, 0|(gdextension.SizeCallable<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeString<<12)|(gdextension.SizeString<<16)|(gdextension.SizeArray<<20), &struct{callback gdextension.Callable; base_type gdextension.StringName; current_type gdextension.String; dialog_title gdextension.String; type_blocklist gdextension.Array}{pointers.Get(gd.InternalCallable(callback)), pointers.Get(gd.InternalStringName(base_type)), pointers.Get(gd.InternalString(current_type)), pointers.Get(gd.InternalString(dialog_title)), pointers.Get(gd.InternalArray(type_blocklist))})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.inspect_object, 0|(gdextension.SizeObject<<4)|(gdextension.SizeString<<8)|(gdextension.SizeBool<<12), &struct{obj gdextension.Object; for_property gdextension.String; inspector_only bool}{	gdextension.Object(gdreference.GetObject(gdclass.GetObject(obj[0])[0])), pointers.Get(gd.InternalString(for_property)), inspector_only})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.edit_script, 0|(gdextension.SizeObject<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeBool<<16), &struct{script gdextension.Object; line int64; column int64; grab_focus bool}{	gdextension.Object(gdreference.GetObject(gdclass.GetScript(script[0])[0])), line, column, grab_focus})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.open_scene_from_path, 0|(gdextension.SizeString<<4)|(gdextension.SizeBool<<8), &struct{scene_filepath gdextension.String; set_inherited bool}{pointers.Get(gd.InternalString(scene_filepath)), set_inherited})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.set_object_edited, 0|(gdextension.SizeObject<<4)|(gdextension.SizeBool<<8), &struct{obj gdextension.Object; edited bool}{	gdextension.Object(gdreference.GetObject(gdclass.GetObject(obj[0])[0])), edited})
}
...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.save_scene_as, 0|(gdextension.SizeString<<4)|(gdextension.SizeBool<<8), &struct{path gdextension.String; with_preview bool}{pointers.Get(gd.InternalString(path)), with_preview})
}
...
func init() {gdclass.Register("EditorInterface", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorInterface(ptr)} })}
