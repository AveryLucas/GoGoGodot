...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.setup, 0|(gdextension.SizeObject<<4)|(gdextension.SizeObject<<8), &struct{action_map gdextension.Object; interaction_profile gdextension.Object}{	gdextension.Object(gdreference.GetObject(gdclass.GetOpenXRActionMap(action_map[0])[0])), 	gdextension.Object(gdreference.GetObject(gdclass.GetOpenXRInteractionProfile(interaction_profile[0])[0]))})
}
...
func (o *Extension[T]) Setup(action_map OpenXRActionMap.Instance, interaction_profile OpenXRInteractionProfile.Instance) {
	o.Super().Setup(action_map, interaction_profile)
}
...
func init() {gdclass.Register("OpenXRInteractionProfileEditorBase", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRInteractionProfileEditorBase(ptr)} })}
