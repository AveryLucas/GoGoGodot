...
func init() {gdclass.Register("VisualShaderNodeParticleRingEmitter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeParticleRingEmitter(ptr)} })}
