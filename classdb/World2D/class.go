...
func (o *Extension[T]) Canvas() RID.Canvas { return o.Super().Canvas() }
...
func (o *Extension[T]) NavigationMap() RID.NavigationMap2D { return o.Super().NavigationMap() }

func (self Instance) Space() RID.Space2D { //gd:World2D.space
		return RID.Space2D(RID.Space2D(class(self).GetSpace()))
}

func (o *Extension[T]) Space() RID.Space2D { return o.Super().Space() }
...
func (o *Extension[T]) DirectSpaceState() PhysicsDirectSpaceState2D.Instance { return o.Super().DirectSpaceState() }
...
func init() {gdclass.Register("World2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewWorld2D(ptr)} })}
