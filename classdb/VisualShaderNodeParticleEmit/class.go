...
func (o *Extension[T]) Flags() EmitFlags { return o.Super().Flags() }
...
func (o *Extension[T]) SetFlags(value EmitFlags) *Extension[T] {
...
func init() {gdclass.Register("VisualShaderNodeParticleEmit", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeParticleEmit(ptr)} })}
