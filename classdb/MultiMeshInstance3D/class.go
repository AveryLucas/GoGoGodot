...
func (o *Extension[T]) Multimesh() MultiMesh.Instance { return o.Super().Multimesh() }
...
func (o *Extension[T]) SetMultimesh(value MultiMesh.Instance) *Extension[T] {
	o.Super().SetMultimesh(value)
	return o
}
...
func init() {gdclass.Register("MultiMeshInstance3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewMultiMeshInstance3D(ptr)} })}
