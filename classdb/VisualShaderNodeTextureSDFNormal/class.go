...
func init() {gdclass.Register("VisualShaderNodeTextureSDFNormal", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeTextureSDFNormal(ptr)} })}
