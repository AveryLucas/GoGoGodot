...
func init() {gdclass.Register("EditorExportPlatformAppleEmbedded", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorExportPlatformAppleEmbedded(ptr)} })}
type File struct {
Path string `gd:"path"`
Tags []string `gd:"tags"`
