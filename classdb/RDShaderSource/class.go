...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_stage_source, 0|(gdextension.SizeInt<<4)|(gdextension.SizeString<<8), &struct{stage Rendering.ShaderStage; source gdextension.String}{stage, pointers.Get(gd.InternalString(source))})
}
...
func init() {gdclass.Register("RDShaderSource", func(ptr gdreference.Object) any { return Instance{gdclass.NewRDShaderSource(ptr)} })}
