...
func (o *Extension[T]) TextureScale() Float.X { return o.Super().TextureScale() }
...
func (o *Extension[T]) SetTextureScale(value Float.X) *Extension[T] {
	o.Super().SetTextureScale(value)
	return o
}
...
func init() {gdclass.Register("PointLight2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewPointLight2D(ptr)} })}
