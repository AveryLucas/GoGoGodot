...
func init() {gdclass.Register("OpenXRSpatialMarkerTrackingCapability", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRSpatialMarkerTrackingCapability(ptr)} })}
