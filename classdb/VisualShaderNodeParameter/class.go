...
func (o *Extension[T]) ParameterName() string { return o.Super().ParameterName() }
...
func (o *Extension[T]) SetParameterName(value string) *Extension[T] {
	o.Super().SetParameterName(value)
	return o
}
...
func (o *Extension[T]) Qualifier() Qualifier { return o.Super().Qualifier() }
...
func (o *Extension[T]) SetQualifier(value Qualifier) *Extension[T] {
	o.Super().SetQualifier(value)
	return o
}
...
func (o *Extension[T]) InstanceIndex() int { return o.Super().InstanceIndex() }
...
func (o *Extension[T]) SetInstanceIndex(value int) *Extension[T] {
	o.Super().SetInstanceIndex(value)
	return o
}
...
func init() {gdclass.Register("VisualShaderNodeParameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeParameter(ptr)} })}
