...
func (o *Extension[T]) Constant() Quaternion.IJKX { return o.Super().Constant() }
...
func (o *Extension[T]) SetConstant(value Quaternion.IJKX) *Extension[T] {
...
func init() {gdclass.Register("VisualShaderNodeVec4Constant", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeVec4Constant(ptr)} })}
