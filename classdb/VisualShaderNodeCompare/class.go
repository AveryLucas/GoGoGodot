...
func (o *Extension[T]) Type() ComparisonType { return o.Super().Type() }
...
func (o *Extension[T]) SetType(value ComparisonType) *Extension[T] {
...
func (o *Extension[T]) Condition() Condition { return o.Super().Condition() }
...
func (o *Extension[T]) SetCondition(value Condition) *Extension[T] {
	o.Super().SetCondition(value)
	return o
}
...
func init() {gdclass.Register("VisualShaderNodeCompare", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeCompare(ptr)} })}
