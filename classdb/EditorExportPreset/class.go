...
func (self class) GetFileExportMode(path String.Readable, def FileExportMode) FileExportMode { //gd:EditorExportPreset.get_file_export_mode
	var r_ret = noescape.Call[FileExportMode]( gd.ObjectChecked(self.AsObject()), methods.get_file_export_mode, gdextension.SizeInt|(gdextension.SizeString<<4)|(gdextension.SizeInt<<8), &struct{path gdextension.String; def FileExportMode}{pointers.Get(gd.InternalString(path)), def})
	var ret = r_ret
	return ret
}
...
func (self class) GetOrEnv(name String.Name, env_var String.Readable) variant.Any { //gd:EditorExportPreset.get_or_env
	var r_ret = noescape.Call[gdextension.Variant]( gd.ObjectChecked(self.AsObject()), methods.get_or_env, gdextension.SizeVariant|(gdextension.SizeStringName<<4)|(gdextension.SizeString<<8), &struct{name gdextension.StringName; env_var gdextension.String}{pointers.Get(gd.InternalStringName(name)), pointers.Get(gd.InternalString(env_var))})
	var ret = variant.Implementation(gd.VariantProxy{}, pointers.Pack(pointers.New[gd.Variant](r_ret)))
	return ret
}
func (self class) GetVersion(name String.Name, windows_version bool) String.Readable { //gd:EditorExportPreset.get_version
	var r_ret = noescape.Call[gdextension.String]( gd.ObjectChecked(self.AsObject()), methods.get_version, gdextension.SizeString|(gdextension.SizeStringName<<4)|(gdextension.SizeBool<<8), &struct{name gdextension.StringName; windows_version bool}{pointers.Get(gd.InternalStringName(name)), windows_version})
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func init() {gdclass.Register("EditorExportPreset", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorExportPreset(ptr)} })}
