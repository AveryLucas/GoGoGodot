...
func (o *Extension[T]) From() Vector3.XYZ { return o.Super().From() }
...
func (o *Extension[T]) SetFrom(value Vector3.XYZ) *Extension[T] {
...
func (o *Extension[T]) To() Vector3.XYZ { return o.Super().To() }
...
func (o *Extension[T]) SetTo(value Vector3.XYZ) *Extension[T] {
	o.Super().SetTo(value)
	return o
}
...
func (self class) Create(from Vector3.XYZ, to Vector3.XYZ, collision_mask int64, exclude Array.Contains[RID.Any]) [1]gdclass.PhysicsRayQueryParameters3D { //gd:PhysicsRayQueryParameters3D.create
	var r_ret = noescape.CallStatic[gdextension.Object]( methods.create, gdextension.SizeObject|(gdextension.SizeVector3<<4)|(gdextension.SizeVector3<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeArray<<16), &struct{from Vector3.XYZ; to Vector3.XYZ; collision_mask int64; exclude gdextension.Array}{from, to, collision_mask, pointers.Get(gd.InternalArray(exclude))})
...
func init() {gdclass.Register("PhysicsRayQueryParameters3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewPhysicsRayQueryParameters3D(ptr)} })}
