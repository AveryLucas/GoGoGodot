...
func (o class) AsEditorSyntaxHighlighter() EditorSyntaxHighlighter.Advanced { return *(*EditorSyntaxHighlighter.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsEditorSyntaxHighlighter() EditorSyntaxHighlighter.Instance { return o.Super().AsEditorSyntaxHighlighter() }
func (o Instance) AsEditorSyntaxHighlighter() EditorSyntaxHighlighter.Instance { return *(*EditorSyntaxHighlighter.Instance)(ie.As(&o)) }
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(EditorSyntaxHighlighter.Advanced(self.AsEditorSyntaxHighlighter()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(EditorSyntaxHighlighter.Instance(self.AsEditorSyntaxHighlighter()), name)
	}
}
func init() {gdclass.Register("GDScriptSyntaxHighlighter", func(ptr gdreference.Object) any { return Instance{gdclass.NewGDScriptSyntaxHighlighter(ptr)} })}
type Entry struct {
