...
func (o *Extension[T]) ModificationCount() int { return o.Super().ModificationCount() }
...
func (o *Extension[T]) SetModificationCount(value int) *Extension[T] {
	o.Super().SetModificationCount(value)
	return o
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.execute, 0|(gdextension.SizeFloat<<4)|(gdextension.SizeInt<<8), &struct{delta float64; execution_mode int64}{delta, execution_mode})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_modification, 0|(gdextension.SizeInt<<4)|(gdextension.SizeObject<<8), &struct{mod_idx int64; modification gdextension.Object}{mod_idx, 	gdextension.Object(gdreference.GetObject(gdclass.GetSkeletonModification2D(modification[0])[0]))})
}
...
func (o *Extension[T]) Setup() {
	o.Super().Setup()
}
func (o *Extension[T]) Execute(delta Float.X, execution_mode int) {
	o.Super().Execute(delta, execution_mode)
}
func (o *Extension[T]) EnableAllModifications(enabled bool) {
	o.Super().EnableAllModifications(enabled)
}
func (o *Extension[T]) DeleteModification(mod_idx int) {
	o.Super().DeleteModification(mod_idx)
}
...
func init() {gdclass.Register("SkeletonModificationStack2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewSkeletonModificationStack2D(ptr)} })}
