...
func (self class) Virtual(name string) reflect.Value {
	...
	case "_set_anisotropic_filtering_level": return reflect.ValueOf(self._set_anisotropic_filtering_level);
...
func init() {gdclass.Register("RenderSceneBuffersExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewRenderSceneBuffersExtension(ptr)} })}
