...
func (self class) SetDropcap(text String.Readable, font [1]gdclass.Font, font_size int64, dropcap_margins Rect2.PositionSize, language String.Readable) bool { //gd:TextParagraph.set_dropcap
	var r_ret = noescape.Call[bool]( gd.ObjectChecked(self.AsObject()), methods.set_dropcap, gdextension.SizeBool|(gdextension.SizeString<<4)|(gdextension.SizeObject<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeRect2<<16)|(gdextension.SizeString<<20), &struct{text gdextension.String; font gdextension.Object; font_size int64; dropcap_margins Rect2.PositionSize; language gdextension.String}{pointers.Get(gd.InternalString(text)), 	gdextension.Object(gdreference.GetObject(gdclass.GetFont(font[0])[0])), font_size, dropcap_margins, pointers.Get(gd.InternalString(language))})
	var ret = r_ret
	return ret
}
...
func (self class) GetLineObjectRect(line int64, key variant.Any) Rect2.PositionSize { //gd:TextParagraph.get_line_object_rect
	var r_ret = noescape.Call[Rect2.PositionSize]( gd.ObjectChecked(self.AsObject()), methods.get_line_object_rect, gdextension.SizeRect2|(gdextension.SizeInt<<4)|(gdextension.SizeVariant<<8), &struct{line int64; key gdextension.Variant}{line, gdextension.Variant(pointers.Get(gd.InternalVariant(key)))})
	var ret = r_ret
	return ret
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.draw, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeColor<<12)|(gdextension.SizeColor<<16)|(gdextension.SizeFloat<<20), &struct{canvas RID.Any; pos Vector2.XY; color Color.RGBA; dc_color Color.RGBA; oversampling float64}{canvas, pos, color, dc_color, oversampling})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.draw_outline, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeColor<<16)|(gdextension.SizeColor<<20)|(gdextension.SizeFloat<<24), &struct{canvas RID.Any; pos Vector2.XY; outline_size int64; color Color.RGBA; dc_color Color.RGBA; oversampling float64}{canvas, pos, outline_size, color, dc_color, oversampling})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.draw_line, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeColor<<16)|(gdextension.SizeFloat<<20), &struct{canvas RID.Any; pos Vector2.XY; line int64; color Color.RGBA; oversampling float64}{canvas, pos, line, color, oversampling})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.draw_line_outline, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeInt<<16)|(gdextension.SizeColor<<20)|(gdextension.SizeFloat<<24), &struct{canvas RID.Any; pos Vector2.XY; line int64; outline_size int64; color Color.RGBA; oversampling float64}{canvas, pos, line, outline_size, color, oversampling})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.draw_dropcap, 0|(gdextension.SizeRID<<4)|(gdextension.SizeVector2<<8)|(gdextension.SizeColor<<12)|(gdextension.SizeFloat<<16), &struct{canvas RID.Any; pos Vector2.XY; color Color.RGBA; oversampling float64}{canvas, pos, color, oversampling})
}
...
func init() {gdclass.Register("TextParagraph", func(ptr gdreference.Object) any { return Instance{gdclass.NewTextParagraph(ptr)} })}
