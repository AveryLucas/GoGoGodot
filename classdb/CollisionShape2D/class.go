...
func (o *Extension[T]) DebugColor() Color.RGBA { return o.Super().DebugColor() }
...
func (o *Extension[T]) SetDebugColor(value Color.RGBA) *Extension[T] {
	o.Super().SetDebugColor(value)
	return o
}
...
func init() {gdclass.Register("CollisionShape2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewCollisionShape2D(ptr)} })}
