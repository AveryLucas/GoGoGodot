...
func (o *Extension[T]) CurveX() Curve.Instance { return o.Super().CurveX() }
...
func (o *Extension[T]) SetCurveX(value Curve.Instance) *Extension[T] {
	o.Super().SetCurveX(value)
	return o
}
...
func (o *Extension[T]) CurveY() Curve.Instance { return o.Super().CurveY() }
...
func (o *Extension[T]) SetCurveY(value Curve.Instance) *Extension[T] {
	o.Super().SetCurveY(value)
	return o
}
...
func (o *Extension[T]) CurveZ() Curve.Instance { return o.Super().CurveZ() }
...
func (o *Extension[T]) SetCurveZ(value Curve.Instance) *Extension[T] {
	o.Super().SetCurveZ(value)
	return o
}
...
func init() {gdclass.Register("CurveXYZTexture", func(ptr gdreference.Object) any { return Instance{gdclass.NewCurveXYZTexture(ptr)} })}
