...
func (o *Extension[T]) Suffix() string { return o.Super().Suffix() }
...
func (o *Extension[T]) SetSuffix(value string) *Extension[T] {
	o.Super().SetSuffix(value)
	return o
}
...
func (o *Extension[T]) SetReadOnly(value bool) *Extension[T] {
	o.Super().SetReadOnly(value)
	return o
}
...
func (o *Extension[T]) ControlState() ControlState { return o.Super().ControlState() }
...
func (o *Extension[T]) SetControlState(value ControlState) *Extension[T] {
	o.Super().SetControlState(value)
	return o
}
...
func (o *Extension[T]) HideSlider() bool { return o.Super().HideSlider() }
...
func (o *Extension[T]) SetHideSlider(value bool) *Extension[T] {
	o.Super().SetHideSlider(value)
	return o
}
...
func (o *Extension[T]) EditingInteger() bool { return o.Super().EditingInteger() }
...
func (o *Extension[T]) SetEditingInteger(value bool) *Extension[T] {
	o.Super().SetEditingInteger(value)
	return o
}
...
func (o *Extension[T]) OnGrabbed(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("grabbed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnUngrabbed(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("ungrabbed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnUpdownPressed(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("updown_pressed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnValueFocusEntered(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("value_focus_entered"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnValueFocusExited(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("value_focus_exited"), gd.NewCallable(cb), int64(flags_together))
	return o
}
