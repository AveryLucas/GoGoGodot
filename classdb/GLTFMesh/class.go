...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_blend_weights, 0|(gdextension.SizePackedArray<<4), &struct{blend_weights gdextension.PackedArray[float32]}{pointers.Get(gd.InternalPacked[gd.PackedFloat32Array, float32](blend_weights))})
}
...
func init() {gdclass.Register("GLTFMesh", func(ptr gdreference.Object) any { return Instance{gdclass.NewGLTFMesh(ptr)} })}
