...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_sync_stream, 0|(gdextension.SizeInt<<4)|(gdextension.SizeObject<<8), &struct{stream_index int64; audio_stream gdextension.Object}{stream_index, 	gdextension.Object(gdreference.GetObject(gdclass.GetAudioStream(audio_stream[0])[0]))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_sync_stream_volume, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct{stream_index int64; volume_db float64}{stream_index, volume_db})
}
...
func (o *Extension[T]) SetSyncStream(stream_index int, audio_stream AudioStream.Instance) *Extension[T] {
	o.Super().SetSyncStream(stream_index, audio_stream)
	return o
}
func (o *Extension[T]) GetSyncStream(stream_index int) AudioStream.Instance {
	return o.Super().GetSyncStream(stream_index)
}
func (o *Extension[T]) SetSyncStreamVolume(stream_index int, volume_db Float.X) *Extension[T] {
	o.Super().SetSyncStreamVolume(stream_index, volume_db)
	return o
}
func (o *Extension[T]) GetSyncStreamVolume(stream_index int) Float.X {
	return o.Super().GetSyncStreamVolume(stream_index)
}
...
func init() {gdclass.Register("AudioStreamSynchronized", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioStreamSynchronized(ptr)} })}
