...
func (o *Extension[T]) PatchMarginLeft() int { return o.Super().PatchMarginLeft() }
...
func (o *Extension[T]) SetPatchMarginLeft(value int) *Extension[T] {
	o.Super().SetPatchMarginLeft(value)
	return o
}
...
func (o *Extension[T]) PatchMarginTop() int { return o.Super().PatchMarginTop() }
...
func (o *Extension[T]) SetPatchMarginTop(value int) *Extension[T] {
	o.Super().SetPatchMarginTop(value)
	return o
}
...
func (o *Extension[T]) PatchMarginRight() int { return o.Super().PatchMarginRight() }
...
func (o *Extension[T]) SetPatchMarginRight(value int) *Extension[T] {
	o.Super().SetPatchMarginRight(value)
	return o
}
...
func (o *Extension[T]) PatchMarginBottom() int { return o.Super().PatchMarginBottom() }
...
func (o *Extension[T]) SetPatchMarginBottom(value int) *Extension[T] {
	o.Super().SetPatchMarginBottom(value)
	return o
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_patch_margin, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct{margin Rect2.Side; value int64}{margin, value})
}
...
func init() {gdclass.Register("NinePatchRect", func(ptr gdreference.Object) any { return Instance{gdclass.NewNinePatchRect(ptr)} })}
