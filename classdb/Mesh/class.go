...
import "github.com/AveryLucas/gogogd/classdb/ConvexPolygonShape3D"
...
func (o *Extension[T]) LightmapSizeHint() Vector2i.XY { return o.Super().LightmapSizeHint() }
...
func (o *Extension[T]) SetLightmapSizeHint(value Vector2i.XY) *Extension[T] {
	o.Super().SetLightmapSizeHint(value)
	return o
}
