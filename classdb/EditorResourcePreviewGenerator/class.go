...
func (o *Extension[T]) RequestDrawAndWait(viewport RID.Viewport) {
	o.Super().RequestDrawAndWait(viewport)
}
...
func init() {gdclass.Register("EditorResourcePreviewGenerator", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorResourcePreviewGenerator(ptr)} })}
