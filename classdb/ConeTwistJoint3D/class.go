...
func (o *Extension[T]) SwingSpan() Float.X { return o.Super().SwingSpan() }
...
func (o *Extension[T]) SetSwingSpan(value Float.X) *Extension[T] {
	o.Super().SetSwingSpan(value)
	return o
}
...
func (o *Extension[T]) TwistSpan() Float.X { return o.Super().TwistSpan() }
...
func (o *Extension[T]) SetTwistSpan(value Float.X) *Extension[T] {
	o.Super().SetTwistSpan(value)
	return o
}
...
func (o *Extension[T]) Relaxation() Float.X { return o.Super().Relaxation() }
...
func (o *Extension[T]) SetRelaxation(value Float.X) *Extension[T] {
	o.Super().SetRelaxation(value)
	return o
}
...
func init() {gdclass.Register("ConeTwistJoint3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewConeTwistJoint3D(ptr)} })}
