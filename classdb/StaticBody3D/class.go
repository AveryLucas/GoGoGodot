...
func (o *Extension[T]) ConstantLinearVelocity() Vector3.XYZ { return o.Super().ConstantLinearVelocity() }
...
func (o *Extension[T]) ConstantAngularVelocity() Vector3.XYZ { return o.Super().ConstantAngularVelocity() }
...
func init() {gdclass.Register("StaticBody3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewStaticBody3D(ptr)} })}
