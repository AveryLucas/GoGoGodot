...
import "github.com/AveryLucas/gogogd/classdb/OpenXRActionMap"
import "github.com/AveryLucas/gogogd/classdb/OpenXRInteractionProfile"
import "github.com/AveryLucas/gogogd/classdb/OpenXRInteractionProfileEditorBase"
...
func (o class) AsOpenXRInteractionProfileEditorBase() OpenXRInteractionProfileEditorBase.Advanced { return *(*OpenXRInteractionProfileEditorBase.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsOpenXRInteractionProfileEditorBase() OpenXRInteractionProfileEditorBase.Instance { return o.Super().AsOpenXRInteractionProfileEditorBase() }
func (o Instance) AsOpenXRInteractionProfileEditorBase() OpenXRInteractionProfileEditorBase.Instance { return *(*OpenXRInteractionProfileEditorBase.Instance)(ie.As(&o)) }
...
// Setup is promoted from [OpenXRInteractionProfileEditorBase.Instance.Setup].
func (self Instance) Setup(action_map OpenXRActionMap.Instance, interaction_profile OpenXRInteractionProfile.Instance) {
	self.AsOpenXRInteractionProfileEditorBase().Setup(action_map, interaction_profile)
}

// Setup is promoted from [OpenXRInteractionProfileEditorBase.Instance.Setup].
func (o *Extension[T]) Setup(action_map OpenXRActionMap.Instance, interaction_profile OpenXRInteractionProfile.Instance) {
	o.Super().AsOpenXRInteractionProfileEditorBase().Setup(action_map, interaction_profile)
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(OpenXRInteractionProfileEditorBase.Advanced(self.AsOpenXRInteractionProfileEditorBase()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(OpenXRInteractionProfileEditorBase.Instance(self.AsOpenXRInteractionProfileEditorBase()), name)
	}
}
func init() {gdclass.Register("OpenXRInteractionProfileEditor", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRInteractionProfileEditor(ptr)} })}
