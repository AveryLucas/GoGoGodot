...
func (o *Extension[T]) GizmoExtents() Float.X { return o.Super().GizmoExtents() }
...
func (o *Extension[T]) SetGizmoExtents(value Float.X) *Extension[T] {
	o.Super().SetGizmoExtents(value)
	return o
}
...
func init() {gdclass.Register("Marker2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewMarker2D(ptr)} })}
