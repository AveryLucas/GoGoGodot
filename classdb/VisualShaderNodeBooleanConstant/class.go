...
func (o *Extension[T]) Constant() bool { return o.Super().Constant() }
...
func (o *Extension[T]) SetConstant(value bool) *Extension[T] {
...
func init() {gdclass.Register("VisualShaderNodeBooleanConstant", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeBooleanConstant(ptr)} })}
