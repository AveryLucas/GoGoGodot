...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.put_var, 0|(gdextension.SizeVariant<<4)|(gdextension.SizeBool<<8), &struct{value gdextension.Variant; full_objects bool}{gdextension.Variant(pointers.Get(gd.InternalVariant(value))), full_objects})
}
...
func init() {gdclass.Register("StreamPeer", func(ptr gdreference.Object) any { return Instance{gdclass.NewStreamPeer(ptr)} })}
