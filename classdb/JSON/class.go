...
func (o *Extension[T]) Data() any { return o.Super().Data() }
...
func (o *Extension[T]) SetData(value any) *Extension[T] {
...
func (self class) Stringify(data variant.Any, indent String.Readable, sort_keys bool, full_precision bool) String.Readable { //gd:JSON.stringify
	var r_ret = noescape.CallStatic[gdextension.String]( methods.stringify, gdextension.SizeString|(gdextension.SizeVariant<<4)|(gdextension.SizeString<<8)|(gdextension.SizeBool<<12)|(gdextension.SizeBool<<16), &struct{data gdextension.Variant; indent gdextension.String; sort_keys bool; full_precision bool}{gdextension.Variant(pointers.Get(gd.InternalVariant(data))), pointers.Get(gd.InternalString(indent)), sort_keys, full_precision})
...
func (self class) Parse(json_text String.Readable, keep_text bool) Error.Code { //gd:JSON.parse
	var r_ret = noescape.Call[int64]( gd.ObjectChecked(self.AsObject()), methods.parse, gdextension.SizeInt|(gdextension.SizeString<<4)|(gdextension.SizeBool<<8), &struct{json_text gdextension.String; keep_text bool}{pointers.Get(gd.InternalString(json_text)), keep_text})
...
func (self class) FromNative(v variant.Any, full_objects bool) variant.Any { //gd:JSON.from_native
	var r_ret = noescape.CallStatic[gdextension.Variant]( methods.from_native, gdextension.SizeVariant|(gdextension.SizeVariant<<4)|(gdextension.SizeBool<<8), &struct{v gdextension.Variant; full_objects bool}{gdextension.Variant(pointers.Get(gd.InternalVariant(v))), full_objects})
	var ret = variant.Implementation(gd.VariantProxy{}, pointers.Pack(pointers.New[gd.Variant](r_ret)))
	return ret
}
func (self class) ToNative(json variant.Any, allow_objects bool) variant.Any { //gd:JSON.to_native
	var r_ret = noescape.CallStatic[gdextension.Variant]( methods.to_native, gdextension.SizeVariant|(gdextension.SizeVariant<<4)|(gdextension.SizeBool<<8), &struct{json gdextension.Variant; allow_objects bool}{gdextension.Variant(pointers.Get(gd.InternalVariant(json))), allow_objects})
	var ret = variant.Implementation(gd.VariantProxy{}, pointers.Pack(pointers.New[gd.Variant](r_ret)))
	return ret
}
...
func (o *Extension[T]) GetErrorLine() int {
	return o.Super().GetErrorLine()
}
func (o *Extension[T]) GetErrorMessage() string {
	return o.Super().GetErrorMessage()
}
...
func init() {gdclass.Register("JSON", func(ptr gdreference.Object) any { return Instance{gdclass.NewJSON(ptr)} })}
