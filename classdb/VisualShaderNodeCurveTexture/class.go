...
import "github.com/AveryLucas/gogogd/classdb/CurveTexture"
...
func (o *Extension[T]) Texture() CurveTexture.Instance { return o.Super().Texture() }
...
func (o *Extension[T]) SetTexture(value CurveTexture.Instance) *Extension[T] {
...
func init() {gdclass.Register("VisualShaderNodeCurveTexture", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeCurveTexture(ptr)} })}
