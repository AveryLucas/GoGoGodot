...
func init() {gdclass.Register("VisualShaderNodeVectorDistance", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeVectorDistance(ptr)} })}
