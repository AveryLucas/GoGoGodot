...
import "github.com/AveryLucas/gogogd/variant/Vector4"
...
func (o *Extension[T]) DefaultValue() Vector4.XYZW { return o.Super().DefaultValue() }
...
func (o *Extension[T]) SetDefaultValue(value Vector4.XYZW) *Extension[T] {
...
func init() {gdclass.Register("VisualShaderNodeVec4Parameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeVec4Parameter(ptr)} })}
