...
func (o *Extension[T]) GetVertices() []Vector3.XYZ {
	return o.Super().GetVertices()
}
func (o *Extension[T]) GetIndices() []int32 {
	return o.Super().GetIndices()
}
...
func init() {gdclass.Register("Occluder3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewOccluder3D(ptr)} })}
