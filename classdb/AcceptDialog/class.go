...
func (o *Extension[T]) OkButtonText() string { return o.Super().OkButtonText() }
...
func (o *Extension[T]) DialogText() string { return o.Super().DialogText() }
...
func (o *Extension[T]) DialogHideOnOk() bool { return o.Super().DialogHideOnOk() }
...
func (o *Extension[T]) SetDialogHideOnOk(value bool) *Extension[T] {
	o.Super().SetDialogHideOnOk(value)
	return o
}
...
func (o *Extension[T]) DialogCloseOnEscape() bool { return o.Super().DialogCloseOnEscape() }
...
func (o *Extension[T]) SetDialogCloseOnEscape(value bool) *Extension[T] {
	o.Super().SetDialogCloseOnEscape(value)
	return o
}
...
func (o *Extension[T]) DialogAutowrap() bool { return o.Super().DialogAutowrap() }
...
func (o *Extension[T]) SetDialogAutowrap(value bool) *Extension[T] {
	o.Super().SetDialogAutowrap(value)
	return o
}
...
func (self class) AddButton(text String.Readable, right bool, action String.Readable) [1]gdclass.Button { //gd:AcceptDialog.add_button
	var r_ret = noescape.Call[gdextension.Object]( gd.ObjectChecked(self.AsObject()), methods.add_button, gdextension.SizeObject|(gdextension.SizeString<<4)|(gdextension.SizeBool<<8)|(gdextension.SizeString<<12), &struct{text gdextension.String; right bool; action gdextension.String}{pointers.Get(gd.InternalString(text)), right, pointers.Get(gd.InternalString(action))})
	var ret = [1]gdclass.Button{gdclass.NewButton(gd.PointerLifetimeBoundTo(self.AsObject(), r_ret))}
	return ret
}
...
func init() {gdclass.Register("AcceptDialog", func(ptr gdreference.Object) any { return Instance{gdclass.NewAcceptDialog(ptr)} })}
