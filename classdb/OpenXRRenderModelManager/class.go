...
import "github.com/AveryLucas/gogogd/classdb/OpenXRRenderModel"
...
func (o *Extension[T]) Tracker() RenderModelTracker { return o.Super().Tracker() }
...
func (o *Extension[T]) SetTracker(value RenderModelTracker) *Extension[T] {
...
func (o *Extension[T]) MakeLocalToPose() string { return o.Super().MakeLocalToPose() }
...
func (o *Extension[T]) SetMakeLocalToPose(value string) *Extension[T] {
	o.Super().SetMakeLocalToPose(value)
	return o
}
...
func (o *Extension[T]) OnRenderModelAdded(cb func(render_model OpenXRRenderModel.Instance), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
func (o *Extension[T]) OnRenderModelRemoved(cb func(render_model OpenXRRenderModel.Instance), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
func init() {gdclass.Register("OpenXRRenderModelManager", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRRenderModelManager(ptr)} })}
