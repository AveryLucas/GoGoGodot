...
func (o *Extension[T]) CustomStep() Float.X { return o.Super().CustomStep() }
...
func init() {gdclass.Register("ScrollBar", func(ptr gdreference.Object) any { return Instance{gdclass.NewScrollBar(ptr)} })}
