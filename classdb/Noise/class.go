...
func (self class) GetNoise2d(x float64, y float64) float64 { //gd:Noise.get_noise_2d
	var r_ret = noescape.Call[float64]( gd.ObjectChecked(self.AsObject()), methods.get_noise_2d, gdextension.SizeFloat|(gdextension.SizeFloat<<4)|(gdextension.SizeFloat<<8), &struct{x float64; y float64}{x, y})
	var ret = r_ret
	return ret
}
...
func (self class) GetNoise3d(x float64, y float64, z float64) float64 { //gd:Noise.get_noise_3d
	var r_ret = noescape.Call[float64]( gd.ObjectChecked(self.AsObject()), methods.get_noise_3d, gdextension.SizeFloat|(gdextension.SizeFloat<<4)|(gdextension.SizeFloat<<8)|(gdextension.SizeFloat<<12), &struct{x float64; y float64; z float64}{x, y, z})
	var ret = r_ret
	return ret
}
...
func (self class) GetImage(width int64, height int64, invert bool, in_3d_space bool, normalize bool) [1]gdclass.Image { //gd:Noise.get_image
	var r_ret = noescape.Call[gdextension.Object]( gd.ObjectChecked(self.AsObject()), methods.get_image, gdextension.SizeObject|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeBool<<12)|(gdextension.SizeBool<<16)|(gdextension.SizeBool<<20), &struct{width int64; height int64; invert bool; in_3d_space bool; normalize bool}{width, height, invert, in_3d_space, normalize})
...
func (self class) GetSeamlessImage(width int64, height int64, invert bool, in_3d_space bool, skirt float64, normalize bool) [1]gdclass.Image { //gd:Noise.get_seamless_image
	var r_ret = noescape.Call[gdextension.Object]( gd.ObjectChecked(self.AsObject()), methods.get_seamless_image, gdextension.SizeObject|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeBool<<12)|(gdextension.SizeBool<<16)|(gdextension.SizeFloat<<20)|(gdextension.SizeBool<<24), &struct{width int64; height int64; invert bool; in_3d_space bool; skirt float64; normalize bool}{width, height, invert, in_3d_space, skirt, normalize})
	var ret = [1]gdclass.Image{gdclass.NewImage(gd.PointerWithOwnershipTransferredToGo(r_ret))}
	return ret
}
func (self class) GetImage3d(width int64, height int64, depth int64, invert bool, normalize bool) Array.Contains[[1]gdclass.Image] { //gd:Noise.get_image_3d
	var r_ret = noescape.Call[gdextension.Array]( gd.ObjectChecked(self.AsObject()), methods.get_image_3d, gdextension.SizeArray|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeBool<<16)|(gdextension.SizeBool<<20), &struct{width int64; height int64; depth int64; invert bool; normalize bool}{width, height, depth, invert, normalize})
...
func (self class) GetSeamlessImage3d(width int64, height int64, depth int64, invert bool, skirt float64, normalize bool) Array.Contains[[1]gdclass.Image] { //gd:Noise.get_seamless_image_3d
	var r_ret = noescape.Call[gdextension.Array]( gd.ObjectChecked(self.AsObject()), methods.get_seamless_image_3d, gdextension.SizeArray|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeBool<<16)|(gdextension.SizeFloat<<20)|(gdextension.SizeBool<<24), &struct{width int64; height int64; depth int64; invert bool; skirt float64; normalize bool}{width, height, depth, invert, skirt, normalize})
	var ret = Array.Through(gd.ArrayProxy[[1]gdclass.Image]{}, pointers.Pack(pointers.New[gd.Array](r_ret)))
	return ret
}
...
func init() {gdclass.Register("Noise", func(ptr gdreference.Object) any { return Instance{gdclass.NewNoise(ptr)} })}
