...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_flag, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct{flag Flag; enabled bool}{flag, enabled})
}
...
func (o *Extension[T]) SetParam(param Param, value Float.X) *Extension[T] {
	o.Super().SetParam(param, value)
	return o
}
func (o *Extension[T]) GetParam(param Param) Float.X {
	return o.Super().GetParam(param)
}
func (o *Extension[T]) SetFlag(flag Flag, enabled bool) *Extension[T] {
	o.Super().SetFlag(flag, enabled)
	return o
}
func (o *Extension[T]) GetFlag(flag Flag) bool {
	return o.Super().GetFlag(flag)
}
...
func init() {gdclass.Register("HingeJoint3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewHingeJoint3D(ptr)} })}
