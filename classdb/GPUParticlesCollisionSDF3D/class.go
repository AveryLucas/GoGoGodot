...
import "github.com/AveryLucas/gogogd/classdb/GPUParticlesCollision3D"
...
import "github.com/AveryLucas/gogogd/classdb/Texture3D"
...
func (o *Extension[T]) Resolution() Resolution { return o.Super().Resolution() }
...
func (o *Extension[T]) SetResolution(value Resolution) *Extension[T] {
...
func (o *Extension[T]) Thickness() Float.X { return o.Super().Thickness() }
...
func (o *Extension[T]) SetThickness(value Float.X) *Extension[T] {
...
func (o *Extension[T]) BakeMask() int { return o.Super().BakeMask() }
...
func (o *Extension[T]) SetBakeMask(value int) *Extension[T] {
	o.Super().SetBakeMask(value)
	return o
}
...
func (o *Extension[T]) Texture() Texture3D.Instance { return o.Super().Texture() }
...
func (o *Extension[T]) SetTexture(value Texture3D.Instance) *Extension[T] {
...
func (o *Extension[T]) SetBakeMaskValue(layer_number int, value bool) *Extension[T] {
	o.Super().SetBakeMaskValue(layer_number, value)
	return o
}
func (o *Extension[T]) GetBakeMaskValue(layer_number int) bool {
	return o.Super().GetBakeMaskValue(layer_number)
}
...
// CullMask is promoted from [GPUParticlesCollision3D.Instance.CullMask].
func (self Instance) CullMask() int { return self.AsGPUParticlesCollision3D().CullMask() }
func (o *Extension[T]) CullMask() int { return o.Super().AsGPUParticlesCollision3D().CullMask() }

// SetCullMask is promoted from [GPUParticlesCollision3D.Instance.SetCullMask].
func (self Instance) SetCullMask(value int) Instance {
	self.AsGPUParticlesCollision3D().SetCullMask(value)
	return self
}
func (o *Extension[T]) SetCullMask(value int) *Extension[T] {
	o.Super().AsGPUParticlesCollision3D().SetCullMask(value)
	return o
}
