...
func (o *Extension[T]) RenderModel() RID.RenderModel { return o.Super().RenderModel() }
...
func (o *Extension[T]) SetRenderModel(value RID.RenderModel) *Extension[T] {
	o.Super().SetRenderModel(value)
	return o
}
...
func (o *Extension[T]) OnRenderModelTopLevelPathChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
func (o *Extension[T]) GetTopLevelPath() string {
	return o.Super().GetTopLevelPath()
}
...
func init() {gdclass.Register("OpenXRRenderModel", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRRenderModel(ptr)} })}
