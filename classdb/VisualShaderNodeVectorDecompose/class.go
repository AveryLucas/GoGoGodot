...
import "github.com/AveryLucas/gogogd/classdb/VisualShaderNodeVectorBase"
...
// OpType is promoted from [VisualShaderNodeVectorBase.Instance.OpType].
func (self Instance) OpType() VisualShaderNodeVectorBase.OpType { return self.AsVisualShaderNodeVectorBase().OpType() }
func (o *Extension[T]) OpType() VisualShaderNodeVectorBase.OpType { return o.Super().AsVisualShaderNodeVectorBase().OpType() }

// SetOpType is promoted from [VisualShaderNodeVectorBase.Instance.SetOpType].
func (self Instance) SetOpType(value VisualShaderNodeVectorBase.OpType) Instance {
	self.AsVisualShaderNodeVectorBase().SetOpType(value)
	return self
}
func (o *Extension[T]) SetOpType(value VisualShaderNodeVectorBase.OpType) *Extension[T] {
	o.Super().AsVisualShaderNodeVectorBase().SetOpType(value)
	return o
}
