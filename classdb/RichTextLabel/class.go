...
func (o *Extension[T]) BbcodeEnabled() bool { return o.Super().BbcodeEnabled() }
...
func (o *Extension[T]) SetBbcodeEnabled(value bool) *Extension[T] {
	o.Super().SetBbcodeEnabled(value)
	return o
}
...
func (o *Extension[T]) FitContent() bool { return o.Super().FitContent() }
...
func (o *Extension[T]) SetFitContent(value bool) *Extension[T] {
	o.Super().SetFitContent(value)
	return o
}
...
func (o *Extension[T]) ScrollActive() bool { return o.Super().ScrollActive() }
...
func (o *Extension[T]) SetScrollActive(value bool) *Extension[T] {
	o.Super().SetScrollActive(value)
	return o
}
...
func (o *Extension[T]) ScrollFollowing() bool { return o.Super().ScrollFollowing() }
...
func (o *Extension[T]) SetScrollFollowing(value bool) *Extension[T] {
	o.Super().SetScrollFollowing(value)
	return o
}
...
func (o *Extension[T]) ScrollFollowingVisibleCharacters() bool { return o.Super().ScrollFollowingVisibleCharacters() }
...
func (o *Extension[T]) SetScrollFollowingVisibleCharacters(value bool) *Extension[T] {
	o.Super().SetScrollFollowingVisibleCharacters(value)
	return o
}
...
func (o *Extension[T]) TabSize() int { return o.Super().TabSize() }
...
func (o *Extension[T]) SetTabSize(value int) *Extension[T] {
	o.Super().SetTabSize(value)
	return o
}
...
func (o *Extension[T]) CustomEffects() []any { return o.Super().CustomEffects() }
...
func (o *Extension[T]) SetCustomEffects(value []any) *Extension[T] {
	o.Super().SetCustomEffects(value)
	return o
}
...
func (o *Extension[T]) MetaUnderlined() bool { return o.Super().MetaUnderlined() }
...
func (o *Extension[T]) SetMetaUnderlined(value bool) *Extension[T] {
	o.Super().SetMetaUnderlined(value)
	return o
}
...
func (o *Extension[T]) HintUnderlined() bool { return o.Super().HintUnderlined() }
...
func (o *Extension[T]) SetHintUnderlined(value bool) *Extension[T] {
	o.Super().SetHintUnderlined(value)
	return o
}
...
func (o *Extension[T]) Threaded() bool { return o.Super().Threaded() }
...
func (o *Extension[T]) SetThreaded(value bool) *Extension[T] {
	o.Super().SetThreaded(value)
	return o
}
...
func (o *Extension[T]) ProgressBarDelay() int { return o.Super().ProgressBarDelay() }
...
func (o *Extension[T]) SetProgressBarDelay(value int) *Extension[T] {
	o.Super().SetProgressBarDelay(value)
	return o
}
...
func (o *Extension[T]) SelectionEnabled() bool { return o.Super().SelectionEnabled() }
...
func (o *Extension[T]) SetSelectionEnabled(value bool) *Extension[T] {
	o.Super().SetSelectionEnabled(value)
	return o
}
...
func (o *Extension[T]) OnMetaClicked(cb func(meta any), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("meta_clicked"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnMetaHoverStarted(cb func(meta any), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("meta_hover_started"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnMetaHoverEnded(cb func(meta any), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("meta_hover_ended"), gd.NewCallable(cb), int64(flags_together))
	return o
}
