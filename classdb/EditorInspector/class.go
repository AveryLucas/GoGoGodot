...
import "github.com/AveryLucas/gogogd/classdb/Container"
import "github.com/AveryLucas/gogogd/classdb/Control"
import "github.com/AveryLucas/gogogd/classdb/DisplayServer"
import "github.com/AveryLucas/gogogd/classdb/EditorProperty"
...
import "github.com/AveryLucas/gogogd/classdb/ScrollContainer"
...
func (self class) InstantiatePropertyEditor(obj [1]gdreference.Object, atype variant.Type, path String.Readable, hint ClassDB.PropertyHint, hint_text String.Readable, usage int64, wide bool) [1]gdclass.EditorProperty { //gd:EditorInspector.instantiate_property_editor
	var r_ret = noescape.CallStatic[gdextension.Object]( methods.instantiate_property_editor, gdextension.SizeObject|(gdextension.SizeObject<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeString<<12)|(gdextension.SizeInt<<16)|(gdextension.SizeString<<20)|(gdextension.SizeInt<<24)|(gdextension.SizeBool<<28), &struct{obj gdextension.Object; atype variant.Type; path gdextension.String; hint ClassDB.PropertyHint; hint_text gdextension.String; usage int64; wide bool}{	gdextension.Object(gdreference.GetObject(gdclass.GetObject(obj[0])[0])), atype, pointers.Get(gd.InternalString(path)), hint, pointers.Get(gd.InternalString(hint_text)), usage, wide})
...
func (o class) AsScrollContainer() ScrollContainer.Advanced { return *(*ScrollContainer.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsScrollContainer() ScrollContainer.Instance { return o.Super().AsScrollContainer() }
func (o Instance) AsScrollContainer() ScrollContainer.Instance { return *(*ScrollContainer.Instance)(ie.As(&o)) }
...
func (o *Extension[T]) OnPropertySelected(cb func(property string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("property_selected"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnPropertyKeyed(cb func(property string, value any, advance bool), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("property_keyed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnPropertyDeleted(cb func(property string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("property_deleted"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnResourceSelected(cb func(resource Resource.Instance, path string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("resource_selected"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnObjectIdSelected(cb func(id int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("object_id_selected"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnPropertyEdited(cb func(property string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("property_edited"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnPropertyToggled(cb func(property string, checked bool), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("property_toggled"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnEditedObjectChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("edited_object_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnRestartRequested(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("restart_requested"), gd.NewCallable(cb), int64(flags_together))
	return o
}

// OnScrollStarted is promoted from [ScrollContainer.Instance.OnScrollStarted].
...
// OnScrollStarted is promoted from [ScrollContainer.Instance.OnScrollStarted].
func (o *Extension[T]) OnScrollStarted(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("scroll_started"), gd.NewCallable(cb), int64(flags_together))
	return o
}

// OnScrollEnded is promoted from [ScrollContainer.Instance.OnScrollEnded].
...
// OnScrollEnded is promoted from [ScrollContainer.Instance.OnScrollEnded].
func (o *Extension[T]) OnScrollEnded(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("scroll_ended"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) OnPreSortChildren(cb func(), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("pre_sort_children"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) OnSortChildren(cb func(), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("sort_children"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) Edit(obj Object.Instance) {
	o.Super().Edit(obj)
}
func (o *Extension[T]) GetSelectedPath() string {
	return o.Super().GetSelectedPath()
}
func (o *Extension[T]) GetEditedObject() Object.Instance {
	return o.Super().GetEditedObject()
}

// GetHScrollBar is promoted from [ScrollContainer.Instance.GetHScrollBar].
func (self Instance) GetHScrollBar() HScrollBar.Instance {
	return self.AsScrollContainer().GetHScrollBar()
}

// GetHScrollBar is promoted from [ScrollContainer.Instance.GetHScrollBar].
func (o *Extension[T]) GetHScrollBar() HScrollBar.Instance {
	return o.Super().AsScrollContainer().GetHScrollBar()
}

// GetVScrollBar is promoted from [ScrollContainer.Instance.GetVScrollBar].
func (self Instance) GetVScrollBar() VScrollBar.Instance {
	return self.AsScrollContainer().GetVScrollBar()
}

// GetVScrollBar is promoted from [ScrollContainer.Instance.GetVScrollBar].
func (o *Extension[T]) GetVScrollBar() VScrollBar.Instance {
	return o.Super().AsScrollContainer().GetVScrollBar()
}

// EnsureControlVisible is promoted from [ScrollContainer.Instance.EnsureControlVisible].
func (self Instance) EnsureControlVisible(control Control.Instance) {
	self.AsScrollContainer().EnsureControlVisible(control)
}

// EnsureControlVisible is promoted from [ScrollContainer.Instance.EnsureControlVisible].
func (o *Extension[T]) EnsureControlVisible(control Control.Instance) {
	o.Super().AsScrollContainer().EnsureControlVisible(control)
}

// QueueSort is promoted from [Container.Instance.QueueSort].
func (self Instance) QueueSort() {
	self.AsContainer().QueueSort()
}

// QueueSort is promoted from [Container.Instance.QueueSort].
func (o *Extension[T]) QueueSort() {
	o.Super().AsContainer().QueueSort()
}
...
func (self Instance) FitChildInRect(child Control.Instance, rect Rect2.PositionSize) {
	self.AsContainer().FitChildInRect(child, rect)
}

// FitChildInRect is promoted from [Container.Instance.FitChildInRect].
func (o *Extension[T]) FitChildInRect(child Control.Instance, rect Rect2.PositionSize) {
	o.Super().AsContainer().FitChildInRect(child, rect)
}
...
// FollowFocus is promoted from [ScrollContainer.Instance.FollowFocus].
func (self Instance) FollowFocus() bool { return self.AsScrollContainer().FollowFocus() }
func (o *Extension[T]) FollowFocus() bool { return o.Super().AsScrollContainer().FollowFocus() }

// SetFollowFocus is promoted from [ScrollContainer.Instance.SetFollowFocus].
func (self Instance) SetFollowFocus(value bool) Instance {
	self.AsScrollContainer().SetFollowFocus(value)
	return self
}
func (o *Extension[T]) SetFollowFocus(value bool) *Extension[T] {
	o.Super().AsScrollContainer().SetFollowFocus(value)
	return o
}

// DrawFocusBorder is promoted from [ScrollContainer.Instance.DrawFocusBorder].
func (self Instance) DrawFocusBorder() bool { return self.AsScrollContainer().DrawFocusBorder() }
func (o *Extension[T]) DrawFocusBorder() bool { return o.Super().AsScrollContainer().DrawFocusBorder() }

// SetDrawFocusBorder is promoted from [ScrollContainer.Instance.SetDrawFocusBorder].
func (self Instance) SetDrawFocusBorder(value bool) Instance {
	self.AsScrollContainer().SetDrawFocusBorder(value)
	return self
}
func (o *Extension[T]) SetDrawFocusBorder(value bool) *Extension[T] {
	o.Super().AsScrollContainer().SetDrawFocusBorder(value)
	return o
}

// ScrollHorizontal is promoted from [ScrollContainer.Instance.ScrollHorizontal].
func (self Instance) ScrollHorizontal() int { return self.AsScrollContainer().ScrollHorizontal() }
func (o *Extension[T]) ScrollHorizontal() int { return o.Super().AsScrollContainer().ScrollHorizontal() }

// SetScrollHorizontal is promoted from [ScrollContainer.Instance.SetScrollHorizontal].
func (self Instance) SetScrollHorizontal(value int) Instance {
	self.AsScrollContainer().SetScrollHorizontal(value)
	return self
}
func (o *Extension[T]) SetScrollHorizontal(value int) *Extension[T] {
	o.Super().AsScrollContainer().SetScrollHorizontal(value)
	return o
}

// ScrollVertical is promoted from [ScrollContainer.Instance.ScrollVertical].
func (self Instance) ScrollVertical() int { return self.AsScrollContainer().ScrollVertical() }
func (o *Extension[T]) ScrollVertical() int { return o.Super().AsScrollContainer().ScrollVertical() }

// SetScrollVertical is promoted from [ScrollContainer.Instance.SetScrollVertical].
func (self Instance) SetScrollVertical(value int) Instance {
	self.AsScrollContainer().SetScrollVertical(value)
	return self
}
func (o *Extension[T]) SetScrollVertical(value int) *Extension[T] {
	o.Super().AsScrollContainer().SetScrollVertical(value)
	return o
}

// ScrollHorizontalCustomStep is promoted from [ScrollContainer.Instance.ScrollHorizontalCustomStep].
func (self Instance) ScrollHorizontalCustomStep() Float.X { return self.AsScrollContainer().ScrollHorizontalCustomStep() }
func (o *Extension[T]) ScrollHorizontalCustomStep() Float.X { return o.Super().AsScrollContainer().ScrollHorizontalCustomStep() }

// SetScrollHorizontalCustomStep is promoted from [ScrollContainer.Instance.SetScrollHorizontalCustomStep].
func (self Instance) SetScrollHorizontalCustomStep(value Float.X) Instance {
	self.AsScrollContainer().SetScrollHorizontalCustomStep(value)
	return self
}
func (o *Extension[T]) SetScrollHorizontalCustomStep(value Float.X) *Extension[T] {
	o.Super().AsScrollContainer().SetScrollHorizontalCustomStep(value)
	return o
}

// ScrollVerticalCustomStep is promoted from [ScrollContainer.Instance.ScrollVerticalCustomStep].
func (self Instance) ScrollVerticalCustomStep() Float.X { return self.AsScrollContainer().ScrollVerticalCustomStep() }
func (o *Extension[T]) ScrollVerticalCustomStep() Float.X { return o.Super().AsScrollContainer().ScrollVerticalCustomStep() }

// SetScrollVerticalCustomStep is promoted from [ScrollContainer.Instance.SetScrollVerticalCustomStep].
func (self Instance) SetScrollVerticalCustomStep(value Float.X) Instance {
	self.AsScrollContainer().SetScrollVerticalCustomStep(value)
	return self
}
func (o *Extension[T]) SetScrollVerticalCustomStep(value Float.X) *Extension[T] {
	o.Super().AsScrollContainer().SetScrollVerticalCustomStep(value)
	return o
}

// HorizontalScrollMode is promoted from [ScrollContainer.Instance.HorizontalScrollMode].
func (self Instance) HorizontalScrollMode() ScrollContainer.ScrollMode { return self.AsScrollContainer().HorizontalScrollMode() }
func (o *Extension[T]) HorizontalScrollMode() ScrollContainer.ScrollMode { return o.Super().AsScrollContainer().HorizontalScrollMode() }

// SetHorizontalScrollMode is promoted from [ScrollContainer.Instance.SetHorizontalScrollMode].
func (self Instance) SetHorizontalScrollMode(value ScrollContainer.ScrollMode) Instance {
	self.AsScrollContainer().SetHorizontalScrollMode(value)
	return self
}
func (o *Extension[T]) SetHorizontalScrollMode(value ScrollContainer.ScrollMode) *Extension[T] {
	o.Super().AsScrollContainer().SetHorizontalScrollMode(value)
	return o
}

// VerticalScrollMode is promoted from [ScrollContainer.Instance.VerticalScrollMode].
func (self Instance) VerticalScrollMode() ScrollContainer.ScrollMode { return self.AsScrollContainer().VerticalScrollMode() }
func (o *Extension[T]) VerticalScrollMode() ScrollContainer.ScrollMode { return o.Super().AsScrollContainer().VerticalScrollMode() }

// SetVerticalScrollMode is promoted from [ScrollContainer.Instance.SetVerticalScrollMode].
func (self Instance) SetVerticalScrollMode(value ScrollContainer.ScrollMode) Instance {
	self.AsScrollContainer().SetVerticalScrollMode(value)
	return self
}
func (o *Extension[T]) SetVerticalScrollMode(value ScrollContainer.ScrollMode) *Extension[T] {
	o.Super().AsScrollContainer().SetVerticalScrollMode(value)
	return o
}

// ScrollDeadzone is promoted from [ScrollContainer.Instance.ScrollDeadzone].
func (self Instance) ScrollDeadzone() int { return self.AsScrollContainer().ScrollDeadzone() }
func (o *Extension[T]) ScrollDeadzone() int { return o.Super().AsScrollContainer().ScrollDeadzone() }

// SetScrollDeadzone is promoted from [ScrollContainer.Instance.SetScrollDeadzone].
func (self Instance) SetScrollDeadzone(value int) Instance {
	self.AsScrollContainer().SetScrollDeadzone(value)
	return self
}
func (o *Extension[T]) SetScrollDeadzone(value int) *Extension[T] {
	o.Super().AsScrollContainer().SetScrollDeadzone(value)
	return o
}

// ScrollHintMode is promoted from [ScrollContainer.Instance.ScrollHintMode].
func (self Instance) ScrollHintMode() ScrollContainer.ScrollHintMode { return self.AsScrollContainer().ScrollHintMode() }
func (o *Extension[T]) ScrollHintMode() ScrollContainer.ScrollHintMode { return o.Super().AsScrollContainer().ScrollHintMode() }

// SetScrollHintMode is promoted from [ScrollContainer.Instance.SetScrollHintMode].
func (self Instance) SetScrollHintMode(value ScrollContainer.ScrollHintMode) Instance {
	self.AsScrollContainer().SetScrollHintMode(value)
	return self
}
func (o *Extension[T]) SetScrollHintMode(value ScrollContainer.ScrollHintMode) *Extension[T] {
	o.Super().AsScrollContainer().SetScrollHintMode(value)
	return o
}

// TileScrollHint is promoted from [ScrollContainer.Instance.TileScrollHint].
func (self Instance) TileScrollHint() bool { return self.AsScrollContainer().TileScrollHint() }
func (o *Extension[T]) TileScrollHint() bool { return o.Super().AsScrollContainer().TileScrollHint() }

// SetTileScrollHint is promoted from [ScrollContainer.Instance.SetTileScrollHint].
func (self Instance) SetTileScrollHint(value bool) Instance {
	self.AsScrollContainer().SetTileScrollHint(value)
	return self
}
func (o *Extension[T]) SetTileScrollHint(value bool) *Extension[T] {
	o.Super().AsScrollContainer().SetTileScrollHint(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(ScrollContainer.Advanced(self.AsScrollContainer()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(ScrollContainer.Instance(self.AsScrollContainer()), name)
	}
}
func init() {gdclass.Register("EditorInspector", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorInspector(ptr)} })}
