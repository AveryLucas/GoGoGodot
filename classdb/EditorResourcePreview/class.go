...
import "github.com/AveryLucas/gogogd/classdb/EditorResourcePreviewGenerator"
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.queue_resource_preview, 0|(gdextension.SizeString<<4)|(gdextension.SizeObject<<8)|(gdextension.SizeStringName<<12)|(gdextension.SizeVariant<<16), &struct{path gdextension.String; receiver gdextension.Object; receiver_func gdextension.StringName; userdata gdextension.Variant}{pointers.Get(gd.InternalString(path)), 	gdextension.Object(gd.PointerWithOwnershipTransferredToGodot(gdclass.GetObject(receiver[0])[0])), pointers.Get(gd.InternalStringName(receiver_func)), gdextension.Variant(pointers.Get(gd.InternalVariant(userdata)))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.queue_edited_resource_preview, 0|(gdextension.SizeObject<<4)|(gdextension.SizeObject<<8)|(gdextension.SizeStringName<<12)|(gdextension.SizeVariant<<16), &struct{resource gdextension.Object; receiver gdextension.Object; receiver_func gdextension.StringName; userdata gdextension.Variant}{	gdextension.Object(gdreference.GetObject(gdclass.GetResource(resource[0])[0])), 	gdextension.Object(gd.PointerWithOwnershipTransferredToGodot(gdclass.GetObject(receiver[0])[0])), pointers.Get(gd.InternalStringName(receiver_func)), gdextension.Variant(pointers.Get(gd.InternalVariant(userdata)))})
}
...
func (o *Extension[T]) OnPreviewInvalidated(cb func(path string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("preview_invalidated"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) QueueResourcePreview(path string, receiver Object.Instance, receiver_func string, userdata any) {
	o.Super().QueueResourcePreview(path, receiver, receiver_func, userdata)
}
func (o *Extension[T]) QueueEditedResourcePreview(resource Resource.Instance, receiver Object.Instance, receiver_func string, userdata any) {
	o.Super().QueueEditedResourcePreview(resource, receiver, receiver_func, userdata)
}
func (o *Extension[T]) AddPreviewGenerator(generator EditorResourcePreviewGenerator.Instance) {
	o.Super().AddPreviewGenerator(generator)
}
func (o *Extension[T]) RemovePreviewGenerator(generator EditorResourcePreviewGenerator.Instance) {
	o.Super().RemovePreviewGenerator(generator)
}
func (o *Extension[T]) CheckForInvalidation(path string) {
	o.Super().CheckForInvalidation(path)
}
...
func init() {gdclass.Register("EditorResourcePreview", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorResourcePreview(ptr)} })}
