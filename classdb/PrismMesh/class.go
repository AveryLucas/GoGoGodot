...
func (o *Extension[T]) LeftToRight() Float.X { return o.Super().LeftToRight() }
...
func (o *Extension[T]) SetLeftToRight(value Float.X) *Extension[T] {
	o.Super().SetLeftToRight(value)
	return o
}
...
func init() {gdclass.Register("PrismMesh", func(ptr gdreference.Object) any { return Instance{gdclass.NewPrismMesh(ptr)} })}
