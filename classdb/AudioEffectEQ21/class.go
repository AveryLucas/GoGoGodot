...
import "github.com/AveryLucas/gogogd/classdb/AudioEffectEQ"
...
func (o Instance) AsAudioEffectEQ() AudioEffectEQ.Instance { return *(*AudioEffectEQ.Instance)(ie.As(&o)) }
...
// SetBandGainDb is promoted from [AudioEffectEQ.Instance.SetBandGainDb].
func (self Instance) SetBandGainDb(band_idx int, volume_db Float.X) Instance {
	self.AsAudioEffectEQ().SetBandGainDb(band_idx, volume_db)
	return self
}

// SetBandGainDb is promoted from [AudioEffectEQ.Instance.SetBandGainDb].
func (o *Extension[T]) SetBandGainDb(band_idx int, volume_db Float.X) *Extension[T] {
	o.Super().AsAudioEffectEQ().SetBandGainDb(band_idx, volume_db)
	return o
}

// GetBandGainDb is promoted from [AudioEffectEQ.Instance.GetBandGainDb].
func (self Instance) GetBandGainDb(band_idx int) Float.X {
	return self.AsAudioEffectEQ().GetBandGainDb(band_idx)
}

// GetBandGainDb is promoted from [AudioEffectEQ.Instance.GetBandGainDb].
func (o *Extension[T]) GetBandGainDb(band_idx int) Float.X {
	return o.Super().AsAudioEffectEQ().GetBandGainDb(band_idx)
}

// GetBandCount is promoted from [AudioEffectEQ.Instance.GetBandCount].
func (self Instance) GetBandCount() int {
	return self.AsAudioEffectEQ().GetBandCount()
}

// GetBandCount is promoted from [AudioEffectEQ.Instance.GetBandCount].
func (o *Extension[T]) GetBandCount() int {
	return o.Super().AsAudioEffectEQ().GetBandCount()
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(AudioEffectEQ.Advanced(self.AsAudioEffectEQ()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(AudioEffectEQ.Instance(self.AsAudioEffectEQ()), name)
	}
}
func init() {gdclass.Register("AudioEffectEQ21", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioEffectEQ21(ptr)} })}
