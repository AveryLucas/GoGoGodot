...
import "github.com/AveryLucas/gogogd/classdb/TabBar"
...
func (o *Extension[T]) TabAlignment() TabBar.AlignmentMode { return o.Super().TabAlignment() }
...
func (o *Extension[T]) SetTabAlignment(value TabBar.AlignmentMode) *Extension[T] {
...
func (o *Extension[T]) TabsPosition() TabPosition { return o.Super().TabsPosition() }
...
func (o *Extension[T]) SetTabsPosition(value TabPosition) *Extension[T] {
	o.Super().SetTabsPosition(value)
	return o
}
...
func (o *Extension[T]) TabsVisible() bool { return o.Super().TabsVisible() }
...
func (o *Extension[T]) SetTabsVisible(value bool) *Extension[T] {
	o.Super().SetTabsVisible(value)
	return o
}
...
func (o *Extension[T]) AllTabsInFront() bool { return o.Super().AllTabsInFront() }
...
func (o *Extension[T]) SetAllTabsInFront(value bool) *Extension[T] {
	o.Super().SetAllTabsInFront(value)
	return o
}
...
func (o *Extension[T]) UseHiddenTabsForMinSize() bool { return o.Super().UseHiddenTabsForMinSize() }
...
func (o *Extension[T]) SetUseHiddenTabsForMinSize(value bool) *Extension[T] {
	o.Super().SetUseHiddenTabsForMinSize(value)
	return o
}
...
func (o *Extension[T]) TabFocusMode() Control.FocusMode { return o.Super().TabFocusMode() }
...
func (o *Extension[T]) SetTabFocusMode(value Control.FocusMode) *Extension[T] {
	o.Super().SetTabFocusMode(value)
	return o
}
...
func (o *Extension[T]) OnPrePopupPressed(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("pre_popup_pressed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) GetTabCount() int {
	return o.Super().GetTabCount()
}
...
func (o *Extension[T]) GetCurrentTabControl() Control.Instance {
	return o.Super().GetCurrentTabControl()
}
func (o *Extension[T]) GetTabBar() TabBar.Instance {
	return o.Super().GetTabBar()
}
func (o *Extension[T]) GetTabControl(tab_idx int) Control.Instance {
	return o.Super().GetTabControl(tab_idx)
}
...
func (o *Extension[T]) GetTabIdxFromControl(control Control.Instance) int {
	return o.Super().GetTabIdxFromControl(control)
}
func (o *Extension[T]) SetPopup(popup Node.Instance) *Extension[T] {
	o.Super().SetPopup(popup)
	return o
}
func (o *Extension[T]) GetPopup() Popup.Instance {
