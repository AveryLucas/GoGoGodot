...
func (o *Extension[T]) Cone() bool { return o.Super().Cone() }
...
func (o *Extension[T]) SetCone(value bool) *Extension[T] {
	o.Super().SetCone(value)
	return o
}
...
func init() {gdclass.Register("CSGCylinder3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewCSGCylinder3D(ptr)} })}
