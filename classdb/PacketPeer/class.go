...
func (self class) PutVar(v variant.Any, full_objects bool) Error.Code { //gd:PacketPeer.put_var
	var r_ret = noescape.Call[int64]( gd.ObjectChecked(self.AsObject()), methods.put_var, gdextension.SizeInt|(gdextension.SizeVariant<<4)|(gdextension.SizeBool<<8), &struct{v gdextension.Variant; full_objects bool}{gdextension.Variant(pointers.Get(gd.InternalVariant(v))), full_objects})
...
func init() {gdclass.Register("PacketPeer", func(ptr gdreference.Object) any { return Instance{gdclass.NewPacketPeer(ptr)} })}
