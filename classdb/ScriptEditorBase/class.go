...
import "github.com/AveryLucas/gogogd/classdb/EditorSyntaxHighlighter"
...
func (o *Extension[T]) OnNameChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("name_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnEditedScriptChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("edited_script_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnRequestHelp(cb func(topic string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("request_help"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnRequestOpenScriptAtLine(cb func(script Object.Instance, line int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("request_open_script_at_line"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnRequestSaveHistory(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("request_save_history"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnRequestSavePreviousState(cb func(state map[any]any), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("request_save_previous_state"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnGoToHelp(cb func(what string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("go_to_help"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnSearchInFilesRequested(cb func(text string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("search_in_files_requested"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnReplaceInFilesRequested(cb func(text string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("replace_in_files_requested"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnGoToMethod(cb func(script Object.Instance, method string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("go_to_method"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) GetBaseEditor() Control.Instance {
	return o.Super().GetBaseEditor()
}
func (o *Extension[T]) AddSyntaxHighlighter(highlighter EditorSyntaxHighlighter.Instance) {
	o.Super().AddSyntaxHighlighter(highlighter)
}
...
func init() {gdclass.Register("ScriptEditorBase", func(ptr gdreference.Object) any { return Instance{gdclass.NewScriptEditorBase(ptr)} })}
