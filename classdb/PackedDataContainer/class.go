...
func (o *Extension[T]) Pack(value any) error {
	return o.Super().Pack(value)
}
func (o *Extension[T]) Size() int {
	return o.Super().Size()
}
...
func init() {gdclass.Register("PackedDataContainer", func(ptr gdreference.Object) any { return Instance{gdclass.NewPackedDataContainer(ptr)} })}
