...
func (o *Extension[T]) Rest() Transform2D.OriginXY { return o.Super().Rest() }
...
func (o *Extension[T]) SetRest(value Transform2D.OriginXY) *Extension[T] {
	o.Super().SetRest(value)
	return o
}
...
func (o *Extension[T]) ApplyRest() {
	o.Super().ApplyRest()
}
func (o *Extension[T]) GetSkeletonRest() Transform2D.OriginXY {
	return o.Super().GetSkeletonRest()
}
func (o *Extension[T]) GetIndexInSkeleton() int {
	return o.Super().GetIndexInSkeleton()
}
func (o *Extension[T]) SetAutocalculateLengthAndAngle(auto_calculate bool) *Extension[T] {
	o.Super().SetAutocalculateLengthAndAngle(auto_calculate)
	return o
}
func (o *Extension[T]) GetAutocalculateLengthAndAngle() bool {
	return o.Super().GetAutocalculateLengthAndAngle()
}
func (o *Extension[T]) SetLength(length Float.X) *Extension[T] {
	o.Super().SetLength(length)
	return o
}
func (o *Extension[T]) GetLength() Float.X {
	return o.Super().GetLength()
}
func (o *Extension[T]) SetBoneAngle(angle Angle.Radians) *Extension[T] {
	o.Super().SetBoneAngle(angle)
	return o
}
func (o *Extension[T]) GetBoneAngle() Angle.Radians {
	return o.Super().GetBoneAngle()
}
