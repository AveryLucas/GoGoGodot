...
import "github.com/AveryLucas/gogogd/classdb/EditorResourceTooltipPlugin"
...
func (o *Extension[T]) OnInherit(cb func(file string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("inherit"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnInstantiate(cb func(files []string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("instantiate"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnResourceRemoved(cb func(resource Resource.Instance), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("resource_removed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnFileRemoved(cb func(file string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("file_removed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnFolderRemoved(cb func(folder string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("folder_removed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnFilesMoved(cb func(old_file string, new_file string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("files_moved"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnFolderMoved(cb func(old_folder string, new_folder string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("folder_moved"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnFolderColorChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("folder_color_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) OnDisplayModeChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("display_mode_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
// OnClosed is promoted from [EditorDock.Instance.OnClosed].
func (o *Extension[T]) OnClosed(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("closed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) NavigateToPath(path string) {
	o.Super().NavigateToPath(path)
}
func (o *Extension[T]) AddResourceTooltipPlugin(plugin EditorResourceTooltipPlugin.Instance) {
	o.Super().AddResourceTooltipPlugin(plugin)
}
func (o *Extension[T]) RemoveResourceTooltipPlugin(plugin EditorResourceTooltipPlugin.Instance) {
	o.Super().RemoveResourceTooltipPlugin(plugin)
}

// Open is promoted from [EditorDock.Instance.Open].
func (self Instance) Open() {
	self.AsEditorDock().Open()
}

// Open is promoted from [EditorDock.Instance.Open].
func (o *Extension[T]) Open() {
	o.Super().AsEditorDock().Open()
}

// MakeVisible is promoted from [EditorDock.Instance.MakeVisible].
func (self Instance) MakeVisible() {
	self.AsEditorDock().MakeVisible()
}

// MakeVisible is promoted from [EditorDock.Instance.MakeVisible].
func (o *Extension[T]) MakeVisible() {
	o.Super().AsEditorDock().MakeVisible()
}

// Close is promoted from [EditorDock.Instance.Close].
func (self Instance) Close() {
	self.AsEditorDock().Close()
}

// Close is promoted from [EditorDock.Instance.Close].
func (o *Extension[T]) Close() {
	o.Super().AsEditorDock().Close()
}
...
// Title is promoted from [EditorDock.Instance.Title].
func (self Instance) Title() string { return self.AsEditorDock().Title() }
func (o *Extension[T]) Title() string { return o.Super().AsEditorDock().Title() }

// SetTitle is promoted from [EditorDock.Instance.SetTitle].
func (self Instance) SetTitle(value string) Instance {
	self.AsEditorDock().SetTitle(value)
	return self
}
func (o *Extension[T]) SetTitle(value string) *Extension[T] {
	o.Super().AsEditorDock().SetTitle(value)
	return o
}

// LayoutKey is promoted from [EditorDock.Instance.LayoutKey].
func (self Instance) LayoutKey() string { return self.AsEditorDock().LayoutKey() }
func (o *Extension[T]) LayoutKey() string { return o.Super().AsEditorDock().LayoutKey() }

// SetLayoutKey is promoted from [EditorDock.Instance.SetLayoutKey].
func (self Instance) SetLayoutKey(value string) Instance {
	self.AsEditorDock().SetLayoutKey(value)
	return self
}
func (o *Extension[T]) SetLayoutKey(value string) *Extension[T] {
	o.Super().AsEditorDock().SetLayoutKey(value)
	return o
}

// Global is promoted from [EditorDock.Instance.Global].
func (self Instance) Global() bool { return self.AsEditorDock().Global() }
func (o *Extension[T]) Global() bool { return o.Super().AsEditorDock().Global() }

// SetGlobal is promoted from [EditorDock.Instance.SetGlobal].
func (self Instance) SetGlobal(value bool) Instance {
	self.AsEditorDock().SetGlobal(value)
	return self
}
func (o *Extension[T]) SetGlobal(value bool) *Extension[T] {
	o.Super().AsEditorDock().SetGlobal(value)
	return o
}

// Transient is promoted from [EditorDock.Instance.Transient].
func (self Instance) Transient() bool { return self.AsEditorDock().Transient() }
func (o *Extension[T]) Transient() bool { return o.Super().AsEditorDock().Transient() }

// SetTransient is promoted from [EditorDock.Instance.SetTransient].
func (self Instance) SetTransient(value bool) Instance {
	self.AsEditorDock().SetTransient(value)
	return self
}
func (o *Extension[T]) SetTransient(value bool) *Extension[T] {
	o.Super().AsEditorDock().SetTransient(value)
	return o
}

// Closable is promoted from [EditorDock.Instance.Closable].
func (self Instance) Closable() bool { return self.AsEditorDock().Closable() }
func (o *Extension[T]) Closable() bool { return o.Super().AsEditorDock().Closable() }

// SetClosable is promoted from [EditorDock.Instance.SetClosable].
func (self Instance) SetClosable(value bool) Instance {
	self.AsEditorDock().SetClosable(value)
	return self
}
func (o *Extension[T]) SetClosable(value bool) *Extension[T] {
	o.Super().AsEditorDock().SetClosable(value)
	return o
}

// IconName is promoted from [EditorDock.Instance.IconName].
func (self Instance) IconName() string { return self.AsEditorDock().IconName() }
func (o *Extension[T]) IconName() string { return o.Super().AsEditorDock().IconName() }

// SetIconName is promoted from [EditorDock.Instance.SetIconName].
func (self Instance) SetIconName(value string) Instance {
	self.AsEditorDock().SetIconName(value)
	return self
}
func (o *Extension[T]) SetIconName(value string) *Extension[T] {
	o.Super().AsEditorDock().SetIconName(value)
	return o
}

// DockIcon is promoted from [EditorDock.Instance.DockIcon].
func (self Instance) DockIcon() Texture2D.Instance { return self.AsEditorDock().DockIcon() }
func (o *Extension[T]) DockIcon() Texture2D.Instance { return o.Super().AsEditorDock().DockIcon() }

// SetDockIcon is promoted from [EditorDock.Instance.SetDockIcon].
func (self Instance) SetDockIcon(value Texture2D.Instance) Instance {
	self.AsEditorDock().SetDockIcon(value)
	return self
}
func (o *Extension[T]) SetDockIcon(value Texture2D.Instance) *Extension[T] {
	o.Super().AsEditorDock().SetDockIcon(value)
	return o
}

// ForceShowIcon is promoted from [EditorDock.Instance.ForceShowIcon].
func (self Instance) ForceShowIcon() bool { return self.AsEditorDock().ForceShowIcon() }
func (o *Extension[T]) ForceShowIcon() bool { return o.Super().AsEditorDock().ForceShowIcon() }

// SetForceShowIcon is promoted from [EditorDock.Instance.SetForceShowIcon].
func (self Instance) SetForceShowIcon(value bool) Instance {
	self.AsEditorDock().SetForceShowIcon(value)
	return self
}
func (o *Extension[T]) SetForceShowIcon(value bool) *Extension[T] {
	o.Super().AsEditorDock().SetForceShowIcon(value)
	return o
}

// TitleColor is promoted from [EditorDock.Instance.TitleColor].
func (self Instance) TitleColor() Color.RGBA { return self.AsEditorDock().TitleColor() }
func (o *Extension[T]) TitleColor() Color.RGBA { return o.Super().AsEditorDock().TitleColor() }

// SetTitleColor is promoted from [EditorDock.Instance.SetTitleColor].
func (self Instance) SetTitleColor(value Color.RGBA) Instance {
	self.AsEditorDock().SetTitleColor(value)
	return self
}
func (o *Extension[T]) SetTitleColor(value Color.RGBA) *Extension[T] {
	o.Super().AsEditorDock().SetTitleColor(value)
	return o
}

// DockShortcut is promoted from [EditorDock.Instance.DockShortcut].
func (self Instance) DockShortcut() Shortcut.Instance { return self.AsEditorDock().DockShortcut() }
func (o *Extension[T]) DockShortcut() Shortcut.Instance { return o.Super().AsEditorDock().DockShortcut() }

// SetDockShortcut is promoted from [EditorDock.Instance.SetDockShortcut].
func (self Instance) SetDockShortcut(value Shortcut.Instance) Instance {
	self.AsEditorDock().SetDockShortcut(value)
	return self
}
func (o *Extension[T]) SetDockShortcut(value Shortcut.Instance) *Extension[T] {
	o.Super().AsEditorDock().SetDockShortcut(value)
	return o
}

// DefaultSlot is promoted from [EditorDock.Instance.DefaultSlot].
func (self Instance) DefaultSlot() EditorDock.DockSlot { return self.AsEditorDock().DefaultSlot() }
func (o *Extension[T]) DefaultSlot() EditorDock.DockSlot { return o.Super().AsEditorDock().DefaultSlot() }

// SetDefaultSlot is promoted from [EditorDock.Instance.SetDefaultSlot].
func (self Instance) SetDefaultSlot(value EditorDock.DockSlot) Instance {
	self.AsEditorDock().SetDefaultSlot(value)
	return self
}
func (o *Extension[T]) SetDefaultSlot(value EditorDock.DockSlot) *Extension[T] {
	o.Super().AsEditorDock().SetDefaultSlot(value)
	return o
}

// AvailableLayouts is promoted from [EditorDock.Instance.AvailableLayouts].
func (self Instance) AvailableLayouts() EditorDock.DockLayout { return self.AsEditorDock().AvailableLayouts() }
func (o *Extension[T]) AvailableLayouts() EditorDock.DockLayout { return o.Super().AsEditorDock().AvailableLayouts() }

// SetAvailableLayouts is promoted from [EditorDock.Instance.SetAvailableLayouts].
func (self Instance) SetAvailableLayouts(value EditorDock.DockLayout) Instance {
	self.AsEditorDock().SetAvailableLayouts(value)
	return self
}
func (o *Extension[T]) SetAvailableLayouts(value EditorDock.DockLayout) *Extension[T] {
	o.Super().AsEditorDock().SetAvailableLayouts(value)
	return o
}
