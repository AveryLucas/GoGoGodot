...
import "github.com/AveryLucas/gogogd/classdb/CompositorEffect"
...
func (o *Extension[T]) CompositorEffects() []CompositorEffect.Instance { return o.Super().CompositorEffects() }
...
func (o *Extension[T]) SetCompositorEffects(value []CompositorEffect.Instance) *Extension[T] {
	o.Super().SetCompositorEffects(value)
	return o
}
...
func init() {gdclass.Register("Compositor", func(ptr gdreference.Object) any { return Instance{gdclass.NewCompositor(ptr)} })}
