...
import "github.com/AveryLucas/gogogd/classdb/GPUParticlesAttractor3D"
...
func (o class) AsGPUParticlesAttractor3D() GPUParticlesAttractor3D.Advanced { return *(*GPUParticlesAttractor3D.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsGPUParticlesAttractor3D() GPUParticlesAttractor3D.Instance { return o.Super().AsGPUParticlesAttractor3D() }
func (o Instance) AsGPUParticlesAttractor3D() GPUParticlesAttractor3D.Instance { return *(*GPUParticlesAttractor3D.Instance)(ie.As(&o)) }
...
// Strength is promoted from [GPUParticlesAttractor3D.Instance.Strength].
func (self Instance) Strength() Float.X { return self.AsGPUParticlesAttractor3D().Strength() }
func (o *Extension[T]) Strength() Float.X { return o.Super().AsGPUParticlesAttractor3D().Strength() }

// SetStrength is promoted from [GPUParticlesAttractor3D.Instance.SetStrength].
func (self Instance) SetStrength(value Float.X) Instance {
	self.AsGPUParticlesAttractor3D().SetStrength(value)
	return self
}
func (o *Extension[T]) SetStrength(value Float.X) *Extension[T] {
	o.Super().AsGPUParticlesAttractor3D().SetStrength(value)
	return o
}

// Attenuation is promoted from [GPUParticlesAttractor3D.Instance.Attenuation].
func (self Instance) Attenuation() Float.X { return self.AsGPUParticlesAttractor3D().Attenuation() }
func (o *Extension[T]) Attenuation() Float.X { return o.Super().AsGPUParticlesAttractor3D().Attenuation() }

// SetAttenuation is promoted from [GPUParticlesAttractor3D.Instance.SetAttenuation].
func (self Instance) SetAttenuation(value Float.X) Instance {
	self.AsGPUParticlesAttractor3D().SetAttenuation(value)
	return self
}
func (o *Extension[T]) SetAttenuation(value Float.X) *Extension[T] {
	o.Super().AsGPUParticlesAttractor3D().SetAttenuation(value)
	return o
}

// Directionality is promoted from [GPUParticlesAttractor3D.Instance.Directionality].
func (self Instance) Directionality() Float.X { return self.AsGPUParticlesAttractor3D().Directionality() }
func (o *Extension[T]) Directionality() Float.X { return o.Super().AsGPUParticlesAttractor3D().Directionality() }

// SetDirectionality is promoted from [GPUParticlesAttractor3D.Instance.SetDirectionality].
func (self Instance) SetDirectionality(value Float.X) Instance {
	self.AsGPUParticlesAttractor3D().SetDirectionality(value)
	return self
}
func (o *Extension[T]) SetDirectionality(value Float.X) *Extension[T] {
	o.Super().AsGPUParticlesAttractor3D().SetDirectionality(value)
	return o
}

// CullMask is promoted from [GPUParticlesAttractor3D.Instance.CullMask].
func (self Instance) CullMask() int { return self.AsGPUParticlesAttractor3D().CullMask() }
func (o *Extension[T]) CullMask() int { return o.Super().AsGPUParticlesAttractor3D().CullMask() }

// SetCullMask is promoted from [GPUParticlesAttractor3D.Instance.SetCullMask].
func (self Instance) SetCullMask(value int) Instance {
	self.AsGPUParticlesAttractor3D().SetCullMask(value)
	return self
}
func (o *Extension[T]) SetCullMask(value int) *Extension[T] {
	o.Super().AsGPUParticlesAttractor3D().SetCullMask(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(GPUParticlesAttractor3D.Advanced(self.AsGPUParticlesAttractor3D()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(GPUParticlesAttractor3D.Instance(self.AsGPUParticlesAttractor3D()), name)
	}
}
func init() {gdclass.Register("GPUParticlesAttractorVectorField3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewGPUParticlesAttractorVectorField3D(ptr)} })}
