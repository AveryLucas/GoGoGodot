...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_ycbcr_images, 0|(gdextension.SizeObject<<4)|(gdextension.SizeObject<<8), &struct{y_image gdextension.Object; cbcr_image gdextension.Object}{	gdextension.Object(gdreference.GetObject(gdclass.GetImage(y_image[0])[0])), 	gdextension.Object(gdreference.GetObject(gdclass.GetImage(cbcr_image[0])[0]))})
}
func (self class) SetExternal(width int64, height int64)  { //gd:CameraFeed.set_external
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_external, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct{width int64; height int64}{width, height})
}
...
func (self class) SetFormat(index int64, parameters Dictionary.Any) bool { //gd:CameraFeed.set_format
	var r_ret = noescape.Call[bool]( gd.ObjectChecked(self.AsObject()), methods.set_format, gdextension.SizeBool|(gdextension.SizeInt<<4)|(gdextension.SizeDictionary<<8), &struct{index int64; parameters gdextension.Dictionary}{index, pointers.Get(gd.InternalDictionary(parameters))})
	var ret = r_ret
	return ret
}
...
func (o *Extension[T]) OnFormatChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("format_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	case "_activate_feed": return reflect.ValueOf(self._activate_feed);
	case "_deactivate_feed": return reflect.ValueOf(self._deactivate_feed);
...
func init() {gdclass.Register("CameraFeed", func(ptr gdreference.Object) any { return Instance{gdclass.NewCameraFeed(ptr)} })}
