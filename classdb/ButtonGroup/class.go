...
func (o *Extension[T]) OnPressed(cb func(button BaseButton.Instance), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
func (o *Extension[T]) GetPressedButton() BaseButton.Instance {
	return o.Super().GetPressedButton()
}
func (o *Extension[T]) GetButtons() []BaseButton.Instance {
	return o.Super().GetButtons()
}
...
func init() {gdclass.Register("ButtonGroup", func(ptr gdreference.Object) any { return Instance{gdclass.NewButtonGroup(ptr)} })}
