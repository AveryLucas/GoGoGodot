...
func (o *Extension[T]) NavigationPolygon() NavigationPolygon.Instance { return o.Super().NavigationPolygon() }
...
func (o *Extension[T]) SetNavigationPolygon(value NavigationPolygon.Instance) *Extension[T] {
	o.Super().SetNavigationPolygon(value)
	return o
}
...
func (o *Extension[T]) UseEdgeConnections() bool { return o.Super().UseEdgeConnections() }
...
func (o *Extension[T]) SetUseEdgeConnections(value bool) *Extension[T] {
	o.Super().SetUseEdgeConnections(value)
	return o
}
...
func (o *Extension[T]) EnterCost() Float.X { return o.Super().EnterCost() }
...
func (o *Extension[T]) SetEnterCost(value Float.X) *Extension[T] {
	o.Super().SetEnterCost(value)
	return o
}
...
func (o *Extension[T]) TravelCost() Float.X { return o.Super().TravelCost() }
...
func (o *Extension[T]) SetTravelCost(value Float.X) *Extension[T] {
	o.Super().SetTravelCost(value)
	return o
}
...
func (o *Extension[T]) OnNavigationPolygonChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("navigation_polygon_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnBakeFinished(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("bake_finished"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) GetRid() RID.NavigationRegion2D {
	return o.Super().GetRid()
}
func (o *Extension[T]) SetNavigationMap(navigation_map RID.NavigationMap2D) *Extension[T] {
...
func (o *Extension[T]) GetRegionRid() RID.NavigationRegion2D {
	return o.Super().GetRegionRid()
}
func (o *Extension[T]) IsBaking() bool {
	return o.Super().IsBaking()
}
...
func init() {gdclass.Register("NavigationRegion2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewNavigationRegion2D(ptr)} })}
