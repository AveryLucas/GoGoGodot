...
func (o *Extension[T]) DegreesMode() bool { return o.Super().DegreesMode() }
...
func (o *Extension[T]) SetDegreesMode(value bool) *Extension[T] {
	o.Super().SetDegreesMode(value)
	return o
}
...
func init() {gdclass.Register("VisualShaderNodeParticleMultiplyByAxisAngle", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeParticleMultiplyByAxisAngle(ptr)} })}
