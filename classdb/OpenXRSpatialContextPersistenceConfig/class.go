...
func (o class) AsOpenXRStructureBase() OpenXRStructureBase.Advanced { return *(*OpenXRStructureBase.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsOpenXRStructureBase() OpenXRStructureBase.Instance { return o.Super().AsOpenXRStructureBase() }
func (o Instance) AsOpenXRStructureBase() OpenXRStructureBase.Instance { return *(*OpenXRStructureBase.Instance)(ie.As(&o)) }
...
func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(OpenXRStructureBase.Instance(self.AsOpenXRStructureBase()), name)
	}
}
func init() {gdclass.Register("OpenXRSpatialContextPersistenceConfig", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRSpatialContextPersistenceConfig(ptr)} })}
