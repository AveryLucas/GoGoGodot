...
func init() {gdclass.Register("VisualShaderNodeParticleConeVelocity", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeParticleConeVelocity(ptr)} })}
