...
import "github.com/AveryLucas/gogogd/classdb/AudioStreamInteractive"
...
func (o *Extension[T]) SwitchToClipByName(clip_name string) {
	o.Super().SwitchToClipByName(clip_name)
}
func (o *Extension[T]) SwitchToClip(clip_index AudioStreamInteractive.Clip) {
	o.Super().SwitchToClip(clip_index)
}
func (o *Extension[T]) GetCurrentClipIndex() AudioStreamInteractive.Clip {
	return o.Super().GetCurrentClipIndex()
}
...
func init() {gdclass.Register("AudioStreamPlaybackInteractive", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioStreamPlaybackInteractive(ptr)} })}
