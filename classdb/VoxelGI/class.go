...
import "github.com/AveryLucas/gogogd/classdb/VoxelGIData"
...
func (o *Extension[T]) Subdiv() Subdiv { return o.Super().Subdiv() }
...
func (o *Extension[T]) SetSubdiv(value Subdiv) *Extension[T] {
	o.Super().SetSubdiv(value)
	return o
}
...
func (o *Extension[T]) Data() VoxelGIData.Instance { return o.Super().Data() }
...
func (o *Extension[T]) SetData(value VoxelGIData.Instance) *Extension[T] {
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.bake, 0|(gdextension.SizeObject<<4)|(gdextension.SizeBool<<8), &struct{from_node gdextension.Object; create_visual_debug bool}{	gdextension.Object(gdreference.GetObject(gdclass.GetNode(from_node[0])[0])), create_visual_debug})
}
...
func init() {gdclass.Register("VoxelGI", func(ptr gdreference.Object) any { return Instance{gdclass.NewVoxelGI(ptr)} })}
