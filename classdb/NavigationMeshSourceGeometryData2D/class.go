...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.add_traversable_outline, 0|(gdextension.SizePackedArray<<4), &struct{shape_outline gdextension.PackedArray[Vector2.XY]}{pointers.Get(gd.InternalPacked[gd.PackedVector2Array, Vector2.XY](shape_outline))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.add_obstruction_outline, 0|(gdextension.SizePackedArray<<4), &struct{shape_outline gdextension.PackedArray[Vector2.XY]}{pointers.Get(gd.InternalPacked[gd.PackedVector2Array, Vector2.XY](shape_outline))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.add_projected_obstruction, 0|(gdextension.SizePackedArray<<4)|(gdextension.SizeBool<<8), &struct{vertices gdextension.PackedArray[Vector2.XY]; carve bool}{pointers.Get(gd.InternalPacked[gd.PackedVector2Array, Vector2.XY](vertices)), carve})
}
...
func (o *Extension[T]) AppendTraversableOutlines(traversable_outlines [][]Vector2.XY) {
	o.Super().AppendTraversableOutlines(traversable_outlines)
}
func (o *Extension[T]) AppendObstructionOutlines(obstruction_outlines [][]Vector2.XY) {
	o.Super().AppendObstructionOutlines(obstruction_outlines)
}
func (o *Extension[T]) AddTraversableOutline(shape_outline []Vector2.XY) {
	o.Super().AddTraversableOutline(shape_outline)
}
func (o *Extension[T]) AddObstructionOutline(shape_outline []Vector2.XY) {
	o.Super().AddObstructionOutline(shape_outline)
}
func (o *Extension[T]) Merge(other_geometry Instance) {
	o.Super().Merge(other_geometry)
}
func (o *Extension[T]) AddProjectedObstruction(vertices []Vector2.XY, carve bool) {
	o.Super().AddProjectedObstruction(vertices, carve)
}
...
func init() {gdclass.Register("NavigationMeshSourceGeometryData2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewNavigationMeshSourceGeometryData2D(ptr)} })}
