...
func (o *Extension[T]) Folded() bool { return o.Super().Folded() }
...
func (o *Extension[T]) SetFolded(value bool) *Extension[T] {
	o.Super().SetFolded(value)
	return o
}
...
func (o *Extension[T]) TitleAlignment() GUI.HorizontalAlignment { return o.Super().TitleAlignment() }
...
func (o *Extension[T]) SetTitleAlignment(value GUI.HorizontalAlignment) *Extension[T] {
	o.Super().SetTitleAlignment(value)
	return o
}
...
func (o *Extension[T]) TitlePosition() TitlePosition { return o.Super().TitlePosition() }
...
func (o *Extension[T]) SetTitlePosition(value TitlePosition) *Extension[T] {
	o.Super().SetTitlePosition(value)
	return o
}
...
func (o *Extension[T]) TitleTextOverrunBehavior() TextServer.OverrunBehavior { return o.Super().TitleTextOverrunBehavior() }
...
func (o *Extension[T]) SetTitleTextOverrunBehavior(value TextServer.OverrunBehavior) *Extension[T] {
	o.Super().SetTitleTextOverrunBehavior(value)
	return o
}
...
func (o *Extension[T]) TitleTextDirection() Control.TextDirection { return o.Super().TitleTextDirection() }
...
func (o *Extension[T]) SetTitleTextDirection(value Control.TextDirection) *Extension[T] {
	o.Super().SetTitleTextDirection(value)
	return o
}
...
func (o *Extension[T]) OnFoldingChanged(cb func(is_folded bool), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("folding_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) Fold() {
	o.Super().Fold()
}
func (o *Extension[T]) Expand() {
	o.Super().Expand()
}
func (o *Extension[T]) AddTitleBarControl(control Control.Instance) {
	o.Super().AddTitleBarControl(control)
}
func (o *Extension[T]) RemoveTitleBarControl(control Control.Instance) {
	o.Super().RemoveTitleBarControl(control)
}
...
func init() {gdclass.Register("FoldableContainer", func(ptr gdreference.Object) any { return Instance{gdclass.NewFoldableContainer(ptr)} })}
