...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_path, 0|(gdextension.SizePackedArray<<4), &struct{path gdextension.PackedArray[Vector3.XYZ]}{pointers.Get(gd.InternalPacked[gd.PackedVector3Array, Vector3.XYZ](path))})
}
...
func init() {gdclass.Register("NavigationPathQueryResult3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewNavigationPathQueryResult3D(ptr)} })}
