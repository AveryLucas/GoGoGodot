...
func (o *Extension[T]) HandTracker() string { return o.Super().HandTracker() }
...
func (o *Extension[T]) SetHandTracker(value string) *Extension[T] {
	o.Super().SetHandTracker(value)
	return o
}
...
func init() {gdclass.Register("XRHandModifier3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewXRHandModifier3D(ptr)} })}
