...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_color_attachments, 0|(gdextension.SizePackedArray<<4), &struct{p_member gdextension.PackedArray[int32]}{pointers.Get(gd.InternalPacked[gd.PackedInt32Array, int32](p_member))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_input_attachments, 0|(gdextension.SizePackedArray<<4), &struct{p_member gdextension.PackedArray[int32]}{pointers.Get(gd.InternalPacked[gd.PackedInt32Array, int32](p_member))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_resolve_attachments, 0|(gdextension.SizePackedArray<<4), &struct{p_member gdextension.PackedArray[int32]}{pointers.Get(gd.InternalPacked[gd.PackedInt32Array, int32](p_member))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_preserve_attachments, 0|(gdextension.SizePackedArray<<4), &struct{p_member gdextension.PackedArray[int32]}{pointers.Get(gd.InternalPacked[gd.PackedInt32Array, int32](p_member))})
}
...
func init() {gdclass.Register("RDFramebufferPass", func(ptr gdreference.Object) any { return Instance{gdclass.NewRDFramebufferPass(ptr)} })}
