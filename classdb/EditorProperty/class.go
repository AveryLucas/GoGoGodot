...
func (o *Extension[T]) Label() string { return o.Super().Label() }
...
func (o *Extension[T]) SetLabel(value string) *Extension[T] {
	o.Super().SetLabel(value)
	return o
}
...
func (o *Extension[T]) ReadOnly() bool { return o.Super().ReadOnly() }

func (self Instance) DrawLabel() bool { //gd:EditorProperty.draw_label
		return bool(class(self).IsDrawLabel())
}

func (o *Extension[T]) DrawLabel() bool { return o.Super().DrawLabel() }
...
func (o *Extension[T]) SetDrawLabel(value bool) *Extension[T] {
	o.Super().SetDrawLabel(value)
	return o
}
...
func (o *Extension[T]) DrawBackground() bool { return o.Super().DrawBackground() }
...
func (o *Extension[T]) SetDrawBackground(value bool) *Extension[T] {
	o.Super().SetDrawBackground(value)
	return o
}
...
func (o *Extension[T]) Checkable() bool { return o.Super().Checkable() }
...
func (o *Extension[T]) SetCheckable(value bool) *Extension[T] {
	o.Super().SetCheckable(value)
	return o
}
...
func (o *Extension[T]) Checked() bool { return o.Super().Checked() }
...
func (o *Extension[T]) SetChecked(value bool) *Extension[T] {
	o.Super().SetChecked(value)
	return o
}
...
func (o *Extension[T]) DrawWarning() bool { return o.Super().DrawWarning() }
...
func (o *Extension[T]) SetDrawWarning(value bool) *Extension[T] {
	o.Super().SetDrawWarning(value)
	return o
}
...
func (o *Extension[T]) Keying() bool { return o.Super().Keying() }
...
func (o *Extension[T]) SetKeying(value bool) *Extension[T] {
	o.Super().SetKeying(value)
	return o
}
...
func (o *Extension[T]) Deletable() bool { return o.Super().Deletable() }
...
func (o *Extension[T]) SetDeletable(value bool) *Extension[T] {
	o.Super().SetDeletable(value)
	return o
}
...
func (o *Extension[T]) Selectable() bool { return o.Super().Selectable() }
...
func (o *Extension[T]) UseFolding() bool { return o.Super().UseFolding() }
...
func (o *Extension[T]) SetUseFolding(value bool) *Extension[T] {
	o.Super().SetUseFolding(value)
	return o
}
...
func (o *Extension[T]) NameSplitRatio() Float.X { return o.Super().NameSplitRatio() }
...
func (o *Extension[T]) SetNameSplitRatio(value Float.X) *Extension[T] {
	o.Super().SetNameSplitRatio(value)
	return o
}
...
func (o *Extension[T]) OnPropertyChanged(cb func(property string, value any, field string, changing bool), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("property_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnMultiplePropertiesChanged(cb func(properties []string, value []any), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("multiple_properties_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnPropertyKeyed(cb func(property string), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
func (o *Extension[T]) OnPropertyKeyedWithValue(cb func(property string, value any), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("property_keyed_with_value"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnPropertyChecked(cb func(property string, checked bool), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("property_checked"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnPropertyOverridden(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("property_overridden"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnPropertyFavorited(cb func(property string, favorited bool), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("property_favorited"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnPropertyPinned(cb func(property string, pinned bool), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("property_pinned"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnPropertyCanRevertChanged(cb func(property string, can_revert bool), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("property_can_revert_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnResourceSelected(cb func(path string, resource Resource.Instance), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
func (o *Extension[T]) OnObjectIdSelected(cb func(property string, id int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
func (o *Extension[T]) OnSelected(cb func(path string, focusable_idx int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("selected"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) GetEditedProperty() string {
	return o.Super().GetEditedProperty()
}
func (o *Extension[T]) GetEditedObject() Object.Instance {
	return o.Super().GetEditedObject()
}
func (o *Extension[T]) UpdateProperty() {
	o.Super().UpdateProperty()
}
func (o *Extension[T]) AddFocusable(control Control.Instance) {
	o.Super().AddFocusable(control)
}
func (o *Extension[T]) SetBottomEditor(editor Control.Instance) *Extension[T] {
	o.Super().SetBottomEditor(editor)
	return o
}
func (o *Extension[T]) Deselect() {
	o.Super().Deselect()
}
func (o *Extension[T]) IsSelected() bool {
	return o.Super().IsSelected()
}
func (o *Extension[T]) SetObjectAndProperty(obj Object.Instance, property string) *Extension[T] {
	o.Super().SetObjectAndProperty(obj, property)
	return o
}
func (o *Extension[T]) SetLabelReference(control Control.Instance) *Extension[T] {
	o.Super().SetLabelReference(control)
	return o
}
