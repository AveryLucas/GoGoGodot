...
func (o *Extension[T]) Constant() Vector3.XYZ { return o.Super().Constant() }
...
func (o *Extension[T]) SetConstant(value Vector3.XYZ) *Extension[T] {
...
func init() {gdclass.Register("VisualShaderNodeVec3Constant", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeVec3Constant(ptr)} })}
