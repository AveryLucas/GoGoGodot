...
func (self class) Client(trusted_chain [1]gdclass.X509Certificate, common_name_override String.Readable) [1]gdclass.TLSOptions { //gd:TLSOptions.client
	var r_ret = noescape.CallStatic[gdextension.Object]( methods.client, gdextension.SizeObject|(gdextension.SizeObject<<4)|(gdextension.SizeString<<8), &struct{trusted_chain gdextension.Object; common_name_override gdextension.String}{	gdextension.Object(gdreference.GetObject(gdclass.GetX509Certificate(trusted_chain[0])[0])), pointers.Get(gd.InternalString(common_name_override))})
...
func (self class) Server(key [1]gdclass.CryptoKey, certificate [1]gdclass.X509Certificate) [1]gdclass.TLSOptions { //gd:TLSOptions.server
	var r_ret = noescape.CallStatic[gdextension.Object]( methods.server, gdextension.SizeObject|(gdextension.SizeObject<<4)|(gdextension.SizeObject<<8), &struct{key gdextension.Object; certificate gdextension.Object}{	gdextension.Object(gdreference.GetObject(gdclass.GetCryptoKey(key[0])[0])), 	gdextension.Object(gdreference.GetObject(gdclass.GetX509Certificate(certificate[0])[0]))})
	var ret = [1]gdclass.TLSOptions{gdclass.NewTLSOptions(gd.PointerWithOwnershipTransferredToGo(r_ret))}
	return ret
}
...
func init() {gdclass.Register("TLSOptions", func(ptr gdreference.Object) any { return Instance{gdclass.NewTLSOptions(ptr)} })}
