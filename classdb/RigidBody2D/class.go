...
func (o *Extension[T]) CenterOfMass() Vector2.XY { return o.Super().CenterOfMass() }
...
func (o *Extension[T]) Inertia() Float.X { return o.Super().Inertia() }
...
func (o *Extension[T]) ContinuousCd() CCDMode { return o.Super().ContinuousCd() }
...
func (o *Extension[T]) SetContinuousCd(value CCDMode) *Extension[T] {
...
func (o *Extension[T]) LinearVelocity() Vector2.XY { return o.Super().LinearVelocity() }
...
func (o *Extension[T]) AngularVelocity() Float.X { return o.Super().AngularVelocity() }
...
func (o *Extension[T]) ConstantForce() Vector2.XY { return o.Super().ConstantForce() }
...
func (o *Extension[T]) ConstantTorque() Float.X { return o.Super().ConstantTorque() }
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.apply_impulse, 0|(gdextension.SizeVector2<<4)|(gdextension.SizeVector2<<8), &struct{impulse Vector2.XY; position Vector2.XY}{impulse, position})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.apply_force, 0|(gdextension.SizeVector2<<4)|(gdextension.SizeVector2<<8), &struct{force Vector2.XY; position Vector2.XY}{force, position})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.add_constant_force, 0|(gdextension.SizeVector2<<4)|(gdextension.SizeVector2<<8), &struct{force Vector2.XY; position Vector2.XY}{force, position})
}
...
func (o *Extension[T]) SetAxisVelocity(axis_velocity Vector2.XY) *Extension[T] {
	o.Super().SetAxisVelocity(axis_velocity)
	return o
}
func (o *Extension[T]) ApplyTorqueImpulse(torque Float.X) {
	o.Super().ApplyTorqueImpulse(torque)
}
func (o *Extension[T]) ApplyCentralForce(force Vector2.XY) {
	o.Super().ApplyCentralForce(force)
}
func (o *Extension[T]) ApplyTorque(torque Float.X) {
	o.Super().ApplyTorque(torque)
}
func (o *Extension[T]) AddConstantCentralForce(force Vector2.XY) {
	o.Super().AddConstantCentralForce(force)
}
func (o *Extension[T]) AddConstantTorque(torque Float.X) {
	o.Super().AddConstantTorque(torque)
}
func (o *Extension[T]) GetCollidingBodies() []Node2D.Instance {
...
func init() {gdclass.Register("RigidBody2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewRigidBody2D(ptr)} })}
