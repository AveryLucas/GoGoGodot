...
func (o *Extension[T]) NodeA() string { return o.Super().NodeA() }
...
func (o *Extension[T]) NodeB() string { return o.Super().NodeB() }
...
func (o *Extension[T]) DisableCollision() bool { return o.Super().DisableCollision() }
...
func (o *Extension[T]) SetDisableCollision(value bool) *Extension[T] {
	o.Super().SetDisableCollision(value)
	return o
}
...
func init() {gdclass.Register("Joint2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewJoint2D(ptr)} })}
