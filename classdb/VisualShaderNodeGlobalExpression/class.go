...
import "github.com/AveryLucas/gogogd/classdb/VisualShaderNodeExpression"
import "github.com/AveryLucas/gogogd/classdb/VisualShaderNodeGroupBase"
...
func (self Instance) Expression() string { return self.AsVisualShaderNodeExpression().Expression() }
...
func (self Instance) SetExpression(value string) Instance {
	self.AsVisualShaderNodeExpression().SetExpression(value)
	return self
}
