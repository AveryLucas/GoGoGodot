...
func (o *Extension[T]) ColorMode() ColorModeType { return o.Super().ColorMode() }
...
func (o *Extension[T]) SetColorMode(value ColorModeType) *Extension[T] {
	o.Super().SetColorMode(value)
	return o
}
...
func (o *Extension[T]) DeferredMode() bool { return o.Super().DeferredMode() }
...
func (o *Extension[T]) SetDeferredMode(value bool) *Extension[T] {
	o.Super().SetDeferredMode(value)
	return o
}
...
func (o *Extension[T]) PickerShape() PickerShapeType { return o.Super().PickerShape() }
...
func (o *Extension[T]) SetPickerShape(value PickerShapeType) *Extension[T] {
	o.Super().SetPickerShape(value)
	return o
}
...
func (o *Extension[T]) CanAddSwatches() bool { return o.Super().CanAddSwatches() }
...
func (o *Extension[T]) SetCanAddSwatches(value bool) *Extension[T] {
	o.Super().SetCanAddSwatches(value)
	return o
}
...
func (o *Extension[T]) SamplerVisible() bool { return o.Super().SamplerVisible() }
...
func (o *Extension[T]) SetSamplerVisible(value bool) *Extension[T] {
	o.Super().SetSamplerVisible(value)
	return o
}
...
func (o *Extension[T]) ColorModesVisible() bool { return o.Super().ColorModesVisible() }
...
func (o *Extension[T]) SetColorModesVisible(value bool) *Extension[T] {
	o.Super().SetColorModesVisible(value)
	return o
}
...
func (o *Extension[T]) SlidersVisible() bool { return o.Super().SlidersVisible() }
...
func (o *Extension[T]) SetSlidersVisible(value bool) *Extension[T] {
	o.Super().SetSlidersVisible(value)
	return o
}
...
func (o *Extension[T]) HexVisible() bool { return o.Super().HexVisible() }
...
func (o *Extension[T]) SetHexVisible(value bool) *Extension[T] {
	o.Super().SetHexVisible(value)
	return o
}
...
func (o *Extension[T]) PresetsVisible() bool { return o.Super().PresetsVisible() }
...
func (o *Extension[T]) SetPresetsVisible(value bool) *Extension[T] {
	o.Super().SetPresetsVisible(value)
	return o
}
...
func (o *Extension[T]) OnPresetAdded(cb func(color Color.RGBA), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("preset_added"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnPresetRemoved(cb func(color Color.RGBA), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("preset_removed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) AddPreset(color Color.RGBA) {
	o.Super().AddPreset(color)
}
func (o *Extension[T]) ErasePreset(color Color.RGBA) {
	o.Super().ErasePreset(color)
}
func (o *Extension[T]) GetPresets() []Color.RGBA {
	return o.Super().GetPresets()
}
func (o *Extension[T]) AddRecentPreset(color Color.RGBA) {
	o.Super().AddRecentPreset(color)
}
func (o *Extension[T]) EraseRecentPreset(color Color.RGBA) {
	o.Super().EraseRecentPreset(color)
}
func (o *Extension[T]) GetRecentPresets() []Color.RGBA {
	return o.Super().GetRecentPresets()
}
