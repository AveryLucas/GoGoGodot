...
func (o *Extension[T]) Constant() int { return o.Super().Constant() }
...
func (o *Extension[T]) SetConstant(value int) *Extension[T] {
...
func (self class) GetConstant() int64 { //gd:VisualShaderNodeUIntConstant.get_constant
	var r_ret = noescape.Call[int64]( gd.ObjectChecked(self.AsObject()), methods.get_constant, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func init() {gdclass.Register("VisualShaderNodeUIntConstant", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeUIntConstant(ptr)} })}
