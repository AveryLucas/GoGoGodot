...
func (o *Extension[T]) Tooltip() string { return o.Super().Tooltip() }
...
func (o *Extension[T]) SetTooltip(value string) *Extension[T] {
	o.Super().SetTooltip(value)
	return o
}
...
func (o *Extension[T]) Menu() string { return o.Super().Menu() }
...
func (o *Extension[T]) SetMenu(value string) *Extension[T] {
	o.Super().SetMenu(value)
	return o
}
...
func (o *Extension[T]) OnPressed(cb func(mouse_button int, mouse_position Vector2i.XY), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
func init() {gdclass.Register("StatusIndicator", func(ptr gdreference.Object) any { return Instance{gdclass.NewStatusIndicator(ptr)} })}
