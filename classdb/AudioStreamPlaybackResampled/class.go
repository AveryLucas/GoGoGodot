...
func init() {gdclass.Register("AudioStreamPlaybackResampled", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioStreamPlaybackResampled(ptr)} })}
