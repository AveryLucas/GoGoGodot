...
func (self class) Virtual(name string) reflect.Value {
	...
	default: return gd.VirtualByName(RenderData.Advanced(self.AsRenderData()), name)
	}
}
...
func (self Instance) Virtual(name string) reflect.Value {
	...
	case "_get_environment": return reflect.ValueOf(self._get_environment);
	case "_get_camera_attributes": return reflect.ValueOf(self._get_camera_attributes);
	default: return gd.VirtualByName(RenderData.Instance(self.AsRenderData()), name)
	}
}
func init() {gdclass.Register("RenderDataExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewRenderDataExtension(ptr)} })}
