...
func (o *Extension[T]) InputName() string { return o.Super().InputName() }
...
func (o *Extension[T]) SetInputName(value string) *Extension[T] {
	o.Super().SetInputName(value)
	return o
}
...
func (o *Extension[T]) OnInputTypeChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("input_type_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) GetInputRealName() string {
	return o.Super().GetInputRealName()
}
...
func init() {gdclass.Register("VisualShaderNodeInput", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeInput(ptr)} })}
