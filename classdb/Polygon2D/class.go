...
func (o *Extension[T]) TextureOffset() Vector2.XY { return o.Super().TextureOffset() }
...
func (o *Extension[T]) SetTextureOffset(value Vector2.XY) *Extension[T] {
	o.Super().SetTextureOffset(value)
	return o
}
...
func (o *Extension[T]) TextureScale() Vector2.XY { return o.Super().TextureScale() }
...
func (o *Extension[T]) SetTextureScale(value Vector2.XY) *Extension[T] {
...
func (o *Extension[T]) TextureRotation() Angle.Radians { return o.Super().TextureRotation() }
...
func (o *Extension[T]) SetTextureRotation(value Angle.Radians) *Extension[T] {
	o.Super().SetTextureRotation(value)
	return o
}
...
func (o *Extension[T]) InvertEnabled() bool { return o.Super().InvertEnabled() }
...
func (o *Extension[T]) SetInvertEnabled(value bool) *Extension[T] {
	o.Super().SetInvertEnabled(value)
	return o
}
...
func (o *Extension[T]) InvertBorder() Float.X { return o.Super().InvertBorder() }
...
func (o *Extension[T]) SetInvertBorder(value Float.X) *Extension[T] {
	o.Super().SetInvertBorder(value)
	return o
}
...
func (o *Extension[T]) Uv() []Vector2.XY { return o.Super().Uv() }
...
func (o *Extension[T]) SetUv(value []Vector2.XY) *Extension[T] {
	o.Super().SetUv(value)
	return o
}
...
func (o *Extension[T]) VertexColors() []Color.RGBA { return o.Super().VertexColors() }
...
func (o *Extension[T]) SetVertexColors(value []Color.RGBA) *Extension[T] {
	o.Super().SetVertexColors(value)
	return o
}
...
func (o *Extension[T]) Polygons() [][]int32 { return o.Super().Polygons() }
...
func (o *Extension[T]) SetPolygons(value [][]int32) *Extension[T] {
	o.Super().SetPolygons(value)
	return o
}
...
func (o *Extension[T]) InternalVertexCount() int { return o.Super().InternalVertexCount() }
...
func (o *Extension[T]) SetInternalVertexCount(value int) *Extension[T] {
	o.Super().SetInternalVertexCount(value)
	return o
}
