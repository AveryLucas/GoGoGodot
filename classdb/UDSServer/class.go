...
import "github.com/AveryLucas/gogogd/classdb/StreamPeerUDS"
...
func init() {gdclass.Register("UDSServer", func(ptr gdreference.Object) any { return Instance{gdclass.NewUDSServer(ptr)} })}
