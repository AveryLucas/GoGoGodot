...
import "github.com/AveryLucas/gogogd/classdb/Curve3D"
...
func (o *Extension[T]) Curve() Curve3D.Instance { return o.Super().Curve() }
...
func (o *Extension[T]) SetCurve(value Curve3D.Instance) *Extension[T] {
...
func (o *Extension[T]) DebugCustomColor() Color.RGBA { return o.Super().DebugCustomColor() }
...
func (o *Extension[T]) SetDebugCustomColor(value Color.RGBA) *Extension[T] {
	o.Super().SetDebugCustomColor(value)
	return o
}
...
func (o *Extension[T]) OnCurveChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("curve_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnDebugColorChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("debug_color_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func init() {gdclass.Register("Path3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewPath3D(ptr)} })}
