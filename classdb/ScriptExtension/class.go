...
func (self class) Virtual(name string) reflect.Value {
	...
	case "_get_doc_class_name": return reflect.ValueOf(self._get_doc_class_name);
...
func init() {gdclass.Register("ScriptExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewScriptExtension(ptr)} })}
