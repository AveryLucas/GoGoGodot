...
func (self class) MixAudio(rate_scale float64, frames int64) Packed.Array[Vector2.XY] { //gd:AudioStreamPlayback.mix_audio
	var r_ret = noescape.Call[gd.PackedPointers]( gd.ObjectChecked(self.AsObject()), methods.mix_audio, gdextension.SizePackedArray|(gdextension.SizeFloat<<4)|(gdextension.SizeInt<<8), &struct{rate_scale float64; frames int64}{rate_scale, frames})
...
func init() {gdclass.Register("AudioStreamPlayback", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioStreamPlayback(ptr)} })}
