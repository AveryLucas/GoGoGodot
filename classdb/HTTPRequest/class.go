...
import "github.com/AveryLucas/gogogd/classdb/HTTPClient"
...
func (o *Extension[T]) DownloadFile() string { return o.Super().DownloadFile() }
...
func (o *Extension[T]) SetDownloadFile(value string) *Extension[T] {
	o.Super().SetDownloadFile(value)
	return o
}
...
func (o *Extension[T]) DownloadChunkSize() int { return o.Super().DownloadChunkSize() }
...
func (o *Extension[T]) SetDownloadChunkSize(value int) *Extension[T] {
	o.Super().SetDownloadChunkSize(value)
	return o
}
...
func (o *Extension[T]) UseThreads() bool { return o.Super().UseThreads() }
...
func (o *Extension[T]) SetUseThreads(value bool) *Extension[T] {
	o.Super().SetUseThreads(value)
	return o
}
...
func (o *Extension[T]) AcceptGzip() bool { return o.Super().AcceptGzip() }
...
func (o *Extension[T]) SetAcceptGzip(value bool) *Extension[T] {
	o.Super().SetAcceptGzip(value)
	return o
}
...
func (o *Extension[T]) BodySizeLimit() int { return o.Super().BodySizeLimit() }
...
func (o *Extension[T]) SetBodySizeLimit(value int) *Extension[T] {
	o.Super().SetBodySizeLimit(value)
	return o
}
...
func (o *Extension[T]) MaxRedirects() int { return o.Super().MaxRedirects() }
...
func (o *Extension[T]) SetMaxRedirects(value int) *Extension[T] {
	o.Super().SetMaxRedirects(value)
	return o
}
...
func (o *Extension[T]) Timeout() Float.X { return o.Super().Timeout() }
...
func (o *Extension[T]) SetTimeout(value Float.X) *Extension[T] {
	o.Super().SetTimeout(value)
	return o
}
...
func (o *Extension[T]) OnRequestCompleted(cb func(result Result, response_code int, headers []string, body []byte), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("request_completed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) CancelRequest() {
	o.Super().CancelRequest()
}
func (o *Extension[T]) SetTlsOptions(client_options TLSOptions.Instance) *Extension[T] {
	o.Super().SetTlsOptions(client_options)
	return o
}
func (o *Extension[T]) GetHttpClientStatus() HTTPClient.Status {
	return o.Super().GetHttpClientStatus()
}
func (o *Extension[T]) GetDownloadedBytes() int {
	return o.Super().GetDownloadedBytes()
}
func (o *Extension[T]) GetBodySize() int {
	return o.Super().GetBodySize()
}
