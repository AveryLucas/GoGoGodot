...
func (o *Extension[T]) OnVelocityComputed(cb func(safe_velocity Vector2.XY), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
func (o *Extension[T]) GetRid() RID.NavigationAgent2D {
...
func (o *Extension[T]) GetNextPathPosition() Vector2.XY {
	return o.Super().GetNextPathPosition()
}
func (o *Extension[T]) SetVelocityForced(velocity Vector2.XY) *Extension[T] {
...
func (o *Extension[T]) GetCurrentNavigationResult() NavigationPathQueryResult2D.Instance {
	return o.Super().GetCurrentNavigationResult()
}
func (o *Extension[T]) GetCurrentNavigationPath() []Vector2.XY {
...
func (o *Extension[T]) GetFinalPosition() Vector2.XY {
