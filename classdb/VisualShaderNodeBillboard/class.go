...
func (o *Extension[T]) BillboardType() BillboardType { return o.Super().BillboardType() }
...
func (o *Extension[T]) SetBillboardType(value BillboardType) *Extension[T] {
	o.Super().SetBillboardType(value)
	return o
}
...
func (o *Extension[T]) KeepScale() bool { return o.Super().KeepScale() }
...
func (o *Extension[T]) SetKeepScale(value bool) *Extension[T] {
	o.Super().SetKeepScale(value)
	return o
}
...
func init() {gdclass.Register("VisualShaderNodeBillboard", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeBillboard(ptr)} })}
