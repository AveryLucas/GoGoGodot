...
func (o *Extension[T]) OriginalClass() string { return o.Super().OriginalClass() }
...
func (o *Extension[T]) SetOriginalClass(value string) *Extension[T] {
	o.Super().SetOriginalClass(value)
	return o
}
...
func (o *Extension[T]) OriginalScene() string { return o.Super().OriginalScene() }
...
func (o *Extension[T]) SetOriginalScene(value string) *Extension[T] {
	o.Super().SetOriginalScene(value)
	return o
}
...
func (o *Extension[T]) RecordingProperties() bool { return o.Super().RecordingProperties() }
...
func (o *Extension[T]) SetRecordingProperties(value bool) *Extension[T] {
	o.Super().SetRecordingProperties(value)
	return o
}
...
func (o *Extension[T]) RecordingSignals() bool { return o.Super().RecordingSignals() }
...
func (o *Extension[T]) SetRecordingSignals(value bool) *Extension[T] {
	o.Super().SetRecordingSignals(value)
	return o
}
