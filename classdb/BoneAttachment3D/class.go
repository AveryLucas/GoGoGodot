...
func (o *Extension[T]) BoneIdx() int { return o.Super().BoneIdx() }
...
func (o *Extension[T]) SetBoneIdx(value int) *Extension[T] {
	o.Super().SetBoneIdx(value)
	return o
}
...
func (o *Extension[T]) OverridePose() bool { return o.Super().OverridePose() }
...
func (o *Extension[T]) SetOverridePose(value bool) *Extension[T] {
	o.Super().SetOverridePose(value)
	return o
}
...
func (o *Extension[T]) UseExternalSkeleton() bool { return o.Super().UseExternalSkeleton() }
...
func (o *Extension[T]) SetUseExternalSkeleton(value bool) *Extension[T] {
	o.Super().SetUseExternalSkeleton(value)
	return o
}
...
func (o *Extension[T]) ExternalSkeleton() string { return o.Super().ExternalSkeleton() }
...
func (o *Extension[T]) SetExternalSkeleton(value string) *Extension[T] {
	o.Super().SetExternalSkeleton(value)
	return o
}
...
func (o *Extension[T]) OnSkeletonUpdate() {
	o.Super().OnSkeletonUpdate()
}
...
func init() {gdclass.Register("BoneAttachment3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewBoneAttachment3D(ptr)} })}
