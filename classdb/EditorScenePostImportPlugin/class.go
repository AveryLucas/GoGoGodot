...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.add_import_option, 0|(gdextension.SizeString<<4)|(gdextension.SizeVariant<<8), &struct{name gdextension.String; value gdextension.Variant}{pointers.Get(gd.InternalString(name)), gdextension.Variant(pointers.Get(gd.InternalVariant(value)))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.add_import_option_advanced, 0|(gdextension.SizeInt<<4)|(gdextension.SizeString<<8)|(gdextension.SizeVariant<<12)|(gdextension.SizeInt<<16)|(gdextension.SizeString<<20)|(gdextension.SizeInt<<24), &struct{atype variant.Type; name gdextension.String; default_value gdextension.Variant; hint ClassDB.PropertyHint; hint_string gdextension.String; usage_flags int64}{atype, pointers.Get(gd.InternalString(name)), gdextension.Variant(pointers.Get(gd.InternalVariant(default_value))), hint, pointers.Get(gd.InternalString(hint_string)), usage_flags})
}
...
func (o *Extension[T]) GetOptionValue(name string) any {
	return o.Super().GetOptionValue(name)
}
func (o *Extension[T]) AddImportOption(name string, value any) {
	o.Super().AddImportOption(name, value)
}
...
func init() {gdclass.Register("EditorScenePostImportPlugin", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorScenePostImportPlugin(ptr)} })}
