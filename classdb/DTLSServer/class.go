...
import "github.com/AveryLucas/gogogd/classdb/PacketPeerDTLS"
...
func init() {gdclass.Register("DTLSServer", func(ptr gdreference.Object) any { return Instance{gdclass.NewDTLSServer(ptr)} })}
