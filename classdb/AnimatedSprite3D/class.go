...
import "github.com/AveryLucas/gogogd/classdb/SpriteBase3D"
import "github.com/AveryLucas/gogogd/classdb/SpriteFrames"
...
func (o *Extension[T]) OnSpriteFramesChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("sprite_frames_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnAnimationChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
func (o *Extension[T]) OnAnimationLooped(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("animation_looped"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnAnimationFinished(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
