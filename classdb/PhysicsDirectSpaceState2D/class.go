...
import "github.com/AveryLucas/gogogd/classdb/PhysicsPointQueryParameters2D"
import "github.com/AveryLucas/gogogd/classdb/PhysicsRayQueryParameters2D"
import "github.com/AveryLucas/gogogd/classdb/PhysicsShapeQueryParameters2D"
...
func (self class) IntersectPoint(parameters [1]gdclass.PhysicsPointQueryParameters2D, max_results int64) Array.Contains[Dictionary.Any] { //gd:PhysicsDirectSpaceState2D.intersect_point
	var r_ret = noescape.Call[gdextension.Array]( gd.ObjectChecked(self.AsObject()), methods.intersect_point, gdextension.SizeArray|(gdextension.SizeObject<<4)|(gdextension.SizeInt<<8), &struct{parameters gdextension.Object; max_results int64}{	gdextension.Object(gdreference.GetObject(gdclass.GetPhysicsPointQueryParameters2D(parameters[0])[0])), max_results})
...
func (self class) IntersectShape(parameters [1]gdclass.PhysicsShapeQueryParameters2D, max_results int64) Array.Contains[Dictionary.Any] { //gd:PhysicsDirectSpaceState2D.intersect_shape
	var r_ret = noescape.Call[gdextension.Array]( gd.ObjectChecked(self.AsObject()), methods.intersect_shape, gdextension.SizeArray|(gdextension.SizeObject<<4)|(gdextension.SizeInt<<8), &struct{parameters gdextension.Object; max_results int64}{	gdextension.Object(gdreference.GetObject(gdclass.GetPhysicsShapeQueryParameters2D(parameters[0])[0])), max_results})
	var ret = Array.Through(gd.ArrayProxy[Dictionary.Any]{}, pointers.Pack(pointers.New[gd.Array](r_ret)))
	return ret
}
...
func init() {gdclass.Register("PhysicsDirectSpaceState2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewPhysicsDirectSpaceState2D(ptr)} })}
