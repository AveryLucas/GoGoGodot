...
func init() {gdclass.Register("VisualShaderNodeLinearSceneDepth", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeLinearSceneDepth(ptr)} })}
