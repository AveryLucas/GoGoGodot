...
func (o *Extension[T]) Bitmask() BitMap.Instance { return o.Super().Bitmask() }
...
func (o *Extension[T]) SetBitmask(value BitMap.Instance) *Extension[T] {
	o.Super().SetBitmask(value)
	return o
}
...
func (o *Extension[T]) ShapeCentered() bool { return o.Super().ShapeCentered() }
...
func (o *Extension[T]) SetShapeCentered(value bool) *Extension[T] {
	o.Super().SetShapeCentered(value)
	return o
}
...
func (o *Extension[T]) ShapeVisible() bool { return o.Super().ShapeVisible() }
...
func (o *Extension[T]) SetShapeVisible(value bool) *Extension[T] {
	o.Super().SetShapeVisible(value)
	return o
}
...
func (o *Extension[T]) PassbyPress() bool { return o.Super().PassbyPress() }
...
func (o *Extension[T]) SetPassbyPress(value bool) *Extension[T] {
	o.Super().SetPassbyPress(value)
	return o
}
...
func (o *Extension[T]) OnReleased(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("released"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func init() {gdclass.Register("TouchScreenButton", func(ptr gdreference.Object) any { return Instance{gdclass.NewTouchScreenButton(ptr)} })}
