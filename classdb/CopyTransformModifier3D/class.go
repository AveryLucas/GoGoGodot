...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_copy_flags, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct{index int64; copy_flags TransformFlag}{index, copy_flags})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_axis_flags, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct{index int64; axis_flags AxisFlag}{index, axis_flags})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_invert_flags, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct{index int64; axis_flags AxisFlag}{index, axis_flags})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_copy_position, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct{index int64; enabled bool}{index, enabled})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_copy_rotation, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct{index int64; enabled bool}{index, enabled})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_copy_scale, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct{index int64; enabled bool}{index, enabled})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_axis_x_enabled, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct{index int64; enabled bool}{index, enabled})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_axis_y_enabled, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct{index int64; enabled bool}{index, enabled})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_axis_z_enabled, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct{index int64; enabled bool}{index, enabled})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_axis_x_inverted, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct{index int64; enabled bool}{index, enabled})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_axis_y_inverted, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct{index int64; enabled bool}{index, enabled})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_axis_z_inverted, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct{index int64; enabled bool}{index, enabled})
}
...
func init() {gdclass.Register("CopyTransformModifier3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewCopyTransformModifier3D(ptr)} })}
