...
func (o *Extension[T]) QuadSize() Vector2.XY { return o.Super().QuadSize() }
...
func (o *Extension[T]) SetQuadSize(value Vector2.XY) *Extension[T] {
	o.Super().SetQuadSize(value)
	return o
}
...
func init() {gdclass.Register("OpenXRCompositionLayerQuad", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRCompositionLayerQuad(ptr)} })}
