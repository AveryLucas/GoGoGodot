...
func (o class) AsWebRTCPeerConnection() WebRTCPeerConnection.Advanced { return *(*WebRTCPeerConnection.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsWebRTCPeerConnection() WebRTCPeerConnection.Instance { return o.Super().AsWebRTCPeerConnection() }
func (o Instance) AsWebRTCPeerConnection() WebRTCPeerConnection.Instance { return *(*WebRTCPeerConnection.Instance)(ie.As(&o)) }
...
func (self class) Virtual(name string) reflect.Value {
	...
	default: return gd.VirtualByName(WebRTCPeerConnection.Advanced(self.AsWebRTCPeerConnection()), name)
	}
}
...
func (self Instance) Virtual(name string) reflect.Value {
	...
	case "_poll": return reflect.ValueOf(self._poll);
	case "_close": return reflect.ValueOf(self._close);
	default: return gd.VirtualByName(WebRTCPeerConnection.Instance(self.AsWebRTCPeerConnection()), name)
	}
}
func init() {gdclass.Register("WebRTCPeerConnectionExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewWebRTCPeerConnectionExtension(ptr)} })}
