...
func (o *Extension[T]) InputRayPickable() bool { return o.Super().InputRayPickable() }
...
func (o *Extension[T]) SetInputRayPickable(value bool) *Extension[T] {
	o.Super().SetInputRayPickable(value)
	return o
}
...
func (o *Extension[T]) InputCaptureOnDrag() bool { return o.Super().InputCaptureOnDrag() }
...
func (o *Extension[T]) SetInputCaptureOnDrag(value bool) *Extension[T] {
	o.Super().SetInputCaptureOnDrag(value)
	return o
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.shape_owner_set_transform, 0|(gdextension.SizeInt<<4)|(gdextension.SizeTransform3D<<8), &struct{owner_id int64; transform Transform3D.BasisOrigin}{owner_id, gd.Transposed(transform)})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.shape_owner_add_shape, 0|(gdextension.SizeInt<<4)|(gdextension.SizeObject<<8), &struct{owner_id int64; shape gdextension.Object}{owner_id, 	gdextension.Object(gdreference.GetObject(gdclass.GetShape3D(shape[0])[0]))})
}
...
func init() {gdclass.Register("CollisionObject3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewCollisionObject3D(ptr)} })}
