...
func (o *Extension[T]) SpawnPath() string { return o.Super().SpawnPath() }
...
func (o *Extension[T]) SetSpawnPath(value string) *Extension[T] {
	o.Super().SetSpawnPath(value)
	return o
}
...
func (o *Extension[T]) SpawnLimit() int { return o.Super().SpawnLimit() }
...
func (o *Extension[T]) SetSpawnLimit(value int) *Extension[T] {
	o.Super().SetSpawnLimit(value)
	return o
}
...
func (o *Extension[T]) SpawnFunction() func(data any) Node.Instance { return o.Super().SpawnFunction() }
...
func (o *Extension[T]) SetSpawnFunction(value func(data any) Node.Instance) *Extension[T] {
	o.Super().SetSpawnFunction(value)
	return o
}
...
func (o *Extension[T]) OnDespawned(cb func(node Node.Instance), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("despawned"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnSpawned(cb func(node Node.Instance), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("spawned"), gd.NewCallable(cb), int64(flags_together))
	return o
}
