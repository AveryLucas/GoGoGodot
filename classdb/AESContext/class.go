...
func (self class) Start(mode Mode, key Packed.Bytes, iv Packed.Bytes) Error.Code { //gd:AESContext.start
	var r_ret = noescape.Call[int64]( gd.ObjectChecked(self.AsObject()), methods.start, gdextension.SizeInt|(gdextension.SizeInt<<4)|(gdextension.SizePackedArray<<8)|(gdextension.SizePackedArray<<12), &struct{mode Mode; key gdextension.PackedArray[byte]; iv gdextension.PackedArray[byte]}{mode, pointers.Get(gd.InternalPacked[gd.PackedByteArray,byte](Packed.Array[byte](key.Array))), pointers.Get(gd.InternalPacked[gd.PackedByteArray,byte](Packed.Array[byte](iv.Array)))})
...
func init() {gdclass.Register("AESContext", func(ptr gdreference.Object) any { return Instance{gdclass.NewAESContext(ptr)} })}
