...
func (o *Extension[T]) UseGlobalPose() bool { return o.Super().UseGlobalPose() }
...
func (o *Extension[T]) SetUseGlobalPose(value bool) *Extension[T] {
	o.Super().SetUseGlobalPose(value)
	return o
}
...
func (o *Extension[T]) Enable() TransformFlag { return o.Super().Enable() }
...
func (o *Extension[T]) SetEnable(value TransformFlag) *Extension[T] {
	o.Super().SetEnable(value)
	return o
}
...
func (o *Extension[T]) SetPositionEnabled(enabled bool) *Extension[T] {
	o.Super().SetPositionEnabled(enabled)
	return o
}
func (o *Extension[T]) IsPositionEnabled() bool {
	return o.Super().IsPositionEnabled()
}
func (o *Extension[T]) SetRotationEnabled(enabled bool) *Extension[T] {
	o.Super().SetRotationEnabled(enabled)
	return o
}
func (o *Extension[T]) IsRotationEnabled() bool {
	return o.Super().IsRotationEnabled()
}
func (o *Extension[T]) SetScaleEnabled(enabled bool) *Extension[T] {
	o.Super().SetScaleEnabled(enabled)
	return o
}
func (o *Extension[T]) IsScaleEnabled() bool {
	return o.Super().IsScaleEnabled()
}
...
func init() {gdclass.Register("RetargetModifier3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewRetargetModifier3D(ptr)} })}
