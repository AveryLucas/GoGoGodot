...
func (o *Extension[T]) FitMargin() Float.X { return o.Super().FitMargin() }
...
func (o *Extension[T]) SetFitMargin(value Float.X) *Extension[T] {
	o.Super().SetFitMargin(value)
	return o
}
...
func (o *Extension[T]) ClearMargin() Float.X { return o.Super().ClearMargin() }
...
func (o *Extension[T]) SetClearMargin(value Float.X) *Extension[T] {
	o.Super().SetClearMargin(value)
	return o
}
...
func (o *Extension[T]) UseMipmaps() bool { return o.Super().UseMipmaps() }
...
func (o *Extension[T]) SetUseMipmaps(value bool) *Extension[T] {
	o.Super().SetUseMipmaps(value)
	return o
}
...
func init() {gdclass.Register("CanvasGroup", func(ptr gdreference.Object) any { return Instance{gdclass.NewCanvasGroup(ptr)} })}
