...
func (o *Extension[T]) Mode2d() bool { return o.Super().Mode2d() }
...
func init() {gdclass.Register("VisualShaderNodeParticleEmitter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeParticleEmitter(ptr)} })}
