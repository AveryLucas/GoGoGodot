...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.send_message, 0|(gdextension.SizeString<<4)|(gdextension.SizeArray<<8), &struct{message gdextension.String; data gdextension.Array}{pointers.Get(gd.InternalString(message)), pointers.Get(gd.InternalArray(data))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.toggle_profiler, 0|(gdextension.SizeString<<4)|(gdextension.SizeBool<<8)|(gdextension.SizeArray<<12), &struct{profiler gdextension.String; enable bool; data gdextension.Array}{pointers.Get(gd.InternalString(profiler)), enable, pointers.Get(gd.InternalArray(data))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_breakpoint, 0|(gdextension.SizeString<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeBool<<12), &struct{path gdextension.String; line int64; enabled bool}{pointers.Get(gd.InternalString(path)), line, enabled})
}
...
func init() {gdclass.Register("EditorDebuggerSession", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorDebuggerSession(ptr)} })}
