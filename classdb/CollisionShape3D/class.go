...
func (o *Extension[T]) DebugFill() bool { return o.Super().DebugFill() }
...
func (o *Extension[T]) SetDebugFill(value bool) *Extension[T] {
	o.Super().SetDebugFill(value)
	return o
}
...
func (o *Extension[T]) MakeConvexFromSiblings() {
	o.Super().MakeConvexFromSiblings()
}
...
func init() {gdclass.Register("CollisionShape3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewCollisionShape3D(ptr)} })}
