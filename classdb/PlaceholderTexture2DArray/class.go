...
import "github.com/AveryLucas/gogogd/classdb/PlaceholderTextureLayered"
...
// Size is promoted from [PlaceholderTextureLayered.Instance.Size].
func (self Instance) Size() Vector2i.XY { return self.AsPlaceholderTextureLayered().Size() }
func (o *Extension[T]) Size() Vector2i.XY { return o.Super().AsPlaceholderTextureLayered().Size() }

// SetSize is promoted from [PlaceholderTextureLayered.Instance.SetSize].
func (self Instance) SetSize(value Vector2i.XY) Instance {
	self.AsPlaceholderTextureLayered().SetSize(value)
	return self
}
func (o *Extension[T]) SetSize(value Vector2i.XY) *Extension[T] {
	o.Super().AsPlaceholderTextureLayered().SetSize(value)
	return o
}

// SetLayers is promoted from [PlaceholderTextureLayered.Instance.SetLayers].
func (self Instance) SetLayers(value int) Instance {
	self.AsPlaceholderTextureLayered().SetLayers(value)
	return self
}
func (o *Extension[T]) SetLayers(value int) *Extension[T] {
	o.Super().AsPlaceholderTextureLayered().SetLayers(value)
	return o
}
