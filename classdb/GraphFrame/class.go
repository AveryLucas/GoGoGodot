...
func (o *Extension[T]) AutoshrinkEnabled() bool { return o.Super().AutoshrinkEnabled() }
...
func (o *Extension[T]) SetAutoshrinkEnabled(value bool) *Extension[T] {
	o.Super().SetAutoshrinkEnabled(value)
	return o
}
...
func (o *Extension[T]) AutoshrinkMargin() int { return o.Super().AutoshrinkMargin() }
...
func (o *Extension[T]) SetAutoshrinkMargin(value int) *Extension[T] {
	o.Super().SetAutoshrinkMargin(value)
	return o
}
...
func (o *Extension[T]) DragMargin() int { return o.Super().DragMargin() }
...
func (o *Extension[T]) SetDragMargin(value int) *Extension[T] {
	o.Super().SetDragMargin(value)
	return o
}
...
func (o *Extension[T]) OnAutoshrinkChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("autoshrink_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
