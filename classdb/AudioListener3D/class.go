...
func (o *Extension[T]) GetListenerTransform() Transform3D.BasisOrigin {
	return o.Super().GetListenerTransform()
}
...
func init() {gdclass.Register("AudioListener3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioListener3D(ptr)} })}
