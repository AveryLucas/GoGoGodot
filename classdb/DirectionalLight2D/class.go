...
import "github.com/AveryLucas/gogogd/classdb/Light2D"
...
func (o *Extension[T]) MaxDistance() Float.X { return o.Super().MaxDistance() }
...
func (o *Extension[T]) SetMaxDistance(value Float.X) *Extension[T] {
	o.Super().SetMaxDistance(value)
	return o
}
...
// SetHeight is promoted from [Light2D.Instance.SetHeight].
func (self Instance) SetHeight(height Float.X) Instance {
	self.AsLight2D().SetHeight(height)
	return self
}

// SetHeight is promoted from [Light2D.Instance.SetHeight].
func (o *Extension[T]) SetHeight(height Float.X) *Extension[T] {
	o.Super().AsLight2D().SetHeight(height)
	return o
}

// GetHeight is promoted from [Light2D.Instance.GetHeight].
func (self Instance) GetHeight() Float.X {
	return self.AsLight2D().GetHeight()
}

// GetHeight is promoted from [Light2D.Instance.GetHeight].
func (o *Extension[T]) GetHeight() Float.X {
	return o.Super().AsLight2D().GetHeight()
}
...
// Enabled is promoted from [Light2D.Instance.Enabled].
func (self Instance) Enabled() bool { return self.AsLight2D().Enabled() }
func (o *Extension[T]) Enabled() bool { return o.Super().AsLight2D().Enabled() }

// SetEnabled is promoted from [Light2D.Instance.SetEnabled].
func (self Instance) SetEnabled(value bool) Instance {
	self.AsLight2D().SetEnabled(value)
	return self
}
func (o *Extension[T]) SetEnabled(value bool) *Extension[T] {
	o.Super().AsLight2D().SetEnabled(value)
	return o
}

// EditorOnly is promoted from [Light2D.Instance.EditorOnly].
func (self Instance) EditorOnly() bool { return self.AsLight2D().EditorOnly() }
func (o *Extension[T]) EditorOnly() bool { return o.Super().AsLight2D().EditorOnly() }

// SetEditorOnly is promoted from [Light2D.Instance.SetEditorOnly].
func (self Instance) SetEditorOnly(value bool) Instance {
	self.AsLight2D().SetEditorOnly(value)
	return self
}
func (o *Extension[T]) SetEditorOnly(value bool) *Extension[T] {
	o.Super().AsLight2D().SetEditorOnly(value)
	return o
}

// Color is promoted from [Light2D.Instance.Color].
func (self Instance) Color() Color.RGBA { return self.AsLight2D().Color() }
func (o *Extension[T]) Color() Color.RGBA { return o.Super().AsLight2D().Color() }

// SetColor is promoted from [Light2D.Instance.SetColor].
func (self Instance) SetColor(value Color.RGBA) Instance {
	self.AsLight2D().SetColor(value)
	return self
}
func (o *Extension[T]) SetColor(value Color.RGBA) *Extension[T] {
	o.Super().AsLight2D().SetColor(value)
	return o
}

// Energy is promoted from [Light2D.Instance.Energy].
func (self Instance) Energy() Float.X { return self.AsLight2D().Energy() }
func (o *Extension[T]) Energy() Float.X { return o.Super().AsLight2D().Energy() }

// SetEnergy is promoted from [Light2D.Instance.SetEnergy].
func (self Instance) SetEnergy(value Float.X) Instance {
	self.AsLight2D().SetEnergy(value)
	return self
}
func (o *Extension[T]) SetEnergy(value Float.X) *Extension[T] {
	o.Super().AsLight2D().SetEnergy(value)
	return o
}

// BlendMode is promoted from [Light2D.Instance.BlendMode].
func (self Instance) BlendMode() Light2D.BlendMode { return self.AsLight2D().BlendMode() }
func (o *Extension[T]) BlendMode() Light2D.BlendMode { return o.Super().AsLight2D().BlendMode() }

// SetBlendMode is promoted from [Light2D.Instance.SetBlendMode].
func (self Instance) SetBlendMode(value Light2D.BlendMode) Instance {
	self.AsLight2D().SetBlendMode(value)
	return self
}
func (o *Extension[T]) SetBlendMode(value Light2D.BlendMode) *Extension[T] {
	o.Super().AsLight2D().SetBlendMode(value)
	return o
}

// RangeZMin is promoted from [Light2D.Instance.RangeZMin].
func (self Instance) RangeZMin() int { return self.AsLight2D().RangeZMin() }
func (o *Extension[T]) RangeZMin() int { return o.Super().AsLight2D().RangeZMin() }

// SetRangeZMin is promoted from [Light2D.Instance.SetRangeZMin].
func (self Instance) SetRangeZMin(value int) Instance {
	self.AsLight2D().SetRangeZMin(value)
	return self
}
func (o *Extension[T]) SetRangeZMin(value int) *Extension[T] {
	o.Super().AsLight2D().SetRangeZMin(value)
	return o
}

// RangeZMax is promoted from [Light2D.Instance.RangeZMax].
func (self Instance) RangeZMax() int { return self.AsLight2D().RangeZMax() }
func (o *Extension[T]) RangeZMax() int { return o.Super().AsLight2D().RangeZMax() }

// SetRangeZMax is promoted from [Light2D.Instance.SetRangeZMax].
func (self Instance) SetRangeZMax(value int) Instance {
	self.AsLight2D().SetRangeZMax(value)
	return self
}
func (o *Extension[T]) SetRangeZMax(value int) *Extension[T] {
	o.Super().AsLight2D().SetRangeZMax(value)
	return o
}

// RangeLayerMin is promoted from [Light2D.Instance.RangeLayerMin].
func (self Instance) RangeLayerMin() int { return self.AsLight2D().RangeLayerMin() }
func (o *Extension[T]) RangeLayerMin() int { return o.Super().AsLight2D().RangeLayerMin() }

// SetRangeLayerMin is promoted from [Light2D.Instance.SetRangeLayerMin].
func (self Instance) SetRangeLayerMin(value int) Instance {
	self.AsLight2D().SetRangeLayerMin(value)
	return self
}
func (o *Extension[T]) SetRangeLayerMin(value int) *Extension[T] {
	o.Super().AsLight2D().SetRangeLayerMin(value)
	return o
}

// RangeLayerMax is promoted from [Light2D.Instance.RangeLayerMax].
func (self Instance) RangeLayerMax() int { return self.AsLight2D().RangeLayerMax() }
func (o *Extension[T]) RangeLayerMax() int { return o.Super().AsLight2D().RangeLayerMax() }

// SetRangeLayerMax is promoted from [Light2D.Instance.SetRangeLayerMax].
func (self Instance) SetRangeLayerMax(value int) Instance {
	self.AsLight2D().SetRangeLayerMax(value)
	return self
}
func (o *Extension[T]) SetRangeLayerMax(value int) *Extension[T] {
	o.Super().AsLight2D().SetRangeLayerMax(value)
	return o
}

// RangeItemCullMask is promoted from [Light2D.Instance.RangeItemCullMask].
func (self Instance) RangeItemCullMask() int { return self.AsLight2D().RangeItemCullMask() }
func (o *Extension[T]) RangeItemCullMask() int { return o.Super().AsLight2D().RangeItemCullMask() }

// SetRangeItemCullMask is promoted from [Light2D.Instance.SetRangeItemCullMask].
func (self Instance) SetRangeItemCullMask(value int) Instance {
	self.AsLight2D().SetRangeItemCullMask(value)
	return self
}
func (o *Extension[T]) SetRangeItemCullMask(value int) *Extension[T] {
	o.Super().AsLight2D().SetRangeItemCullMask(value)
	return o
}

// ShadowEnabled is promoted from [Light2D.Instance.ShadowEnabled].
func (self Instance) ShadowEnabled() bool { return self.AsLight2D().ShadowEnabled() }
func (o *Extension[T]) ShadowEnabled() bool { return o.Super().AsLight2D().ShadowEnabled() }

// SetShadowEnabled is promoted from [Light2D.Instance.SetShadowEnabled].
func (self Instance) SetShadowEnabled(value bool) Instance {
	self.AsLight2D().SetShadowEnabled(value)
	return self
}
func (o *Extension[T]) SetShadowEnabled(value bool) *Extension[T] {
	o.Super().AsLight2D().SetShadowEnabled(value)
	return o
}

// ShadowColor is promoted from [Light2D.Instance.ShadowColor].
func (self Instance) ShadowColor() Color.RGBA { return self.AsLight2D().ShadowColor() }
func (o *Extension[T]) ShadowColor() Color.RGBA { return o.Super().AsLight2D().ShadowColor() }

// SetShadowColor is promoted from [Light2D.Instance.SetShadowColor].
func (self Instance) SetShadowColor(value Color.RGBA) Instance {
	self.AsLight2D().SetShadowColor(value)
	return self
}
func (o *Extension[T]) SetShadowColor(value Color.RGBA) *Extension[T] {
	o.Super().AsLight2D().SetShadowColor(value)
	return o
}

// ShadowFilter is promoted from [Light2D.Instance.ShadowFilter].
func (self Instance) ShadowFilter() Light2D.ShadowFilter { return self.AsLight2D().ShadowFilter() }
func (o *Extension[T]) ShadowFilter() Light2D.ShadowFilter { return o.Super().AsLight2D().ShadowFilter() }

// SetShadowFilter is promoted from [Light2D.Instance.SetShadowFilter].
func (self Instance) SetShadowFilter(value Light2D.ShadowFilter) Instance {
	self.AsLight2D().SetShadowFilter(value)
	return self
}
func (o *Extension[T]) SetShadowFilter(value Light2D.ShadowFilter) *Extension[T] {
	o.Super().AsLight2D().SetShadowFilter(value)
	return o
}

// ShadowFilterSmooth is promoted from [Light2D.Instance.ShadowFilterSmooth].
func (self Instance) ShadowFilterSmooth() Float.X { return self.AsLight2D().ShadowFilterSmooth() }
func (o *Extension[T]) ShadowFilterSmooth() Float.X { return o.Super().AsLight2D().ShadowFilterSmooth() }

// SetShadowFilterSmooth is promoted from [Light2D.Instance.SetShadowFilterSmooth].
func (self Instance) SetShadowFilterSmooth(value Float.X) Instance {
	self.AsLight2D().SetShadowFilterSmooth(value)
	return self
}
func (o *Extension[T]) SetShadowFilterSmooth(value Float.X) *Extension[T] {
	o.Super().AsLight2D().SetShadowFilterSmooth(value)
	return o
}

// ShadowItemCullMask is promoted from [Light2D.Instance.ShadowItemCullMask].
func (self Instance) ShadowItemCullMask() int { return self.AsLight2D().ShadowItemCullMask() }
func (o *Extension[T]) ShadowItemCullMask() int { return o.Super().AsLight2D().ShadowItemCullMask() }

// SetShadowItemCullMask is promoted from [Light2D.Instance.SetShadowItemCullMask].
func (self Instance) SetShadowItemCullMask(value int) Instance {
	self.AsLight2D().SetShadowItemCullMask(value)
	return self
}
func (o *Extension[T]) SetShadowItemCullMask(value int) *Extension[T] {
	o.Super().AsLight2D().SetShadowItemCullMask(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(Light2D.Advanced(self.AsLight2D()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(Light2D.Instance(self.AsLight2D()), name)
	}
}
func init() {gdclass.Register("DirectionalLight2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewDirectionalLight2D(ptr)} })}
