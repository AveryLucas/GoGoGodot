...
import "github.com/AveryLucas/gogogd/classdb/GraphElement"
...
func (o *Extension[T]) IgnoreInvalidConnectionType() bool { return o.Super().IgnoreInvalidConnectionType() }
...
func (o *Extension[T]) SetIgnoreInvalidConnectionType(value bool) *Extension[T] {
	o.Super().SetIgnoreInvalidConnectionType(value)
	return o
}
...
func (o *Extension[T]) SlotsFocusMode() Control.FocusMode { return o.Super().SlotsFocusMode() }
...
func (o *Extension[T]) SetSlotsFocusMode(value Control.FocusMode) *Extension[T] {
	o.Super().SetSlotsFocusMode(value)
	return o
}
...
func (o *Extension[T]) OnSlotUpdated(cb func(slot_index int), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("slot_updated"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnSlotSizesChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("slot_sizes_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) OnRaiseRequest(cb func(), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("raise_request"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) OnDeleteRequest(cb func(), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("delete_request"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) OnResizeRequest(cb func(new_size Vector2.XY), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("resize_request"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) OnResizeEnd(cb func(new_size Vector2.XY), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("resize_end"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) OnDragged(cb func(from Vector2.XY, to Vector2.XY), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("dragged"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) OnPositionOffsetChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("position_offset_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) GetInputPortPosition(port_idx int) Vector2.XY {
	return o.Super().GetInputPortPosition(port_idx)
}
func (o *Extension[T]) GetInputPortType(port_idx int) int {
	return o.Super().GetInputPortType(port_idx)
}
func (o *Extension[T]) GetInputPortColor(port_idx int) Color.RGBA {
	return o.Super().GetInputPortColor(port_idx)
}
func (o *Extension[T]) GetInputPortSlot(port_idx int) int {
	return o.Super().GetInputPortSlot(port_idx)
}
...
func (o *Extension[T]) GetOutputPortPosition(port_idx int) Vector2.XY {
	return o.Super().GetOutputPortPosition(port_idx)
}
func (o *Extension[T]) GetOutputPortType(port_idx int) int {
	return o.Super().GetOutputPortType(port_idx)
}
func (o *Extension[T]) GetOutputPortColor(port_idx int) Color.RGBA {
	return o.Super().GetOutputPortColor(port_idx)
}
func (o *Extension[T]) GetOutputPortSlot(port_idx int) int {
	return o.Super().GetOutputPortSlot(port_idx)
}
...
func (self Instance) PositionOffset() Vector2.XY { return self.AsGraphElement().PositionOffset() }
func (o *Extension[T]) PositionOffset() Vector2.XY { return o.Super().AsGraphElement().PositionOffset() }
...
func (self Instance) SetPositionOffset(value Vector2.XY) Instance {
	self.AsGraphElement().SetPositionOffset(value)
	return self
}
func (o *Extension[T]) SetPositionOffset(value Vector2.XY) *Extension[T] {
	o.Super().AsGraphElement().SetPositionOffset(value)
	return o
}

// Resizable is promoted from [GraphElement.Instance.Resizable].
func (self Instance) Resizable() bool { return self.AsGraphElement().Resizable() }
func (o *Extension[T]) Resizable() bool { return o.Super().AsGraphElement().Resizable() }

// SetResizable is promoted from [GraphElement.Instance.SetResizable].
func (self Instance) SetResizable(value bool) Instance {
	self.AsGraphElement().SetResizable(value)
	return self
}
func (o *Extension[T]) SetResizable(value bool) *Extension[T] {
	o.Super().AsGraphElement().SetResizable(value)
	return o
}

// Draggable is promoted from [GraphElement.Instance.Draggable].
func (self Instance) Draggable() bool { return self.AsGraphElement().Draggable() }
func (o *Extension[T]) Draggable() bool { return o.Super().AsGraphElement().Draggable() }

// SetDraggable is promoted from [GraphElement.Instance.SetDraggable].
func (self Instance) SetDraggable(value bool) Instance {
	self.AsGraphElement().SetDraggable(value)
	return self
}
func (o *Extension[T]) SetDraggable(value bool) *Extension[T] {
	o.Super().AsGraphElement().SetDraggable(value)
	return o
}

// Selectable is promoted from [GraphElement.Instance.Selectable].
func (self Instance) Selectable() bool { return self.AsGraphElement().Selectable() }
func (o *Extension[T]) Selectable() bool { return o.Super().AsGraphElement().Selectable() }

// SetSelectable is promoted from [GraphElement.Instance.SetSelectable].
func (self Instance) SetSelectable(value bool) Instance {
	self.AsGraphElement().SetSelectable(value)
	return self
}
func (o *Extension[T]) SetSelectable(value bool) *Extension[T] {
	o.Super().AsGraphElement().SetSelectable(value)
	return o
}

// Selected is promoted from [GraphElement.Instance.Selected].
func (self Instance) Selected() bool { return self.AsGraphElement().Selected() }
func (o *Extension[T]) Selected() bool { return o.Super().AsGraphElement().Selected() }

// SetSelected is promoted from [GraphElement.Instance.SetSelected].
func (self Instance) SetSelected(value bool) Instance {
	self.AsGraphElement().SetSelected(value)
	return self
}
func (o *Extension[T]) SetSelected(value bool) *Extension[T] {
	o.Super().AsGraphElement().SetSelected(value)
	return o
}

// ScalingMenus is promoted from [GraphElement.Instance.ScalingMenus].
func (self Instance) ScalingMenus() bool { return self.AsGraphElement().ScalingMenus() }
func (o *Extension[T]) ScalingMenus() bool { return o.Super().AsGraphElement().ScalingMenus() }
...
func (self Instance) SetScalingMenus(value bool) Instance {
	self.AsGraphElement().SetScalingMenus(value)
	return self
}
func (o *Extension[T]) SetScalingMenus(value bool) *Extension[T] {
	o.Super().AsGraphElement().SetScalingMenus(value)
	return o
}
