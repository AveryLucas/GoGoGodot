...
func (o *Extension[T]) DefaultValue() Vector2.XY { return o.Super().DefaultValue() }
...
func (o *Extension[T]) SetDefaultValue(value Vector2.XY) *Extension[T] {
...
func (self class) GetDefaultValue() Vector2.XY { //gd:VisualShaderNodeVec2Parameter.get_default_value
	var r_ret = noescape.Call[Vector2.XY]( gd.ObjectChecked(self.AsObject()), methods.get_default_value, gdextension.SizeVector2, &struct{}{})
	var ret = r_ret
	return ret
}
...
func init() {gdclass.Register("VisualShaderNodeVec2Parameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeVec2Parameter(ptr)} })}
