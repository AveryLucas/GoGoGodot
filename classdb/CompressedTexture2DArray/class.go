...
import "github.com/AveryLucas/gogogd/classdb/CompressedTextureLayered"
...
func (o class) AsCompressedTextureLayered() CompressedTextureLayered.Advanced { return *(*CompressedTextureLayered.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsCompressedTextureLayered() CompressedTextureLayered.Instance { return o.Super().AsCompressedTextureLayered() }
func (o Instance) AsCompressedTextureLayered() CompressedTextureLayered.Instance { return *(*CompressedTextureLayered.Instance)(ie.As(&o)) }
...
// LoadPath is promoted from [CompressedTextureLayered.Instance.LoadPath].
func (self Instance) LoadPath() string { return self.AsCompressedTextureLayered().LoadPath() }
func (o *Extension[T]) LoadPath() string { return o.Super().AsCompressedTextureLayered().LoadPath() }

// SetLoadPath is promoted from [CompressedTextureLayered.Instance.SetLoadPath].
func (self Instance) SetLoadPath(value string) Instance {
	self.AsCompressedTextureLayered().SetLoadPath(value)
	return self
}
func (o *Extension[T]) SetLoadPath(value string) *Extension[T] {
	o.Super().AsCompressedTextureLayered().SetLoadPath(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(CompressedTextureLayered.Advanced(self.AsCompressedTextureLayered()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(CompressedTextureLayered.Instance(self.AsCompressedTextureLayered()), name)
	}
}
func init() {gdclass.Register("CompressedTexture2DArray", func(ptr gdreference.Object) any { return Instance{gdclass.NewCompressedTexture2DArray(ptr)} })}
