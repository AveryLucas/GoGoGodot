...
func init() {gdclass.Register("RDPipelineSpecializationConstant", func(ptr gdreference.Object) any { return Instance{gdclass.NewRDPipelineSpecializationConstant(ptr)} })}
