...
import "github.com/AveryLucas/gogogd/classdb/InputEventGesture"
...
func (o class) AsInputEventGesture() InputEventGesture.Advanced { return *(*InputEventGesture.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsInputEventGesture() InputEventGesture.Instance { return o.Super().AsInputEventGesture() }
func (o Instance) AsInputEventGesture() InputEventGesture.Instance { return *(*InputEventGesture.Instance)(ie.As(&o)) }
...
// Position is promoted from [InputEventGesture.Instance.Position].
func (self Instance) Position() Vector2.XY { return self.AsInputEventGesture().Position() }
func (o *Extension[T]) Position() Vector2.XY { return o.Super().AsInputEventGesture().Position() }

// SetPosition is promoted from [InputEventGesture.Instance.SetPosition].
func (self Instance) SetPosition(value Vector2.XY) Instance {
	self.AsInputEventGesture().SetPosition(value)
	return self
}
func (o *Extension[T]) SetPosition(value Vector2.XY) *Extension[T] {
	o.Super().AsInputEventGesture().SetPosition(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(InputEventGesture.Advanced(self.AsInputEventGesture()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(InputEventGesture.Instance(self.AsInputEventGesture()), name)
	}
}
func init() {gdclass.Register("InputEventMagnifyGesture", func(ptr gdreference.Object) any { return Instance{gdclass.NewInputEventMagnifyGesture(ptr)} })}
