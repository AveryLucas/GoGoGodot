...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	case "_get_build_dependencies": return reflect.ValueOf(self._get_build_dependencies);
...
func init() {gdclass.Register("ResourceImporter", func(ptr gdreference.Object) any { return Instance{gdclass.NewResourceImporter(ptr)} })}
