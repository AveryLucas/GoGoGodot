...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(BoxContainer.Advanced(self.AsBoxContainer()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(BoxContainer.Instance(self.AsBoxContainer()), name)
	}
}
func init() {gdclass.Register("VBoxContainer", func(ptr gdreference.Object) any { return Instance{gdclass.NewVBoxContainer(ptr)} })}
