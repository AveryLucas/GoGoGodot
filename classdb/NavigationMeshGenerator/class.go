...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.bake, 0|(gdextension.SizeObject<<4)|(gdextension.SizeObject<<8), &struct{navigation_mesh gdextension.Object; root_node gdextension.Object}{	gdextension.Object(gdreference.GetObject(gdclass.GetNavigationMesh(navigation_mesh[0])[0])), 	gdextension.Object(gdreference.GetObject(gdclass.GetNode(root_node[0])[0]))})
}
...
func init() {gdclass.Register("NavigationMeshGenerator", func(ptr gdreference.Object) any { return Instance{gdclass.NewNavigationMeshGenerator(ptr)} })}
