...
func (o *Extension[T]) IsLibraryOpen() bool {
	return o.Super().IsLibraryOpen()
}
func (o *Extension[T]) GetMinimumLibraryInitializationLevel() InitializationLevel {
	return o.Super().GetMinimumLibraryInitializationLevel()
}
...
func init() {gdclass.Register("GDExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewGDExtension(ptr)} })}
