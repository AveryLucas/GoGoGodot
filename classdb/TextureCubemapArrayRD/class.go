...
import "github.com/AveryLucas/gogogd/classdb/TextureLayeredRD"
...
func (o class) AsTextureLayeredRD() TextureLayeredRD.Advanced { return *(*TextureLayeredRD.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsTextureLayeredRD() TextureLayeredRD.Instance { return o.Super().AsTextureLayeredRD() }
func (o Instance) AsTextureLayeredRD() TextureLayeredRD.Instance { return *(*TextureLayeredRD.Instance)(ie.As(&o)) }
...
// TextureRdRid is promoted from [TextureLayeredRD.Instance.TextureRdRid].
func (self Instance) TextureRdRid() RID.Texture { return self.AsTextureLayeredRD().TextureRdRid() }
func (o *Extension[T]) TextureRdRid() RID.Texture { return o.Super().AsTextureLayeredRD().TextureRdRid() }

// SetTextureRdRid is promoted from [TextureLayeredRD.Instance.SetTextureRdRid].
func (self Instance) SetTextureRdRid(value RID.Texture) Instance {
	self.AsTextureLayeredRD().SetTextureRdRid(value)
	return self
}
func (o *Extension[T]) SetTextureRdRid(value RID.Texture) *Extension[T] {
	o.Super().AsTextureLayeredRD().SetTextureRdRid(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(TextureLayeredRD.Advanced(self.AsTextureLayeredRD()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(TextureLayeredRD.Instance(self.AsTextureLayeredRD()), name)
	}
}
func init() {gdclass.Register("TextureCubemapArrayRD", func(ptr gdreference.Object) any { return Instance{gdclass.NewTextureCubemapArrayRD(ptr)} })}
