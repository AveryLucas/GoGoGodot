...
func (o *Extension[T]) ViewportPath() string { return o.Super().ViewportPath() }
...
func (o *Extension[T]) SetViewportPath(value string) *Extension[T] {
	o.Super().SetViewportPath(value)
	return o
}
...
func init() {gdclass.Register("ViewportTexture", func(ptr gdreference.Object) any { return Instance{gdclass.NewViewportTexture(ptr)} })}
