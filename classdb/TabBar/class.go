...
func (o *Extension[T]) CurrentTab() int { return o.Super().CurrentTab() }
...
func (o *Extension[T]) SetCurrentTab(value int) *Extension[T] {
	o.Super().SetCurrentTab(value)
	return o
}
...
func (o *Extension[T]) TabAlignment() AlignmentMode { return o.Super().TabAlignment() }
...
func (o *Extension[T]) SetTabAlignment(value AlignmentMode) *Extension[T] {
	o.Super().SetTabAlignment(value)
	return o
}
...
func (o *Extension[T]) ClipTabs() bool { return o.Super().ClipTabs() }
...
func (o *Extension[T]) SetClipTabs(value bool) *Extension[T] {
	o.Super().SetClipTabs(value)
	return o
}
...
func (o *Extension[T]) CloseWithMiddleMouse() bool { return o.Super().CloseWithMiddleMouse() }
...
func (o *Extension[T]) SetCloseWithMiddleMouse(value bool) *Extension[T] {
	o.Super().SetCloseWithMiddleMouse(value)
	return o
}
...
func (o *Extension[T]) TabCloseDisplayPolicy() CloseButtonDisplayPolicy { return o.Super().TabCloseDisplayPolicy() }
...
func (o *Extension[T]) SetTabCloseDisplayPolicy(value CloseButtonDisplayPolicy) *Extension[T] {
	o.Super().SetTabCloseDisplayPolicy(value)
	return o
}
...
func (o *Extension[T]) MaxTabWidth() int { return o.Super().MaxTabWidth() }
...
func (o *Extension[T]) SetMaxTabWidth(value int) *Extension[T] {
	o.Super().SetMaxTabWidth(value)
	return o
}
...
func (o *Extension[T]) ScrollingEnabled() bool { return o.Super().ScrollingEnabled() }
...
func (o *Extension[T]) SetScrollingEnabled(value bool) *Extension[T] {
	o.Super().SetScrollingEnabled(value)
	return o
}
...
func (o *Extension[T]) DragToRearrangeEnabled() bool { return o.Super().DragToRearrangeEnabled() }
...
func (o *Extension[T]) SetDragToRearrangeEnabled(value bool) *Extension[T] {
	o.Super().SetDragToRearrangeEnabled(value)
	return o
}
...
func (o *Extension[T]) SwitchOnDragHover() bool { return o.Super().SwitchOnDragHover() }
...
func (o *Extension[T]) SetSwitchOnDragHover(value bool) *Extension[T] {
	o.Super().SetSwitchOnDragHover(value)
	return o
}
...
func (o *Extension[T]) TabsRearrangeGroup() int { return o.Super().TabsRearrangeGroup() }
...
func (o *Extension[T]) SetTabsRearrangeGroup(value int) *Extension[T] {
	o.Super().SetTabsRearrangeGroup(value)
	return o
}
...
func (o *Extension[T]) ScrollToSelected() bool { return o.Super().ScrollToSelected() }
...
func (o *Extension[T]) SetScrollToSelected(value bool) *Extension[T] {
	o.Super().SetScrollToSelected(value)
	return o
}
...
func (o *Extension[T]) SelectWithRmb() bool { return o.Super().SelectWithRmb() }
...
func (o *Extension[T]) SetSelectWithRmb(value bool) *Extension[T] {
	o.Super().SetSelectWithRmb(value)
	return o
}
...
func (o *Extension[T]) DeselectEnabled() bool { return o.Super().DeselectEnabled() }
...
func (o *Extension[T]) SetDeselectEnabled(value bool) *Extension[T] {
	o.Super().SetDeselectEnabled(value)
	return o
}
...
func (o *Extension[T]) TabCount() int { return o.Super().TabCount() }
...
func (o *Extension[T]) SetTabCount(value int) *Extension[T] {
	o.Super().SetTabCount(value)
	return o
}
...
func (o *Extension[T]) OnTabSelected(cb func(tab int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("tab_selected"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnTabChanged(cb func(tab int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("tab_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnTabClicked(cb func(tab int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("tab_clicked"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnTabRmbClicked(cb func(tab int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("tab_rmb_clicked"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnTabClosePressed(cb func(tab int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("tab_close_pressed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnTabButtonPressed(cb func(tab int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("tab_button_pressed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnTabHovered(cb func(tab int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("tab_hovered"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnActiveTabRearranged(cb func(idx_to int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("active_tab_rearranged"), gd.NewCallable(cb), int64(flags_together))
	return o
}
