...
import "github.com/AveryLucas/gogogd/classdb/CharFXTransform"
...
func init() {gdclass.Register("RichTextEffect", func(ptr gdreference.Object) any { return Instance{gdclass.NewRichTextEffect(ptr)} })}
