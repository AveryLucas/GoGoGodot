...
import "github.com/AveryLucas/gogogd/classdb/ChainIK3D"
import "github.com/AveryLucas/gogogd/classdb/IKModifier3D"
import "github.com/AveryLucas/gogogd/classdb/JointLimitation3D"
...
func (o *Extension[T]) MaxIterations() int { return o.Super().MaxIterations() }
...
func (o *Extension[T]) SetMaxIterations(value int) *Extension[T] {
	o.Super().SetMaxIterations(value)
	return o
}
...
func (o *Extension[T]) MinDistance() Float.X { return o.Super().MinDistance() }
...
func (o *Extension[T]) SetMinDistance(value Float.X) *Extension[T] {
	o.Super().SetMinDistance(value)
	return o
}
...
func (o *Extension[T]) AngularDeltaLimit() Float.X { return o.Super().AngularDeltaLimit() }
...
func (o *Extension[T]) SetAngularDeltaLimit(value Float.X) *Extension[T] {
	o.Super().SetAngularDeltaLimit(value)
	return o
}
