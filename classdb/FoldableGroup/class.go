...
import "github.com/AveryLucas/gogogd/classdb/FoldableContainer"
...
func (o *Extension[T]) AllowFoldingAll() bool { return o.Super().AllowFoldingAll() }
...
func (o *Extension[T]) SetAllowFoldingAll(value bool) *Extension[T] {
	o.Super().SetAllowFoldingAll(value)
	return o
}
...
func (o *Extension[T]) OnExpanded(cb func(container FoldableContainer.Instance), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("expanded"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) GetExpandedContainer() FoldableContainer.Instance {
	return o.Super().GetExpandedContainer()
}
func (o *Extension[T]) GetContainers() []FoldableContainer.Instance {
	return o.Super().GetContainers()
}
...
func init() {gdclass.Register("FoldableGroup", func(ptr gdreference.Object) any { return Instance{gdclass.NewFoldableGroup(ptr)} })}
