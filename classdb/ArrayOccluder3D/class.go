...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_arrays, 0|(gdextension.SizePackedArray<<4)|(gdextension.SizePackedArray<<8), &struct{vertices gdextension.PackedArray[Vector3.XYZ]; indices gdextension.PackedArray[int32]}{pointers.Get(gd.InternalPacked[gd.PackedVector3Array, Vector3.XYZ](vertices)), pointers.Get(gd.InternalPacked[gd.PackedInt32Array, int32](indices))})
}
...
func (o *Extension[T]) SetArrays(vertices []Vector3.XYZ, indices []int32) *Extension[T] {
	o.Super().SetArrays(vertices, indices)
	return o
}
...
func init() {gdclass.Register("ArrayOccluder3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewArrayOccluder3D(ptr)} })}
