...
func init() {gdclass.Register("OpenXRExtensionWrapperExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRExtensionWrapperExtension(ptr)} })}
