...
func (o *Extension[T]) NavigationMesh() NavigationMesh.Instance { return o.Super().NavigationMesh() }
...
func (o *Extension[T]) SetNavigationMesh(value NavigationMesh.Instance) *Extension[T] {
	o.Super().SetNavigationMesh(value)
	return o
}
...
func (o *Extension[T]) OnNavigationMeshChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("navigation_mesh_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) GetRid() RID.NavigationRegion3D {
...
func (o *Extension[T]) GetRegionRid() RID.NavigationRegion3D {
...
func init() {gdclass.Register("NavigationRegion3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewNavigationRegion3D(ptr)} })}
