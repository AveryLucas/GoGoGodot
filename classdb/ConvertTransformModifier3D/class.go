...
import "github.com/AveryLucas/gogogd/classdb/BoneConstraint3D"
...
func (o *Extension[T]) SetApplyTransformMode(index int, transform_mode TransformMode) *Extension[T] {
	o.Super().SetApplyTransformMode(index, transform_mode)
	return o
}
func (o *Extension[T]) GetApplyTransformMode(index int) TransformMode {
	return o.Super().GetApplyTransformMode(index)
}
func (o *Extension[T]) SetApplyAxis(index int, axis Vector3.Axis) *Extension[T] {
	o.Super().SetApplyAxis(index, axis)
	return o
}
func (o *Extension[T]) GetApplyAxis(index int) Vector3.Axis {
	return o.Super().GetApplyAxis(index)
}
func (o *Extension[T]) SetApplyRangeMin(index int, range_min Float.X) *Extension[T] {
	o.Super().SetApplyRangeMin(index, range_min)
	return o
}
func (o *Extension[T]) GetApplyRangeMin(index int) Float.X {
	return o.Super().GetApplyRangeMin(index)
}
func (o *Extension[T]) SetApplyRangeMax(index int, range_max Float.X) *Extension[T] {
	o.Super().SetApplyRangeMax(index, range_max)
	return o
}
func (o *Extension[T]) GetApplyRangeMax(index int) Float.X {
	return o.Super().GetApplyRangeMax(index)
}
func (o *Extension[T]) SetReferenceTransformMode(index int, transform_mode TransformMode) *Extension[T] {
	o.Super().SetReferenceTransformMode(index, transform_mode)
	return o
}
func (o *Extension[T]) GetReferenceTransformMode(index int) TransformMode {
	return o.Super().GetReferenceTransformMode(index)
}
func (o *Extension[T]) SetReferenceAxis(index int, axis Vector3.Axis) *Extension[T] {
	o.Super().SetReferenceAxis(index, axis)
	return o
}
func (o *Extension[T]) GetReferenceAxis(index int) Vector3.Axis {
	return o.Super().GetReferenceAxis(index)
}
func (o *Extension[T]) SetReferenceRangeMin(index int, range_min Float.X) *Extension[T] {
	o.Super().SetReferenceRangeMin(index, range_min)
	return o
}
func (o *Extension[T]) GetReferenceRangeMin(index int) Float.X {
	return o.Super().GetReferenceRangeMin(index)
}
func (o *Extension[T]) SetReferenceRangeMax(index int, range_max Float.X) *Extension[T] {
	o.Super().SetReferenceRangeMax(index, range_max)
	return o
}
func (o *Extension[T]) GetReferenceRangeMax(index int) Float.X {
	return o.Super().GetReferenceRangeMax(index)
}
...
func (o *Extension[T]) SetAdditive(index int, enabled bool) *Extension[T] {
	o.Super().SetAdditive(index, enabled)
	return o
}
func (o *Extension[T]) IsAdditive(index int) bool {
	return o.Super().IsAdditive(index)
}
