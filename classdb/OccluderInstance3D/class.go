...
func (o *Extension[T]) Occluder() Occluder3D.Instance { return o.Super().Occluder() }
...
func (o *Extension[T]) SetOccluder(value Occluder3D.Instance) *Extension[T] {
	o.Super().SetOccluder(value)
	return o
}
...
func (o *Extension[T]) BakeSimplificationDistance() Float.X { return o.Super().BakeSimplificationDistance() }
...
func (o *Extension[T]) SetBakeSimplificationDistance(value Float.X) *Extension[T] {
	o.Super().SetBakeSimplificationDistance(value)
	return o
}
