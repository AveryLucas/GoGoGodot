...
import "github.com/AveryLucas/gogogd/classdb/VisualShaderNodeSample3D"
...
func (o class) AsVisualShaderNodeSample3D() VisualShaderNodeSample3D.Advanced { return *(*VisualShaderNodeSample3D.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsVisualShaderNodeSample3D() VisualShaderNodeSample3D.Instance { return o.Super().AsVisualShaderNodeSample3D() }
func (o Instance) AsVisualShaderNodeSample3D() VisualShaderNodeSample3D.Instance { return *(*VisualShaderNodeSample3D.Instance)(ie.As(&o)) }
...
func (self Instance) Source() VisualShaderNodeSample3D.Source { return self.AsVisualShaderNodeSample3D().Source() }
func (o *Extension[T]) Source() VisualShaderNodeSample3D.Source { return o.Super().AsVisualShaderNodeSample3D().Source() }
...
func (self Instance) SetSource(value VisualShaderNodeSample3D.Source) Instance {
	self.AsVisualShaderNodeSample3D().SetSource(value)
	return self
}
func (o *Extension[T]) SetSource(value VisualShaderNodeSample3D.Source) *Extension[T] {
	o.Super().AsVisualShaderNodeSample3D().SetSource(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(VisualShaderNodeSample3D.Advanced(self.AsVisualShaderNodeSample3D()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(VisualShaderNodeSample3D.Instance(self.AsVisualShaderNodeSample3D()), name)
	}
}
func init() {gdclass.Register("VisualShaderNodeTexture3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeTexture3D(ptr)} })}
