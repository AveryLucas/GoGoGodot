...
func (o *Extension[T]) Influence() Float.X { return o.Super().Influence() }
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	case "_process_modification_with_delta": return reflect.ValueOf(self._process_modification_with_delta);
	case "_process_modification": return reflect.ValueOf(self._process_modification);
	case "_skeleton_changed": return reflect.ValueOf(self._skeleton_changed);
	case "_validate_bone_names": return reflect.ValueOf(self._validate_bone_names);
...
func init() {gdclass.Register("SkeletonModifier3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewSkeletonModifier3D(ptr)} })}
