...
func (o *Extension[T]) SetAsMix() *Extension[T] {
	o.Super().SetAsMix()
	return o
}
...
func init() {gdclass.Register("RDPipelineColorBlendStateAttachment", func(ptr gdreference.Object) any { return Instance{gdclass.NewRDPipelineColorBlendStateAttachment(ptr)} })}
