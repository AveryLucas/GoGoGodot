...
func (o *Extension[T]) Generate(from Translation.Instance) {
	o.Super().Generate(from)
}

// GetMessageList is promoted from [Translation.Instance.GetMessageList].
func (self Instance) GetMessageList() []string {
	return self.AsTranslation().GetMessageList()
}

// GetMessageList is promoted from [Translation.Instance.GetMessageList].
func (o *Extension[T]) GetMessageList() []string {
	return o.Super().AsTranslation().GetMessageList()
}

// GetTranslatedMessageList is promoted from [Translation.Instance.GetTranslatedMessageList].
func (self Instance) GetTranslatedMessageList() []string {
	return self.AsTranslation().GetTranslatedMessageList()
}

// GetTranslatedMessageList is promoted from [Translation.Instance.GetTranslatedMessageList].
func (o *Extension[T]) GetTranslatedMessageList() []string {
	return o.Super().AsTranslation().GetTranslatedMessageList()
}

// GetMessageCount is promoted from [Translation.Instance.GetMessageCount].
func (self Instance) GetMessageCount() int {
	return self.AsTranslation().GetMessageCount()
}

// GetMessageCount is promoted from [Translation.Instance.GetMessageCount].
func (o *Extension[T]) GetMessageCount() int {
	return o.Super().AsTranslation().GetMessageCount()
}
...
// Locale is promoted from [Translation.Instance.Locale].
func (self Instance) Locale() string { return self.AsTranslation().Locale() }
func (o *Extension[T]) Locale() string { return o.Super().AsTranslation().Locale() }

// SetLocale is promoted from [Translation.Instance.SetLocale].
func (self Instance) SetLocale(value string) Instance {
	self.AsTranslation().SetLocale(value)
	return self
}
func (o *Extension[T]) SetLocale(value string) *Extension[T] {
	o.Super().AsTranslation().SetLocale(value)
	return o
}

// PluralRulesOverride is promoted from [Translation.Instance.PluralRulesOverride].
func (self Instance) PluralRulesOverride() string { return self.AsTranslation().PluralRulesOverride() }
func (o *Extension[T]) PluralRulesOverride() string { return o.Super().AsTranslation().PluralRulesOverride() }

// SetPluralRulesOverride is promoted from [Translation.Instance.SetPluralRulesOverride].
func (self Instance) SetPluralRulesOverride(value string) Instance {
	self.AsTranslation().SetPluralRulesOverride(value)
	return self
}
func (o *Extension[T]) SetPluralRulesOverride(value string) *Extension[T] {
	o.Super().AsTranslation().SetPluralRulesOverride(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(Translation.Advanced(self.AsTranslation()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(Translation.Instance(self.AsTranslation()), name)
	}
}
func init() {gdclass.Register("OptimizedTranslation", func(ptr gdreference.Object) any { return Instance{gdclass.NewOptimizedTranslation(ptr)} })}
