...
func (o *Extension[T]) AffectNavigationMesh() bool { return o.Super().AffectNavigationMesh() }
...
func (o *Extension[T]) SetAffectNavigationMesh(value bool) *Extension[T] {
	o.Super().SetAffectNavigationMesh(value)
	return o
}
...
func (o *Extension[T]) CarveNavigationMesh() bool { return o.Super().CarveNavigationMesh() }
...
func (o *Extension[T]) SetCarveNavigationMesh(value bool) *Extension[T] {
	o.Super().SetCarveNavigationMesh(value)
	return o
}
...
func (o *Extension[T]) GetRid() RID.NavigationObstacle2D {
...
func init() {gdclass.Register("NavigationObstacle2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewNavigationObstacle2D(ptr)} })}
