...
func (o *Extension[T]) Shape() RenderingServer.FogVolumeShape { return o.Super().Shape() }
...
func (o *Extension[T]) SetShape(value RenderingServer.FogVolumeShape) *Extension[T] {
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_shape, 0|(gdextension.SizeInt<<4), &struct{shape RenderingServer.FogVolumeShape}{shape})
}
...
func init() {gdclass.Register("FogVolume", func(ptr gdreference.Object) any { return Instance{gdclass.NewFogVolume(ptr)} })}
