...
func (o *Extension[T]) Alignment() AlignmentMode { return o.Super().Alignment() }
...
func (o *Extension[T]) SetAlignment(value AlignmentMode) *Extension[T] {
...
func (o *Extension[T]) LastWrapAlignment() LastWrapAlignmentMode { return o.Super().LastWrapAlignment() }
...
func (o *Extension[T]) SetLastWrapAlignment(value LastWrapAlignmentMode) *Extension[T] {
	o.Super().SetLastWrapAlignment(value)
	return o
}
...
func (o *Extension[T]) ReverseFill() bool { return o.Super().ReverseFill() }
...
func init() {gdclass.Register("FlowContainer", func(ptr gdreference.Object) any { return Instance{gdclass.NewFlowContainer(ptr)} })}
