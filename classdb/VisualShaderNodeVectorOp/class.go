...
func (o *Extension[T]) Operator() Operator { return o.Super().Operator() }
...
func (o *Extension[T]) SetOperator(value Operator) *Extension[T] {
	o.Super().SetOperator(value)
	return o
}
...
func init() {gdclass.Register("VisualShaderNodeVectorOp", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeVectorOp(ptr)} })}
