...
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.add_id, 0|(gdextension.SizeInt<<4)|(gdextension.SizeString<<8), &struct{id int64; path gdextension.String}{id, pointers.Get(gd.InternalString(path))})
}
func (self class) SetId(id int64, path String.Readable)  { //gd:ResourceUID.set_id
once.Do(singleton)
	noescape.Call[struct{}]( gdreference.GetObject(self.AsObject()[0]), methods.set_id, 0|(gdextension.SizeInt<<4)|(gdextension.SizeString<<8), &struct{id int64; path gdextension.String}{id, pointers.Get(gd.InternalString(path))})
}
...
func init() {gdclass.Register("ResourceUID", func(ptr gdreference.Object) any { return Instance{gdclass.NewResourceUID(ptr)} })}
