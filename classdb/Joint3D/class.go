...
func (o *Extension[T]) SolverPriority() int { return o.Super().SolverPriority() }
...
func (o *Extension[T]) SetSolverPriority(value int) *Extension[T] {
	o.Super().SetSolverPriority(value)
	return o
}
...
func (o *Extension[T]) ExcludeNodesFromCollision() bool { return o.Super().ExcludeNodesFromCollision() }
...
func (o *Extension[T]) SetExcludeNodesFromCollision(value bool) *Extension[T] {
	o.Super().SetExcludeNodesFromCollision(value)
	return o
}
...
func (self class) GetSolverPriority() int64 { //gd:Joint3D.get_solver_priority
	var r_ret = noescape.Call[int64]( gd.ObjectChecked(self.AsObject()), methods.get_solver_priority, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func init() {gdclass.Register("Joint3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewJoint3D(ptr)} })}
