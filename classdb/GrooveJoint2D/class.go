...
func (o *Extension[T]) InitialOffset() Float.X { return o.Super().InitialOffset() }
...
func (o *Extension[T]) SetInitialOffset(value Float.X) *Extension[T] {
	o.Super().SetInitialOffset(value)
	return o
}
...
func init() {gdclass.Register("GrooveJoint2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewGrooveJoint2D(ptr)} })}
