...
import "github.com/AveryLucas/gogogd/classdb/OpenXRSpatialComponentPlaneAlignmentList"
import "github.com/AveryLucas/gogogd/classdb/OpenXRSpatialEntityTracker"
...
func (o *Extension[T]) OnMeshChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("mesh_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
