...
func (o *Extension[T]) SetInstanceTransform(instance int, transform Transform3D.BasisOrigin) *Extension[T] {
	o.Super().SetInstanceTransform(instance, transform)
	return o
}
func (o *Extension[T]) SetInstanceTransform2d(instance int, transform Transform2D.OriginXY) *Extension[T] {
	o.Super().SetInstanceTransform2d(instance, transform)
	return o
}
func (o *Extension[T]) GetInstanceTransform(instance int) Transform3D.BasisOrigin {
	return o.Super().GetInstanceTransform(instance)
}
func (o *Extension[T]) GetInstanceTransform2d(instance int) Transform2D.OriginXY {
	return o.Super().GetInstanceTransform2d(instance)
}
func (o *Extension[T]) SetInstanceColor(instance int, color Color.RGBA) *Extension[T] {
	o.Super().SetInstanceColor(instance, color)
	return o
}
func (o *Extension[T]) GetInstanceColor(instance int) Color.RGBA {
	return o.Super().GetInstanceColor(instance)
}
func (o *Extension[T]) SetInstanceCustomData(instance int, custom_data Color.RGBA) *Extension[T] {
	o.Super().SetInstanceCustomData(instance, custom_data)
	return o
}
func (o *Extension[T]) GetInstanceCustomData(instance int) Color.RGBA {
	return o.Super().GetInstanceCustomData(instance)
}
func (o *Extension[T]) ResetInstancePhysicsInterpolation(instance int) {
	o.Super().ResetInstancePhysicsInterpolation(instance)
}
func (o *Extension[T]) ResetInstancesPhysicsInterpolation() {
	o.Super().ResetInstancesPhysicsInterpolation()
}
func (o *Extension[T]) GetAabb() AABB.PositionSize {
	return o.Super().GetAabb()
}
func (o *Extension[T]) SetBufferInterpolated(buffer_curr []float32, buffer_prev []float32) *Extension[T] {
	o.Super().SetBufferInterpolated(buffer_curr, buffer_prev)
	return o
}
