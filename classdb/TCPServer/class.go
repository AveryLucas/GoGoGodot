...
import "github.com/AveryLucas/gogogd/classdb/SocketServer"
import "github.com/AveryLucas/gogogd/classdb/StreamPeerSocket"
import "github.com/AveryLucas/gogogd/classdb/StreamPeerTCP"
...
func (o *Extension[T]) TakeConnection() StreamPeerTCP.Instance {
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(SocketServer.Advanced(self.AsSocketServer()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(SocketServer.Instance(self.AsSocketServer()), name)
	}
}
func init() {gdclass.Register("TCPServer", func(ptr gdreference.Object) any { return Instance{gdclass.NewTCPServer(ptr)} })}
