...
func (o *Extension[T]) EndPosition() Vector3.XYZ { return o.Super().EndPosition() }
...
func (o *Extension[T]) SetEndPosition(value Vector3.XYZ) *Extension[T] {
...
func (o *Extension[T]) GetRid() RID.NavigationLink3D {
...
func (o *Extension[T]) SetGlobalStartPosition(position Vector3.XYZ) *Extension[T] {
	o.Super().SetGlobalStartPosition(position)
	return o
}
func (o *Extension[T]) GetGlobalStartPosition() Vector3.XYZ {
	return o.Super().GetGlobalStartPosition()
}
func (o *Extension[T]) SetGlobalEndPosition(position Vector3.XYZ) *Extension[T] {
	o.Super().SetGlobalEndPosition(position)
	return o
}
func (o *Extension[T]) GetGlobalEndPosition() Vector3.XYZ {
...
func init() {gdclass.Register("NavigationLink3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewNavigationLink3D(ptr)} })}
