...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.config, 0|(gdextension.SizeString<<4)|(gdextension.SizeString<<8)|(gdextension.SizeBool<<12)|(gdextension.SizeBool<<16), &struct{inherits gdextension.String; path gdextension.String; built_in_enabled bool; load_enabled bool}{pointers.Get(gd.InternalString(inherits)), pointers.Get(gd.InternalString(path)), built_in_enabled, load_enabled})
}
...
func (o *Extension[T]) OnScriptCreated(cb func(script Script.Instance), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("script_created"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func init() {gdclass.Register("ScriptCreateDialog", func(ptr gdreference.Object) any { return Instance{gdclass.NewScriptCreateDialog(ptr)} })}
