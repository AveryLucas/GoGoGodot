...
func (o *Extension[T]) Action() OpenXRAction.Instance { return o.Super().Action() }
...
func (o *Extension[T]) SetAction(value OpenXRAction.Instance) *Extension[T] {
...
func (o *Extension[T]) BindingPath() string { return o.Super().BindingPath() }
...
func (o *Extension[T]) SetBindingPath(value string) *Extension[T] {
	o.Super().SetBindingPath(value)
	return o
}
...
func (o *Extension[T]) BindingModifiers() []OpenXRActionBindingModifier.Instance { return o.Super().BindingModifiers() }
...
func (o *Extension[T]) SetBindingModifiers(value []OpenXRActionBindingModifier.Instance) *Extension[T] {
	o.Super().SetBindingModifiers(value)
	return o
}
...
func (o *Extension[T]) Paths() []string { return o.Super().Paths() }
...
func (o *Extension[T]) SetPaths(value []string) *Extension[T] {
	o.Super().SetPaths(value)
	return o
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_paths, 0|(gdextension.SizePackedArray<<4), &struct{paths gdextension.PackedArray[gdextension.String]}{pointers.Get(gd.InternalPackedStrings(paths))})
}
...
func (o *Extension[T]) GetBindingModifierCount() int {
	return o.Super().GetBindingModifierCount()
}
func (o *Extension[T]) GetBindingModifier(index int) OpenXRActionBindingModifier.Instance {
	return o.Super().GetBindingModifier(index)
}
func (o *Extension[T]) GetPathCount() int {
	return o.Super().GetPathCount()
}
func (o *Extension[T]) HasPath(path string) bool {
	return o.Super().HasPath(path)
}
func (o *Extension[T]) AddPath(path string) {
	o.Super().AddPath(path)
}
func (o *Extension[T]) RemovePath(path string) {
	o.Super().RemovePath(path)
}
...
func init() {gdclass.Register("OpenXRIPBinding", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRIPBinding(ptr)} })}
