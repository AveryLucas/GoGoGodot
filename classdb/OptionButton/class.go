...
import "github.com/AveryLucas/gogogd/classdb/BaseButton"
...
func (o *Extension[T]) Selected() int { return o.Super().Selected() }

func (self Instance) FitToLongestItem() bool { //gd:OptionButton.fit_to_longest_item
		return bool(class(self).IsFitToLongestItem())
}

func (o *Extension[T]) FitToLongestItem() bool { return o.Super().FitToLongestItem() }
...
func (o *Extension[T]) SetFitToLongestItem(value bool) *Extension[T] {
	o.Super().SetFitToLongestItem(value)
	return o
}
...
func (o *Extension[T]) OnItemFocused(cb func(index int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("item_focused"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) OnPressed(cb func(), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("pressed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) OnButtonUp(cb func(), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("button_up"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) OnButtonDown(cb func(), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("button_down"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) OnToggled(cb func(toggled_on bool), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("toggled"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) SetItemIcon(idx int, texture Texture2D.Instance) *Extension[T] {
	o.Super().SetItemIcon(idx, texture)
	return o
}
...
func (o *Extension[T]) SetItemId(idx int, id int) *Extension[T] {
	o.Super().SetItemId(idx, id)
	return o
}
...
func (o *Extension[T]) GetItemId(idx int) int {
	return o.Super().GetItemId(idx)
}
...
func (o *Extension[T]) IsItemSeparator(idx int) bool {
	return o.Super().IsItemSeparator(idx)
}
func (o *Extension[T]) Clear() {
	o.Super().Clear()
}
func (o *Extension[T]) Select(idx int) {
	o.Super().Select(idx)
}
func (o *Extension[T]) GetSelectedId() int {
	return o.Super().GetSelectedId()
}
func (o *Extension[T]) GetSelectedMetadata() any {
	return o.Super().GetSelectedMetadata()
}
func (o *Extension[T]) RemoveItem(idx int) {
	o.Super().RemoveItem(idx)
}
func (o *Extension[T]) GetPopup() PopupMenu.Instance {
	return o.Super().GetPopup()
}
func (o *Extension[T]) ShowPopup() {
	o.Super().ShowPopup()
}
func (o *Extension[T]) HasSelectableItems() bool {
	return o.Super().HasSelectableItems()
}
func (o *Extension[T]) SetDisableShortcuts(disabled bool) *Extension[T] {
	o.Super().SetDisableShortcuts(disabled)
	return o
}
...
func (self Instance) Text() string { return self.AsButton().Text() }
func (o *Extension[T]) Text() string { return o.Super().AsButton().Text() }

// SetText is promoted from [Button.Instance.SetText].
func (self Instance) SetText(value string) Instance {
	self.AsButton().SetText(value)
	return self
}
func (o *Extension[T]) SetText(value string) *Extension[T] {
	o.Super().AsButton().SetText(value)
	return o
}

// Icon is promoted from [Button.Instance.Icon].
func (self Instance) Icon() Texture2D.Instance { return self.AsButton().Icon() }
func (o *Extension[T]) Icon() Texture2D.Instance { return o.Super().AsButton().Icon() }

// SetIcon is promoted from [Button.Instance.SetIcon].
func (self Instance) SetIcon(value Texture2D.Instance) Instance {
	self.AsButton().SetIcon(value)
	return self
}
func (o *Extension[T]) SetIcon(value Texture2D.Instance) *Extension[T] {
	o.Super().AsButton().SetIcon(value)
	return o
}

// Flat is promoted from [Button.Instance.Flat].
func (self Instance) Flat() bool { return self.AsButton().Flat() }
func (o *Extension[T]) Flat() bool { return o.Super().AsButton().Flat() }

// SetFlat is promoted from [Button.Instance.SetFlat].
func (self Instance) SetFlat(value bool) Instance {
	self.AsButton().SetFlat(value)
	return self
}
func (o *Extension[T]) SetFlat(value bool) *Extension[T] {
	o.Super().AsButton().SetFlat(value)
	return o
}

// Alignment is promoted from [Button.Instance.Alignment].
func (self Instance) Alignment() GUI.HorizontalAlignment { return self.AsButton().Alignment() }
func (o *Extension[T]) Alignment() GUI.HorizontalAlignment { return o.Super().AsButton().Alignment() }
...
func (self Instance) SetAlignment(value GUI.HorizontalAlignment) Instance {
	self.AsButton().SetAlignment(value)
	return self
}
func (o *Extension[T]) SetAlignment(value GUI.HorizontalAlignment) *Extension[T] {
	o.Super().AsButton().SetAlignment(value)
	return o
}

// TextOverrunBehavior is promoted from [Button.Instance.TextOverrunBehavior].
func (self Instance) TextOverrunBehavior() TextServer.OverrunBehavior { return self.AsButton().TextOverrunBehavior() }
func (o *Extension[T]) TextOverrunBehavior() TextServer.OverrunBehavior { return o.Super().AsButton().TextOverrunBehavior() }
...
func (self Instance) SetTextOverrunBehavior(value TextServer.OverrunBehavior) Instance {
	self.AsButton().SetTextOverrunBehavior(value)
	return self
}
func (o *Extension[T]) SetTextOverrunBehavior(value TextServer.OverrunBehavior) *Extension[T] {
	o.Super().AsButton().SetTextOverrunBehavior(value)
	return o
}

// AutowrapMode is promoted from [Button.Instance.AutowrapMode].
func (self Instance) AutowrapMode() TextServer.AutowrapMode { return self.AsButton().AutowrapMode() }
func (o *Extension[T]) AutowrapMode() TextServer.AutowrapMode { return o.Super().AsButton().AutowrapMode() }
...
func (self Instance) SetAutowrapMode(value TextServer.AutowrapMode) Instance {
	self.AsButton().SetAutowrapMode(value)
	return self
}
func (o *Extension[T]) SetAutowrapMode(value TextServer.AutowrapMode) *Extension[T] {
	o.Super().AsButton().SetAutowrapMode(value)
	return o
}

// AutowrapTrimFlags is promoted from [Button.Instance.AutowrapTrimFlags].
func (self Instance) AutowrapTrimFlags() TextServer.LineBreakFlag { return self.AsButton().AutowrapTrimFlags() }
func (o *Extension[T]) AutowrapTrimFlags() TextServer.LineBreakFlag { return o.Super().AsButton().AutowrapTrimFlags() }
...
func (self Instance) SetAutowrapTrimFlags(value TextServer.LineBreakFlag) Instance {
	self.AsButton().SetAutowrapTrimFlags(value)
	return self
}
func (o *Extension[T]) SetAutowrapTrimFlags(value TextServer.LineBreakFlag) *Extension[T] {
	o.Super().AsButton().SetAutowrapTrimFlags(value)
	return o
}

// ClipText is promoted from [Button.Instance.ClipText].
func (self Instance) ClipText() bool { return self.AsButton().ClipText() }
func (o *Extension[T]) ClipText() bool { return o.Super().AsButton().ClipText() }

// SetClipText is promoted from [Button.Instance.SetClipText].
func (self Instance) SetClipText(value bool) Instance {
	self.AsButton().SetClipText(value)
	return self
}
func (o *Extension[T]) SetClipText(value bool) *Extension[T] {
	o.Super().AsButton().SetClipText(value)
	return o
}

// IconAlignment is promoted from [Button.Instance.IconAlignment].
func (self Instance) IconAlignment() GUI.HorizontalAlignment { return self.AsButton().IconAlignment() }
func (o *Extension[T]) IconAlignment() GUI.HorizontalAlignment { return o.Super().AsButton().IconAlignment() }
...
func (self Instance) SetIconAlignment(value GUI.HorizontalAlignment) Instance {
	self.AsButton().SetIconAlignment(value)
	return self
}
func (o *Extension[T]) SetIconAlignment(value GUI.HorizontalAlignment) *Extension[T] {
	o.Super().AsButton().SetIconAlignment(value)
	return o
}

// VerticalIconAlignment is promoted from [Button.Instance.VerticalIconAlignment].
func (self Instance) VerticalIconAlignment() GUI.VerticalAlignment { return self.AsButton().VerticalIconAlignment() }
func (o *Extension[T]) VerticalIconAlignment() GUI.VerticalAlignment { return o.Super().AsButton().VerticalIconAlignment() }
...
func (self Instance) SetVerticalIconAlignment(value GUI.VerticalAlignment) Instance {
	self.AsButton().SetVerticalIconAlignment(value)
	return self
}
func (o *Extension[T]) SetVerticalIconAlignment(value GUI.VerticalAlignment) *Extension[T] {
	o.Super().AsButton().SetVerticalIconAlignment(value)
	return o
}

// ExpandIcon is promoted from [Button.Instance.ExpandIcon].
func (self Instance) ExpandIcon() bool { return self.AsButton().ExpandIcon() }
func (o *Extension[T]) ExpandIcon() bool { return o.Super().AsButton().ExpandIcon() }

// SetExpandIcon is promoted from [Button.Instance.SetExpandIcon].
func (self Instance) SetExpandIcon(value bool) Instance {
	self.AsButton().SetExpandIcon(value)
	return self
}
func (o *Extension[T]) SetExpandIcon(value bool) *Extension[T] {
	o.Super().AsButton().SetExpandIcon(value)
	return o
}

// TextDirection is promoted from [Button.Instance.TextDirection].
func (self Instance) TextDirection() Control.TextDirection { return self.AsButton().TextDirection() }
func (o *Extension[T]) TextDirection() Control.TextDirection { return o.Super().AsButton().TextDirection() }
...
func (self Instance) SetTextDirection(value Control.TextDirection) Instance {
	self.AsButton().SetTextDirection(value)
	return self
}
func (o *Extension[T]) SetTextDirection(value Control.TextDirection) *Extension[T] {
	o.Super().AsButton().SetTextDirection(value)
	return o
}

// Language is promoted from [Button.Instance.Language].
func (self Instance) Language() string { return self.AsButton().Language() }
func (o *Extension[T]) Language() string { return o.Super().AsButton().Language() }

// SetLanguage is promoted from [Button.Instance.SetLanguage].
func (self Instance) SetLanguage(value string) Instance {
	self.AsButton().SetLanguage(value)
	return self
}
func (o *Extension[T]) SetLanguage(value string) *Extension[T] {
	o.Super().AsButton().SetLanguage(value)
	return o
}

// Disabled is promoted from [BaseButton.Instance.Disabled].
func (self Instance) Disabled() bool { return self.AsBaseButton().Disabled() }
func (o *Extension[T]) Disabled() bool { return o.Super().AsBaseButton().Disabled() }

// SetDisabled is promoted from [BaseButton.Instance.SetDisabled].
func (self Instance) SetDisabled(value bool) Instance {
	self.AsBaseButton().SetDisabled(value)
	return self
}
func (o *Extension[T]) SetDisabled(value bool) *Extension[T] {
	o.Super().AsBaseButton().SetDisabled(value)
	return o
}

// ToggleMode is promoted from [BaseButton.Instance.ToggleMode].
func (self Instance) ToggleMode() bool { return self.AsBaseButton().ToggleMode() }
func (o *Extension[T]) ToggleMode() bool { return o.Super().AsBaseButton().ToggleMode() }

// SetToggleMode is promoted from [BaseButton.Instance.SetToggleMode].
func (self Instance) SetToggleMode(value bool) Instance {
	self.AsBaseButton().SetToggleMode(value)
	return self
}
func (o *Extension[T]) SetToggleMode(value bool) *Extension[T] {
	o.Super().AsBaseButton().SetToggleMode(value)
	return o
}

// ButtonPressed is promoted from [BaseButton.Instance.ButtonPressed].
func (self Instance) ButtonPressed() bool { return self.AsBaseButton().ButtonPressed() }
func (o *Extension[T]) ButtonPressed() bool { return o.Super().AsBaseButton().ButtonPressed() }
...
func (self Instance) SetButtonPressed(value bool) Instance {
	self.AsBaseButton().SetButtonPressed(value)
	return self
}
func (o *Extension[T]) SetButtonPressed(value bool) *Extension[T] {
	o.Super().AsBaseButton().SetButtonPressed(value)
	return o
}

// ActionMode is promoted from [BaseButton.Instance.ActionMode].
func (self Instance) ActionMode() BaseButton.ActionMode { return self.AsBaseButton().ActionMode() }
func (o *Extension[T]) ActionMode() BaseButton.ActionMode { return o.Super().AsBaseButton().ActionMode() }
...
func (self Instance) SetActionMode(value BaseButton.ActionMode) Instance {
	self.AsBaseButton().SetActionMode(value)
	return self
}
func (o *Extension[T]) SetActionMode(value BaseButton.ActionMode) *Extension[T] {
	o.Super().AsBaseButton().SetActionMode(value)
	return o
}

// ButtonMask is promoted from [BaseButton.Instance.ButtonMask].
func (self Instance) ButtonMask() Input.MouseButtonMask { return self.AsBaseButton().ButtonMask() }
func (o *Extension[T]) ButtonMask() Input.MouseButtonMask { return o.Super().AsBaseButton().ButtonMask() }
...
func (self Instance) SetButtonMask(value Input.MouseButtonMask) Instance {
	self.AsBaseButton().SetButtonMask(value)
	return self
}
func (o *Extension[T]) SetButtonMask(value Input.MouseButtonMask) *Extension[T] {
	o.Super().AsBaseButton().SetButtonMask(value)
	return o
}

// KeepPressedOutside is promoted from [BaseButton.Instance.KeepPressedOutside].
func (self Instance) KeepPressedOutside() bool { return self.AsBaseButton().KeepPressedOutside() }
func (o *Extension[T]) KeepPressedOutside() bool { return o.Super().AsBaseButton().KeepPressedOutside() }
...
func (self Instance) SetKeepPressedOutside(value bool) Instance {
	self.AsBaseButton().SetKeepPressedOutside(value)
	return self
}
func (o *Extension[T]) SetKeepPressedOutside(value bool) *Extension[T] {
	o.Super().AsBaseButton().SetKeepPressedOutside(value)
	return o
}

// Shortcut is promoted from [BaseButton.Instance.Shortcut].
func (self Instance) Shortcut() Shortcut.Instance { return self.AsBaseButton().Shortcut() }
func (o *Extension[T]) Shortcut() Shortcut.Instance { return o.Super().AsBaseButton().Shortcut() }
...
func (self Instance) SetShortcut(value Shortcut.Instance) Instance {
	self.AsBaseButton().SetShortcut(value)
	return self
}
func (o *Extension[T]) SetShortcut(value Shortcut.Instance) *Extension[T] {
	o.Super().AsBaseButton().SetShortcut(value)
	return o
}

// ShortcutFeedback is promoted from [BaseButton.Instance.ShortcutFeedback].
func (self Instance) ShortcutFeedback() bool { return self.AsBaseButton().ShortcutFeedback() }
func (o *Extension[T]) ShortcutFeedback() bool { return o.Super().AsBaseButton().ShortcutFeedback() }
...
func (self Instance) SetShortcutFeedback(value bool) Instance {
	self.AsBaseButton().SetShortcutFeedback(value)
	return self
}
func (o *Extension[T]) SetShortcutFeedback(value bool) *Extension[T] {
	o.Super().AsBaseButton().SetShortcutFeedback(value)
	return o
}

// ShortcutInTooltip is promoted from [BaseButton.Instance.ShortcutInTooltip].
func (self Instance) ShortcutInTooltip() bool { return self.AsBaseButton().ShortcutInTooltip() }
func (o *Extension[T]) ShortcutInTooltip() bool { return o.Super().AsBaseButton().ShortcutInTooltip() }
...
func (self Instance) SetShortcutInTooltip(value bool) Instance {
	self.AsBaseButton().SetShortcutInTooltip(value)
	return self
}
func (o *Extension[T]) SetShortcutInTooltip(value bool) *Extension[T] {
	o.Super().AsBaseButton().SetShortcutInTooltip(value)
	return o
}
