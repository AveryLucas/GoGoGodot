...
func (o *Extension[T]) Hand() Hands { return o.Super().Hand() }
...
func (o *Extension[T]) SetHand(value Hands) *Extension[T] {
...
func (o *Extension[T]) MotionRange() MotionRange { return o.Super().MotionRange() }
...
func (o *Extension[T]) SetMotionRange(value MotionRange) *Extension[T] {
	o.Super().SetMotionRange(value)
	return o
}
...
func (o *Extension[T]) HandSkeleton() string { return o.Super().HandSkeleton() }
...
func (o *Extension[T]) SetHandSkeleton(value string) *Extension[T] {
	o.Super().SetHandSkeleton(value)
	return o
}
...
func (o *Extension[T]) SkeletonRig() SkeletonRig { return o.Super().SkeletonRig() }
...
func (o *Extension[T]) SetSkeletonRig(value SkeletonRig) *Extension[T] {
	o.Super().SetSkeletonRig(value)
	return o
}
