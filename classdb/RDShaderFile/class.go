...
func (o *Extension[T]) BaseError() string { return o.Super().BaseError() }
...
func (o *Extension[T]) SetBaseError(value string) *Extension[T] {
	o.Super().SetBaseError(value)
	return o
}

func (self class) SetBytecode(bytecode [1]gdclass.RDShaderSPIRV, version String.Name)  { //gd:RDShaderFile.set_bytecode
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_bytecode, 0|(gdextension.SizeObject<<4)|(gdextension.SizeStringName<<8), &struct{bytecode gdextension.Object; version gdextension.StringName}{	gdextension.Object(gdreference.GetObject(gdclass.GetRDShaderSPIRV(bytecode[0])[0])), pointers.Get(gd.InternalStringName(version))})
}
...
func (o *Extension[T]) GetVersionList() []string {
	return o.Super().GetVersionList()
}
...
func init() {gdclass.Register("RDShaderFile", func(ptr gdreference.Object) any { return Instance{gdclass.NewRDShaderFile(ptr)} })}
