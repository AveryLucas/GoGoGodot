...
import "github.com/AveryLucas/gogogd/classdb/EditorDebuggerSession"
...
func (o *Extension[T]) GetSession(id int) EditorDebuggerSession.Instance {
	return o.Super().GetSession(id)
}
func (o *Extension[T]) GetSessions() []EditorDebuggerSession.Instance {
	return o.Super().GetSessions()
}
