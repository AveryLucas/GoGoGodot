...
func init() {gdclass.Register("VisualShaderNodeBooleanParameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeBooleanParameter(ptr)} })}
