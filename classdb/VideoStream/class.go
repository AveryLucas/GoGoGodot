...
import "github.com/AveryLucas/gogogd/classdb/VideoStreamPlayback"
...
func (o *Extension[T]) File() string { return o.Super().File() }
...
func init() {gdclass.Register("VideoStream", func(ptr gdreference.Object) any { return Instance{gdclass.NewVideoStream(ptr)} })}
