...
func (o *Extension[T]) BodyTracker() string { return o.Super().BodyTracker() }
...
func (o *Extension[T]) SetBodyTracker(value string) *Extension[T] {
	o.Super().SetBodyTracker(value)
	return o
}
...
func (o *Extension[T]) BodyUpdate() BodyUpdate { return o.Super().BodyUpdate() }
...
func (o *Extension[T]) SetBodyUpdate(value BodyUpdate) *Extension[T] {
	o.Super().SetBodyUpdate(value)
	return o
}
...
func (o *Extension[T]) BoneUpdate() BoneUpdate { return o.Super().BoneUpdate() }
...
func (o *Extension[T]) SetBoneUpdate(value BoneUpdate) *Extension[T] {
	o.Super().SetBoneUpdate(value)
	return o
}
...
func init() {gdclass.Register("XRBodyModifier3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewXRBodyModifier3D(ptr)} })}
