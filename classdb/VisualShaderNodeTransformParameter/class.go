...
func (o *Extension[T]) DefaultValue() Transform3D.BasisOrigin { return o.Super().DefaultValue() }
...
func (o *Extension[T]) SetDefaultValue(value Transform3D.BasisOrigin) *Extension[T] {
...
func (self class) GetDefaultValue() Transform3D.BasisOrigin { //gd:VisualShaderNodeTransformParameter.get_default_value
	var r_ret = noescape.Call[Transform3D.BasisOrigin]( gd.ObjectChecked(self.AsObject()), methods.get_default_value, gdextension.SizeTransform3D, &struct{}{})
...
func init() {gdclass.Register("VisualShaderNodeTransformParameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeTransformParameter(ptr)} })}
