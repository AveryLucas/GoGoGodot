...
func (o *Extension[T]) Constant() Transform3D.BasisOrigin { return o.Super().Constant() }
...
func (o *Extension[T]) SetConstant(value Transform3D.BasisOrigin) *Extension[T] {
...
func init() {gdclass.Register("VisualShaderNodeTransformConstant", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeTransformConstant(ptr)} })}
