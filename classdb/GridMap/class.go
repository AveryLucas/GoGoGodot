...
import "github.com/AveryLucas/gogogd/classdb/MeshLibrary"
...
func (o *Extension[T]) MeshLibrary() MeshLibrary.Instance { return o.Super().MeshLibrary() }
...
func (o *Extension[T]) PhysicsMaterial() PhysicsMaterial.Instance { return o.Super().PhysicsMaterial() }
...
func (o *Extension[T]) SetPhysicsMaterial(value PhysicsMaterial.Instance) *Extension[T] {
	o.Super().SetPhysicsMaterial(value)
	return o
}
...
func (o *Extension[T]) CellSize() Vector3.XYZ { return o.Super().CellSize() }
...
func (o *Extension[T]) CellOctantSize() int { return o.Super().CellOctantSize() }
...
func (o *Extension[T]) SetCellOctantSize(value int) *Extension[T] {
	o.Super().SetCellOctantSize(value)
	return o
}
...
func (o *Extension[T]) CellCenterX() bool { return o.Super().CellCenterX() }
...
func (o *Extension[T]) CellCenterY() bool { return o.Super().CellCenterY() }
...
func (o *Extension[T]) CellCenterZ() bool { return o.Super().CellCenterZ() }
...
func (o *Extension[T]) CellScale() Float.X { return o.Super().CellScale() }
...
func (o *Extension[T]) BakeNavigation() bool { return o.Super().BakeNavigation() }
...
func (o *Extension[T]) SetBakeNavigation(value bool) *Extension[T] {
	o.Super().SetBakeNavigation(value)
	return o
}
...
func (o *Extension[T]) OnCellSizeChanged(cb func(cell_size Vector3.XYZ), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("cell_size_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
