...
func (o *Extension[T]) Constant() Vector2.XY { return o.Super().Constant() }
...
func (o *Extension[T]) SetConstant(value Vector2.XY) *Extension[T] {
...
func init() {gdclass.Register("VisualShaderNodeVec2Constant", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeVec2Constant(ptr)} })}
