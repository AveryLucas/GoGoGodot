...
import "github.com/AveryLucas/gogogd/classdb/BoxContainer"
...
import "github.com/AveryLucas/gogogd/classdb/EditorResourcePicker"
...
func (o *Extension[T]) ScriptOwner() Node.Instance { return o.Super().ScriptOwner() }
...
func (o *Extension[T]) SetScriptOwner(value Node.Instance) *Extension[T] {
	o.Super().SetScriptOwner(value)
	return o
}
...
func (o class) AsEditorResourcePicker() EditorResourcePicker.Advanced { return *(*EditorResourcePicker.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsEditorResourcePicker() EditorResourcePicker.Instance { return o.Super().AsEditorResourcePicker() }
func (o Instance) AsEditorResourcePicker() EditorResourcePicker.Instance { return *(*EditorResourcePicker.Instance)(ie.As(&o)) }
...
// OnResourceSelected is promoted from [EditorResourcePicker.Instance.OnResourceSelected].
...
// OnResourceSelected is promoted from [EditorResourcePicker.Instance.OnResourceSelected].
func (o *Extension[T]) OnResourceSelected(cb func(resource Resource.Instance, inspect bool), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
// OnResourceChanged is promoted from [EditorResourcePicker.Instance.OnResourceChanged].
...
// OnResourceChanged is promoted from [EditorResourcePicker.Instance.OnResourceChanged].
func (o *Extension[T]) OnResourceChanged(cb func(resource Resource.Instance), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("resource_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
// GetAllowedTypes is promoted from [EditorResourcePicker.Instance.GetAllowedTypes].
func (self Instance) GetAllowedTypes() []string {
	return self.AsEditorResourcePicker().GetAllowedTypes()
}

// GetAllowedTypes is promoted from [EditorResourcePicker.Instance.GetAllowedTypes].
func (o *Extension[T]) GetAllowedTypes() []string {
	return o.Super().AsEditorResourcePicker().GetAllowedTypes()
}

// SetTogglePressed is promoted from [EditorResourcePicker.Instance.SetTogglePressed].
func (self Instance) SetTogglePressed(pressed bool) Instance {
	self.AsEditorResourcePicker().SetTogglePressed(pressed)
	return self
}

// SetTogglePressed is promoted from [EditorResourcePicker.Instance.SetTogglePressed].
func (o *Extension[T]) SetTogglePressed(pressed bool) *Extension[T] {
	o.Super().AsEditorResourcePicker().SetTogglePressed(pressed)
	return o
}

// AddSpacer is promoted from [BoxContainer.Instance.AddSpacer].
func (self Instance) AddSpacer(begin bool) Control.Instance {
	return self.AsBoxContainer().AddSpacer(begin)
}

// AddSpacer is promoted from [BoxContainer.Instance.AddSpacer].
func (o *Extension[T]) AddSpacer(begin bool) Control.Instance {
	return o.Super().AsBoxContainer().AddSpacer(begin)
}
...
// BaseType is promoted from [EditorResourcePicker.Instance.BaseType].
func (self Instance) BaseType() string { return self.AsEditorResourcePicker().BaseType() }
func (o *Extension[T]) BaseType() string { return o.Super().AsEditorResourcePicker().BaseType() }

// SetBaseType is promoted from [EditorResourcePicker.Instance.SetBaseType].
func (self Instance) SetBaseType(value string) Instance {
	self.AsEditorResourcePicker().SetBaseType(value)
	return self
}
func (o *Extension[T]) SetBaseType(value string) *Extension[T] {
	o.Super().AsEditorResourcePicker().SetBaseType(value)
	return o
}

// EditedResource is promoted from [EditorResourcePicker.Instance.EditedResource].
func (self Instance) EditedResource() Resource.Instance { return self.AsEditorResourcePicker().EditedResource() }
func (o *Extension[T]) EditedResource() Resource.Instance { return o.Super().AsEditorResourcePicker().EditedResource() }

// SetEditedResource is promoted from [EditorResourcePicker.Instance.SetEditedResource].
func (self Instance) SetEditedResource(value Resource.Instance) Instance {
	self.AsEditorResourcePicker().SetEditedResource(value)
	return self
}
func (o *Extension[T]) SetEditedResource(value Resource.Instance) *Extension[T] {
	o.Super().AsEditorResourcePicker().SetEditedResource(value)
	return o
}

// Editable is promoted from [EditorResourcePicker.Instance.Editable].
func (self Instance) Editable() bool { return self.AsEditorResourcePicker().Editable() }
func (o *Extension[T]) Editable() bool { return o.Super().AsEditorResourcePicker().Editable() }

// SetEditable is promoted from [EditorResourcePicker.Instance.SetEditable].
func (self Instance) SetEditable(value bool) Instance {
	self.AsEditorResourcePicker().SetEditable(value)
	return self
}
func (o *Extension[T]) SetEditable(value bool) *Extension[T] {
	o.Super().AsEditorResourcePicker().SetEditable(value)
	return o
}

// ToggleMode is promoted from [EditorResourcePicker.Instance.ToggleMode].
func (self Instance) ToggleMode() bool { return self.AsEditorResourcePicker().ToggleMode() }
func (o *Extension[T]) ToggleMode() bool { return o.Super().AsEditorResourcePicker().ToggleMode() }

// SetToggleMode is promoted from [EditorResourcePicker.Instance.SetToggleMode].
func (self Instance) SetToggleMode(value bool) Instance {
	self.AsEditorResourcePicker().SetToggleMode(value)
	return self
}
func (o *Extension[T]) SetToggleMode(value bool) *Extension[T] {
	o.Super().AsEditorResourcePicker().SetToggleMode(value)
	return o
}

// Alignment is promoted from [BoxContainer.Instance.Alignment].
func (self Instance) Alignment() BoxContainer.AlignmentMode { return self.AsBoxContainer().Alignment() }
func (o *Extension[T]) Alignment() BoxContainer.AlignmentMode { return o.Super().AsBoxContainer().Alignment() }

// SetAlignment is promoted from [BoxContainer.Instance.SetAlignment].
func (self Instance) SetAlignment(value BoxContainer.AlignmentMode) Instance {
	self.AsBoxContainer().SetAlignment(value)
	return self
}
func (o *Extension[T]) SetAlignment(value BoxContainer.AlignmentMode) *Extension[T] {
	o.Super().AsBoxContainer().SetAlignment(value)
	return o
}

// Vertical is promoted from [BoxContainer.Instance.Vertical].
func (self Instance) Vertical() bool { return self.AsBoxContainer().Vertical() }
func (o *Extension[T]) Vertical() bool { return o.Super().AsBoxContainer().Vertical() }

// SetVertical is promoted from [BoxContainer.Instance.SetVertical].
func (self Instance) SetVertical(value bool) Instance {
	self.AsBoxContainer().SetVertical(value)
	return self
}
func (o *Extension[T]) SetVertical(value bool) *Extension[T] {
	o.Super().AsBoxContainer().SetVertical(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(EditorResourcePicker.Advanced(self.AsEditorResourcePicker()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(EditorResourcePicker.Instance(self.AsEditorResourcePicker()), name)
	}
}
func init() {gdclass.Register("EditorScriptPicker", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorScriptPicker(ptr)} })}
