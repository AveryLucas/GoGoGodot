...
func init() {gdclass.Register("VisualShaderNodeScreenNormalWorldSpace", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeScreenNormalWorldSpace(ptr)} })}
