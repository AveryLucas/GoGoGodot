...
func (o *Extension[T]) CopyMode() CopyMode { return o.Super().CopyMode() }
...
func (o *Extension[T]) SetCopyMode(value CopyMode) *Extension[T] {
	o.Super().SetCopyMode(value)
	return o
}
...
func init() {gdclass.Register("BackBufferCopy", func(ptr gdreference.Object) any { return Instance{gdclass.NewBackBufferCopy(ptr)} })}
