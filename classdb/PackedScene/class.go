...
func (o *Extension[T]) Pack(path Node.Instance) error {
	return o.Super().Pack(path)
}
...
func init() {gdclass.Register("PackedScene", func(ptr gdreference.Object) any { return Instance{gdclass.NewPackedScene(ptr)} })}
