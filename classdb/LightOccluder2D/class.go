...
func (o *Extension[T]) Occluder() OccluderPolygon2D.Instance { return o.Super().Occluder() }
...
func (o *Extension[T]) SetOccluder(value OccluderPolygon2D.Instance) *Extension[T] {
...
func (o *Extension[T]) SdfCollision() bool { return o.Super().SdfCollision() }
...
func (o *Extension[T]) SetSdfCollision(value bool) *Extension[T] {
	o.Super().SetSdfCollision(value)
	return o
}
...
func (o *Extension[T]) OccluderLightMask() int { return o.Super().OccluderLightMask() }
...
func (o *Extension[T]) SetOccluderLightMask(value int) *Extension[T] {
	o.Super().SetOccluderLightMask(value)
	return o
}
...
func init() {gdclass.Register("LightOccluder2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewLightOccluder2D(ptr)} })}
