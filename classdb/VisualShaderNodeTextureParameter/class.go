...
func (o *Extension[T]) ColorDefault() ColorDefault { return o.Super().ColorDefault() }
...
func (o *Extension[T]) SetColorDefault(value ColorDefault) *Extension[T] {
	o.Super().SetColorDefault(value)
	return o
}
...
func (o *Extension[T]) TextureSource() TextureSource { return o.Super().TextureSource() }
...
func (o *Extension[T]) SetTextureSource(value TextureSource) *Extension[T] {
	o.Super().SetTextureSource(value)
	return o
}
...
func init() {gdclass.Register("VisualShaderNodeTextureParameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeTextureParameter(ptr)} })}
