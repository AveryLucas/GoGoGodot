...
func (o *Extension[T]) CancelButtonText() string { return o.Super().CancelButtonText() }
...
func (o *Extension[T]) SetCancelButtonText(value string) *Extension[T] {
	o.Super().SetCancelButtonText(value)
	return o
}
...
func (o *Extension[T]) GetCancelButton() Button.Instance {
	return o.Super().GetCancelButton()
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(AcceptDialog.Advanced(self.AsAcceptDialog()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(AcceptDialog.Instance(self.AsAcceptDialog()), name)
	}
}
func init() {gdclass.Register("ConfirmationDialog", func(ptr gdreference.Object) any { return Instance{gdclass.NewConfirmationDialog(ptr)} })}
