...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.add_point, 0|(gdextension.SizeInt<<4)|(gdextension.SizeVector3<<8)|(gdextension.SizeFloat<<12), &struct{id int64; position Vector3.XYZ; weight_scale float64}{id, position, weight_scale})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_point_position, 0|(gdextension.SizeInt<<4)|(gdextension.SizeVector3<<8), &struct{id int64; position Vector3.XYZ}{id, position})
}
...
func (self class) GetClosestPoint(to_position Vector3.XYZ, include_disabled bool) int64 { //gd:AStar3D.get_closest_point
	var r_ret = noescape.Call[int64]( gd.ObjectChecked(self.AsObject()), methods.get_closest_point, gdextension.SizeInt|(gdextension.SizeVector3<<4)|(gdextension.SizeBool<<8), &struct{to_position Vector3.XYZ; include_disabled bool}{to_position, include_disabled})
	var ret = r_ret
	return ret
}
...
func (o *Extension[T]) GetPointPosition(id Point) Vector3.XYZ {
	return o.Super().GetPointPosition(id)
}
func (o *Extension[T]) SetPointPosition(id Point, position Vector3.XYZ) *Extension[T] {
...
func (o *Extension[T]) GetClosestPositionInSegment(to_position Vector3.XYZ) Vector3.XYZ {
...
func init() {gdclass.Register("AStar3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewAStar3D(ptr)} })}
