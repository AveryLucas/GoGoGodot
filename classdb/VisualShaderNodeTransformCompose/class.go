...
func init() {gdclass.Register("VisualShaderNodeTransformCompose", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeTransformCompose(ptr)} })}
