...
func init() {gdclass.Register("VisualShaderNodeDerivativeFunc", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeDerivativeFunc(ptr)} })}
