...
func (o *Extension[T]) Segments() []Vector2.XY { return o.Super().Segments() }
...
func (o *Extension[T]) SetSegments(value []Vector2.XY) *Extension[T] {
	o.Super().SetSegments(value)
	return o
}

func (self class) SetSegments(segments Packed.Array[Vector2.XY])  { //gd:ConcavePolygonShape2D.set_segments
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_segments, 0|(gdextension.SizePackedArray<<4), &struct{segments gdextension.PackedArray[Vector2.XY]}{pointers.Get(gd.InternalPacked[gd.PackedVector2Array, Vector2.XY](segments))})
}
...
func init() {gdclass.Register("ConcavePolygonShape2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewConcavePolygonShape2D(ptr)} })}
