...
func (o *Extension[T]) Angle() Float.X { return o.Super().Angle() }
...
func (o *Extension[T]) SetAngle(value Float.X) *Extension[T] {
...
func (self class) GetAngle() float64 { //gd:JointLimitationCone3D.get_angle
	var r_ret = noescape.Call[float64]( gd.ObjectChecked(self.AsObject()), methods.get_angle, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (o class) AsJointLimitation3D() JointLimitation3D.Advanced { return *(*JointLimitation3D.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsJointLimitation3D() JointLimitation3D.Instance { return o.Super().AsJointLimitation3D() }
func (o Instance) AsJointLimitation3D() JointLimitation3D.Instance { return *(*JointLimitation3D.Instance)(ie.As(&o)) }
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(JointLimitation3D.Advanced(self.AsJointLimitation3D()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(JointLimitation3D.Instance(self.AsJointLimitation3D()), name)
	}
}
func init() {gdclass.Register("JointLimitationCone3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewJointLimitationCone3D(ptr)} })}
