...
func (o *Extension[T]) Lock() {
	o.Super().Lock()
}
func (o *Extension[T]) TryLock() bool {
	return o.Super().TryLock()
}
func (o *Extension[T]) Unlock() {
	o.Super().Unlock()
}
...
func init() {gdclass.Register("Mutex", func(ptr gdreference.Object) any { return Instance{gdclass.NewMutex(ptr)} })}
