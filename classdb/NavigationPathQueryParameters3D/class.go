...
func init() {gdclass.Register("NavigationPathQueryParameters3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewNavigationPathQueryParameters3D(ptr)} })}
