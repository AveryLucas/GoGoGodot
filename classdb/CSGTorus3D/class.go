...
func (o *Extension[T]) InnerRadius() Float.X { return o.Super().InnerRadius() }
...
func (o *Extension[T]) SetInnerRadius(value Float.X) *Extension[T] {
	o.Super().SetInnerRadius(value)
	return o
}
...
func (o *Extension[T]) OuterRadius() Float.X { return o.Super().OuterRadius() }
...
func (o *Extension[T]) SetOuterRadius(value Float.X) *Extension[T] {
	o.Super().SetOuterRadius(value)
	return o
}
...
func (o *Extension[T]) Sides() int { return o.Super().Sides() }
...
func (o *Extension[T]) SetSides(value int) *Extension[T] {
	o.Super().SetSides(value)
	return o
}
...
func (o *Extension[T]) RingSides() int { return o.Super().RingSides() }
...
func (o *Extension[T]) SetRingSides(value int) *Extension[T] {
	o.Super().SetRingSides(value)
	return o
}
...
func init() {gdclass.Register("CSGTorus3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewCSGTorus3D(ptr)} })}
