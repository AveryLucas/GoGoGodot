...
import "github.com/AveryLucas/gogogd/classdb/SplitContainer"
...
func (o class) AsSplitContainer() SplitContainer.Advanced { return *(*SplitContainer.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsSplitContainer() SplitContainer.Instance { return o.Super().AsSplitContainer() }
func (o Instance) AsSplitContainer() SplitContainer.Instance { return *(*SplitContainer.Instance)(ie.As(&o)) }
...
// OnDragged is promoted from [SplitContainer.Instance.OnDragged].
...
// OnDragged is promoted from [SplitContainer.Instance.OnDragged].
func (o *Extension[T]) OnDragged(cb func(offset int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
// OnDragStarted is promoted from [SplitContainer.Instance.OnDragStarted].
...
// OnDragStarted is promoted from [SplitContainer.Instance.OnDragStarted].
func (o *Extension[T]) OnDragStarted(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("drag_started"), gd.NewCallable(cb), int64(flags_together))
	return o
}

// OnDragEnded is promoted from [SplitContainer.Instance.OnDragEnded].
...
// OnDragEnded is promoted from [SplitContainer.Instance.OnDragEnded].
func (o *Extension[T]) OnDragEnded(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("drag_ended"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
// GetDragAreaControls is promoted from [SplitContainer.Instance.GetDragAreaControls].
func (self Instance) GetDragAreaControls() []Control.Instance {
	return self.AsSplitContainer().GetDragAreaControls()
}

// GetDragAreaControls is promoted from [SplitContainer.Instance.GetDragAreaControls].
func (o *Extension[T]) GetDragAreaControls() []Control.Instance {
	return o.Super().AsSplitContainer().GetDragAreaControls()
}

// GetDragAreaControl is promoted from [SplitContainer.Instance.GetDragAreaControl].
func (self Instance) GetDragAreaControl() Control.Instance {
	return self.AsSplitContainer().GetDragAreaControl()
}

// GetDragAreaControl is promoted from [SplitContainer.Instance.GetDragAreaControl].
func (o *Extension[T]) GetDragAreaControl() Control.Instance {
	return o.Super().AsSplitContainer().GetDragAreaControl()
}
...
// SplitOffsets is promoted from [SplitContainer.Instance.SplitOffsets].
func (self Instance) SplitOffsets() []int32 { return self.AsSplitContainer().SplitOffsets() }
func (o *Extension[T]) SplitOffsets() []int32 { return o.Super().AsSplitContainer().SplitOffsets() }

// SetSplitOffsets is promoted from [SplitContainer.Instance.SetSplitOffsets].
func (self Instance) SetSplitOffsets(value []int32) Instance {
	self.AsSplitContainer().SetSplitOffsets(value)
	return self
}
func (o *Extension[T]) SetSplitOffsets(value []int32) *Extension[T] {
	o.Super().AsSplitContainer().SetSplitOffsets(value)
	return o
}

// Collapsed is promoted from [SplitContainer.Instance.Collapsed].
func (self Instance) Collapsed() bool { return self.AsSplitContainer().Collapsed() }
func (o *Extension[T]) Collapsed() bool { return o.Super().AsSplitContainer().Collapsed() }

// SetCollapsed is promoted from [SplitContainer.Instance.SetCollapsed].
func (self Instance) SetCollapsed(value bool) Instance {
	self.AsSplitContainer().SetCollapsed(value)
	return self
}
func (o *Extension[T]) SetCollapsed(value bool) *Extension[T] {
	o.Super().AsSplitContainer().SetCollapsed(value)
	return o
}

// DraggingEnabled is promoted from [SplitContainer.Instance.DraggingEnabled].
func (self Instance) DraggingEnabled() bool { return self.AsSplitContainer().DraggingEnabled() }
func (o *Extension[T]) DraggingEnabled() bool { return o.Super().AsSplitContainer().DraggingEnabled() }

// SetDraggingEnabled is promoted from [SplitContainer.Instance.SetDraggingEnabled].
func (self Instance) SetDraggingEnabled(value bool) Instance {
	self.AsSplitContainer().SetDraggingEnabled(value)
	return self
}
func (o *Extension[T]) SetDraggingEnabled(value bool) *Extension[T] {
	o.Super().AsSplitContainer().SetDraggingEnabled(value)
	return o
}

// DraggerVisibility is promoted from [SplitContainer.Instance.DraggerVisibility].
func (self Instance) DraggerVisibility() SplitContainer.DraggerVisibility { return self.AsSplitContainer().DraggerVisibility() }
func (o *Extension[T]) DraggerVisibility() SplitContainer.DraggerVisibility { return o.Super().AsSplitContainer().DraggerVisibility() }

// SetDraggerVisibility is promoted from [SplitContainer.Instance.SetDraggerVisibility].
func (self Instance) SetDraggerVisibility(value SplitContainer.DraggerVisibility) Instance {
	self.AsSplitContainer().SetDraggerVisibility(value)
	return self
}
func (o *Extension[T]) SetDraggerVisibility(value SplitContainer.DraggerVisibility) *Extension[T] {
	o.Super().AsSplitContainer().SetDraggerVisibility(value)
	return o
}

// Vertical is promoted from [SplitContainer.Instance.Vertical].
func (self Instance) Vertical() bool { return self.AsSplitContainer().Vertical() }
func (o *Extension[T]) Vertical() bool { return o.Super().AsSplitContainer().Vertical() }

// SetVertical is promoted from [SplitContainer.Instance.SetVertical].
func (self Instance) SetVertical(value bool) Instance {
	self.AsSplitContainer().SetVertical(value)
	return self
}
func (o *Extension[T]) SetVertical(value bool) *Extension[T] {
	o.Super().AsSplitContainer().SetVertical(value)
	return o
}

// TouchDraggerEnabled is promoted from [SplitContainer.Instance.TouchDraggerEnabled].
func (self Instance) TouchDraggerEnabled() bool { return self.AsSplitContainer().TouchDraggerEnabled() }
func (o *Extension[T]) TouchDraggerEnabled() bool { return o.Super().AsSplitContainer().TouchDraggerEnabled() }

// SetTouchDraggerEnabled is promoted from [SplitContainer.Instance.SetTouchDraggerEnabled].
func (self Instance) SetTouchDraggerEnabled(value bool) Instance {
	self.AsSplitContainer().SetTouchDraggerEnabled(value)
	return self
}
func (o *Extension[T]) SetTouchDraggerEnabled(value bool) *Extension[T] {
	o.Super().AsSplitContainer().SetTouchDraggerEnabled(value)
	return o
}

// DragAreaMarginBegin is promoted from [SplitContainer.Instance.DragAreaMarginBegin].
func (self Instance) DragAreaMarginBegin() int { return self.AsSplitContainer().DragAreaMarginBegin() }
func (o *Extension[T]) DragAreaMarginBegin() int { return o.Super().AsSplitContainer().DragAreaMarginBegin() }

// SetDragAreaMarginBegin is promoted from [SplitContainer.Instance.SetDragAreaMarginBegin].
func (self Instance) SetDragAreaMarginBegin(value int) Instance {
	self.AsSplitContainer().SetDragAreaMarginBegin(value)
	return self
}
func (o *Extension[T]) SetDragAreaMarginBegin(value int) *Extension[T] {
	o.Super().AsSplitContainer().SetDragAreaMarginBegin(value)
	return o
}

// DragAreaMarginEnd is promoted from [SplitContainer.Instance.DragAreaMarginEnd].
func (self Instance) DragAreaMarginEnd() int { return self.AsSplitContainer().DragAreaMarginEnd() }
func (o *Extension[T]) DragAreaMarginEnd() int { return o.Super().AsSplitContainer().DragAreaMarginEnd() }

// SetDragAreaMarginEnd is promoted from [SplitContainer.Instance.SetDragAreaMarginEnd].
func (self Instance) SetDragAreaMarginEnd(value int) Instance {
	self.AsSplitContainer().SetDragAreaMarginEnd(value)
	return self
}
func (o *Extension[T]) SetDragAreaMarginEnd(value int) *Extension[T] {
	o.Super().AsSplitContainer().SetDragAreaMarginEnd(value)
	return o
}

// DragAreaOffset is promoted from [SplitContainer.Instance.DragAreaOffset].
func (self Instance) DragAreaOffset() int { return self.AsSplitContainer().DragAreaOffset() }
func (o *Extension[T]) DragAreaOffset() int { return o.Super().AsSplitContainer().DragAreaOffset() }

// SetDragAreaOffset is promoted from [SplitContainer.Instance.SetDragAreaOffset].
func (self Instance) SetDragAreaOffset(value int) Instance {
	self.AsSplitContainer().SetDragAreaOffset(value)
	return self
}
func (o *Extension[T]) SetDragAreaOffset(value int) *Extension[T] {
	o.Super().AsSplitContainer().SetDragAreaOffset(value)
	return o
}

// DragAreaHighlightInEditor is promoted from [SplitContainer.Instance.DragAreaHighlightInEditor].
func (self Instance) DragAreaHighlightInEditor() bool { return self.AsSplitContainer().DragAreaHighlightInEditor() }
func (o *Extension[T]) DragAreaHighlightInEditor() bool { return o.Super().AsSplitContainer().DragAreaHighlightInEditor() }

// SetDragAreaHighlightInEditor is promoted from [SplitContainer.Instance.SetDragAreaHighlightInEditor].
func (self Instance) SetDragAreaHighlightInEditor(value bool) Instance {
	self.AsSplitContainer().SetDragAreaHighlightInEditor(value)
	return self
}
func (o *Extension[T]) SetDragAreaHighlightInEditor(value bool) *Extension[T] {
	o.Super().AsSplitContainer().SetDragAreaHighlightInEditor(value)
	return o
}

// SplitOffset is promoted from [SplitContainer.Instance.SplitOffset].
func (self Instance) SplitOffset() int { return self.AsSplitContainer().SplitOffset() }
func (o *Extension[T]) SplitOffset() int { return o.Super().AsSplitContainer().SplitOffset() }

// SetSplitOffset is promoted from [SplitContainer.Instance.SetSplitOffset].
func (self Instance) SetSplitOffset(value int) Instance {
	self.AsSplitContainer().SetSplitOffset(value)
	return self
}
func (o *Extension[T]) SetSplitOffset(value int) *Extension[T] {
	o.Super().AsSplitContainer().SetSplitOffset(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(SplitContainer.Advanced(self.AsSplitContainer()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(SplitContainer.Instance(self.AsSplitContainer()), name)
	}
}
func init() {gdclass.Register("HSplitContainer", func(ptr gdreference.Object) any { return Instance{gdclass.NewHSplitContainer(ptr)} })}
