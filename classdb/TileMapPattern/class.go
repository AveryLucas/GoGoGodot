...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.remove_cell, 0|(gdextension.SizeVector2i<<4)|(gdextension.SizeBool<<8), &struct{coords Vector2i.XY; update_size bool}{coords, update_size})
}
...
func (o *Extension[T]) HasCell(coords Vector2i.XY) bool {
	return o.Super().HasCell(coords)
}
func (o *Extension[T]) RemoveCell(coords Vector2i.XY, update_size bool) {
	o.Super().RemoveCell(coords, update_size)
}
...
func (o *Extension[T]) SetSize(size Vector2i.XY) *Extension[T] {
	o.Super().SetSize(size)
	return o
}
...
func init() {gdclass.Register("TileMapPattern", func(ptr gdreference.Object) any { return Instance{gdclass.NewTileMapPattern(ptr)} })}
