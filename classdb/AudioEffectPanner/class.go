...
func (o *Extension[T]) Pan() Float.X { return o.Super().Pan() }
...
func (o *Extension[T]) SetPan(value Float.X) *Extension[T] {
	o.Super().SetPan(value)
	return o
}
...
func init() {gdclass.Register("AudioEffectPanner", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioEffectPanner(ptr)} })}
