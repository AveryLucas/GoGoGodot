...
func (o *Extension[T]) GetActionCount() int {
	return o.Super().GetActionCount()
}
func (o *Extension[T]) AddAction(action OpenXRAction.Instance) {
	o.Super().AddAction(action)
}
func (o *Extension[T]) RemoveAction(action OpenXRAction.Instance) {
	o.Super().RemoveAction(action)
}
...
func init() {gdclass.Register("OpenXRActionSet", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRActionSet(ptr)} })}
