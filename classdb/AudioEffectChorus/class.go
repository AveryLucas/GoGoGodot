...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_voice_delay_ms, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct{voice_idx int64; delay_ms float64}{voice_idx, delay_ms})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_voice_rate_hz, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct{voice_idx int64; rate_hz float64}{voice_idx, rate_hz})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_voice_depth_ms, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct{voice_idx int64; depth_ms float64}{voice_idx, depth_ms})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_voice_level_db, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct{voice_idx int64; level_db float64}{voice_idx, level_db})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_voice_cutoff_hz, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct{voice_idx int64; cutoff_hz float64}{voice_idx, cutoff_hz})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_voice_pan, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct{voice_idx int64; pan float64}{voice_idx, pan})
}
...
func init() {gdclass.Register("AudioEffectChorus", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioEffectChorus(ptr)} })}
