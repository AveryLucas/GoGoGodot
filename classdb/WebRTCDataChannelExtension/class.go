...
func (o class) AsWebRTCDataChannel() WebRTCDataChannel.Advanced { return *(*WebRTCDataChannel.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsWebRTCDataChannel() WebRTCDataChannel.Instance { return o.Super().AsWebRTCDataChannel() }
func (o Instance) AsWebRTCDataChannel() WebRTCDataChannel.Instance { return *(*WebRTCDataChannel.Instance)(ie.As(&o)) }
...
func (self class) Virtual(name string) reflect.Value {
	...
	default: return gd.VirtualByName(WebRTCDataChannel.Advanced(self.AsWebRTCDataChannel()), name)
	}
}
...
func (self Instance) Virtual(name string) reflect.Value {
	...
	case "_is_negotiated": return reflect.ValueOf(self._is_negotiated);
	case "_get_buffered_amount": return reflect.ValueOf(self._get_buffered_amount);
	default: return gd.VirtualByName(WebRTCDataChannel.Instance(self.AsWebRTCDataChannel()), name)
	}
}
func init() {gdclass.Register("WebRTCDataChannelExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewWebRTCDataChannelExtension(ptr)} })}
