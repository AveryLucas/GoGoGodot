...
func (o *Extension[T]) GetExternalTextureId() int {
	return o.Super().GetExternalTextureId()
}
func (o *Extension[T]) SetExternalBufferId(external_buffer_id int) *Extension[T] {
	o.Super().SetExternalBufferId(external_buffer_id)
	return o
}
...
func init() {gdclass.Register("ExternalTexture", func(ptr gdreference.Object) any { return Instance{gdclass.NewExternalTexture(ptr)} })}
