...
func (o *Extension[T]) SetPath3d(index int, path_3d string) *Extension[T] {
	o.Super().SetPath3d(index, path_3d)
	return o
}
func (o *Extension[T]) GetPath3d(index int) string {
	return o.Super().GetPath3d(index)
}
func (o *Extension[T]) SetTiltEnabled(index int, enabled bool) *Extension[T] {
	o.Super().SetTiltEnabled(index, enabled)
	return o
}
func (o *Extension[T]) IsTiltEnabled(index int) bool {
	return o.Super().IsTiltEnabled(index)
}
func (o *Extension[T]) SetTiltFadeIn(index int, size int) *Extension[T] {
	o.Super().SetTiltFadeIn(index, size)
	return o
}
func (o *Extension[T]) GetTiltFadeIn(index int) int {
	return o.Super().GetTiltFadeIn(index)
}
func (o *Extension[T]) SetTiltFadeOut(index int, size int) *Extension[T] {
	o.Super().SetTiltFadeOut(index, size)
	return o
}
func (o *Extension[T]) GetTiltFadeOut(index int) int {
	return o.Super().GetTiltFadeOut(index)
}
