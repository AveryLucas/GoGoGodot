...
func (o *Extension[T]) Constant() Color.RGBA { return o.Super().Constant() }
...
func (o *Extension[T]) SetConstant(value Color.RGBA) *Extension[T] {
...
func init() {gdclass.Register("VisualShaderNodeColorConstant", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeColorConstant(ptr)} })}
