...
import "github.com/AveryLucas/gogogd/classdb/SpringBoneCollision3D"
...
func (o *Extension[T]) Inside() bool { return o.Super().Inside() }
...
func (o *Extension[T]) SetInside(value bool) *Extension[T] {
	o.Super().SetInside(value)
	return o
}
...
func (o class) AsSpringBoneCollision3D() SpringBoneCollision3D.Advanced { return *(*SpringBoneCollision3D.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsSpringBoneCollision3D() SpringBoneCollision3D.Instance { return o.Super().AsSpringBoneCollision3D() }
func (o Instance) AsSpringBoneCollision3D() SpringBoneCollision3D.Instance { return *(*SpringBoneCollision3D.Instance)(ie.As(&o)) }
...
// GetSkeleton is promoted from [SpringBoneCollision3D.Instance.GetSkeleton].
func (self Instance) GetSkeleton() Skeleton3D.Instance {
	return self.AsSpringBoneCollision3D().GetSkeleton()
}

// GetSkeleton is promoted from [SpringBoneCollision3D.Instance.GetSkeleton].
func (o *Extension[T]) GetSkeleton() Skeleton3D.Instance {
	return o.Super().AsSpringBoneCollision3D().GetSkeleton()
}
...
// BoneName is promoted from [SpringBoneCollision3D.Instance.BoneName].
func (self Instance) BoneName() string { return self.AsSpringBoneCollision3D().BoneName() }
func (o *Extension[T]) BoneName() string { return o.Super().AsSpringBoneCollision3D().BoneName() }

// SetBoneName is promoted from [SpringBoneCollision3D.Instance.SetBoneName].
func (self Instance) SetBoneName(value string) Instance {
	self.AsSpringBoneCollision3D().SetBoneName(value)
	return self
}
func (o *Extension[T]) SetBoneName(value string) *Extension[T] {
	o.Super().AsSpringBoneCollision3D().SetBoneName(value)
	return o
}

// Bone is promoted from [SpringBoneCollision3D.Instance.Bone].
func (self Instance) Bone() int { return self.AsSpringBoneCollision3D().Bone() }
func (o *Extension[T]) Bone() int { return o.Super().AsSpringBoneCollision3D().Bone() }

// SetBone is promoted from [SpringBoneCollision3D.Instance.SetBone].
func (self Instance) SetBone(value int) Instance {
	self.AsSpringBoneCollision3D().SetBone(value)
	return self
}
func (o *Extension[T]) SetBone(value int) *Extension[T] {
	o.Super().AsSpringBoneCollision3D().SetBone(value)
	return o
}

// PositionOffset is promoted from [SpringBoneCollision3D.Instance.PositionOffset].
func (self Instance) PositionOffset() Vector3.XYZ { return self.AsSpringBoneCollision3D().PositionOffset() }
func (o *Extension[T]) PositionOffset() Vector3.XYZ { return o.Super().AsSpringBoneCollision3D().PositionOffset() }

// SetPositionOffset is promoted from [SpringBoneCollision3D.Instance.SetPositionOffset].
func (self Instance) SetPositionOffset(value Vector3.XYZ) Instance {
	self.AsSpringBoneCollision3D().SetPositionOffset(value)
	return self
}
func (o *Extension[T]) SetPositionOffset(value Vector3.XYZ) *Extension[T] {
	o.Super().AsSpringBoneCollision3D().SetPositionOffset(value)
	return o
}

// RotationOffset is promoted from [SpringBoneCollision3D.Instance.RotationOffset].
func (self Instance) RotationOffset() Quaternion.IJKX { return self.AsSpringBoneCollision3D().RotationOffset() }
func (o *Extension[T]) RotationOffset() Quaternion.IJKX { return o.Super().AsSpringBoneCollision3D().RotationOffset() }

// SetRotationOffset is promoted from [SpringBoneCollision3D.Instance.SetRotationOffset].
func (self Instance) SetRotationOffset(value Quaternion.IJKX) Instance {
	self.AsSpringBoneCollision3D().SetRotationOffset(value)
	return self
}
func (o *Extension[T]) SetRotationOffset(value Quaternion.IJKX) *Extension[T] {
	o.Super().AsSpringBoneCollision3D().SetRotationOffset(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(SpringBoneCollision3D.Advanced(self.AsSpringBoneCollision3D()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(SpringBoneCollision3D.Instance(self.AsSpringBoneCollision3D()), name)
	}
}
func init() {gdclass.Register("SpringBoneCollisionCapsule3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewSpringBoneCollisionCapsule3D(ptr)} })}
