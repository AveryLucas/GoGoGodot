...
func (o *Extension[T]) OnItemSelected(cb func(index int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("item_selected"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnEmptyClicked(cb func(at_position Vector2.XY, mouse_button_index int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("empty_clicked"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnItemClicked(cb func(index int, at_position Vector2.XY, mouse_button_index int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("item_clicked"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnMultiSelected(cb func(index int, selected bool), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("multi_selected"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnItemActivated(cb func(index int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("item_activated"), gd.NewCallable(cb), int64(flags_together))
	return o
}
