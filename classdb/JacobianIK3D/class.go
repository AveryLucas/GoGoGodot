...
import "github.com/AveryLucas/gogogd/classdb/IterateIK3D"
...
// SetTargetNode is promoted from [IterateIK3D.Instance.SetTargetNode].
func (self Instance) SetTargetNode(index int, target_node string) Instance {
	self.AsIterateIK3D().SetTargetNode(index, target_node)
	return self
}

// SetTargetNode is promoted from [IterateIK3D.Instance.SetTargetNode].
func (o *Extension[T]) SetTargetNode(index int, target_node string) *Extension[T] {
	o.Super().AsIterateIK3D().SetTargetNode(index, target_node)
	return o
}

// GetTargetNode is promoted from [IterateIK3D.Instance.GetTargetNode].
func (self Instance) GetTargetNode(index int) string {
	return self.AsIterateIK3D().GetTargetNode(index)
}

// GetTargetNode is promoted from [IterateIK3D.Instance.GetTargetNode].
func (o *Extension[T]) GetTargetNode(index int) string {
	return o.Super().AsIterateIK3D().GetTargetNode(index)
}

// SetJointRotationAxis is promoted from [IterateIK3D.Instance.SetJointRotationAxis].
func (self Instance) SetJointRotationAxis(index int, joint int, axis SkeletonModifier3D.RotationAxis) Instance {
	self.AsIterateIK3D().SetJointRotationAxis(index, joint, axis)
	return self
}

// SetJointRotationAxis is promoted from [IterateIK3D.Instance.SetJointRotationAxis].
func (o *Extension[T]) SetJointRotationAxis(index int, joint int, axis SkeletonModifier3D.RotationAxis) *Extension[T] {
	o.Super().AsIterateIK3D().SetJointRotationAxis(index, joint, axis)
	return o
}

// GetJointRotationAxis is promoted from [IterateIK3D.Instance.GetJointRotationAxis].
func (self Instance) GetJointRotationAxis(index int, joint int) SkeletonModifier3D.RotationAxis {
	return self.AsIterateIK3D().GetJointRotationAxis(index, joint)
}

// GetJointRotationAxis is promoted from [IterateIK3D.Instance.GetJointRotationAxis].
func (o *Extension[T]) GetJointRotationAxis(index int, joint int) SkeletonModifier3D.RotationAxis {
	return o.Super().AsIterateIK3D().GetJointRotationAxis(index, joint)
}

// SetJointRotationAxisVector is promoted from [IterateIK3D.Instance.SetJointRotationAxisVector].
func (self Instance) SetJointRotationAxisVector(index int, joint int, axis_vector Vector3.XYZ) Instance {
	self.AsIterateIK3D().SetJointRotationAxisVector(index, joint, axis_vector)
	return self
}

// SetJointRotationAxisVector is promoted from [IterateIK3D.Instance.SetJointRotationAxisVector].
func (o *Extension[T]) SetJointRotationAxisVector(index int, joint int, axis_vector Vector3.XYZ) *Extension[T] {
	o.Super().AsIterateIK3D().SetJointRotationAxisVector(index, joint, axis_vector)
	return o
}

// GetJointRotationAxisVector is promoted from [IterateIK3D.Instance.GetJointRotationAxisVector].
func (self Instance) GetJointRotationAxisVector(index int, joint int) Vector3.XYZ {
	return self.AsIterateIK3D().GetJointRotationAxisVector(index, joint)
}

// GetJointRotationAxisVector is promoted from [IterateIK3D.Instance.GetJointRotationAxisVector].
func (o *Extension[T]) GetJointRotationAxisVector(index int, joint int) Vector3.XYZ {
	return o.Super().AsIterateIK3D().GetJointRotationAxisVector(index, joint)
}

// SetJointLimitation is promoted from [IterateIK3D.Instance.SetJointLimitation].
func (self Instance) SetJointLimitation(index int, joint int, limitation JointLimitation3D.Instance) Instance {
	self.AsIterateIK3D().SetJointLimitation(index, joint, limitation)
	return self
}

// SetJointLimitation is promoted from [IterateIK3D.Instance.SetJointLimitation].
func (o *Extension[T]) SetJointLimitation(index int, joint int, limitation JointLimitation3D.Instance) *Extension[T] {
	o.Super().AsIterateIK3D().SetJointLimitation(index, joint, limitation)
	return o
}

// GetJointLimitation is promoted from [IterateIK3D.Instance.GetJointLimitation].
func (self Instance) GetJointLimitation(index int, joint int) JointLimitation3D.Instance {
	return self.AsIterateIK3D().GetJointLimitation(index, joint)
}

// GetJointLimitation is promoted from [IterateIK3D.Instance.GetJointLimitation].
func (o *Extension[T]) GetJointLimitation(index int, joint int) JointLimitation3D.Instance {
	return o.Super().AsIterateIK3D().GetJointLimitation(index, joint)
}

// SetJointLimitationRightAxis is promoted from [IterateIK3D.Instance.SetJointLimitationRightAxis].
func (self Instance) SetJointLimitationRightAxis(index int, joint int, direction SkeletonModifier3D.SecondaryDirection) Instance {
	self.AsIterateIK3D().SetJointLimitationRightAxis(index, joint, direction)
	return self
}
...
func (o *Extension[T]) SetJointLimitationRightAxis(index int, joint int, direction SkeletonModifier3D.SecondaryDirection) *Extension[T] {
	o.Super().AsIterateIK3D().SetJointLimitationRightAxis(index, joint, direction)
	return o
}

// GetJointLimitationRightAxis is promoted from [IterateIK3D.Instance.GetJointLimitationRightAxis].
func (self Instance) GetJointLimitationRightAxis(index int, joint int) SkeletonModifier3D.SecondaryDirection {
	return self.AsIterateIK3D().GetJointLimitationRightAxis(index, joint)
}

// GetJointLimitationRightAxis is promoted from [IterateIK3D.Instance.GetJointLimitationRightAxis].
func (o *Extension[T]) GetJointLimitationRightAxis(index int, joint int) SkeletonModifier3D.SecondaryDirection {
	return o.Super().AsIterateIK3D().GetJointLimitationRightAxis(index, joint)
}

// SetJointLimitationRightAxisVector is promoted from [IterateIK3D.Instance.SetJointLimitationRightAxisVector].
func (self Instance) SetJointLimitationRightAxisVector(index int, joint int, vector Vector3.XYZ) Instance {
	self.AsIterateIK3D().SetJointLimitationRightAxisVector(index, joint, vector)
	return self
}

// SetJointLimitationRightAxisVector is promoted from [IterateIK3D.Instance.SetJointLimitationRightAxisVector].
func (o *Extension[T]) SetJointLimitationRightAxisVector(index int, joint int, vector Vector3.XYZ) *Extension[T] {
	o.Super().AsIterateIK3D().SetJointLimitationRightAxisVector(index, joint, vector)
	return o
}

// GetJointLimitationRightAxisVector is promoted from [IterateIK3D.Instance.GetJointLimitationRightAxisVector].
func (self Instance) GetJointLimitationRightAxisVector(index int, joint int) Vector3.XYZ {
	return self.AsIterateIK3D().GetJointLimitationRightAxisVector(index, joint)
}

// GetJointLimitationRightAxisVector is promoted from [IterateIK3D.Instance.GetJointLimitationRightAxisVector].
func (o *Extension[T]) GetJointLimitationRightAxisVector(index int, joint int) Vector3.XYZ {
	return o.Super().AsIterateIK3D().GetJointLimitationRightAxisVector(index, joint)
}

// SetJointLimitationRotationOffset is promoted from [IterateIK3D.Instance.SetJointLimitationRotationOffset].
func (self Instance) SetJointLimitationRotationOffset(index int, joint int, offset Quaternion.IJKX) Instance {
	self.AsIterateIK3D().SetJointLimitationRotationOffset(index, joint, offset)
	return self
}

// SetJointLimitationRotationOffset is promoted from [IterateIK3D.Instance.SetJointLimitationRotationOffset].
func (o *Extension[T]) SetJointLimitationRotationOffset(index int, joint int, offset Quaternion.IJKX) *Extension[T] {
	o.Super().AsIterateIK3D().SetJointLimitationRotationOffset(index, joint, offset)
	return o
}

// GetJointLimitationRotationOffset is promoted from [IterateIK3D.Instance.GetJointLimitationRotationOffset].
func (self Instance) GetJointLimitationRotationOffset(index int, joint int) Quaternion.IJKX {
	return self.AsIterateIK3D().GetJointLimitationRotationOffset(index, joint)
}

// GetJointLimitationRotationOffset is promoted from [IterateIK3D.Instance.GetJointLimitationRotationOffset].
func (o *Extension[T]) GetJointLimitationRotationOffset(index int, joint int) Quaternion.IJKX {
	return o.Super().AsIterateIK3D().GetJointLimitationRotationOffset(index, joint)
}
...
// MaxIterations is promoted from [IterateIK3D.Instance.MaxIterations].
func (self Instance) MaxIterations() int { return self.AsIterateIK3D().MaxIterations() }
func (o *Extension[T]) MaxIterations() int { return o.Super().AsIterateIK3D().MaxIterations() }

// SetMaxIterations is promoted from [IterateIK3D.Instance.SetMaxIterations].
func (self Instance) SetMaxIterations(value int) Instance {
	self.AsIterateIK3D().SetMaxIterations(value)
	return self
}
func (o *Extension[T]) SetMaxIterations(value int) *Extension[T] {
	o.Super().AsIterateIK3D().SetMaxIterations(value)
	return o
}

// MinDistance is promoted from [IterateIK3D.Instance.MinDistance].
func (self Instance) MinDistance() Float.X { return self.AsIterateIK3D().MinDistance() }
func (o *Extension[T]) MinDistance() Float.X { return o.Super().AsIterateIK3D().MinDistance() }

// SetMinDistance is promoted from [IterateIK3D.Instance.SetMinDistance].
func (self Instance) SetMinDistance(value Float.X) Instance {
	self.AsIterateIK3D().SetMinDistance(value)
	return self
}
func (o *Extension[T]) SetMinDistance(value Float.X) *Extension[T] {
	o.Super().AsIterateIK3D().SetMinDistance(value)
	return o
}

// AngularDeltaLimit is promoted from [IterateIK3D.Instance.AngularDeltaLimit].
func (self Instance) AngularDeltaLimit() Float.X { return self.AsIterateIK3D().AngularDeltaLimit() }
func (o *Extension[T]) AngularDeltaLimit() Float.X { return o.Super().AsIterateIK3D().AngularDeltaLimit() }

// SetAngularDeltaLimit is promoted from [IterateIK3D.Instance.SetAngularDeltaLimit].
func (self Instance) SetAngularDeltaLimit(value Float.X) Instance {
	self.AsIterateIK3D().SetAngularDeltaLimit(value)
	return self
}
func (o *Extension[T]) SetAngularDeltaLimit(value Float.X) *Extension[T] {
	o.Super().AsIterateIK3D().SetAngularDeltaLimit(value)
	return o
}

// Deterministic is promoted from [IterateIK3D.Instance.Deterministic].
func (self Instance) Deterministic() bool { return self.AsIterateIK3D().Deterministic() }
func (o *Extension[T]) Deterministic() bool { return o.Super().AsIterateIK3D().Deterministic() }

// SetDeterministic is promoted from [IterateIK3D.Instance.SetDeterministic].
func (self Instance) SetDeterministic(value bool) Instance {
	self.AsIterateIK3D().SetDeterministic(value)
	return self
}
func (o *Extension[T]) SetDeterministic(value bool) *Extension[T] {
	o.Super().AsIterateIK3D().SetDeterministic(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(IterateIK3D.Advanced(self.AsIterateIK3D()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(IterateIK3D.Instance(self.AsIterateIK3D()), name)
	}
}
func init() {gdclass.Register("JacobianIK3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewJacobianIK3D(ptr)} })}
