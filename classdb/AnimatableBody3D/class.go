...
import "github.com/AveryLucas/gogogd/classdb/StaticBody3D"
...
// PhysicsMaterialOverride is promoted from [StaticBody3D.Instance.PhysicsMaterialOverride].
func (self Instance) PhysicsMaterialOverride() PhysicsMaterial.Instance { return self.AsStaticBody3D().PhysicsMaterialOverride() }
func (o *Extension[T]) PhysicsMaterialOverride() PhysicsMaterial.Instance { return o.Super().AsStaticBody3D().PhysicsMaterialOverride() }

// SetPhysicsMaterialOverride is promoted from [StaticBody3D.Instance.SetPhysicsMaterialOverride].
func (self Instance) SetPhysicsMaterialOverride(value PhysicsMaterial.Instance) Instance {
	self.AsStaticBody3D().SetPhysicsMaterialOverride(value)
	return self
}
func (o *Extension[T]) SetPhysicsMaterialOverride(value PhysicsMaterial.Instance) *Extension[T] {
	o.Super().AsStaticBody3D().SetPhysicsMaterialOverride(value)
	return o
}

// ConstantLinearVelocity is promoted from [StaticBody3D.Instance.ConstantLinearVelocity].
func (self Instance) ConstantLinearVelocity() Vector3.XYZ { return self.AsStaticBody3D().ConstantLinearVelocity() }
func (o *Extension[T]) ConstantLinearVelocity() Vector3.XYZ { return o.Super().AsStaticBody3D().ConstantLinearVelocity() }

// SetConstantLinearVelocity is promoted from [StaticBody3D.Instance.SetConstantLinearVelocity].
func (self Instance) SetConstantLinearVelocity(value Vector3.XYZ) Instance {
	self.AsStaticBody3D().SetConstantLinearVelocity(value)
	return self
}
func (o *Extension[T]) SetConstantLinearVelocity(value Vector3.XYZ) *Extension[T] {
	o.Super().AsStaticBody3D().SetConstantLinearVelocity(value)
	return o
}

// ConstantAngularVelocity is promoted from [StaticBody3D.Instance.ConstantAngularVelocity].
func (self Instance) ConstantAngularVelocity() Vector3.XYZ { return self.AsStaticBody3D().ConstantAngularVelocity() }
func (o *Extension[T]) ConstantAngularVelocity() Vector3.XYZ { return o.Super().AsStaticBody3D().ConstantAngularVelocity() }

// SetConstantAngularVelocity is promoted from [StaticBody3D.Instance.SetConstantAngularVelocity].
func (self Instance) SetConstantAngularVelocity(value Vector3.XYZ) Instance {
	self.AsStaticBody3D().SetConstantAngularVelocity(value)
	return self
}
func (o *Extension[T]) SetConstantAngularVelocity(value Vector3.XYZ) *Extension[T] {
	o.Super().AsStaticBody3D().SetConstantAngularVelocity(value)
	return o
}
