...
import "github.com/AveryLucas/gogogd/classdb/Curve2D"
...
func (o *Extension[T]) Curve() Curve2D.Instance { return o.Super().Curve() }
...
func (o *Extension[T]) SetCurve(value Curve2D.Instance) *Extension[T] {
...
func init() {gdclass.Register("Path2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewPath2D(ptr)} })}
