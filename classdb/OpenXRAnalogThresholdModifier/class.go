...
import "github.com/AveryLucas/gogogd/classdb/OpenXRActionBindingModifier"
...
func (self class) GetOnThreshold() float64 { //gd:OpenXRAnalogThresholdModifier.get_on_threshold
	var r_ret = noescape.Call[float64]( gd.ObjectChecked(self.AsObject()), methods.get_on_threshold, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (self class) GetOffThreshold() float64 { //gd:OpenXRAnalogThresholdModifier.get_off_threshold
	var r_ret = noescape.Call[float64]( gd.ObjectChecked(self.AsObject()), methods.get_off_threshold, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (o class) AsOpenXRActionBindingModifier() OpenXRActionBindingModifier.Advanced { return *(*OpenXRActionBindingModifier.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsOpenXRActionBindingModifier() OpenXRActionBindingModifier.Instance { return o.Super().AsOpenXRActionBindingModifier() }
func (o Instance) AsOpenXRActionBindingModifier() OpenXRActionBindingModifier.Instance { return *(*OpenXRActionBindingModifier.Instance)(ie.As(&o)) }
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(OpenXRActionBindingModifier.Advanced(self.AsOpenXRActionBindingModifier()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(OpenXRActionBindingModifier.Instance(self.AsOpenXRActionBindingModifier()), name)
	}
}
func init() {gdclass.Register("OpenXRAnalogThresholdModifier", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRAnalogThresholdModifier(ptr)} })}
