...
func (o class) AsGLTFDocumentExtension() GLTFDocumentExtension.Advanced { return *(*GLTFDocumentExtension.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsGLTFDocumentExtension() GLTFDocumentExtension.Instance { return o.Super().AsGLTFDocumentExtension() }
func (o Instance) AsGLTFDocumentExtension() GLTFDocumentExtension.Instance { return *(*GLTFDocumentExtension.Instance)(ie.As(&o)) }
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(GLTFDocumentExtension.Advanced(self.AsGLTFDocumentExtension()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(GLTFDocumentExtension.Instance(self.AsGLTFDocumentExtension()), name)
	}
}
func init() {gdclass.Register("GLTFDocumentExtensionConvertImporterMesh", func(ptr gdreference.Object) any { return Instance{gdclass.NewGLTFDocumentExtensionConvertImporterMesh(ptr)} })}
