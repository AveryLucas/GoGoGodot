...
import "github.com/AveryLucas/gogogd/classdb/BoneAttachment3D"
...
func (o *Extension[T]) GodotBoneNode() map[int]int { return o.Super().GodotBoneNode() }
...
func (o *Extension[T]) SetGodotBoneNode(value map[int]int) *Extension[T] {
	o.Super().SetGodotBoneNode(value)
	return o
}
...
func (self class) GetGodotSkeleton() [1]gdclass.Skeleton3D { //gd:GLTFSkeleton.get_godot_skeleton
	var r_ret = noescape.Call[gdextension.Object]( gd.ObjectChecked(self.AsObject()), methods.get_godot_skeleton, gdextension.SizeObject, &struct{}{})
...
func (o *Extension[T]) GetGodotSkeleton() Skeleton3D.Instance {
	return o.Super().GetGodotSkeleton()
}
func (o *Extension[T]) GetBoneAttachmentCount() int {
	return o.Super().GetBoneAttachmentCount()
}
func (o *Extension[T]) GetBoneAttachment(idx int) BoneAttachment3D.Instance {
	return o.Super().GetBoneAttachment(idx)
}
...
func init() {gdclass.Register("GLTFSkeleton", func(ptr gdreference.Object) any { return Instance{gdclass.NewGLTFSkeleton(ptr)} })}
