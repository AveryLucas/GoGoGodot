...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_pole_node, 0|(gdextension.SizeInt<<4)|(gdextension.SizeNodePath<<8), &struct{index int64; pole_node gdextension.NodePath}{index, pointers.Get(gd.InternalNodePath(pole_node))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_middle_bone_name, 0|(gdextension.SizeInt<<4)|(gdextension.SizeString<<8), &struct{index int64; bone_name gdextension.String}{index, pointers.Get(gd.InternalString(bone_name))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_middle_bone, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct{index int64; bone int64}{index, bone})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_pole_direction, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct{index int64; direction SkeletonModifier3D.SecondaryDirection}{index, direction})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_pole_direction_vector, 0|(gdextension.SizeInt<<4)|(gdextension.SizeVector3<<8), &struct{index int64; vector Vector3.XYZ}{index, vector})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_use_virtual_end, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct{index int64; enabled bool}{index, enabled})
}
...
func (o *Extension[T]) SetPoleNode(index int, pole_node string) *Extension[T] {
	o.Super().SetPoleNode(index, pole_node)
	return o
}
func (o *Extension[T]) GetPoleNode(index int) string {
	return o.Super().GetPoleNode(index)
}
...
func (o *Extension[T]) SetMiddleBoneName(index int, bone_name string) *Extension[T] {
	o.Super().SetMiddleBoneName(index, bone_name)
	return o
}
func (o *Extension[T]) GetMiddleBoneName(index int) string {
	return o.Super().GetMiddleBoneName(index)
}
func (o *Extension[T]) SetMiddleBone(index int, bone int) *Extension[T] {
	o.Super().SetMiddleBone(index, bone)
	return o
}
func (o *Extension[T]) GetMiddleBone(index int) int {
	return o.Super().GetMiddleBone(index)
}
func (o *Extension[T]) SetPoleDirection(index int, direction SkeletonModifier3D.SecondaryDirection) *Extension[T] {
	o.Super().SetPoleDirection(index, direction)
	return o
}
func (o *Extension[T]) GetPoleDirection(index int) SkeletonModifier3D.SecondaryDirection {
	return o.Super().GetPoleDirection(index)
}
func (o *Extension[T]) SetPoleDirectionVector(index int, vector Vector3.XYZ) *Extension[T] {
	o.Super().SetPoleDirectionVector(index, vector)
	return o
}
func (o *Extension[T]) GetPoleDirectionVector(index int) Vector3.XYZ {
	return o.Super().GetPoleDirectionVector(index)
}
...
func (o *Extension[T]) SetUseVirtualEnd(index int, enabled bool) *Extension[T] {
	o.Super().SetUseVirtualEnd(index, enabled)
	return o
}
func (o *Extension[T]) IsUsingVirtualEnd(index int) bool {
	return o.Super().IsUsingVirtualEnd(index)
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(IKModifier3D.Advanced(self.AsIKModifier3D()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(IKModifier3D.Instance(self.AsIKModifier3D()), name)
	}
}
func init() {gdclass.Register("TwoBoneIK3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewTwoBoneIK3D(ptr)} })}
