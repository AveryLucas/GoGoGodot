...
func (self class) XrResult(result int64, format String.Readable, args Array.Any) bool { //gd:OpenXRAPIExtension.xr_result
	var r_ret = noescape.Call[bool]( gd.ObjectChecked(self.AsObject()), methods.xr_result, gdextension.SizeBool|(gdextension.SizeInt<<4)|(gdextension.SizeString<<8)|(gdextension.SizeArray<<12), &struct{result int64; format gdextension.String; args gdextension.Array}{result, pointers.Get(gd.InternalString(format)), pointers.Get(gd.InternalArray(args))})
	var ret = r_ret
	return ret
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_object_name, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeString<<12), &struct{object_type int64; object_handle int64; object_name gdextension.String}{object_type, object_handle, pointers.Get(gd.InternalString(object_name))})
}
...
func (self class) FindAction(name String.Readable, action_set RID.Any) RID.Any { //gd:OpenXRAPIExtension.find_action
	var r_ret = noescape.Call[RID.Any]( gd.ObjectChecked(self.AsObject()), methods.find_action, gdextension.SizeRID|(gdextension.SizeString<<4)|(gdextension.SizeRID<<8), &struct{name gdextension.String; action_set RID.Any}{pointers.Get(gd.InternalString(name)), action_set})
	var ret = r_ret
	return ret
}
...
func (self class) OpenxrSwapchainCreate(create_flags int64, usage_flags int64, swapchain_format int64, width int64, height int64, sample_count int64, array_size int64) int64 { //gd:OpenXRAPIExtension.openxr_swapchain_create
	var r_ret = noescape.Call[int64]( gd.ObjectChecked(self.AsObject()), methods.openxr_swapchain_create, gdextension.SizeInt|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeInt<<16)|(gdextension.SizeInt<<20)|(gdextension.SizeInt<<24)|(gdextension.SizeInt<<28), &struct{create_flags int64; usage_flags int64; swapchain_format int64; width int64; height int64; sample_count int64; array_size int64}{create_flags, usage_flags, swapchain_format, width, height, sample_count, array_size})
	var ret = r_ret
	return ret
}
...
func init() {gdclass.Register("OpenXRAPIExtension", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRAPIExtension(ptr)} })}
