...
func (o *Extension[T]) ContentMarginLeft() Float.X { return o.Super().ContentMarginLeft() }
...
func (o *Extension[T]) SetContentMarginLeft(value Float.X) *Extension[T] {
	o.Super().SetContentMarginLeft(value)
	return o
}
...
func (o *Extension[T]) ContentMarginTop() Float.X { return o.Super().ContentMarginTop() }
...
func (o *Extension[T]) SetContentMarginTop(value Float.X) *Extension[T] {
	o.Super().SetContentMarginTop(value)
	return o
}
...
func (o *Extension[T]) ContentMarginRight() Float.X { return o.Super().ContentMarginRight() }
...
func (o *Extension[T]) SetContentMarginRight(value Float.X) *Extension[T] {
	o.Super().SetContentMarginRight(value)
	return o
}
...
func (o *Extension[T]) ContentMarginBottom() Float.X { return o.Super().ContentMarginBottom() }
...
func (o *Extension[T]) SetContentMarginBottom(value Float.X) *Extension[T] {
	o.Super().SetContentMarginBottom(value)
	return o
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_content_margin, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct{margin Rect2.Side; offset float64}{margin, offset})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.draw, 0|(gdextension.SizeRID<<4)|(gdextension.SizeRect2<<8), &struct{canvas_item RID.Any; rect Rect2.PositionSize}{canvas_item, rect})
}
...
func (self class) TestMask(point Vector2.XY, rect Rect2.PositionSize) bool { //gd:StyleBox.test_mask
	var r_ret = noescape.Call[bool]( gd.ObjectChecked(self.AsObject()), methods.test_mask, gdextension.SizeBool|(gdextension.SizeVector2<<4)|(gdextension.SizeRect2<<8), &struct{point Vector2.XY; rect Rect2.PositionSize}{point, rect})
	var ret = r_ret
	return ret
}
...
func init() {gdclass.Register("StyleBox", func(ptr gdreference.Object) any { return Instance{gdclass.NewStyleBox(ptr)} })}
