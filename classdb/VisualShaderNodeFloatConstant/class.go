...
import "github.com/AveryLucas/gogogd/classdb/VisualShaderNodeConstant"
...
func (o *Extension[T]) Constant() Float.X { return o.Super().Constant() }
...
func (o *Extension[T]) SetConstant(value Float.X) *Extension[T] {
	o.Super().SetConstant(value)
	return o
}
...
func (self class) GetConstant() float64 { //gd:VisualShaderNodeFloatConstant.get_constant
	var r_ret = noescape.Call[float64]( gd.ObjectChecked(self.AsObject()), methods.get_constant, gdextension.SizeFloat, &struct{}{})
	var ret = r_ret
	return ret
}
...
func (o class) AsVisualShaderNodeConstant() VisualShaderNodeConstant.Advanced { return *(*VisualShaderNodeConstant.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsVisualShaderNodeConstant() VisualShaderNodeConstant.Instance { return o.Super().AsVisualShaderNodeConstant() }
func (o Instance) AsVisualShaderNodeConstant() VisualShaderNodeConstant.Instance { return *(*VisualShaderNodeConstant.Instance)(ie.As(&o)) }
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(VisualShaderNodeConstant.Advanced(self.AsVisualShaderNodeConstant()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(VisualShaderNodeConstant.Instance(self.AsVisualShaderNodeConstant()), name)
	}
}
func init() {gdclass.Register("VisualShaderNodeFloatConstant", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeFloatConstant(ptr)} })}
