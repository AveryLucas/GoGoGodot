...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_vertex, 0|(gdextension.SizeInt<<4)|(gdextension.SizeVector3<<8), &struct{vertex_id int64; vertex Vector3.XYZ}{vertex_id, vertex})
}
func (self class) SetNormal(vertex_id int64, normal Vector3.XYZ)  { //gd:PhysicsServer3DRenderingServerHandler.set_normal
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_normal, 0|(gdextension.SizeInt<<4)|(gdextension.SizeVector3<<8), &struct{vertex_id int64; normal Vector3.XYZ}{vertex_id, normal})
}
...
func init() {gdclass.Register("PhysicsServer3DRenderingServerHandler", func(ptr gdreference.Object) any { return Instance{gdclass.NewPhysicsServer3DRenderingServerHandler(ptr)} })}
