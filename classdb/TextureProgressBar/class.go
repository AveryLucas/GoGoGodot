...
import "github.com/AveryLucas/gogogd/classdb/Range"
...
func (o *Extension[T]) FillMode() int { return o.Super().FillMode() }
...
func (o *Extension[T]) SetFillMode(value int) *Extension[T] {
	o.Super().SetFillMode(value)
	return o
}
...
func (o *Extension[T]) RadialInitialAngle() Angle.Radians { return o.Super().RadialInitialAngle() }
...
func (o *Extension[T]) SetRadialInitialAngle(value Angle.Radians) *Extension[T] {
	o.Super().SetRadialInitialAngle(value)
	return o
}
...
func (o *Extension[T]) RadialFillDegrees() Float.X { return o.Super().RadialFillDegrees() }
...
func (o *Extension[T]) SetRadialFillDegrees(value Float.X) *Extension[T] {
	o.Super().SetRadialFillDegrees(value)
	return o
}
...
func (o *Extension[T]) RadialCenterOffset() Vector2.XY { return o.Super().RadialCenterOffset() }
...
func (o *Extension[T]) SetRadialCenterOffset(value Vector2.XY) *Extension[T] {
	o.Super().SetRadialCenterOffset(value)
	return o
}
...
func (o *Extension[T]) NinePatchStretch() bool { return o.Super().NinePatchStretch() }
...
func (o *Extension[T]) SetNinePatchStretch(value bool) *Extension[T] {
	o.Super().SetNinePatchStretch(value)
	return o
}
...
func (o *Extension[T]) StretchMarginLeft() int { return o.Super().StretchMarginLeft() }
...
func (o *Extension[T]) SetStretchMarginLeft(value int) *Extension[T] {
	o.Super().SetStretchMarginLeft(value)
	return o
}
...
func (o *Extension[T]) StretchMarginTop() int { return o.Super().StretchMarginTop() }
...
func (o *Extension[T]) SetStretchMarginTop(value int) *Extension[T] {
	o.Super().SetStretchMarginTop(value)
	return o
}
...
func (o *Extension[T]) StretchMarginRight() int { return o.Super().StretchMarginRight() }
...
func (o *Extension[T]) SetStretchMarginRight(value int) *Extension[T] {
	o.Super().SetStretchMarginRight(value)
	return o
}
...
func (o *Extension[T]) StretchMarginBottom() int { return o.Super().StretchMarginBottom() }
...
func (o *Extension[T]) SetStretchMarginBottom(value int) *Extension[T] {
	o.Super().SetStretchMarginBottom(value)
	return o
}
...
func (o *Extension[T]) TextureUnder() Texture2D.Instance { return o.Super().TextureUnder() }
...
func (o *Extension[T]) SetTextureUnder(value Texture2D.Instance) *Extension[T] {
	o.Super().SetTextureUnder(value)
	return o
}
...
func (o *Extension[T]) TextureOver() Texture2D.Instance { return o.Super().TextureOver() }
...
func (o *Extension[T]) SetTextureOver(value Texture2D.Instance) *Extension[T] {
	o.Super().SetTextureOver(value)
	return o
}
...
func (o *Extension[T]) TextureProgress() Texture2D.Instance { return o.Super().TextureProgress() }
...
func (o *Extension[T]) SetTextureProgress(value Texture2D.Instance) *Extension[T] {
	o.Super().SetTextureProgress(value)
	return o
}
...
func (o *Extension[T]) TextureProgressOffset() Vector2.XY { return o.Super().TextureProgressOffset() }
...
func (o *Extension[T]) SetTextureProgressOffset(value Vector2.XY) *Extension[T] {
	o.Super().SetTextureProgressOffset(value)
	return o
}
...
func (o *Extension[T]) TintUnder() Color.RGBA { return o.Super().TintUnder() }
...
func (o *Extension[T]) SetTintUnder(value Color.RGBA) *Extension[T] {
	o.Super().SetTintUnder(value)
	return o
}
...
func (o *Extension[T]) TintOver() Color.RGBA { return o.Super().TintOver() }
...
func (o *Extension[T]) SetTintOver(value Color.RGBA) *Extension[T] {
	o.Super().SetTintOver(value)
	return o
}
...
func (o *Extension[T]) TintProgress() Color.RGBA { return o.Super().TintProgress() }
...
func (o *Extension[T]) SetTintProgress(value Color.RGBA) *Extension[T] {
	o.Super().SetTintProgress(value)
	return o
}
...
// OnValueChanged is promoted from [Range.Instance.OnValueChanged].
func (o *Extension[T]) OnValueChanged(cb func(value Float.X), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("value_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
// SetValueNoSignal is promoted from [Range.Instance.SetValueNoSignal].
func (self Instance) SetValueNoSignal(value Float.X) Instance {
	self.AsRange().SetValueNoSignal(value)
	return self
}

// SetValueNoSignal is promoted from [Range.Instance.SetValueNoSignal].
func (o *Extension[T]) SetValueNoSignal(value Float.X) *Extension[T] {
	o.Super().AsRange().SetValueNoSignal(value)
	return o
}

// Share is promoted from [Range.Instance.Share].
func (self Instance) Share(with Node.Instance) {
	self.AsRange().Share(with)
}

// Share is promoted from [Range.Instance.Share].
func (o *Extension[T]) Share(with Node.Instance) {
	o.Super().AsRange().Share(with)
}

// Unshare is promoted from [Range.Instance.Unshare].
func (self Instance) Unshare() {
	self.AsRange().Unshare()
}

// Unshare is promoted from [Range.Instance.Unshare].
func (o *Extension[T]) Unshare() {
	o.Super().AsRange().Unshare()
}
...
// MinValue is promoted from [Range.Instance.MinValue].
func (self Instance) MinValue() Float.X { return self.AsRange().MinValue() }
func (o *Extension[T]) MinValue() Float.X { return o.Super().AsRange().MinValue() }

// SetMinValue is promoted from [Range.Instance.SetMinValue].
func (self Instance) SetMinValue(value Float.X) Instance {
	self.AsRange().SetMinValue(value)
	return self
}
func (o *Extension[T]) SetMinValue(value Float.X) *Extension[T] {
	o.Super().AsRange().SetMinValue(value)
	return o
}

// MaxValue is promoted from [Range.Instance.MaxValue].
func (self Instance) MaxValue() Float.X { return self.AsRange().MaxValue() }
func (o *Extension[T]) MaxValue() Float.X { return o.Super().AsRange().MaxValue() }

// SetMaxValue is promoted from [Range.Instance.SetMaxValue].
func (self Instance) SetMaxValue(value Float.X) Instance {
	self.AsRange().SetMaxValue(value)
	return self
}
func (o *Extension[T]) SetMaxValue(value Float.X) *Extension[T] {
	o.Super().AsRange().SetMaxValue(value)
	return o
}

// Step is promoted from [Range.Instance.Step].
func (self Instance) Step() Float.X { return self.AsRange().Step() }
func (o *Extension[T]) Step() Float.X { return o.Super().AsRange().Step() }

// SetStep is promoted from [Range.Instance.SetStep].
func (self Instance) SetStep(value Float.X) Instance {
	self.AsRange().SetStep(value)
	return self
}
func (o *Extension[T]) SetStep(value Float.X) *Extension[T] {
	o.Super().AsRange().SetStep(value)
	return o
}

// Page is promoted from [Range.Instance.Page].
func (self Instance) Page() Float.X { return self.AsRange().Page() }
func (o *Extension[T]) Page() Float.X { return o.Super().AsRange().Page() }

// SetPage is promoted from [Range.Instance.SetPage].
func (self Instance) SetPage(value Float.X) Instance {
	self.AsRange().SetPage(value)
	return self
}
func (o *Extension[T]) SetPage(value Float.X) *Extension[T] {
	o.Super().AsRange().SetPage(value)
	return o
}

// Value is promoted from [Range.Instance.Value].
func (self Instance) Value() Float.X { return self.AsRange().Value() }
func (o *Extension[T]) Value() Float.X { return o.Super().AsRange().Value() }

// SetValue is promoted from [Range.Instance.SetValue].
func (self Instance) SetValue(value Float.X) Instance {
	self.AsRange().SetValue(value)
	return self
}
func (o *Extension[T]) SetValue(value Float.X) *Extension[T] {
	o.Super().AsRange().SetValue(value)
	return o
}

// Ratio is promoted from [Range.Instance.Ratio].
func (self Instance) Ratio() Float.X { return self.AsRange().Ratio() }
func (o *Extension[T]) Ratio() Float.X { return o.Super().AsRange().Ratio() }

// SetRatio is promoted from [Range.Instance.SetRatio].
func (self Instance) SetRatio(value Float.X) Instance {
	self.AsRange().SetRatio(value)
	return self
}
func (o *Extension[T]) SetRatio(value Float.X) *Extension[T] {
	o.Super().AsRange().SetRatio(value)
	return o
}

// ExpEdit is promoted from [Range.Instance.ExpEdit].
func (self Instance) ExpEdit() bool { return self.AsRange().ExpEdit() }
func (o *Extension[T]) ExpEdit() bool { return o.Super().AsRange().ExpEdit() }

// SetExpEdit is promoted from [Range.Instance.SetExpEdit].
func (self Instance) SetExpEdit(value bool) Instance {
	self.AsRange().SetExpEdit(value)
	return self
}
func (o *Extension[T]) SetExpEdit(value bool) *Extension[T] {
	o.Super().AsRange().SetExpEdit(value)
	return o
}

// Rounded is promoted from [Range.Instance.Rounded].
func (self Instance) Rounded() bool { return self.AsRange().Rounded() }
func (o *Extension[T]) Rounded() bool { return o.Super().AsRange().Rounded() }

// SetRounded is promoted from [Range.Instance.SetRounded].
func (self Instance) SetRounded(value bool) Instance {
	self.AsRange().SetRounded(value)
	return self
}
func (o *Extension[T]) SetRounded(value bool) *Extension[T] {
	o.Super().AsRange().SetRounded(value)
	return o
}

// AllowGreater is promoted from [Range.Instance.AllowGreater].
func (self Instance) AllowGreater() bool { return self.AsRange().AllowGreater() }
func (o *Extension[T]) AllowGreater() bool { return o.Super().AsRange().AllowGreater() }

// SetAllowGreater is promoted from [Range.Instance.SetAllowGreater].
func (self Instance) SetAllowGreater(value bool) Instance {
	self.AsRange().SetAllowGreater(value)
	return self
}
func (o *Extension[T]) SetAllowGreater(value bool) *Extension[T] {
	o.Super().AsRange().SetAllowGreater(value)
	return o
}

// AllowLesser is promoted from [Range.Instance.AllowLesser].
func (self Instance) AllowLesser() bool { return self.AsRange().AllowLesser() }
func (o *Extension[T]) AllowLesser() bool { return o.Super().AsRange().AllowLesser() }

// SetAllowLesser is promoted from [Range.Instance.SetAllowLesser].
func (self Instance) SetAllowLesser(value bool) Instance {
	self.AsRange().SetAllowLesser(value)
	return self
}
func (o *Extension[T]) SetAllowLesser(value bool) *Extension[T] {
	o.Super().AsRange().SetAllowLesser(value)
	return o
}
