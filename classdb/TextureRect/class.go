...
func (o *Extension[T]) ExpandMode() ExpandMode { return o.Super().ExpandMode() }
...
func (o *Extension[T]) SetExpandMode(value ExpandMode) *Extension[T] {
	o.Super().SetExpandMode(value)
	return o
}
