...
func (o *Extension[T]) Bind(path string) error {
	return o.Super().Bind(path)
}
func (o *Extension[T]) ConnectToHost(path string) error {
	return o.Super().ConnectToHost(path)
}
func (o *Extension[T]) GetConnectedPath() string {
	return o.Super().GetConnectedPath()
}
...
func init() {gdclass.Register("StreamPeerUDS", func(ptr gdreference.Object) any { return Instance{gdclass.NewStreamPeerUDS(ptr)} })}
