...
func (o *Extension[T]) OnPathChanged(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("path_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnTargetReached(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("target_reached"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnWaypointReached(cb func(details map[any]any), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("waypoint_reached"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnLinkReached(cb func(details map[any]any), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("link_reached"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnNavigationFinished(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("navigation_finished"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnVelocityComputed(cb func(safe_velocity Vector3.XYZ), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("velocity_computed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
