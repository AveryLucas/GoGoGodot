...
func (o *Extension[T]) Tracker() string { return o.Super().Tracker() }
...
func (o *Extension[T]) Pose() string { return o.Super().Pose() }
...
func (o *Extension[T]) ShowWhenTracked() bool { return o.Super().ShowWhenTracked() }
...
func (o *Extension[T]) SetShowWhenTracked(value bool) *Extension[T] {
	o.Super().SetShowWhenTracked(value)
	return o
}
...
func (o *Extension[T]) TriggerHapticPulse(action_name string, frequency Float.X, amplitude Float.X, duration_sec Float.X, delay_sec Float.X) {
	o.Super().TriggerHapticPulse(action_name, frequency, amplitude, duration_sec, delay_sec)
}
