...
import "github.com/AveryLucas/gogogd/classdb/AnimationNodeSync"
...
func (o *Extension[T]) SetInputCount(value int) *Extension[T] {
	o.Super().SetInputCount(value)
	return o
}
...
func (self Instance) Sync() bool { return self.AsAnimationNodeSync().Sync() }
...
func (self Instance) SetSync(value bool) Instance {
	self.AsAnimationNodeSync().SetSync(value)
	return self
}
