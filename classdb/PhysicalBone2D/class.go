...
import "github.com/AveryLucas/gogogd/classdb/Joint2D"
...
import "github.com/AveryLucas/gogogd/classdb/RigidBody2D"
...
func (o *Extension[T]) IsSimulatingPhysics() bool {
	return o.Super().IsSimulatingPhysics()
}

// GetContactCount is promoted from [RigidBody2D.Instance.GetContactCount].
func (self Instance) GetContactCount() int {
	return self.AsRigidBody2D().GetContactCount()
}

// GetContactCount is promoted from [RigidBody2D.Instance.GetContactCount].
func (o *Extension[T]) GetContactCount() int {
	return o.Super().AsRigidBody2D().GetContactCount()
}

// SetAxisVelocity is promoted from [RigidBody2D.Instance.SetAxisVelocity].
func (self Instance) SetAxisVelocity(axis_velocity Vector2.XY) Instance {
	self.AsRigidBody2D().SetAxisVelocity(axis_velocity)
	return self
}

// SetAxisVelocity is promoted from [RigidBody2D.Instance.SetAxisVelocity].
func (o *Extension[T]) SetAxisVelocity(axis_velocity Vector2.XY) *Extension[T] {
	o.Super().AsRigidBody2D().SetAxisVelocity(axis_velocity)
	return o
}

// ApplyTorqueImpulse is promoted from [RigidBody2D.Instance.ApplyTorqueImpulse].
func (self Instance) ApplyTorqueImpulse(torque Float.X) {
	self.AsRigidBody2D().ApplyTorqueImpulse(torque)
}

// ApplyTorqueImpulse is promoted from [RigidBody2D.Instance.ApplyTorqueImpulse].
func (o *Extension[T]) ApplyTorqueImpulse(torque Float.X) {
	o.Super().AsRigidBody2D().ApplyTorqueImpulse(torque)
}

// ApplyCentralForce is promoted from [RigidBody2D.Instance.ApplyCentralForce].
func (self Instance) ApplyCentralForce(force Vector2.XY) {
	self.AsRigidBody2D().ApplyCentralForce(force)
}

// ApplyCentralForce is promoted from [RigidBody2D.Instance.ApplyCentralForce].
func (o *Extension[T]) ApplyCentralForce(force Vector2.XY) {
	o.Super().AsRigidBody2D().ApplyCentralForce(force)
}

// ApplyTorque is promoted from [RigidBody2D.Instance.ApplyTorque].
func (self Instance) ApplyTorque(torque Float.X) {
	self.AsRigidBody2D().ApplyTorque(torque)
}

// ApplyTorque is promoted from [RigidBody2D.Instance.ApplyTorque].
func (o *Extension[T]) ApplyTorque(torque Float.X) {
	o.Super().AsRigidBody2D().ApplyTorque(torque)
}

// AddConstantCentralForce is promoted from [RigidBody2D.Instance.AddConstantCentralForce].
func (self Instance) AddConstantCentralForce(force Vector2.XY) {
	self.AsRigidBody2D().AddConstantCentralForce(force)
}

// AddConstantCentralForce is promoted from [RigidBody2D.Instance.AddConstantCentralForce].
func (o *Extension[T]) AddConstantCentralForce(force Vector2.XY) {
	o.Super().AsRigidBody2D().AddConstantCentralForce(force)
}

// AddConstantTorque is promoted from [RigidBody2D.Instance.AddConstantTorque].
func (self Instance) AddConstantTorque(torque Float.X) {
	self.AsRigidBody2D().AddConstantTorque(torque)
}

// AddConstantTorque is promoted from [RigidBody2D.Instance.AddConstantTorque].
func (o *Extension[T]) AddConstantTorque(torque Float.X) {
	o.Super().AsRigidBody2D().AddConstantTorque(torque)
}

// GetCollidingBodies is promoted from [RigidBody2D.Instance.GetCollidingBodies].
func (self Instance) GetCollidingBodies() []Node2D.Instance {
	return self.AsRigidBody2D().GetCollidingBodies()
}

// GetCollidingBodies is promoted from [RigidBody2D.Instance.GetCollidingBodies].
func (o *Extension[T]) GetCollidingBodies() []Node2D.Instance {
	return o.Super().AsRigidBody2D().GetCollidingBodies()
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(RigidBody2D.Advanced(self.AsRigidBody2D()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(RigidBody2D.Instance(self.AsRigidBody2D()), name)
	}
}
func init() {gdclass.Register("PhysicalBone2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewPhysicalBone2D(ptr)} })}
