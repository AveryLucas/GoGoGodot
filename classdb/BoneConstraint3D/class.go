...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_amount, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct{index int64; amount float64}{index, amount})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_apply_bone_name, 0|(gdextension.SizeInt<<4)|(gdextension.SizeString<<8), &struct{index int64; bone_name gdextension.String}{index, pointers.Get(gd.InternalString(bone_name))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_apply_bone, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct{index int64; bone int64}{index, bone})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_reference_type, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct{index int64; atype ReferenceType}{index, atype})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_reference_bone_name, 0|(gdextension.SizeInt<<4)|(gdextension.SizeString<<8), &struct{index int64; bone_name gdextension.String}{index, pointers.Get(gd.InternalString(bone_name))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_reference_bone, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct{index int64; bone int64}{index, bone})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_reference_node, 0|(gdextension.SizeInt<<4)|(gdextension.SizeNodePath<<8), &struct{index int64; node gdextension.NodePath}{index, pointers.Get(gd.InternalNodePath(node))})
}
...
func (o *Extension[T]) SetAmount(index int, amount Float.X) *Extension[T] {
	o.Super().SetAmount(index, amount)
	return o
}
func (o *Extension[T]) GetAmount(index int) Float.X {
	return o.Super().GetAmount(index)
}
func (o *Extension[T]) SetApplyBoneName(index int, bone_name string) *Extension[T] {
	o.Super().SetApplyBoneName(index, bone_name)
	return o
}
func (o *Extension[T]) GetApplyBoneName(index int) string {
	return o.Super().GetApplyBoneName(index)
}
func (o *Extension[T]) SetApplyBone(index int, bone int) *Extension[T] {
	o.Super().SetApplyBone(index, bone)
	return o
}
func (o *Extension[T]) GetApplyBone(index int) int {
	return o.Super().GetApplyBone(index)
}
func (o *Extension[T]) SetReferenceType(index int, atype ReferenceType) *Extension[T] {
	o.Super().SetReferenceType(index, atype)
	return o
}
func (o *Extension[T]) GetReferenceType(index int) ReferenceType {
	return o.Super().GetReferenceType(index)
}
func (o *Extension[T]) SetReferenceBoneName(index int, bone_name string) *Extension[T] {
	o.Super().SetReferenceBoneName(index, bone_name)
	return o
}
...
func (o *Extension[T]) SetReferenceBone(index int, bone int) *Extension[T] {
	o.Super().SetReferenceBone(index, bone)
	return o
}
...
func init() {gdclass.Register("BoneConstraint3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewBoneConstraint3D(ptr)} })}
