...
func (o *Extension[T]) Shape() Shape3D.Instance { return o.Super().Shape() }
...
func (o *Extension[T]) SetShape(value Shape3D.Instance) *Extension[T] {
...
func (o *Extension[T]) CollisionResult() []PhysicsDirectSpaceState3D_RestInfo { return o.Super().CollisionResult() }
...
func (o *Extension[T]) DebugShapeCustomColor() Color.RGBA { return o.Super().DebugShapeCustomColor() }
...
func (o *Extension[T]) SetDebugShapeCustomColor(value Color.RGBA) *Extension[T] {
	o.Super().SetDebugShapeCustomColor(value)
	return o
}
