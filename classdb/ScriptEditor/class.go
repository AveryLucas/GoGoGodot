...
import "github.com/AveryLucas/gogogd/classdb/PanelContainer"
import "github.com/AveryLucas/gogogd/classdb/Script"
import "github.com/AveryLucas/gogogd/classdb/ScriptEditorBase"
...
func (o *Extension[T]) OnEditorScriptChanged(cb func(script Script.Instance), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("editor_script_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnScriptClose(cb func(script Script.Instance), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("script_close"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) GetCurrentEditor() ScriptEditorBase.Instance {
	return o.Super().GetCurrentEditor()
}
func (o *Extension[T]) GetOpenScriptEditors() []ScriptEditorBase.Instance {
	return o.Super().GetOpenScriptEditors()
}
func (o *Extension[T]) GetBreakpoints() []string {
	return o.Super().GetBreakpoints()
}
func (o *Extension[T]) RegisterSyntaxHighlighter(syntax_highlighter EditorSyntaxHighlighter.Instance) {
	o.Super().RegisterSyntaxHighlighter(syntax_highlighter)
}
func (o *Extension[T]) UnregisterSyntaxHighlighter(syntax_highlighter EditorSyntaxHighlighter.Instance) {
	o.Super().UnregisterSyntaxHighlighter(syntax_highlighter)
}
func (o *Extension[T]) GotoLine(line_number int) {
	o.Super().GotoLine(line_number)
}
func (o *Extension[T]) GetCurrentScript() Script.Instance {
	return o.Super().GetCurrentScript()
}
func (o *Extension[T]) GetOpenScripts() []Script.Instance {
	return o.Super().GetOpenScripts()
}
func (o *Extension[T]) OpenScriptCreateDialog(base_name string, base_path string) {
	o.Super().OpenScriptCreateDialog(base_name, base_path)
}
func (o *Extension[T]) GotoHelp(topic string) {
	o.Super().GotoHelp(topic)
}
func (o *Extension[T]) UpdateDocsFromScript(script Script.Instance) {
	o.Super().UpdateDocsFromScript(script)
}
func (o *Extension[T]) ClearDocsFromScript(script Script.Instance) {
	o.Super().ClearDocsFromScript(script)
}
