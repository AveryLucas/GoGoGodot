...
func (o *Extension[T]) Bidirectional() bool { return o.Super().Bidirectional() }
...
func (o *Extension[T]) SetBidirectional(value bool) *Extension[T] {
	o.Super().SetBidirectional(value)
	return o
}
...
func (o *Extension[T]) EndPosition() Vector2.XY { return o.Super().EndPosition() }
...
func (o *Extension[T]) SetEndPosition(value Vector2.XY) *Extension[T] {
	o.Super().SetEndPosition(value)
	return o
}
...
func (o *Extension[T]) GetRid() RID.NavigationLink2D {
...
func (o *Extension[T]) SetGlobalStartPosition(position Vector2.XY) *Extension[T] {
	o.Super().SetGlobalStartPosition(position)
	return o
}
func (o *Extension[T]) GetGlobalStartPosition() Vector2.XY {
	return o.Super().GetGlobalStartPosition()
}
func (o *Extension[T]) SetGlobalEndPosition(position Vector2.XY) *Extension[T] {
	o.Super().SetGlobalEndPosition(position)
	return o
}
func (o *Extension[T]) GetGlobalEndPosition() Vector2.XY {
	return o.Super().GetGlobalEndPosition()
}
...
func init() {gdclass.Register("NavigationLink2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewNavigationLink2D(ptr)} })}
