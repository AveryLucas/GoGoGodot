...
func (o *Extension[T]) PositionOffset() Vector2.XY { return o.Super().PositionOffset() }
...
func (o *Extension[T]) SetPositionOffset(value Vector2.XY) *Extension[T] {
	o.Super().SetPositionOffset(value)
	return o
}
...
func (o *Extension[T]) Resizable() bool { return o.Super().Resizable() }
...
func (o *Extension[T]) Draggable() bool { return o.Super().Draggable() }
...
func (o *Extension[T]) Selected() bool { return o.Super().Selected() }
...
func (o *Extension[T]) ScalingMenus() bool { return o.Super().ScalingMenus() }
