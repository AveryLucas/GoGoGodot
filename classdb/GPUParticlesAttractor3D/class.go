...
func (o *Extension[T]) Directionality() Float.X { return o.Super().Directionality() }
...
func (o *Extension[T]) SetDirectionality(value Float.X) *Extension[T] {
	o.Super().SetDirectionality(value)
	return o
}
...
func init() {gdclass.Register("GPUParticlesAttractor3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewGPUParticlesAttractor3D(ptr)} })}
