...
import "github.com/AveryLucas/gogogd/classdb/VisibleOnScreenNotifier2D"
...
func (o *Extension[T]) EnableMode() EnableMode { return o.Super().EnableMode() }
...
func (o *Extension[T]) SetEnableMode(value EnableMode) *Extension[T] {
	o.Super().SetEnableMode(value)
	return o
}
...
func (o *Extension[T]) EnableNodePath() string { return o.Super().EnableNodePath() }
...
func (o *Extension[T]) SetEnableNodePath(value string) *Extension[T] {
	o.Super().SetEnableNodePath(value)
	return o
}
...
func (o class) AsVisibleOnScreenNotifier2D() VisibleOnScreenNotifier2D.Advanced { return *(*VisibleOnScreenNotifier2D.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsVisibleOnScreenNotifier2D() VisibleOnScreenNotifier2D.Instance { return o.Super().AsVisibleOnScreenNotifier2D() }
func (o Instance) AsVisibleOnScreenNotifier2D() VisibleOnScreenNotifier2D.Instance { return *(*VisibleOnScreenNotifier2D.Instance)(ie.As(&o)) }
...
// OnScreenEntered is promoted from [VisibleOnScreenNotifier2D.Instance.OnScreenEntered].
...
// OnScreenEntered is promoted from [VisibleOnScreenNotifier2D.Instance.OnScreenEntered].
func (o *Extension[T]) OnScreenEntered(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("screen_entered"), gd.NewCallable(cb), int64(flags_together))
	return o
}

// OnScreenExited is promoted from [VisibleOnScreenNotifier2D.Instance.OnScreenExited].
...
// OnScreenExited is promoted from [VisibleOnScreenNotifier2D.Instance.OnScreenExited].
func (o *Extension[T]) OnScreenExited(cb func(), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("screen_exited"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
// IsOnScreen is promoted from [VisibleOnScreenNotifier2D.Instance.IsOnScreen].
func (self Instance) IsOnScreen() bool {
	return self.AsVisibleOnScreenNotifier2D().IsOnScreen()
}

// IsOnScreen is promoted from [VisibleOnScreenNotifier2D.Instance.IsOnScreen].
func (o *Extension[T]) IsOnScreen() bool {
	return o.Super().AsVisibleOnScreenNotifier2D().IsOnScreen()
}
...
// Rect is promoted from [VisibleOnScreenNotifier2D.Instance.Rect].
func (self Instance) Rect() Rect2.PositionSize { return self.AsVisibleOnScreenNotifier2D().Rect() }
func (o *Extension[T]) Rect() Rect2.PositionSize { return o.Super().AsVisibleOnScreenNotifier2D().Rect() }

// SetRect is promoted from [VisibleOnScreenNotifier2D.Instance.SetRect].
func (self Instance) SetRect(value Rect2.PositionSize) Instance {
	self.AsVisibleOnScreenNotifier2D().SetRect(value)
	return self
}
func (o *Extension[T]) SetRect(value Rect2.PositionSize) *Extension[T] {
	o.Super().AsVisibleOnScreenNotifier2D().SetRect(value)
	return o
}

// ShowRect is promoted from [VisibleOnScreenNotifier2D.Instance.ShowRect].
func (self Instance) ShowRect() bool { return self.AsVisibleOnScreenNotifier2D().ShowRect() }
func (o *Extension[T]) ShowRect() bool { return o.Super().AsVisibleOnScreenNotifier2D().ShowRect() }

// SetShowRect is promoted from [VisibleOnScreenNotifier2D.Instance.SetShowRect].
func (self Instance) SetShowRect(value bool) Instance {
	self.AsVisibleOnScreenNotifier2D().SetShowRect(value)
	return self
}
func (o *Extension[T]) SetShowRect(value bool) *Extension[T] {
	o.Super().AsVisibleOnScreenNotifier2D().SetShowRect(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(VisibleOnScreenNotifier2D.Advanced(self.AsVisibleOnScreenNotifier2D()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(VisibleOnScreenNotifier2D.Instance(self.AsVisibleOnScreenNotifier2D()), name)
	}
}
func init() {gdclass.Register("VisibleOnScreenEnabler2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisibleOnScreenEnabler2D(ptr)} })}
