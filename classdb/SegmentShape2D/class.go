...
func (o *Extension[T]) A() Vector2.XY { return o.Super().A() }
...
func (o *Extension[T]) SetA(value Vector2.XY) *Extension[T] {
	o.Super().SetA(value)
	return o
}
...
func (o *Extension[T]) B() Vector2.XY { return o.Super().B() }
...
func (o *Extension[T]) SetB(value Vector2.XY) *Extension[T] {
	o.Super().SetB(value)
	return o
}
...
func init() {gdclass.Register("SegmentShape2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewSegmentShape2D(ptr)} })}
