...
import "github.com/AveryLucas/gogogd/classdb/ImageTextureLayered"
...
func (o class) AsImageTextureLayered() ImageTextureLayered.Advanced { return *(*ImageTextureLayered.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsImageTextureLayered() ImageTextureLayered.Instance { return o.Super().AsImageTextureLayered() }
func (o Instance) AsImageTextureLayered() ImageTextureLayered.Instance { return *(*ImageTextureLayered.Instance)(ie.As(&o)) }
...
// CreateFromImages is promoted from [ImageTextureLayered.Instance.CreateFromImages].
func (self Instance) CreateFromImages(images []Image.Instance) error {
	return self.AsImageTextureLayered().CreateFromImages(images)
}

// CreateFromImages is promoted from [ImageTextureLayered.Instance.CreateFromImages].
func (o *Extension[T]) CreateFromImages(images []Image.Instance) error {
	return o.Super().AsImageTextureLayered().CreateFromImages(images)
}

// UpdateLayer is promoted from [ImageTextureLayered.Instance.UpdateLayer].
func (self Instance) UpdateLayer(image Image.Instance, layer int) {
	self.AsImageTextureLayered().UpdateLayer(image, layer)
}

// UpdateLayer is promoted from [ImageTextureLayered.Instance.UpdateLayer].
func (o *Extension[T]) UpdateLayer(image Image.Instance, layer int) {
	o.Super().AsImageTextureLayered().UpdateLayer(image, layer)
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(ImageTextureLayered.Advanced(self.AsImageTextureLayered()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(ImageTextureLayered.Instance(self.AsImageTextureLayered()), name)
	}
}
func init() {gdclass.Register("Texture2DArray", func(ptr gdreference.Object) any { return Instance{gdclass.NewTexture2DArray(ptr)} })}
