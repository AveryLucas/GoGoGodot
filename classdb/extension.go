...
// ExtensionInherits can be embedded to have a Go extension class inherit another, this
// means they will show up nested in the Node selection menu within the editor. This is
// an advanced technique and any desired helper methods like AsNode, AsParent are not
