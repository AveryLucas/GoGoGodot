...
import "github.com/AveryLucas/gogogd/classdb/XRNode3D"
...
func (o *Extension[T]) OnInputVector2Changed(cb func(name string, value Vector2.XY), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
// OnTrackingChanged is promoted from [XRNode3D.Instance.OnTrackingChanged].
...
// OnTrackingChanged is promoted from [XRNode3D.Instance.OnTrackingChanged].
func (o *Extension[T]) OnTrackingChanged(cb func(tracking bool), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("tracking_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) IsButtonPressed(name string) bool {
	return o.Super().IsButtonPressed(name)
}
func (o *Extension[T]) GetInput(name string) any {
	return o.Super().GetInput(name)
}
func (o *Extension[T]) GetFloat(name string) Float.X {
	return o.Super().GetFloat(name)
}
func (o *Extension[T]) GetVector2(name string) Vector2.XY {
	return o.Super().GetVector2(name)
}
func (o *Extension[T]) GetTrackerHand() XRPositionalTracker.TrackerHand {
	return o.Super().GetTrackerHand()
}

// GetIsActive is promoted from [XRNode3D.Instance.GetIsActive].
func (self Instance) GetIsActive() bool {
	return self.AsXRNode3D().GetIsActive()
}

// GetIsActive is promoted from [XRNode3D.Instance.GetIsActive].
func (o *Extension[T]) GetIsActive() bool {
	return o.Super().AsXRNode3D().GetIsActive()
}

// GetHasTrackingData is promoted from [XRNode3D.Instance.GetHasTrackingData].
func (self Instance) GetHasTrackingData() bool {
	return self.AsXRNode3D().GetHasTrackingData()
}

// GetHasTrackingData is promoted from [XRNode3D.Instance.GetHasTrackingData].
func (o *Extension[T]) GetHasTrackingData() bool {
	return o.Super().AsXRNode3D().GetHasTrackingData()
}

// GetPose is promoted from [XRNode3D.Instance.GetPose].
func (self Instance) GetPose() XRPose.Instance {
	return self.AsXRNode3D().GetPose()
}

// GetPose is promoted from [XRNode3D.Instance.GetPose].
func (o *Extension[T]) GetPose() XRPose.Instance {
	return o.Super().AsXRNode3D().GetPose()
}

// TriggerHapticPulse is promoted from [XRNode3D.Instance.TriggerHapticPulse].
func (self Instance) TriggerHapticPulse(action_name string, frequency Float.X, amplitude Float.X, duration_sec Float.X, delay_sec Float.X) {
	self.AsXRNode3D().TriggerHapticPulse(action_name, frequency, amplitude, duration_sec, delay_sec)
}

// TriggerHapticPulse is promoted from [XRNode3D.Instance.TriggerHapticPulse].
func (o *Extension[T]) TriggerHapticPulse(action_name string, frequency Float.X, amplitude Float.X, duration_sec Float.X, delay_sec Float.X) {
	o.Super().AsXRNode3D().TriggerHapticPulse(action_name, frequency, amplitude, duration_sec, delay_sec)
}
...
// Tracker is promoted from [XRNode3D.Instance.Tracker].
func (self Instance) Tracker() string { return self.AsXRNode3D().Tracker() }
func (o *Extension[T]) Tracker() string { return o.Super().AsXRNode3D().Tracker() }

// SetTracker is promoted from [XRNode3D.Instance.SetTracker].
func (self Instance) SetTracker(value string) Instance {
	self.AsXRNode3D().SetTracker(value)
	return self
}
func (o *Extension[T]) SetTracker(value string) *Extension[T] {
	o.Super().AsXRNode3D().SetTracker(value)
	return o
}

// Pose is promoted from [XRNode3D.Instance.Pose].
func (self Instance) Pose() string { return self.AsXRNode3D().Pose() }
func (o *Extension[T]) Pose() string { return o.Super().AsXRNode3D().Pose() }

// SetPose is promoted from [XRNode3D.Instance.SetPose].
func (self Instance) SetPose(value string) Instance {
	self.AsXRNode3D().SetPose(value)
	return self
}
func (o *Extension[T]) SetPose(value string) *Extension[T] {
	o.Super().AsXRNode3D().SetPose(value)
	return o
}

// ShowWhenTracked is promoted from [XRNode3D.Instance.ShowWhenTracked].
func (self Instance) ShowWhenTracked() bool { return self.AsXRNode3D().ShowWhenTracked() }
func (o *Extension[T]) ShowWhenTracked() bool { return o.Super().AsXRNode3D().ShowWhenTracked() }

// SetShowWhenTracked is promoted from [XRNode3D.Instance.SetShowWhenTracked].
func (self Instance) SetShowWhenTracked(value bool) Instance {
	self.AsXRNode3D().SetShowWhenTracked(value)
	return self
}
func (o *Extension[T]) SetShowWhenTracked(value bool) *Extension[T] {
	o.Super().AsXRNode3D().SetShowWhenTracked(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(XRNode3D.Advanced(self.AsXRNode3D()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(XRNode3D.Instance(self.AsXRNode3D()), name)
	}
}
func init() {gdclass.Register("XRController3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewXRController3D(ptr)} })}
