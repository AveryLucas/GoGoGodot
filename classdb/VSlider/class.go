...
import "github.com/AveryLucas/gogogd/classdb/Slider"
...
// OnDragStarted is promoted from [Slider.Instance.OnDragStarted].
...
// OnDragEnded is promoted from [Slider.Instance.OnDragEnded].
...
// OnDragEnded is promoted from [Slider.Instance.OnDragEnded].
func (o *Extension[T]) OnDragEnded(cb func(value_changed bool), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
// Editable is promoted from [Slider.Instance.Editable].
func (self Instance) Editable() bool { return self.AsSlider().Editable() }
func (o *Extension[T]) Editable() bool { return o.Super().AsSlider().Editable() }

// SetEditable is promoted from [Slider.Instance.SetEditable].
func (self Instance) SetEditable(value bool) Instance {
	self.AsSlider().SetEditable(value)
	return self
}
func (o *Extension[T]) SetEditable(value bool) *Extension[T] {
	o.Super().AsSlider().SetEditable(value)
	return o
}

// Scrollable is promoted from [Slider.Instance.Scrollable].
func (self Instance) Scrollable() bool { return self.AsSlider().Scrollable() }
func (o *Extension[T]) Scrollable() bool { return o.Super().AsSlider().Scrollable() }

// SetScrollable is promoted from [Slider.Instance.SetScrollable].
func (self Instance) SetScrollable(value bool) Instance {
	self.AsSlider().SetScrollable(value)
	return self
}
func (o *Extension[T]) SetScrollable(value bool) *Extension[T] {
	o.Super().AsSlider().SetScrollable(value)
	return o
}

// TickCount is promoted from [Slider.Instance.TickCount].
func (self Instance) TickCount() int { return self.AsSlider().TickCount() }
func (o *Extension[T]) TickCount() int { return o.Super().AsSlider().TickCount() }

// SetTickCount is promoted from [Slider.Instance.SetTickCount].
func (self Instance) SetTickCount(value int) Instance {
	self.AsSlider().SetTickCount(value)
	return self
}
func (o *Extension[T]) SetTickCount(value int) *Extension[T] {
	o.Super().AsSlider().SetTickCount(value)
	return o
}

// TicksOnBorders is promoted from [Slider.Instance.TicksOnBorders].
func (self Instance) TicksOnBorders() bool { return self.AsSlider().TicksOnBorders() }
func (o *Extension[T]) TicksOnBorders() bool { return o.Super().AsSlider().TicksOnBorders() }

// SetTicksOnBorders is promoted from [Slider.Instance.SetTicksOnBorders].
func (self Instance) SetTicksOnBorders(value bool) Instance {
	self.AsSlider().SetTicksOnBorders(value)
	return self
}
func (o *Extension[T]) SetTicksOnBorders(value bool) *Extension[T] {
	o.Super().AsSlider().SetTicksOnBorders(value)
	return o
}

// TicksPosition is promoted from [Slider.Instance.TicksPosition].
func (self Instance) TicksPosition() Slider.TickPosition { return self.AsSlider().TicksPosition() }
func (o *Extension[T]) TicksPosition() Slider.TickPosition { return o.Super().AsSlider().TicksPosition() }

// SetTicksPosition is promoted from [Slider.Instance.SetTicksPosition].
func (self Instance) SetTicksPosition(value Slider.TickPosition) Instance {
	self.AsSlider().SetTicksPosition(value)
	return self
}
func (o *Extension[T]) SetTicksPosition(value Slider.TickPosition) *Extension[T] {
	o.Super().AsSlider().SetTicksPosition(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(Slider.Advanced(self.AsSlider()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(Slider.Instance(self.AsSlider()), name)
	}
}
func init() {gdclass.Register("VSlider", func(ptr gdreference.Object) any { return Instance{gdclass.NewVSlider(ptr)} })}
