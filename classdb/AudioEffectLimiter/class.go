...
func (o *Extension[T]) ThresholdDb() Float.X { return o.Super().ThresholdDb() }
...
func (o *Extension[T]) SetThresholdDb(value Float.X) *Extension[T] {
	o.Super().SetThresholdDb(value)
	return o
}
...
func (o *Extension[T]) SoftClipDb() Float.X { return o.Super().SoftClipDb() }
...
func (o *Extension[T]) SetSoftClipDb(value Float.X) *Extension[T] {
	o.Super().SetSoftClipDb(value)
	return o
}
...
func (o *Extension[T]) SoftClipRatio() Float.X { return o.Super().SoftClipRatio() }
...
func (o *Extension[T]) SetSoftClipRatio(value Float.X) *Extension[T] {
	o.Super().SetSoftClipRatio(value)
	return o
}
...
func init() {gdclass.Register("AudioEffectLimiter", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioEffectLimiter(ptr)} })}
