...
import "github.com/AveryLucas/gogogd/classdb/OpenXRIPBinding"
...
func (o *Extension[T]) InteractionProfilePath() string { return o.Super().InteractionProfilePath() }
...
func (o *Extension[T]) SetInteractionProfilePath(value string) *Extension[T] {
	o.Super().SetInteractionProfilePath(value)
	return o
}
...
func (o *Extension[T]) Bindings() []OpenXRIPBinding.Instance { return o.Super().Bindings() }
...
func (o *Extension[T]) SetBindings(value []OpenXRIPBinding.Instance) *Extension[T] {
	o.Super().SetBindings(value)
	return o
}
...
func (o *Extension[T]) BindingModifiers() []OpenXRIPBindingModifier.Instance { return o.Super().BindingModifiers() }
...
func (o *Extension[T]) SetBindingModifiers(value []OpenXRIPBindingModifier.Instance) *Extension[T] {
...
func (o *Extension[T]) GetBindingCount() int {
	return o.Super().GetBindingCount()
}
func (o *Extension[T]) GetBinding(index int) OpenXRIPBinding.Instance {
	return o.Super().GetBinding(index)
}
func (o *Extension[T]) GetBindingModifierCount() int {
	return o.Super().GetBindingModifierCount()
}
func (o *Extension[T]) GetBindingModifier(index int) OpenXRIPBindingModifier.Instance {
...
func init() {gdclass.Register("OpenXRInteractionProfile", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRInteractionProfile(ptr)} })}
