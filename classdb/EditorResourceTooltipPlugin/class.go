...
import "github.com/AveryLucas/gogogd/classdb/TextureRect"
...
func (o *Extension[T]) RequestThumbnail(path string, control TextureRect.Instance) {
	o.Super().RequestThumbnail(path, control)
}
