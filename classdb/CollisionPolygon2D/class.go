...
func (o *Extension[T]) BuildMode() BuildMode { return o.Super().BuildMode() }
...
func (o *Extension[T]) SetBuildMode(value BuildMode) *Extension[T] {
	o.Super().SetBuildMode(value)
	return o
}
...
func (o *Extension[T]) OneWayCollision() bool { return o.Super().OneWayCollision() }
...
func (o *Extension[T]) SetOneWayCollision(value bool) *Extension[T] {
	o.Super().SetOneWayCollision(value)
	return o
}
...
func (o *Extension[T]) OneWayCollisionMargin() Float.X { return o.Super().OneWayCollisionMargin() }
...
func (o *Extension[T]) SetOneWayCollisionMargin(value Float.X) *Extension[T] {
	o.Super().SetOneWayCollisionMargin(value)
	return o
}
