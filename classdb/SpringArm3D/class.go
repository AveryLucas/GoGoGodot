...
func (o *Extension[T]) SpringLength() Float.X { return o.Super().SpringLength() }
...
func (o *Extension[T]) SetSpringLength(value Float.X) *Extension[T] {
	o.Super().SetSpringLength(value)
	return o
}
...
func (o *Extension[T]) GetHitLength() Float.X {
	return o.Super().GetHitLength()
}
func (o *Extension[T]) AddExcludedObject(rid RID.Body3D) {
	o.Super().AddExcludedObject(rid)
}
func (o *Extension[T]) RemoveExcludedObject(rid RID.Body3D) bool {
	return o.Super().RemoveExcludedObject(rid)
}
func (o *Extension[T]) ClearExcludedObjects() {
	o.Super().ClearExcludedObjects()
}
...
func init() {gdclass.Register("SpringArm3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewSpringArm3D(ptr)} })}
