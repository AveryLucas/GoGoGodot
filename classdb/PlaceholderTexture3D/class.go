...
func (o *Extension[T]) Size() Vector3i.XYZ { return o.Super().Size() }
...
func (o *Extension[T]) SetSize(value Vector3i.XYZ) *Extension[T] {
...
func init() {gdclass.Register("PlaceholderTexture3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewPlaceholderTexture3D(ptr)} })}
