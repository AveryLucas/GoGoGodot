...
func (self class) Virtual(name string) reflect.Value {
	...
	case "_get_ip_modification": return reflect.ValueOf(self._get_ip_modification);
...
func init() {gdclass.Register("OpenXRBindingModifier", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRBindingModifier(ptr)} })}
