...
func (o *Extension[T]) BaseType() string { return o.Super().BaseType() }
...
func (o *Extension[T]) EditedResource() Resource.Instance { return o.Super().EditedResource() }
...
func (o *Extension[T]) SetEditedResource(value Resource.Instance) *Extension[T] {
	o.Super().SetEditedResource(value)
	return o
}
...
func (o *Extension[T]) ToggleMode() bool { return o.Super().ToggleMode() }
...
func (o *Extension[T]) GetAllowedTypes() []string {
	return o.Super().GetAllowedTypes()
}
func (o *Extension[T]) SetTogglePressed(pressed bool) *Extension[T] {
	o.Super().SetTogglePressed(pressed)
	return o
}
