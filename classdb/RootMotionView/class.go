...
func (o *Extension[T]) AnimationPath() string { return o.Super().AnimationPath() }
...
func (o *Extension[T]) SetAnimationPath(value string) *Extension[T] {
	o.Super().SetAnimationPath(value)
	return o
}
...
func (o *Extension[T]) ZeroY() bool { return o.Super().ZeroY() }
...
func (o *Extension[T]) SetZeroY(value bool) *Extension[T] {
	o.Super().SetZeroY(value)
	return o
}
