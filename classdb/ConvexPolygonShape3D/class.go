...
func (o *Extension[T]) Points() []Vector3.XYZ { return o.Super().Points() }
...
func (o *Extension[T]) SetPoints(value []Vector3.XYZ) *Extension[T] {
	o.Super().SetPoints(value)
	return o
}

func (self class) SetPoints(points Packed.Array[Vector3.XYZ])  { //gd:ConvexPolygonShape3D.set_points
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_points, 0|(gdextension.SizePackedArray<<4), &struct{points gdextension.PackedArray[Vector3.XYZ]}{pointers.Get(gd.InternalPacked[gd.PackedVector3Array, Vector3.XYZ](points))})
}
...
func init() {gdclass.Register("ConvexPolygonShape3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewConvexPolygonShape3D(ptr)} })}
