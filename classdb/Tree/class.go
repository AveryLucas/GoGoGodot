...
import "github.com/AveryLucas/gogogd/classdb/TreeItem"
...
func (o *Extension[T]) Columns() int { return o.Super().Columns() }
...
func (o *Extension[T]) ColumnTitlesVisible() bool { return o.Super().ColumnTitlesVisible() }
...
func (o *Extension[T]) SetColumnTitlesVisible(value bool) *Extension[T] {
	o.Super().SetColumnTitlesVisible(value)
	return o
}
...
func (o *Extension[T]) HideFolding() bool { return o.Super().HideFolding() }
...
func (o *Extension[T]) EnableRecursiveFolding() bool { return o.Super().EnableRecursiveFolding() }
...
func (o *Extension[T]) SetEnableRecursiveFolding(value bool) *Extension[T] {
	o.Super().SetEnableRecursiveFolding(value)
	return o
}
...
func (o *Extension[T]) EnableDragUnfolding() bool { return o.Super().EnableDragUnfolding() }
...
func (o *Extension[T]) SetEnableDragUnfolding(value bool) *Extension[T] {
	o.Super().SetEnableDragUnfolding(value)
	return o
}
...
func (o *Extension[T]) HideRoot() bool { return o.Super().HideRoot() }
...
func (o *Extension[T]) DropModeFlags() int { return o.Super().DropModeFlags() }
...
func (o *Extension[T]) SetDropModeFlags(value int) *Extension[T] {
	o.Super().SetDropModeFlags(value)
	return o
}
...
func (o *Extension[T]) AutoTooltip() bool { return o.Super().AutoTooltip() }
...
func (o *Extension[T]) ScrollHorizontalEnabled() bool { return o.Super().ScrollHorizontalEnabled() }
...
func (o *Extension[T]) SetScrollHorizontalEnabled(value bool) *Extension[T] {
	o.Super().SetScrollHorizontalEnabled(value)
	return o
}
...
func (o *Extension[T]) ScrollVerticalEnabled() bool { return o.Super().ScrollVerticalEnabled() }
...
func (o *Extension[T]) SetScrollVerticalEnabled(value bool) *Extension[T] {
	o.Super().SetScrollVerticalEnabled(value)
	return o
}
...
func (o *Extension[T]) OnCellSelected(cb func(), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("cell_selected"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnMultiSelected(cb func(item TreeItem.Instance, column int, selected bool), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
func (o *Extension[T]) OnItemMouseSelected(cb func(mouse_position Vector2.XY, mouse_button_index int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("item_mouse_selected"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnEmptyClicked(cb func(click_position Vector2.XY, mouse_button_index int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
...
func (o *Extension[T]) OnItemEdited(cb func(), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("item_edited"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnCustomItemClicked(cb func(mouse_button_index int), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("custom_item_clicked"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnItemIconDoubleClicked(cb func(), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("item_icon_double_clicked"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnItemCollapsed(cb func(item TreeItem.Instance), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("item_collapsed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnCheckPropagatedToItem(cb func(item TreeItem.Instance, column int), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("check_propagated_to_item"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnButtonClicked(cb func(item TreeItem.Instance, column int, id int, mouse_button_index int), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("button_clicked"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnCustomPopupEdited(cb func(arrow_clicked bool), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("custom_popup_edited"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) OnColumnTitleClicked(cb func(column int, mouse_button_index int), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("column_title_clicked"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnNothingSelected(cb func(), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("nothing_selected"), gd.NewCallable(cb), int64(flags_together))
	return o
}
