...
func (o *Extension[T]) Operation() Operation { return o.Super().Operation() }
...
func (o *Extension[T]) SetOperation(value Operation) *Extension[T] {
	o.Super().SetOperation(value)
	return o
}
...
func (o *Extension[T]) CalculateTangents() bool { return o.Super().CalculateTangents() }
...
func (o *Extension[T]) SetCalculateTangents(value bool) *Extension[T] {
	o.Super().SetCalculateTangents(value)
	return o
}
...
func (o *Extension[T]) UseCollision() bool { return o.Super().UseCollision() }
...
func (o *Extension[T]) BakeCollisionShape() ConcavePolygonShape3D.Instance {
	return o.Super().BakeCollisionShape()
}
func (o *Extension[T]) BakeStaticMesh() ArrayMesh.Instance {
	return o.Super().BakeStaticMesh()
}
