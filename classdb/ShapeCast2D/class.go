...
func (o *Extension[T]) Shape() Shape2D.Instance { return o.Super().Shape() }
...
func (o *Extension[T]) SetShape(value Shape2D.Instance) *Extension[T] {
...
func (o *Extension[T]) ExcludeParent() bool { return o.Super().ExcludeParent() }
...
func (o *Extension[T]) SetExcludeParent(value bool) *Extension[T] {
	o.Super().SetExcludeParent(value)
	return o
}
...
func (o *Extension[T]) MaxResults() int { return o.Super().MaxResults() }
...
func (o *Extension[T]) SetMaxResults(value int) *Extension[T] {
	o.Super().SetMaxResults(value)
	return o
}
...
func (o *Extension[T]) CollisionResult() []PhysicsDirectSpaceState2D_RestInfo { return o.Super().CollisionResult() }
