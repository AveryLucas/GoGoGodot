...
func (o *Extension[T]) Delta() Vector2.XY { return o.Super().Delta() }
...
func (o *Extension[T]) SetDelta(value Vector2.XY) *Extension[T] {
	o.Super().SetDelta(value)
	return o
}
...
func init() {gdclass.Register("InputEventPanGesture", func(ptr gdreference.Object) any { return Instance{gdclass.NewInputEventPanGesture(ptr)} })}
