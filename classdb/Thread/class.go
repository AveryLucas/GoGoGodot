...
func (self class) Start(callable Callable.Function, priority Priority) Error.Code { //gd:Thread.start
	var r_ret = noescape.Call[int64]( gd.ObjectChecked(self.AsObject()), methods.start, gdextension.SizeInt|(gdextension.SizeCallable<<4)|(gdextension.SizeInt<<8), &struct{callable gdextension.Callable; priority Priority}{pointers.Get(gd.InternalCallable(callable)), priority})
...
func (o *Extension[T]) GetId() string {
	return o.Super().GetId()
}
func (o *Extension[T]) IsStarted() bool {
	return o.Super().IsStarted()
}
func (o *Extension[T]) IsAlive() bool {
	return o.Super().IsAlive()
}
func (o *Extension[T]) WaitToFinish() any {
	return o.Super().WaitToFinish()
}
...
func init() {gdclass.Register("Thread", func(ptr gdreference.Object) any { return Instance{gdclass.NewThread(ptr)} })}
