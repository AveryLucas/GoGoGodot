...
import "github.com/AveryLucas/gogogd/classdb/StaticBody2D"
...
func (o *Extension[T]) SyncToPhysics() bool { return o.Super().SyncToPhysics() }
...
func (o *Extension[T]) SetSyncToPhysics(value bool) *Extension[T] {
	o.Super().SetSyncToPhysics(value)
	return o
}
...
// PhysicsMaterialOverride is promoted from [StaticBody2D.Instance.PhysicsMaterialOverride].
func (self Instance) PhysicsMaterialOverride() PhysicsMaterial.Instance { return self.AsStaticBody2D().PhysicsMaterialOverride() }
func (o *Extension[T]) PhysicsMaterialOverride() PhysicsMaterial.Instance { return o.Super().AsStaticBody2D().PhysicsMaterialOverride() }

// SetPhysicsMaterialOverride is promoted from [StaticBody2D.Instance.SetPhysicsMaterialOverride].
func (self Instance) SetPhysicsMaterialOverride(value PhysicsMaterial.Instance) Instance {
	self.AsStaticBody2D().SetPhysicsMaterialOverride(value)
	return self
}
func (o *Extension[T]) SetPhysicsMaterialOverride(value PhysicsMaterial.Instance) *Extension[T] {
	o.Super().AsStaticBody2D().SetPhysicsMaterialOverride(value)
	return o
}

// ConstantLinearVelocity is promoted from [StaticBody2D.Instance.ConstantLinearVelocity].
func (self Instance) ConstantLinearVelocity() Vector2.XY { return self.AsStaticBody2D().ConstantLinearVelocity() }
func (o *Extension[T]) ConstantLinearVelocity() Vector2.XY { return o.Super().AsStaticBody2D().ConstantLinearVelocity() }

// SetConstantLinearVelocity is promoted from [StaticBody2D.Instance.SetConstantLinearVelocity].
func (self Instance) SetConstantLinearVelocity(value Vector2.XY) Instance {
	self.AsStaticBody2D().SetConstantLinearVelocity(value)
	return self
}
func (o *Extension[T]) SetConstantLinearVelocity(value Vector2.XY) *Extension[T] {
	o.Super().AsStaticBody2D().SetConstantLinearVelocity(value)
	return o
}

// ConstantAngularVelocity is promoted from [StaticBody2D.Instance.ConstantAngularVelocity].
func (self Instance) ConstantAngularVelocity() Float.X { return self.AsStaticBody2D().ConstantAngularVelocity() }
func (o *Extension[T]) ConstantAngularVelocity() Float.X { return o.Super().AsStaticBody2D().ConstantAngularVelocity() }

// SetConstantAngularVelocity is promoted from [StaticBody2D.Instance.SetConstantAngularVelocity].
func (self Instance) SetConstantAngularVelocity(value Float.X) Instance {
	self.AsStaticBody2D().SetConstantAngularVelocity(value)
	return self
}
func (o *Extension[T]) SetConstantAngularVelocity(value Float.X) *Extension[T] {
	o.Super().AsStaticBody2D().SetConstantAngularVelocity(value)
	return o
}
