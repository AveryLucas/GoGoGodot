...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(OpenXRBindingModifier.Advanced(self.AsOpenXRBindingModifier()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(OpenXRBindingModifier.Instance(self.AsOpenXRBindingModifier()), name)
	}
}
func init() {gdclass.Register("OpenXRActionBindingModifier", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRActionBindingModifier(ptr)} })}
