...
func (self Instance) SourceCode() string { return self.AsScript().SourceCode() }
func (o *Extension[T]) SourceCode() string { return o.Super().AsScript().SourceCode() }

// SetSourceCode is promoted from [Script.Instance.SetSourceCode].
func (self Instance) SetSourceCode(value string) Instance {
	self.AsScript().SetSourceCode(value)
	return self
}
func (o *Extension[T]) SetSourceCode(value string) *Extension[T] {
	o.Super().AsScript().SetSourceCode(value)
	return o
}
