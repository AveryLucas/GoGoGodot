...
func (o *Extension[T]) ClearCurrent() {
	o.Super().ClearCurrent()
}
...
func init() {gdclass.Register("AudioListener2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioListener2D(ptr)} })}
