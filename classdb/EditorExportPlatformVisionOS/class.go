...
import "github.com/AveryLucas/gogogd/classdb/EditorExportPlatformAppleEmbedded"
...
func (o class) AsEditorExportPlatformAppleEmbedded() EditorExportPlatformAppleEmbedded.Advanced { return *(*EditorExportPlatformAppleEmbedded.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsEditorExportPlatformAppleEmbedded() EditorExportPlatformAppleEmbedded.Instance { return o.Super().AsEditorExportPlatformAppleEmbedded() }
func (o Instance) AsEditorExportPlatformAppleEmbedded() EditorExportPlatformAppleEmbedded.Instance { return *(*EditorExportPlatformAppleEmbedded.Instance)(ie.As(&o)) }
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(EditorExportPlatformAppleEmbedded.Advanced(self.AsEditorExportPlatformAppleEmbedded()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(EditorExportPlatformAppleEmbedded.Instance(self.AsEditorExportPlatformAppleEmbedded()), name)
	}
}
func init() {gdclass.Register("EditorExportPlatformVisionOS", func(ptr gdreference.Object) any { return Instance{gdclass.NewEditorExportPlatformVisionOS(ptr)} })}
type File struct {
Path string `gd:"path"`
Tags []string `gd:"tags"`
