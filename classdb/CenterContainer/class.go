...
func (o *Extension[T]) UseTopLeft() bool { return o.Super().UseTopLeft() }
...
func (o *Extension[T]) SetUseTopLeft(value bool) *Extension[T] {
	o.Super().SetUseTopLeft(value)
	return o
}
...
func init() {gdclass.Register("CenterContainer", func(ptr gdreference.Object) any { return Instance{gdclass.NewCenterContainer(ptr)} })}
