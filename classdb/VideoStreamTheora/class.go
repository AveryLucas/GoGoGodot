...
// File is promoted from [VideoStream.Instance.File].
func (self Instance) File() string { return self.AsVideoStream().File() }
func (o *Extension[T]) File() string { return o.Super().AsVideoStream().File() }

// SetFile is promoted from [VideoStream.Instance.SetFile].
func (self Instance) SetFile(value string) Instance {
	self.AsVideoStream().SetFile(value)
	return self
}
func (o *Extension[T]) SetFile(value string) *Extension[T] {
	o.Super().AsVideoStream().SetFile(value)
	return o
}
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(VideoStream.Advanced(self.AsVideoStream()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(VideoStream.Instance(self.AsVideoStream()), name)
	}
}
func init() {gdclass.Register("VideoStreamTheora", func(ptr gdreference.Object) any { return Instance{gdclass.NewVideoStreamTheora(ptr)} })}
