...
func (o *Extension[T]) Start(atype HashType) error {
	return o.Super().Start(atype)
}
func (o *Extension[T]) Update(chunk []byte) error {
	return o.Super().Update(chunk)
}
...
func init() {gdclass.Register("HashingContext", func(ptr gdreference.Object) any { return Instance{gdclass.NewHashingContext(ptr)} })}
