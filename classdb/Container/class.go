...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.fit_child_in_rect, 0|(gdextension.SizeObject<<4)|(gdextension.SizeRect2<<8), &struct{child gdextension.Object; rect Rect2.PositionSize}{	gdextension.Object(gdreference.GetObject(gdclass.GetControl(child[0])[0])), rect})
}
...
func (o *Extension[T]) FitChildInRect(child Control.Instance, rect Rect2.PositionSize) {
	o.Super().FitChildInRect(child, rect)
}
...
func init() {gdclass.Register("Container", func(ptr gdreference.Object) any { return Instance{gdclass.NewContainer(ptr)} })}
