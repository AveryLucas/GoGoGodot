...
func (o *Extension[T]) PortType() VisualShaderNode.PortType { return o.Super().PortType() }

func (self class) GetPortType() VisualShaderNode.PortType { //gd:VisualShaderNodeReroute.get_port_type
	var r_ret = noescape.Call[VisualShaderNode.PortType]( gd.ObjectChecked(self.AsObject()), methods.get_port_type, gdextension.SizeInt, &struct{}{})
	var ret = r_ret
	return ret
}
...
func init() {gdclass.Register("VisualShaderNodeReroute", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeReroute(ptr)} })}
