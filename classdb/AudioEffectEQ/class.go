...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_band_gain_db, 0|(gdextension.SizeInt<<4)|(gdextension.SizeFloat<<8), &struct{band_idx int64; volume_db float64}{band_idx, volume_db})
}
...
func (o *Extension[T]) SetBandGainDb(band_idx int, volume_db Float.X) *Extension[T] {
	o.Super().SetBandGainDb(band_idx, volume_db)
	return o
}
func (o *Extension[T]) GetBandGainDb(band_idx int) Float.X {
	return o.Super().GetBandGainDb(band_idx)
}
func (o *Extension[T]) GetBandCount() int {
	return o.Super().GetBandCount()
}
...
func init() {gdclass.Register("AudioEffectEQ", func(ptr gdreference.Object) any { return Instance{gdclass.NewAudioEffectEQ(ptr)} })}
