...
import "github.com/AveryLucas/gogogd/classdb/OpenXRBindingModifier"
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.setup, 0|(gdextension.SizeObject<<4)|(gdextension.SizeObject<<8), &struct{action_map gdextension.Object; binding_modifier gdextension.Object}{	gdextension.Object(gdreference.GetObject(gdclass.GetOpenXRActionMap(action_map[0])[0])), 	gdextension.Object(gdreference.GetObject(gdclass.GetOpenXRBindingModifier(binding_modifier[0])[0]))})
}
...
func (o *Extension[T]) OnBindingModifierRemoved(cb func(binding_modifier_editor Object.Instance), flags ...Signal.Flags) *Extension[T] {
	var flags_together Signal.Flags
	for _, flag := range flags {
		flags_together |= flag
	}
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("binding_modifier_removed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
...
func (o *Extension[T]) GetBindingModifier() OpenXRBindingModifier.Instance {
	return o.Super().GetBindingModifier()
}
func (o *Extension[T]) Setup(action_map OpenXRActionMap.Instance, binding_modifier OpenXRBindingModifier.Instance) {
	o.Super().Setup(action_map, binding_modifier)
}
...
func init() {gdclass.Register("OpenXRBindingModifierEditor", func(ptr gdreference.Object) any { return Instance{gdclass.NewOpenXRBindingModifierEditor(ptr)} })}
