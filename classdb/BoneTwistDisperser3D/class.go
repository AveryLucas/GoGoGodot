...
func (o *Extension[T]) GetReferenceBoneName(index int) string {
	return o.Super().GetReferenceBoneName(index)
}
func (o *Extension[T]) GetReferenceBone(index int) int {
	return o.Super().GetReferenceBone(index)
}
...
func (o *Extension[T]) SetTwistFromRest(index int, enabled bool) *Extension[T] {
	o.Super().SetTwistFromRest(index, enabled)
	return o
}
func (o *Extension[T]) IsTwistFromRest(index int) bool {
	return o.Super().IsTwistFromRest(index)
}
func (o *Extension[T]) SetTwistFrom(index int, from Quaternion.IJKX) *Extension[T] {
	o.Super().SetTwistFrom(index, from)
	return o
}
func (o *Extension[T]) GetTwistFrom(index int) Quaternion.IJKX {
	return o.Super().GetTwistFrom(index)
}
func (o *Extension[T]) SetDisperseMode(index int, disperse_mode DisperseMode) *Extension[T] {
	o.Super().SetDisperseMode(index, disperse_mode)
	return o
}
func (o *Extension[T]) GetDisperseMode(index int) DisperseMode {
	return o.Super().GetDisperseMode(index)
}
func (o *Extension[T]) SetWeightPosition(index int, weight_position Float.X) *Extension[T] {
	o.Super().SetWeightPosition(index, weight_position)
	return o
}
func (o *Extension[T]) GetWeightPosition(index int) Float.X {
	return o.Super().GetWeightPosition(index)
}
func (o *Extension[T]) SetDampingCurve(index int, curve Curve.Instance) *Extension[T] {
	o.Super().SetDampingCurve(index, curve)
	return o
}
func (o *Extension[T]) GetDampingCurve(index int) Curve.Instance {
	return o.Super().GetDampingCurve(index)
}
...
func (o *Extension[T]) GetJointTwistAmount(index int, joint int) Float.X {
	return o.Super().GetJointTwistAmount(index, joint)
}
func (o *Extension[T]) SetJointTwistAmount(index int, joint int, twist_amount Float.X) *Extension[T] {
	o.Super().SetJointTwistAmount(index, joint, twist_amount)
	return o
}
