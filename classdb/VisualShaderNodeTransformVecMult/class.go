...
func init() {gdclass.Register("VisualShaderNodeTransformVecMult", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeTransformVecMult(ptr)} })}
