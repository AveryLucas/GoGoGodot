...
func (o *Extension[T]) GetAdjustedTransform() Transform3D.BasisOrigin {
	return o.Super().GetAdjustedTransform()
}
...
func init() {gdclass.Register("XRPose", func(ptr gdreference.Object) any { return Instance{gdclass.NewXRPose(ptr)} })}
