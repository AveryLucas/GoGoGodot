...
import "github.com/AveryLucas/gogogd/classdb/TranslationDomain"
...
once.Do(singleton)
		var r_ret = noescape.Call[int64]( gdreference.GetObject(self.AsObject()[0]), methods.compare_locales, gdextension.SizeInt|(gdextension.SizeString<<4)|(gdextension.SizeString<<8), &struct{locale_a gdextension.String; locale_b gdextension.String}{pointers.Get(gd.InternalString(locale_a)), pointers.Get(gd.InternalString(locale_b))})
	var ret = r_ret
	return ret
}
...
once.Do(singleton)
		var r_ret = noescape.Call[gdextension.String]( gdreference.GetObject(self.AsObject()[0]), methods.standardize_locale, gdextension.SizeString|(gdextension.SizeString<<4)|(gdextension.SizeBool<<8), &struct{locale gdextension.String; add_defaults bool}{pointers.Get(gd.InternalString(locale)), add_defaults})
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
once.Do(singleton)
		var r_ret = noescape.Call[gdextension.StringName]( gdreference.GetObject(self.AsObject()[0]), methods.translate_plural, gdextension.SizeStringName|(gdextension.SizeStringName<<4)|(gdextension.SizeStringName<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeStringName<<16), &struct{message gdextension.StringName; plural_message gdextension.StringName; n int64; context gdextension.StringName}{pointers.Get(gd.InternalStringName(message)), pointers.Get(gd.InternalStringName(plural_message)), n, pointers.Get(gd.InternalStringName(context))})
	var ret = String.Name(String.Via(gd.StringNameProxy{}, pointers.Pack(pointers.New[gd.StringName](r_ret))))
	return ret
}
...
once.Do(singleton)
		var r_ret = noescape.Call[gdextension.Array]( gdreference.GetObject(self.AsObject()[0]), methods.find_translations, gdextension.SizeArray|(gdextension.SizeString<<4)|(gdextension.SizeBool<<8), &struct{locale gdextension.String; exact bool}{pointers.Get(gd.InternalString(locale)), exact})
	var ret = Array.Through(gd.ArrayProxy[[1]gdclass.Translation]{}, pointers.Pack(pointers.New[gd.Array](r_ret)))
	return ret
}
...
once.Do(singleton)
		var r_ret = noescape.Call[bool]( gdreference.GetObject(self.AsObject()[0]), methods.has_translation_for_locale, gdextension.SizeBool|(gdextension.SizeString<<4)|(gdextension.SizeBool<<8), &struct{locale gdextension.String; exact bool}{pointers.Get(gd.InternalString(locale)), exact})
	var ret = r_ret
	return ret
}
...
once.Do(singleton)
		var r_ret = noescape.Call[gdextension.String]( gdreference.GetObject(self.AsObject()[0]), methods.format_number, gdextension.SizeString|(gdextension.SizeString<<4)|(gdextension.SizeString<<8), &struct{number gdextension.String; locale gdextension.String}{pointers.Get(gd.InternalString(number)), pointers.Get(gd.InternalString(locale))})
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
once.Do(singleton)
		var r_ret = noescape.Call[gdextension.String]( gdreference.GetObject(self.AsObject()[0]), methods.parse_number, gdextension.SizeString|(gdextension.SizeString<<4)|(gdextension.SizeString<<8), &struct{number gdextension.String; locale gdextension.String}{pointers.Get(gd.InternalString(number)), pointers.Get(gd.InternalString(locale))})
	var ret = String.Via(gd.StringProxy{}, pointers.Pack(pointers.New[gd.String](r_ret)))
	return ret
}
...
func init() {gdclass.Register("TranslationServer", func(ptr gdreference.Object) any { return Instance{gdclass.NewTranslationServer(ptr)} })}
