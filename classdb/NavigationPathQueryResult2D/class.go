...
func (o *Extension[T]) Path() []Vector2.XY { return o.Super().Path() }
...
func (o *Extension[T]) SetPath(value []Vector2.XY) *Extension[T] {
...
func (o *Extension[T]) PathRids() []RID.Either[RID.NavigationLink2D,RID.NavigationRegion2D] { return o.Super().PathRids() }
...
func (o *Extension[T]) SetPathRids(value []RID.Either[RID.NavigationLink2D,RID.NavigationRegion2D]) *Extension[T] {
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_path, 0|(gdextension.SizePackedArray<<4), &struct{path gdextension.PackedArray[Vector2.XY]}{pointers.Get(gd.InternalPacked[gd.PackedVector2Array, Vector2.XY](path))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_path_types, 0|(gdextension.SizePackedArray<<4), &struct{path_types gdextension.PackedArray[int32]}{pointers.Get(gd.InternalPacked[gd.PackedInt32Array, int32](path_types))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_path_owner_ids, 0|(gdextension.SizePackedArray<<4), &struct{path_owner_ids gdextension.PackedArray[int64]}{pointers.Get(gd.InternalPacked[gd.PackedInt64Array, int64](path_owner_ids))})
}
...
func init() {gdclass.Register("NavigationPathQueryResult2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewNavigationPathQueryResult2D(ptr)} })}
