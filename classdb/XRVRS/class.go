...
func (self class) MakeVrsTexture(target_size Vector2.XY, eye_foci Packed.Array[Vector2.XY]) RID.Any { //gd:XRVRS.make_vrs_texture
	var r_ret = noescape.Call[RID.Any]( gd.ObjectChecked(self.AsObject()), methods.make_vrs_texture, gdextension.SizeRID|(gdextension.SizeVector2<<4)|(gdextension.SizePackedArray<<8), &struct{target_size Vector2.XY; eye_foci gdextension.PackedArray[Vector2.XY]}{target_size, pointers.Get(gd.InternalPacked[gd.PackedVector2Array, Vector2.XY](eye_foci))})
	var ret = r_ret
	return ret
}
...
func init() {gdclass.Register("XRVRS", func(ptr gdreference.Object) any { return Instance{gdclass.NewXRVRS(ptr)} })}
