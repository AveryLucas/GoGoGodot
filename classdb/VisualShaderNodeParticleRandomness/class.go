...
func init() {gdclass.Register("VisualShaderNodeParticleRandomness", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeParticleRandomness(ptr)} })}
