...
import "github.com/AveryLucas/gogogd/classdb/VisualShaderNodeOutput"
...
func (o class) AsVisualShaderNodeOutput() VisualShaderNodeOutput.Advanced { return *(*VisualShaderNodeOutput.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsVisualShaderNodeOutput() VisualShaderNodeOutput.Instance { return o.Super().AsVisualShaderNodeOutput() }
func (o Instance) AsVisualShaderNodeOutput() VisualShaderNodeOutput.Instance { return *(*VisualShaderNodeOutput.Instance)(ie.As(&o)) }
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(VisualShaderNodeOutput.Advanced(self.AsVisualShaderNodeOutput()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(VisualShaderNodeOutput.Instance(self.AsVisualShaderNodeOutput()), name)
	}
}
func init() {gdclass.Register("VisualShaderNodeParticleOutput", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeParticleOutput(ptr)} })}
