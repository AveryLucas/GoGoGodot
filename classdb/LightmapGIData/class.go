...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.add_user, 0|(gdextension.SizeNodePath<<4)|(gdextension.SizeRect2<<8)|(gdextension.SizeInt<<12)|(gdextension.SizeInt<<16), &struct{path gdextension.NodePath; uv_scale Rect2.PositionSize; slice_index int64; sub_instance int64}{pointers.Get(gd.InternalNodePath(path)), uv_scale, slice_index, sub_instance})
}
...
func (o *Extension[T]) AddUser(path string, uv_scale Rect2.PositionSize, slice_index int, sub_instance int) {
	o.Super().AddUser(path, uv_scale, slice_index, sub_instance)
}
func (o *Extension[T]) GetUserCount() int {
	return o.Super().GetUserCount()
}
func (o *Extension[T]) GetUserPath(user_idx int) string {
	return o.Super().GetUserPath(user_idx)
}
func (o *Extension[T]) ClearUsers() {
	o.Super().ClearUsers()
}
...
func init() {gdclass.Register("LightmapGIData", func(ptr gdreference.Object) any { return Instance{gdclass.NewLightmapGIData(ptr)} })}
