...
func init() {gdclass.Register("VisualShaderNodeParticleSphereEmitter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeParticleSphereEmitter(ptr)} })}
