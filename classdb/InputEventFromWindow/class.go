...
func (o *Extension[T]) WindowId() int { return o.Super().WindowId() }
...
func init() {gdclass.Register("InputEventFromWindow", func(ptr gdreference.Object) any { return Instance{gdclass.NewInputEventFromWindow(ptr)} })}
