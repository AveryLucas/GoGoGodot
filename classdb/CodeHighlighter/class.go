...
import "github.com/AveryLucas/gogogd/classdb/SyntaxHighlighter"
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.add_keyword_color, 0|(gdextension.SizeString<<4)|(gdextension.SizeColor<<8), &struct{keyword gdextension.String; color Color.RGBA}{pointers.Get(gd.InternalString(keyword)), color})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.add_member_keyword_color, 0|(gdextension.SizeString<<4)|(gdextension.SizeColor<<8), &struct{member_keyword gdextension.String; color Color.RGBA}{pointers.Get(gd.InternalString(member_keyword)), color})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.add_color_region, 0|(gdextension.SizeString<<4)|(gdextension.SizeString<<8)|(gdextension.SizeColor<<12)|(gdextension.SizeBool<<16), &struct{start_key gdextension.String; end_key gdextension.String; color Color.RGBA; line_only bool}{pointers.Get(gd.InternalString(start_key)), pointers.Get(gd.InternalString(end_key)), color, line_only})
}
...
func (o class) AsSyntaxHighlighter() SyntaxHighlighter.Advanced { return *(*SyntaxHighlighter.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsSyntaxHighlighter() SyntaxHighlighter.Instance { return o.Super().AsSyntaxHighlighter() }
func (o Instance) AsSyntaxHighlighter() SyntaxHighlighter.Instance { return *(*SyntaxHighlighter.Instance)(ie.As(&o)) }
...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(SyntaxHighlighter.Advanced(self.AsSyntaxHighlighter()), name)
	}
}

func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(SyntaxHighlighter.Instance(self.AsSyntaxHighlighter()), name)
	}
}
