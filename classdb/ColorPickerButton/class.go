...
import "github.com/AveryLucas/gogogd/classdb/ColorPicker"
...
import "github.com/AveryLucas/gogogd/classdb/PopupPanel"
...
func (o *Extension[T]) EditAlpha() bool { return o.Super().EditAlpha() }
...
func (o *Extension[T]) EditIntensity() bool { return o.Super().EditIntensity() }
...
func (o *Extension[T]) SetEditIntensity(value bool) *Extension[T] {
	o.Super().SetEditIntensity(value)
	return o
}
...
func (o *Extension[T]) OnColorChanged(cb func(color Color.RGBA), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("color_changed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnPopupClosed(cb func(), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("popup_closed"), gd.NewCallable(cb), int64(flags_together))
	return o
}
func (o *Extension[T]) OnPickerCreated(cb func(), flags ...Signal.Flags) *Extension[T] {
	...
	gd.ObjectConnect(o.AsObject()[0], gd.NewStringName("picker_created"), gd.NewCallable(cb), int64(flags_together))
	return o
}
