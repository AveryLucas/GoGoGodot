...
func (o *Extension[T]) Scrollable() bool { return o.Super().Scrollable() }
...
func (o *Extension[T]) TickCount() int { return o.Super().TickCount() }
...
func (o *Extension[T]) TicksOnBorders() bool { return o.Super().TicksOnBorders() }
...
func (o *Extension[T]) SetTicksOnBorders(value bool) *Extension[T] {
	o.Super().SetTicksOnBorders(value)
	return o
}
...
func (o *Extension[T]) TicksPosition() TickPosition { return o.Super().TicksPosition() }
...
func (o *Extension[T]) SetTicksPosition(value TickPosition) *Extension[T] {
	o.Super().SetTicksPosition(value)
	return o
}
...
func init() {gdclass.Register("Slider", func(ptr gdreference.Object) any { return Instance{gdclass.NewSlider(ptr)} })}
