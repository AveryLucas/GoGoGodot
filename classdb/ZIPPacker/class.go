...
func (self class) Open(path String.Readable, append ZipAppend) Error.Code { //gd:ZIPPacker.open
	var r_ret = noescape.Call[int64]( gd.ObjectChecked(self.AsObject()), methods.open, gdextension.SizeInt|(gdextension.SizeString<<4)|(gdextension.SizeInt<<8), &struct{path gdextension.String; append ZipAppend}{pointers.Get(gd.InternalString(path)), append})
...
func (o *Extension[T]) StartFile(path string) error {
	return o.Super().StartFile(path)
}
func (o *Extension[T]) WriteFile(data []byte) error {
	return o.Super().WriteFile(data)
}
func (o *Extension[T]) CloseFile() error {
	return o.Super().CloseFile()
}
...
func init() {gdclass.Register("ZIPPacker", func(ptr gdreference.Object) any { return Instance{gdclass.NewZIPPacker(ptr)} })}
