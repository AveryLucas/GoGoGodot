...
func (self class) Virtual(name string) reflect.Value {
	switch name {
	case "_log_error": return reflect.ValueOf(self._log_error);
	case "_log_message": return reflect.ValueOf(self._log_message);
...
func init() {gdclass.Register("Logger", func(ptr gdreference.Object) any { return Instance{gdclass.NewLogger(ptr)} })}
