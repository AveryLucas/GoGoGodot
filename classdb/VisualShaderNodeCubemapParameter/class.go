...
func init() {gdclass.Register("VisualShaderNodeCubemapParameter", func(ptr gdreference.Object) any { return Instance{gdclass.NewVisualShaderNodeCubemapParameter(ptr)} })}
