...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.move_stacked_outline, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct{from_index int64; to_position int64}{from_index, to_position})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_stacked_outline_size, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct{index int64; size int64}{index, size})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_stacked_outline_color, 0|(gdextension.SizeInt<<4)|(gdextension.SizeColor<<8), &struct{index int64; color Color.RGBA}{index, color})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.move_stacked_shadow, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct{from_index int64; to_position int64}{from_index, to_position})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_stacked_shadow_offset, 0|(gdextension.SizeInt<<4)|(gdextension.SizeVector2<<8), &struct{index int64; offset Vector2.XY}{index, offset})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_stacked_shadow_color, 0|(gdextension.SizeInt<<4)|(gdextension.SizeColor<<8), &struct{index int64; color Color.RGBA}{index, color})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_stacked_shadow_outline_size, 0|(gdextension.SizeInt<<4)|(gdextension.SizeInt<<8), &struct{index int64; size int64}{index, size})
}
...
func (o *Extension[T]) MoveStackedOutline(from_index int, to_position int) {
	o.Super().MoveStackedOutline(from_index, to_position)
}
func (o *Extension[T]) RemoveStackedOutline(index int) {
	o.Super().RemoveStackedOutline(index)
}
func (o *Extension[T]) SetStackedOutlineSize(index int, size int) *Extension[T] {
	o.Super().SetStackedOutlineSize(index, size)
	return o
}
func (o *Extension[T]) GetStackedOutlineSize(index int) int {
	return o.Super().GetStackedOutlineSize(index)
}
func (o *Extension[T]) SetStackedOutlineColor(index int, color Color.RGBA) *Extension[T] {
	o.Super().SetStackedOutlineColor(index, color)
	return o
}
func (o *Extension[T]) GetStackedOutlineColor(index int) Color.RGBA {
	return o.Super().GetStackedOutlineColor(index)
}
func (o *Extension[T]) MoveStackedShadow(from_index int, to_position int) {
	o.Super().MoveStackedShadow(from_index, to_position)
}
func (o *Extension[T]) RemoveStackedShadow(index int) {
	o.Super().RemoveStackedShadow(index)
}
func (o *Extension[T]) SetStackedShadowOffset(index int, offset Vector2.XY) *Extension[T] {
	o.Super().SetStackedShadowOffset(index, offset)
	return o
}
func (o *Extension[T]) GetStackedShadowOffset(index int) Vector2.XY {
	return o.Super().GetStackedShadowOffset(index)
}
func (o *Extension[T]) SetStackedShadowColor(index int, color Color.RGBA) *Extension[T] {
	o.Super().SetStackedShadowColor(index, color)
	return o
}
func (o *Extension[T]) GetStackedShadowColor(index int) Color.RGBA {
	return o.Super().GetStackedShadowColor(index)
}
func (o *Extension[T]) SetStackedShadowOutlineSize(index int, size int) *Extension[T] {
	o.Super().SetStackedShadowOutlineSize(index, size)
	return o
}
func (o *Extension[T]) GetStackedShadowOutlineSize(index int) int {
	return o.Super().GetStackedShadowOutlineSize(index)
}
...
func init() {gdclass.Register("LabelSettings", func(ptr gdreference.Object) any { return Instance{gdclass.NewLabelSettings(ptr)} })}
