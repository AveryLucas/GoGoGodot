...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.disconnect_peer, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct{peer int64; force bool}{peer, force})
}
...
func init() {gdclass.Register("MultiplayerPeer", func(ptr gdreference.Object) any { return Instance{gdclass.NewMultiplayerPeer(ptr)} })}
