...
func (o *Extension[T]) MaxAngularVelocity() Float.X { return o.Super().MaxAngularVelocity() }
...
func (o *Extension[T]) SetMaxAngularVelocity(value Float.X) *Extension[T] {
	o.Super().SetMaxAngularVelocity(value)
	return o
}
...
func (o *Extension[T]) Exclude() bool { return o.Super().Exclude() }
...
func (o *Extension[T]) SetExclude(value bool) *Extension[T] {
...
func (o *Extension[T]) ChainCount() int { return o.Super().ChainCount() }
...
func (o *Extension[T]) SetChainCount(value int) *Extension[T] {
	o.Super().SetChainCount(value)
	return o
}
...
func (o *Extension[T]) ClearChains() {
	o.Super().ClearChains()
}
...
func init() {gdclass.Register("LimitAngularVelocityModifier3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewLimitAngularVelocityModifier3D(ptr)} })}
