...
func (o *Extension[T]) Underline() UnderlineMode { return o.Super().Underline() }
...
func (o *Extension[T]) SetUnderline(value UnderlineMode) *Extension[T] {
	o.Super().SetUnderline(value)
	return o
}
...
func (o *Extension[T]) Uri() string { return o.Super().Uri() }
...
func (o *Extension[T]) SetUri(value string) *Extension[T] {
	o.Super().SetUri(value)
	return o
}
