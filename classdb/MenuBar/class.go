...
func (o *Extension[T]) StartIndex() int { return o.Super().StartIndex() }
...
func (o *Extension[T]) SetStartIndex(value int) *Extension[T] {
	o.Super().SetStartIndex(value)
	return o
}
...
func (o *Extension[T]) PreferGlobalMenu() bool { return o.Super().PreferGlobalMenu() }
...
func (o *Extension[T]) SetPreferGlobalMenu(value bool) *Extension[T] {
	o.Super().SetPreferGlobalMenu(value)
	return o
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_menu_title, 0|(gdextension.SizeInt<<4)|(gdextension.SizeString<<8), &struct{menu int64; title gdextension.String}{menu, pointers.Get(gd.InternalString(title))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_menu_tooltip, 0|(gdextension.SizeInt<<4)|(gdextension.SizeString<<8), &struct{menu int64; tooltip gdextension.String}{menu, pointers.Get(gd.InternalString(tooltip))})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_menu_disabled, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct{menu int64; disabled bool}{menu, disabled})
}
...
noescape.Call[struct{}]( gd.ObjectChecked(self.AsObject()), methods.set_menu_hidden, 0|(gdextension.SizeInt<<4)|(gdextension.SizeBool<<8), &struct{menu int64; hidden bool}{menu, hidden})
}
...
func (o *Extension[T]) GetMenuCount() int {
	return o.Super().GetMenuCount()
}
func (o *Extension[T]) SetMenuTitle(menu int, title string) *Extension[T] {
	o.Super().SetMenuTitle(menu, title)
	return o
}
func (o *Extension[T]) GetMenuTitle(menu int) string {
	return o.Super().GetMenuTitle(menu)
}
func (o *Extension[T]) SetMenuTooltip(menu int, tooltip string) *Extension[T] {
	o.Super().SetMenuTooltip(menu, tooltip)
	return o
}
func (o *Extension[T]) GetMenuTooltip(menu int) string {
	return o.Super().GetMenuTooltip(menu)
}
func (o *Extension[T]) SetMenuDisabled(menu int, disabled bool) *Extension[T] {
	o.Super().SetMenuDisabled(menu, disabled)
	return o
}
func (o *Extension[T]) IsMenuDisabled(menu int) bool {
	return o.Super().IsMenuDisabled(menu)
}
func (o *Extension[T]) SetMenuHidden(menu int, hidden bool) *Extension[T] {
	o.Super().SetMenuHidden(menu, hidden)
	return o
}
func (o *Extension[T]) IsMenuHidden(menu int) bool {
	return o.Super().IsMenuHidden(menu)
}
func (o *Extension[T]) GetMenuPopup(menu int) PopupMenu.Instance {
	return o.Super().GetMenuPopup(menu)
}
...
func init() {gdclass.Register("MenuBar", func(ptr gdreference.Object) any { return Instance{gdclass.NewMenuBar(ptr)} })}
