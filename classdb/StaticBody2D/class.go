...
func (o *Extension[T]) ConstantLinearVelocity() Vector2.XY { return o.Super().ConstantLinearVelocity() }
...
func (o *Extension[T]) SetConstantLinearVelocity(value Vector2.XY) *Extension[T] {
	o.Super().SetConstantLinearVelocity(value)
	return o
}
...
func (o *Extension[T]) ConstantAngularVelocity() Float.X { return o.Super().ConstantAngularVelocity() }
...
func (o *Extension[T]) SetConstantAngularVelocity(value Float.X) *Extension[T] {
	o.Super().SetConstantAngularVelocity(value)
	return o
}
...
func init() {gdclass.Register("StaticBody2D", func(ptr gdreference.Object) any { return Instance{gdclass.NewStaticBody2D(ptr)} })}
