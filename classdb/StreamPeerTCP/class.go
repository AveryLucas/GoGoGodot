...
import "github.com/AveryLucas/gogogd/classdb/StreamPeerSocket"
...
func (self class) Bind(port int64, host String.Readable) Error.Code { //gd:StreamPeerTCP.bind
	var r_ret = noescape.Call[int64]( gd.ObjectChecked(self.AsObject()), methods.bind, gdextension.SizeInt|(gdextension.SizeInt<<4)|(gdextension.SizeString<<8), &struct{port int64; host gdextension.String}{port, pointers.Get(gd.InternalString(host))})
...
func (o class) AsStreamPeerSocket() StreamPeerSocket.Advanced { return *(*StreamPeerSocket.Advanced)(ie.As(&o)) }
func (o *Extension[T]) AsStreamPeerSocket() StreamPeerSocket.Instance { return o.Super().AsStreamPeerSocket() }
func (o Instance) AsStreamPeerSocket() StreamPeerSocket.Instance { return *(*StreamPeerSocket.Instance)(ie.As(&o)) }
...
// Poll is promoted from [StreamPeerSocket.Instance.Poll].
func (self Instance) Poll() error {
	return self.AsStreamPeerSocket().Poll()
}

// Poll is promoted from [StreamPeerSocket.Instance.Poll].
func (o *Extension[T]) Poll() error {
	return o.Super().AsStreamPeerSocket().Poll()
}

// GetStatus is promoted from [StreamPeerSocket.Instance.GetStatus].
func (self Instance) GetStatus() StreamPeerSocket.Status {
	return self.AsStreamPeerSocket().GetStatus()
}

// GetStatus is promoted from [StreamPeerSocket.Instance.GetStatus].
func (o *Extension[T]) GetStatus() StreamPeerSocket.Status {
	return o.Super().AsStreamPeerSocket().GetStatus()
}

// DisconnectFromHost is promoted from [StreamPeerSocket.Instance.DisconnectFromHost].
func (self Instance) DisconnectFromHost() {
	self.AsStreamPeerSocket().DisconnectFromHost()
}

// DisconnectFromHost is promoted from [StreamPeerSocket.Instance.DisconnectFromHost].
func (o *Extension[T]) DisconnectFromHost() {
	o.Super().AsStreamPeerSocket().DisconnectFromHost()
}
...
func (self Instance) Virtual(name string) reflect.Value {
	switch name {
	default: return gd.VirtualByName(StreamPeerSocket.Instance(self.AsStreamPeerSocket()), name)
	}
}
func init() {gdclass.Register("StreamPeerTCP", func(ptr gdreference.Object) any { return Instance{gdclass.NewStreamPeerTCP(ptr)} })}
