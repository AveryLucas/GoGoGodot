...
func (o *Extension[T]) Plane() Plane.NormalD { return o.Super().Plane() }
...
func (o *Extension[T]) SetPlane(value Plane.NormalD) *Extension[T] {
	o.Super().SetPlane(value)
	return o
}
...
func init() {gdclass.Register("WorldBoundaryShape3D", func(ptr gdreference.Object) any { return Instance{gdclass.NewWorldBoundaryShape3D(ptr)} })}
