...
func (o *Extension[T]) GetLayeredType() LayeredType {
	return o.Super().GetLayeredType()
}
...
func init() {gdclass.Register("TextureLayered", func(ptr gdreference.Object) any { return Instance{gdclass.NewTextureLayered(ptr)} })}
