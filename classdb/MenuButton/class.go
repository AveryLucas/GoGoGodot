...
func (o *Extension[T]) SwitchOnHover() bool { return o.Super().SwitchOnHover() }
...
func (o *Extension[T]) SetSwitchOnHover(value bool) *Extension[T] {
	o.Super().SetSwitchOnHover(value)
	return o
}
...
func init() {gdclass.Register("MenuButton", func(ptr gdreference.Object) any { return Instance{gdclass.NewMenuButton(ptr)} })}
