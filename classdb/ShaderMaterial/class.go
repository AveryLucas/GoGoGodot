...
func (o *Extension[T]) Shader() Shader.Instance { return o.Super().Shader() }
...
func (o *Extension[T]) SetShader(value Shader.Instance) *Extension[T] {
	o.Super().SetShader(value)
	return o
}
...
func (o *Extension[T]) SetShaderParameter(param string, value any) *Extension[T] {
	o.Super().SetShaderParameter(param, value)
	return o
}
func (o *Extension[T]) GetShaderParameter(param string) any {
	return o.Super().GetShaderParameter(param)
}
