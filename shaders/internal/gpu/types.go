...
import (
	...
	"github.com/AveryLucas/gogogd/classdb/Texture3D"
	"github.com/AveryLucas/gogogd/variant/Basis"
	"github.com/AveryLucas/gogogd/variant/Color"
	FloatVariant "github.com/AveryLucas/gogogd/variant/Float"
	IntVariant "github.com/AveryLucas/gogogd/variant/Int"
...
func NewVec2bExpression(e Expression) Vec2b { var r Vec2b; Set(&r, e); return r }
...
func NewVec3bExpression(e Expression) Vec3b { var r Vec3b; Set(&r, e); return r }
...
func NewVec4bExpression(e Expression) Vec4b { var r Vec4b; Set(&r, e); return r }
...
func NewVec2iExpression(e Expression) Vec2i { var r Vec2i; Set(&r, e); return r }
...
func NewVec3iExpression(e Expression) Vec3i { var r Vec3i; Set(&r, e); return r }
...
func NewVec4iExpression(e Expression) Vec4i { var r Vec4i; Set(&r, e); return r }
...
func NewVec2uExpression(e Expression) Vec2u { var r Vec2u; Set(&r, e); return r }
...
func NewVec3uExpression(e Expression) Vec3u { var r Vec3u; Set(&r, e); return r }
...
func NewVec4uExpression(e Expression) Vec4u { var r Vec4u; Set(&r, e); return r }
...
func NewVec3Expression(e Expression) Vec3 { var r Vec3; Set(&r, e); return r }
...
func NewVec4Expression(e Expression) Vec4 { var r Vec4; Set(&r, e); return r }
...
func NewRGBAExpression(e Expression) RGBA { var r RGBA; Set(&r, e); return r }
...
func NewRGBExpression(e Expression) RGB { var r RGB; Set(&r, e); return r }
