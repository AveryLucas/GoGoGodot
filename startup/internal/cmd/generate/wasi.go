...
func generate_startup_wasip1() error {
	...
	fmt.Fprint(f, "// Code generated by github.com/AveryLucas/gogogd/startup/internal/cmd/generate; DO NOT EDIT.\n")
	...
	fmt.Fprint(f, "import \"github.com/AveryLucas/gogogd/internal/gdmemory\"\n")
...
func generate_reloads_go() error {
	...
	fmt.Fprint(f, "\tgd \"github.com/AveryLucas/gogogd/internal\"\n")
	fmt.Fprint(f, "\t\"github.com/AveryLucas/gogogd/internal/callframe\"\n")
	fmt.Fprint(f, "\t\"github.com/AveryLucas/gogogd/internal/pointers\"\n")
	fmt.Fprint(f, ")\n\n")
